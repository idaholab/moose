...
data = np.genfromtxt(
    r"gold/single_var_final_csv_final_results_0001.csv", delimiter=",", names=True
)
...
l2.append(
    np.sqrt(
        sum(
            [
                np.power(data["T"][i] - analytical_simple(100.0, data["x"][i]), 2)
...
data = np.genfromtxt(
    r"gold/single_var_final_csv_final_results_0010.csv", delimiter=",", names=True
)
...
data = np.genfromtxt(
    r"gold/single_var_final_csv_final_results_0100.csv", delimiter=",", names=True
)
...
data = np.genfromtxt(
    r"gold/two_vars_final_csv_final_results_0001.csv", delimiter=",", names=True
)
...
l2.append(
    np.sqrt(
        sum(
            [
                np.power(data["frac_T"][i] - analytical_multi(100.0, data["x"][i]), 2)
                for i in range(len(data["x"]) - 1)
            ]
        )
    )
...
data = np.genfromtxt(
    r"gold/two_vars_final_csv_final_results_0010.csv", delimiter=",", names=True
)
...
data = np.genfromtxt(
    r"gold/two_vars_final_csv_final_results_0100.csv", delimiter=",", names=True
)
...
plt.plot(xvals, analytical_multi(100.0, xvals), label="analytical")
data = np.genfromtxt(
    r"gold/fracture_app_final_csv_final_results_0001.csv", delimiter=",", names=True
)
plt.plot(data["x"], data["frac_T"], linestyle="dotted", marker=".", label="dt = 100")
l2.append(
    np.sqrt(
...
data = np.genfromtxt(
    r"gold/fracture_app_final_csv_final_results_0010.csv", delimiter=",", names=True
)
plt.plot(data["x"], data["frac_T"], linestyle="dotted", marker=".", label="dt = 10")
l2.append(
    np.sqrt(
...
data = np.genfromtxt(
    r"gold/fracture_app_final_csv_final_results_0100.csv", delimiter=",", names=True
)
plt.plot(data["x"], data["frac_T"], ".", label="dt = 1")
l2.append(
    np.sqrt(
...
plt.plot(xvals, analytical_multi(100.0, xvals), label="analytical")
data = np.genfromtxt(
    r"gold/fracture_app_heat_final_csv_final_results_0001.csv",
    delimiter=",",
    names=True,
)
plt.plot(data["x"], data["frac_T"], linestyle="dotted", marker=".", label="dt = 100")
...
data = np.genfromtxt(
    r"gold/fracture_app_heat_final_csv_final_results_0010.csv",
    delimiter=",",
    names=True,
)
plt.plot(data["x"], data["frac_T"], linestyle="dotted", marker=".", label="dt = 10")
...
data = np.genfromtxt(
    r"gold/fracture_app_heat_final_csv_final_results_0100.csv",
    delimiter=",",
    names=True,
)
plt.plot(data["x"], data["frac_T"], ".", label="dt = 1")
...
plt.figure()
plt.loglog(
    l2errors["single_var"]["dt"], l2errors["single_var"]["l2"], label="No heat transfer"
)
plt.loglog(
    l2errors["two_vars"]["dt"], l2errors["two_vars"]["l2"], label="Coupled, no MultiApp"
)
plt.loglog(
    l2errors["fracture_app_heat"]["dt"],
    l2errors["fracture_app_heat"]["l2"],
    linestyle="dashed",
    label='Coupled, "heat" MultiApp',
)
plt.loglog(
    l2errors["fracture_app"]["dt"],
    l2errors["fracture_app"]["l2"],
    linestyle="dotted",
    label='Coupled, "T" MultiApp',
)
plt.grid()
plt.legend()
plt.xlabel("dt")

...
def moose(fn):
    try:
        ...
        subsample = [
            np.power(10, log10_max_val * i / float(num_pts_displayed - 1))
            for i in range(num_pts_displayed)
        ]  # 1 to max_val in logarithmic progression
        subsample = sorted(
            list(set([0] + [int(np.round(s)) for s in subsample]))
        )  # 0 to len(data)-1 in log progression
...
result_file_names = [
    "seff_rr_one_hour.csv",
    "seff_rr_one_day.csv",
    "seff_rr_one_month.csv",
    "seff_rr_five_years.csv",
]
tara_seff_rr = [tara_read(fn, scaling=1) for fn in result_file_names]
result_file_names = [
    "seff_tt_one_hour.csv",
    "seff_tt_one_day.csv",
    "seff_tt_one_month.csv",
    "seff_tt_five_years.csv",
]
...
plt.semilogx(
    moosePTSUSS[0][0],
    [(p - 18.3e6) / 1e6 for p in moosePTSUSS[0][1]],
    "b*",
    markersize=4,
    label="MOOSE (1 hour)",
)
...
plt.semilogx(
    moosePTSUSS[1][0],
    [(p - 18.3e6) / 1e6 for p in moosePTSUSS[1][1]],
    "rs",
    markersize=4,
    label="MOOSE (1 day)",
)
...
plt.semilogx(
    moosePTSUSS[2][0],
    [(p - 18.3e6) / 1e6 for p in moosePTSUSS[2][1]],
    "g^",
    markersize=4,
    label="MOOSE (1 month)",
)
...
plt.semilogx(
    moosePTSUSS[3][0],
    [(p - 18.3e6) / 1e6 for p in moosePTSUSS[3][1]],
    "ko",
    markersize=4,
    label="MOOSE (5 years)",
)
...
plt.figure()
plt.semilogx(
    moosePTSUSS[0][0], moosePTSUSS[0][2], "b*", markersize=4, label="MOOSE (1 hour)"
)
plt.semilogx(tara_tt[0][0], tara_tt[0][1], "b-", label="LaForce (1 hour)")
plt.semilogx(
    moosePTSUSS[1][0], moosePTSUSS[1][2], "rs", markersize=4, label="MOOSE (1 day)"
)
plt.semilogx(tara_tt[1][0], tara_tt[1][1], "r-", label="LaForce (1 day)")
plt.semilogx(
    moosePTSUSS[2][0], moosePTSUSS[2][2], "g^", markersize=4, label="MOOSE (1 month)"
)
plt.semilogx(tara_tt[2][0], tara_tt[2][1], "g-", label="LaForce (1 month)")
plt.semilogx(
    moosePTSUSS[3][0], moosePTSUSS[3][2], "ko", markersize=4, label="MOOSE (5 years)"
)
...
plt.semilogx(
    moosePTSUSS[0][0],
    [u * 1000 for u in moosePTSUSS[0][4]],
    "b*",
    markersize=4,
    label="MOOSE (1 hour)",
)
...
plt.semilogx(
    moosePTSUSS[1][0],
    [u * 1000 for u in moosePTSUSS[1][4]],
    "rs",
    markersize=4,
    label="MOOSE (1 day)",
)
...
plt.semilogx(
    moosePTSUSS[2][0],
    [u * 1000 for u in moosePTSUSS[2][4]],
    "g^",
    markersize=4,
    label="MOOSE (1 month)",
)
...
plt.semilogx(
    moosePTSUSS[3][0],
    [u * 1000 for u in moosePTSUSS[3][4]],
    "ko",
    markersize=4,
    label="MOOSE (5 years)",
)
...
plt.figure()
plt.semilogx(
    moosePTSUSS[0][0], moosePTSUSS[0][3], "b*", markersize=4, label="MOOSE (1 hour)"
)
plt.semilogx(tara_sg[0][0], tara_sg[0][1], "b-", label="LaForce (1 hour)")
plt.semilogx(
    moosePTSUSS[1][0], moosePTSUSS[1][3], "rs", markersize=4, label="MOOSE (1 day)"
)
plt.semilogx(tara_sg[1][0], tara_sg[1][1], "r-", label="LaForce (1 day)")
plt.semilogx(
    moosePTSUSS[2][0], moosePTSUSS[2][3], "g^", markersize=4, label="MOOSE (1 month)"
)
plt.semilogx(tara_sg[2][0], tara_sg[2][1], "g-", label="LaForce (1 month)")
plt.semilogx(
    moosePTSUSS[3][0], moosePTSUSS[3][3], "ko", markersize=4, label="MOOSE (5 years)"
)
...
plt.semilogx(
    moosePTSUSS[0][0],
    [s / 1e6 for s in moosePTSUSS[0][5]],
    "b*",
    markersize=4,
    label="MOOSE (1 hour)",
)
...
plt.semilogx(
    moosePTSUSS[1][0],
    [s / 1e6 for s in moosePTSUSS[1][5]],
    "rs",
    markersize=4,
    label="MOOSE (1 day)",
)
...
plt.semilogx(
    moosePTSUSS[2][0],
    [s / 1e6 for s in moosePTSUSS[2][5]],
    "g^",
    markersize=4,
    label="MOOSE (1 month)",
)
...
plt.semilogx(
    moosePTSUSS[3][0],
    [s / 1e6 for s in moosePTSUSS[3][5]],
    "ko",
    markersize=4,
    label="MOOSE (5 years)",
)
...
plt.semilogx(
    moosePTSUSS[0][0],
    [s / 1e6 for s in moosePTSUSS[0][6]],
    "b*",
    markersize=4,
    label="MOOSE (1 hour)",
)
...
plt.semilogx(
    moosePTSUSS[1][0],
    [s / 1e6 for s in moosePTSUSS[1][6]],
    "rs",
    markersize=4,
    label="MOOSE (1 day)",
)
...
plt.semilogx(
    moosePTSUSS[2][0],
    [s / 1e6 for s in moosePTSUSS[2][6]],
    "g^",
    markersize=4,
    label="MOOSE (1 month)",
)
...
plt.semilogx(
    moosePTSUSS[3][0],
    [s / 1e6 for s in moosePTSUSS[3][6]],
    "ko",
    markersize=4,
    label="MOOSE (5 years)",
)

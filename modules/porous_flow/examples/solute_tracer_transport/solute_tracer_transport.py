...
s01 = np.genfromtxt(
    "solute_tracer_transport_0.1.csv", delimiter=",", names=True, dtype=float
)
s03 = np.genfromtxt(
    "solute_tracer_transport_0.3.csv", delimiter=",", names=True, dtype=float
)
s05 = np.genfromtxt(
    "solute_tracer_transport_0.5.csv", delimiter=",", names=True, dtype=float
)
s07 = np.genfromtxt(
    "solute_tracer_transport_0.7.csv", delimiter=",", names=True, dtype=float
)
s1 = np.genfromtxt(
    "solute_tracer_transport_1.csv", delimiter=",", names=True, dtype=float
)
s3 = np.genfromtxt(
    "solute_tracer_transport_3.csv", delimiter=",", names=True, dtype=float
)
s5 = np.genfromtxt(
    "solute_tracer_transport_5.csv", delimiter=",", names=True, dtype=float
)
s7 = np.genfromtxt(
    "solute_tracer_transport_7.csv", delimiter=",", names=True, dtype=float
)
s10 = np.genfromtxt(
    "solute_tracer_transport_10.csv", delimiter=",", names=True, dtype=float
)
...
plt.plot(
    ...
    np.array(C_a_5) * 1000,
    "b",
    label="Analytical (dispersivity=5.0)",
)

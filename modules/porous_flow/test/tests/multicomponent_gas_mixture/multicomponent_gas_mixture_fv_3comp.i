...
[UserObjects]
  [dictator]
    ...
    porous_flow_vars = 'pp_CO2 mass_frac_CH4 mass_frac_N2'
...
[Materials]
  ...
  [CO2]
    ...
    fp = 'CH4 CO2 N2'
    mass_fraction = 'mass_frac_CH4 mass_frac_N2'
    phase = 0
  []
  [massfrac]
    type = ADPorousFlowMassFraction
    mass_fraction_vars = 'mass_frac_CH4 mass_frac_N2'
  []
  [temperature]

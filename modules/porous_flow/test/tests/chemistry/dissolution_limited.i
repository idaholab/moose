...
#
# a' = -mineral' = rate * surf_area * molar_vol (1 - (1 / eqm_const) * (act_coeff * a)^stoi)
#
...
#
# This test checks that (a+c) is time-independent, and that a follows the above solution, until c=0 and thereafter remains fixed.
#
# Aside:

...
# d(mineral)/dt = rate * surf_area * molar_vol (1 - (1 / eqm_const) * (act_coeff * a)^stoi)
#
...
# porosity = porosity(t=0) - (mineral - mineral(t=0)) = porosity(t=0) - t
#
# This test checks that mineral and porosity evolve correctly
[Mesh]
  type = GeneratedMesh
  dim = 1
[]

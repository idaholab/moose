...
def no_fluid(fn):
    correct_answer = map(
        float,
        "100,300,262.05620419362,233.16444061125,215.5562816469,206.53657081398,202.5048010279,200.88831039136,200.29514030239,200.09319946286,200.02989431659,200.0158846078".split(
            ","
        ),
    )

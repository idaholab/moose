...
b01 = np.genfromtxt(
    "../../../../../../test/tests/heat_advection/gold/heat_advection_1d_fully_saturated_T_0010.csv",
    delimiter=",",
    names=True,
    dtype=float,
)
c01 = np.genfromtxt(
    "../../../../../../test/tests/heat_advection/gold/heat_advection_1d_KT_T_0010.csv",
    delimiter=",",
    names=True,
    dtype=float,
)
...
a06 = np.genfromtxt(
    "../../../../../../test/tests/heat_advection/gold/heat_advection_1d_csv_T_0060.csv",
    delimiter=",",
    names=True,
    dtype=float,
)
b06 = np.genfromtxt(
    "../../../../../../test/tests/heat_advection/gold/heat_advection_1d_fully_saturated_T_0060.csv",
    delimiter=",",
    names=True,
    dtype=float,
)
c06 = np.genfromtxt(
    "../../../../../../test/tests/heat_advection/gold/heat_advection_1d_KT_T_0060.csv",
    delimiter=",",
    names=True,
    dtype=float,
)

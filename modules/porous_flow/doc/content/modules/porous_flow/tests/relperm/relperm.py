...
def brook_corey_func(
    lamda, S_res_w=0, sum_S_res_w=0, S_res_nw=0, sum_S_res_nw=0
...
def corey_func(
    n, S_res_w=0, sum_S_res_w=0, S_res_nw=0, sum_S_res_nw=0, scalew=1, scalenw=1
):  # This function return a list of 2 listes, the first one is for wet phase and second is for non wet
    k = []
    Seff_w = effS(S_res_w, sum_S_res_w, np.linspace(0, 1, 100))
...
def vanGen_func(
    m, S_res_w=0, sum_S_res_w=0, S_res_nw=0, sum_S_res_nw=0, scalew=1, scalenw=1
):  # This function return a list of 2 listes, the first one is for wet phase and second is for non wet
    k = []
    Seff_w = effS(S_res_w, sum_S_res_w, np.linspace(0, 1, 100))
...
brook_corey1 = np.genfromtxt(
    "../../../../../../test/tests/relperm/brooks_corey1_out_vpp_0001.csv",
    delimiter=",",
    names=True,
    dtype=float,
)
brook_corey2 = np.genfromtxt(
    "../../../../../../test/tests/relperm/brooks_corey2_out_vpp_0001.csv",
    delimiter=",",
    names=True,
    dtype=float,
)

corey1 = np.genfromtxt(
    "../../../../../../test/tests/relperm/corey1_out_vpp_0001.csv",
    delimiter=",",
    names=True,
    dtype=float,
)
corey2 = np.genfromtxt(
    "../../../../../../test/tests/relperm/corey2_out_vpp_0001.csv",
    delimiter=",",
    names=True,
    dtype=float,
)
corey3 = np.genfromtxt(
    "../../../../../../test/tests/relperm/corey3_out_vpp_0001.csv",
    delimiter=",",
    names=True,
    dtype=float,
)
corey4 = np.genfromtxt(
    "../../../../../../test/tests/relperm/corey4_out_vpp_0001.csv",
    delimiter=",",
    names=True,
    dtype=float,
)
...
vangen1 = np.genfromtxt(
    "../../../../../../test/tests/relperm/vangenuchten1_out_vpp_0001.csv",
    delimiter=",",
    names=True,
    dtype=float,
)
vangen2 = np.genfromtxt(
    "../../../../../../test/tests/relperm/vangenuchten2_out_vpp_0001.csv",
    delimiter=",",
    names=True,
    dtype=float,
)
...
unity = np.genfromtxt(
    "../../../../../../test/tests/relperm/unity_out_vpp_0001.csv",
    delimiter=",",
    names=True,
    dtype=float,
)

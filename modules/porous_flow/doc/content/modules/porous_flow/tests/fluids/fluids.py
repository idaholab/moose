...
brine1 = np.genfromtxt(
    "../../../../../../test/tests/fluids/brine1.csv",
    delimiter=",",
    names=True,
    dtype=float,
)
co2 = np.genfromtxt(
    "../../../../../../test/tests/fluids/co2.csv",
    delimiter=",",
    names=True,
    dtype=float,
)
h2o = np.genfromtxt(
    "../../../../../../test/tests/fluids/h2o.csv",
    delimiter=",",
    names=True,
    dtype=float,
)
ideal_gas = np.genfromtxt(
    "../../../../../../test/tests/fluids/ideal_gas.csv",
    delimiter=",",
    names=True,
    dtype=float,
)
methane = np.genfromtxt(
    "../../../../../../test/tests/fluids/methane.csv",
    delimiter=",",
    names=True,
    dtype=float,
)
...
sfdy = np.genfromtxt(
    "../../../../../../test/tests/fluids/simple_fluid_dy_out.csv",
    delimiter=",",
    names=True,
    dtype=float,
)
sfhr = np.genfromtxt(
    "../../../../../../test/tests/fluids/simple_fluid_hr_out.csv",
    delimiter=",",
    names=True,
    dtype=float,
)
sfMPa = np.genfromtxt(
    "../../../../../../test/tests/fluids/simple_fluid_MPa_out.csv",
    delimiter=",",
    names=True,
    dtype=float,
)
sfyrMPa = np.genfromtxt(
    "../../../../../../test/tests/fluids/simple_fluid_yr_MPa_C_out.csv",
    delimiter=",",
    names=True,
    dtype=float,
)
sfyr = np.genfromtxt(
    "../../../../../../test/tests/fluids/simple_fluid_yr_out.csv",
    delimiter=",",
    names=True,
    dtype=float,
)
sf = np.genfromtxt(
    "../../../../../../test/tests/fluids/simple_fluid.csv",
    delimiter=",",
    names=True,
    dtype=float,
)

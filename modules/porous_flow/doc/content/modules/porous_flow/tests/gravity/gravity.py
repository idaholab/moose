...
def grav01():
    correct_answer = map(
        float,
        "1,0,0.10441434109933,0.21878753483875,0.34522157340659,0.48656333815975,0.64680430448933,0.83179050603148,1.0505858193139,1.3183764163454,1.6636365785267,2.1503197642602,2.1501113630737,2.1503197642602".split(
            ","
        ),
    )
    try:
...
plt.figure()
plt.plot(
    xpoints, expected(xpoints), "k-", linewidth=3.0, label="expected (single phase)"
)

...
data = pd.read_csv(
    "../../../../../../test/tests/dispersion/gold/diff01_out_xmass_0021.csv"
)
data_fv = pd.read_csv(
...
def expected(x, t):
    ...
    return (
        ...
        + np.sqrt(v * v * t / (np.pi * D)) * np.exp(-((x - v * t) ** 2) / (4 * D * t))
        - 0.5
        * (1 + v * x / D + v * v * t / D)
        * np.exp(v * x / D)
...
# Read MOOSE simulation data
data = pd.read_csv(
    "../../../../../../test/tests/dispersion/gold/disp01_out_xmass_0029.csv"
)
data_fv = pd.read_csv(
    "../../../../../../test/tests/dispersion/gold/disp01_fv_out_xmass_0023.csv"
)
data_heavy = pd.read_csv(
    "../../../../../../test/tests/dispersion/gold/disp01_heavy_out_xmass_0105.csv"
)

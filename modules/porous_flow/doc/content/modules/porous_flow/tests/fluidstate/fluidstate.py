...
tdata = np.genfromtxt(
    "../../../../../../test/tests/fluidstate/gold/theis_tabulated_csvout_line_0010.csv",
    delimiter=",",
    names=True,
    dtype=float,
)
rdata = np.genfromtxt(
    "../../../../../../test/tests/fluidstate/gold/theis_tabulated_csvout.csv",
    delimiter=",",
    names=True,
    dtype=float,
)
...
tdata = np.genfromtxt(
    "../../../../../../test/tests/fluidstate/gold/theis_brineco2_csvout_line_0028.csv",
    delimiter=",",
    names=True,
    dtype=float,
)
rdata = np.genfromtxt(
    "../../../../../../test/tests/fluidstate/gold/theis_brineco2_csvout.csv",
    delimiter=",",
    names=True,
    dtype=float,
)

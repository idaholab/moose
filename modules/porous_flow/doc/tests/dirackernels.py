...
def bh07():
    f = open("../../tests/dirackernels/gold/bh07_pp_0003.csv")
    data = [line.strip().split(",") for line in f.readlines()[1:]]
    f.close()
...
plt.figure()
plt.plot(ppoints, bh02_expected(ppoints), 'k-', linewidth = 3.0, label = 'expected')
plt.plot([x[0] for x in bh02], [x[1] for x in bh02], 'rs', markersize = 10.0, label = 'MOOSE')
...
plt.figure()
plt.plot(ppoints, bh03_expected(ppoints), 'k-', linewidth = 3.0, label = 'expected')
plt.plot([x[0] for x in bh03], [x[1] for x in bh03], 'rs', markersize = 10.0, label = 'MOOSE')
plt.legend(loc = 'lower right')
plt.xlabel("Porepressure (Pa)")
plt.ylabel("flow rate (kg/s)")
...
plt.figure()
plt.plot(ppoints, bh04_expected(ppoints), 'k-', linewidth = 3.0, label = 'expected')
plt.plot([x[0] for x in bh04], [x[1] for x in bh04], 'rs', markersize = 10.0, label = 'MOOSE')
plt.legend(loc = 'lower right')
plt.xlabel("Porepressure (Pa)")
plt.ylabel("flow rate (kg/s)")
...
plt.figure()
plt.plot(ppoints, bh05_expected(ppoints), 'k-', linewidth = 3.0, label = 'expected')
plt.plot([x[0] for x in bh05], [x[1] for x in bh05], 'rs', markersize = 10.0, label = 'MOOSE')
plt.legend(loc = 'lower right')
plt.xlabel("Porepressure (Pa)")
plt.ylabel("flow rate (kg/s)")
...
plt.figure()
plt.plot([x[0]/1E3 for x in bh05], [x[2]*1E13 for x in bh05], 'rs', markersize = 10.0, label = 'MOOSE')
plt.xlabel("Porepressure (kPa)")
plt.ylabel("Mass-balance error (units 1E-13)")
...
plt.figure()
plt.plot(rpoints/1E6, bh07_expected(rpoints), 'k-', linewidth = 3.0, label = 'expected')
plt.plot([x[0]/1E6 for x in bh07], [x[1] for x in bh07], 'rs', markersize = 10.0, label = 'MOOSE')
plt.legend(loc = 'lower right')
plt.xlabel("radius (m)")

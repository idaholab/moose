...
tdata = np.genfromtxt('../../test/tests/dirackernels/theis3_line_0016.csv', delimiter = ',', names = True, dtype = float)
rdata = np.genfromtxt('../../test/tests/dirackernels/theis3.csv', delimiter = ',', names = True, dtype = float)
...
tdata = np.genfromtxt('../../test/tests/fluidstate/theis_csvout_line_0028.csv', delimiter = ',', names = True, dtype = float)
rdata = np.genfromtxt('../../test/tests/fluidstate/theis_csvout.csv', delimiter = ',', names = True, dtype = float)
...
tdata = np.genfromtxt('../../test/tests/fluidstate/theis_brineco2_csvout_line_0028.csv', delimiter = ',', names = True, dtype = float)
rdata = np.genfromtxt('../../test/tests/fluidstate/theis_brineco2_csvout.csv', delimiter = ',', names = True, dtype = float)

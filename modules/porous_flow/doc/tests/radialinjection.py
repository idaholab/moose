...
tdata2 = np.genfromtxt('../../tests/fluidstate/theis_brineco2_csvout_line2_0028.csv', delimiter = ',', names = True, dtype = float)
...
axes[1].legend()
plt.tight_layout()
plt.savefig("theis_similarity_brineco2_fig2.pdf")

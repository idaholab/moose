...
PorousFlowEnthalpy::PorousFlowEnthalpy(const InputParameters & parameters) :
    ...
    _density(_nodal_material ? getMaterialProperty<Real>("PorousFlow_fluid_phase_density" + Moose::stringify(_phase_num)) : getMaterialProperty<Real>("PorousFlow_fluid_phase_density_qp" + Moose::stringify(_phase_num))),
    _ddensity_dp(_nodal_material ? getMaterialPropertyDerivative<Real>("PorousFlow_fluid_phase_density" + Moose::stringify(_phase_num), _pressure_variable_name) : getMaterialPropertyDerivative<Real>("PorousFlow_fluid_phase_density_qp" + Moose::stringify(_phase_num), _pressure_variable_name)),
    _ddensity_dt(_nodal_material ? getMaterialPropertyDerivative<Real>("PorousFlow_fluid_phase_density" + Moose::stringify(_phase_num), _temperature_variable_name) : getMaterialPropertyDerivative<Real>("PorousFlow_fluid_phase_density_qp" + Moose::stringify(_phase_num), _temperature_variable_name)),

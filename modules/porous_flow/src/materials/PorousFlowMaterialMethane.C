...
PorousFlowMaterialMethane::computeQpProperties()
{
  ...
  _density[_qp] = density(_porepressure_nodal[_qp][_phase_num], _temperature_nodal[_qp][_phase_num]);
  _ddensity_dp[_qp] = dDensity_dP(_temperature_nodal[_qp][_phase_num]);
  ...
  _viscosity[_qp] = viscosity(_temperature_nodal[_qp][_phase_num]);
  _dviscosity_dt[_qp] = dViscosity_dT(_temperature_nodal[_qp][_phase_num]);
}

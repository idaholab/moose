...
Real
PorousFlowMaterialSimpleCO2::density(Real pressure, Real temperature) const
{
  Real rho;
...
Real
PorousFlowMaterialSimpleCO2::viscosity(Real pressure, Real temperature, Real density) const
{
  Real mu;
...
Real
PorousFlowMaterialSimpleCO2::dDensity_dP(Real pressure, Real temperature) const
{
  Real drho;
...
Real
PorousFlowMaterialSimpleCO2::dDensity_dT(Real pressure, Real temperature) const
{
  Real drho;
...
Real
PorousFlowMaterialSimpleCO2::gasViscosity(Real temperature, Real density) const
{
...
Real
PorousFlowMaterialSimpleCO2::supercriticalViscosity(Real pressure, Real temperature) const
{
...
Real
PorousFlowMaterialSimpleCO2::partialDensity(Real temperature) const
{
...
Real
PorousFlowMaterialSimpleCO2::supercriticalDensity(Real pressure, Real temperature) const
{
...
Real
PorousFlowMaterialSimpleCO2::gasDensity(Real pressure, Real temperature) const
{
  Real tk = temperature + _t_c2k;
...
Real
PorousFlowMaterialSimpleCO2::dGasDensity_dP(Real pressure, Real temperature) const
{
  Real tk = temperature + _t_c2k;
  Real tc = std::pow((tk * 1.e-2), 10./3.);
  Real pc = pressure * 1.e-6;
...
Real
PorousFlowMaterialSimpleCO2::dGasDensity_dT(Real pressure, Real temperature) const
{
  Real tk = temperature + _t_c2k;
  Real tc = std::pow((tk * 1.e-2), 10./3.);
  Real pc = pressure * 1.e-6;
...
Real
PorousFlowMaterialSimpleCO2::dSupercriticalDensity_dP(Real pressure, Real temperature) const
{
  Real b1[5] = {4.757146002428e2, -2.619250287624e1, 5.215134206837e-1,
    -4.494511089838e-3, 1.423058795982e-5};
  Real b2[5] = {-3.713900186613e-1, 2.072488876536e-2, -4.169082831078e-4,
...
Real
PorousFlowMaterialSimpleCO2::dSupercriticalDensity_dT(Real pressure, Real temperature) const
{
  Real b0[5] = {-2.148322085348e5, 1.168116599408e4, -2.302236659392e2,
    1.967428940167, -6.184842764145e-3};
  Real b1[5] = {4.757146002428e2, -2.619250287624e1, 5.215134206837e-1,
...
Real
PorousFlowMaterialSimpleCO2::dViscosity_dDensity(Real pressure, Real temperature, Real density) const
{
  Real dmu_drho;
...
Real
PorousFlowMaterialSimpleCO2::dGasViscosity_dDensity(Real temperature, Real density) const
{
  Real tk = temperature + _t_c2k;
  Real tstar = tk / 251.196;
  Real d[5] = {0.4071119e-2, 0.7198037e-4, 0.2411697e-16, 0.2971072e-22, -0.1627888e-22};
...
Real
PorousFlowMaterialSimpleCO2::dSupercriticalViscosity_dDensity(Real pressure, Real temperature) const
{
  Real dmu_drho = 0.;
...
Real
PorousFlowMaterialSimpleCO2::dSupercriticalViscosity_dP(Real pressure, Real temperature) const
{
  Real b1[5] = {4.187280585109E-02, -2.425666731623E-03, 5.051177210444E-05,
    -4.527585394282E-07, 1.483580144144E-09};
  Real b2[5] = {-3.164424775231E-05, 1.853493293079E-06, -3.892243662924E-08,

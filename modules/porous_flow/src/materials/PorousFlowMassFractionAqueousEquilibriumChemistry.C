...
validParams<PorousFlowMassFractionAqueousEquilibriumChemistry>()
{
  ...
  params.addClassDescription(
      ...
      "(total concentrations of primary species (dimensionless) and since this is for an aqueous "
      "system only mass-fraction equals volume-fraction) corresponding to an "

...
PorousFlowMaterialCapillaryPressureVGP::PorousFlowMaterialCapillaryPressureVGP(const InputParameters & parameters) :
...
void
PorousFlowMaterialCapillaryPressureVGP::computeQpProperties()
{
...
Real
PorousFlowMaterialCapillaryPressureVGP::effectiveSaturation(Real pressure) const
{
  Real n, seff;
...
Real
PorousFlowMaterialCapillaryPressureVGP::dEffectiveSaturation(Real pressure) const
{
  if (pressure >= 0.0)
    return 0.0;
  else
...
Real
PorousFlowMaterialCapillaryPressureVGP::d2EffectiveSaturation(Real pressure) const
{
  if (pressure >= 0.0)
    return 0.0;
  else

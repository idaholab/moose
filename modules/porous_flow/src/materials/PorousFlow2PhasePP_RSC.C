...
{
  return PorousFlowEffectiveSaturationRSC::seff(- pressure, _shift, _scale);
}

Real
PorousFlow2PhasePP_RSC::dEffectiveSaturation_dP(Real pressure) const
{
  return - PorousFlowEffectiveSaturationRSC::dseff(- pressure, _shift, _scale);
}

Real
PorousFlow2PhasePP_RSC::d2EffectiveSaturation_dP2(Real pressure) const
{
  return PorousFlowEffectiveSaturationRSC::d2seff(- pressure, _shift, _scale);
}

    ...
    _phase1_porepressure_varnum(coupled("phase1_porepressure"))
{
  if (_dictator_UO.num_phases() != 2)
    mooseError("The Dictator announces that the number of phases is " << _dictator_UO.num_phases() << " whereas PorousFlowMaterial2PhasePP can only be used for 2-phase simulation.  When you have an efficient government, you have a dictatorship.");
}

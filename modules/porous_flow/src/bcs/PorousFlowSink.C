...
PorousFlowSink::PorousFlowSink(const InputParameters & parameters) :
    ...
    _has_enthalpy(hasMaterialProperty<std::vector<Real> >("PorousFlow_fluid_phase_enthalpy") && hasMaterialProperty<std::vector<std::vector<Real> > >("dPorousFlow_fluid_phase_enthalpy_nodal_dvar")),

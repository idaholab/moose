...
PorousFlowSink::PorousFlowSink(const InputParameters & parameters) :
    ...
    _internal_energy(_has_internal_energy ? &getMaterialPropertyByName<std::vector<Real> >("PorousFlow_fluid_phase_internal_energy_nodal") : NULL),
    _dinternal_energy_dvar(_has_internal_energy ? &getMaterialPropertyByName<std::vector<std::vector<Real> > >("dPorousFlow_fluid_phase_internal_energy_nodal_dvar") : NULL),
    _thermal_conductivity(_has_thermal_conductivity ? &getMaterialProperty<RealTensorValue>("PorousFlow_thermal_conductivity_qp") : NULL),
    _dthermal_conductivity_dvar(_has_thermal_conductivity ? &getMaterialProperty<std::vector<RealTensorValue> >("dPorousFlow_thermal_conductivity_qp_dvar") : NULL),

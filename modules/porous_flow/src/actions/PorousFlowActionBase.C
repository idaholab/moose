...
PorousFlowActionBase::addTemperatureMaterial()
{
  if (_current_task == "add_material")
  {
    ...
    params.applyParameters(parameters()); // this sets the temperature variable
    params.set<UserObjectName>("PorousFlowDictator") = _dictator_name;
    params.set<std::vector<SubdomainName>>("block") = {};
...
PorousFlowActionBase::addMassFractionMaterial()
{
  if (_current_task == "add_material")
  {
    ...
    params.applyParameters(parameters()); // this sets the mass_fraction_vars variable
    params.set<UserObjectName>("PorousFlowDictator") = _dictator_name;
    params.set<std::vector<SubdomainName>>("block") = {};
...
void
PorousFlowActionBase::addSingleComponentFluidMaterial(unsigned phase, const UserObjectName & fp)
{
  if (_current_task == "add_material")
  {
...
void
PorousFlowActionBase::addRelativePermeabilityCorey(unsigned phase,
                                                   Real n,
                                                   Real s_res,
                                                   Real sum_s_res)
...
void
PorousFlowActionBase::addRelativePermeabilityFLAC(unsigned phase,
                                                  Real m,
                                                  Real s_res,
                                                  Real sum_s_res)
{

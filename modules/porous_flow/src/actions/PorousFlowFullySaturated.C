...
PorousFlowFullySaturated::act()
{
  ...
  if (_current_task == "add_material")
  {
    ...
    material_name = "PorousFlowFullySaturated_1PhaseP";
  ...
  // relative permeability is always unity, and is only needed by AuxKernels
  addRelativePermeabilityCorey(0, 0.0, 0.0, 0.0);
}

...
Real
PorousFlowEffectiveSaturationVG::seff(Real p, Real al, Real m)
{
  Real n, seff;
...
Real
PorousFlowEffectiveSaturationVG::dseff(Real p, Real al, Real m)
{
  if (p >= 0)
    return 0.0;
  else
...
Real
PorousFlowEffectiveSaturationVG::d2seff(Real p, Real al, Real m)
{
  if (p >= 0)
    return 0.0;
  else

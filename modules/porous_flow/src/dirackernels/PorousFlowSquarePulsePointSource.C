...
InputParameters validParams<PorousFlowSquarePulsePointSource>()
{
  ...
  params.addParam<Real>("start_time", 0.0, "The time at which the source will start (Default is 0)");
  params.addParam<Real>("end_time", 1.0e30, "The time at which the source will end (Default is 1e30)");
  return params;
}

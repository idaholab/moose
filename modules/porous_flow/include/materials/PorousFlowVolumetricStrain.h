 ...
 */
template <bool is_ad>
class PorousFlowVolumetricStrainTempl : public PorousFlowMaterialVectorBase
{
public:
  static InputParameters validParams();

  PorousFlowVolumetricStrainTempl(const InputParameters & parameters);
...
protected:
  ...
  GenericMaterialProperty<Real, is_ad> & _vol_strain_rate_qp;
   ...
   */
  MaterialProperty<std::vector<RealGradient>> * const _dvol_strain_rate_qp_dvar;

  /// The total volumetric strain at the quadpoints
  GenericMaterialProperty<Real, is_ad> & _vol_total_strain_qp;
   ...
   * this should be multiplied by _grad_phi in kernels
   */
  MaterialProperty<std::vector<RealGradient>> * const _dvol_total_strain_qp_dvar;
};

typedef PorousFlowVolumetricStrainTempl<false> PorousFlowVolumetricStrain;
typedef PorousFlowVolumetricStrainTempl<true> ADPorousFlowVolumetricStrain;

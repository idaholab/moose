 ...
 */
template <bool is_ad>
class PorousFlowPorosityChemCoupledTempl : public PorousFlowPorosityBaseTempl<is_ad>
{
public:
  static InputParameters validParams();

  PorousFlowPorosityChemCoupledTempl(const InputParameters & parameters);
...
typedef PorousFlowPorosityChemCoupledTempl<false> PorousFlowPorosityChemCoupled;
typedef PorousFlowPorosityChemCoupledTempl<true> ADPorousFlowPorosityChemCoupled;

...
[Materials]
  ...
  [czm]
    ...
    # Match the AD law's normal peak and initial tangential stiffness for comparison.
    maximum_normal_traction = 183.939720585721
    maximum_shear_traction = 303.265329856317
    boundary = Block1_Block2
  []
[]

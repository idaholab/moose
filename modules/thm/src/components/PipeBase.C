...
PipeBase::init()
{
  ...
  pars.set<UserObjectName>("rdg_conservative_flux") = _rdg_conservative_flux_name;
  ...
  {
    pars.set<UserObjectName>("rdg_nonconservative_flux") = _rdg_nonconservative_flux_name;

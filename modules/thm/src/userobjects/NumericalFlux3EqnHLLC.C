                                    ...
                                    DenseMatrix<Real> & dFR_dUR) const
{
  ...
  dFL_dUL.resize(THM3Eqn::N_EQ, THM3Eqn::N_EQ);
  dFL_dUR.resize(THM3Eqn::N_EQ, THM3Eqn::N_EQ);
  if (s1 > 0.0) // left region
  {
    dFL_dUL(THM3Eqn::EQ_MASS, THM3Eqn::EQ_MASS) = 0.0;
    dFL_dUL(THM3Eqn::EQ_MASS, THM3Eqn::EQ_MOMENTUM) = 1.0;
    dFL_dUL(THM3Eqn::EQ_MASS, THM3Eqn::EQ_ENERGY) = 0.0;

    dFL_dUL(THM3Eqn::EQ_MOMENTUM, THM3Eqn::EQ_MASS) = (dp1_drho1 - u1 * u1);
    dFL_dUL(THM3Eqn::EQ_MOMENTUM, THM3Eqn::EQ_MOMENTUM) = (2.0 * u1 + dp1_drhou1);
    dFL_dUL(THM3Eqn::EQ_MOMENTUM, THM3Eqn::EQ_ENERGY) = dp1_drhoE1;

    dFL_dUL(THM3Eqn::EQ_ENERGY, THM3Eqn::EQ_MASS) = (u1 * dp1_drho1 - u1 / rho1 * (rhoE1 + p1));
    dFL_dUL(THM3Eqn::EQ_ENERGY, THM3Eqn::EQ_MOMENTUM) = ((rhoE1 + p1) / rho1 + u1 * dp1_drhou1);
    dFL_dUL(THM3Eqn::EQ_ENERGY, THM3Eqn::EQ_ENERGY) = u1 * (1.0 + dp1_drhoE1);

    _last_region_index = 0;
  }
  else if (s2 < 0.0) // right region
  {
    dFL_dUR(THM3Eqn::EQ_MASS, THM3Eqn::EQ_MASS) = 0.0;
    dFL_dUR(THM3Eqn::EQ_MASS, THM3Eqn::EQ_MOMENTUM) = 1.0;
    dFL_dUR(THM3Eqn::EQ_MASS, THM3Eqn::EQ_ENERGY) = 0.0;

    dFL_dUR(THM3Eqn::EQ_MOMENTUM, THM3Eqn::EQ_MASS) = (dp2_drho2 - u2 * u2);
    dFL_dUR(THM3Eqn::EQ_MOMENTUM, THM3Eqn::EQ_MOMENTUM) = (2.0 * u2 + dp2_drhou2);
    dFL_dUR(THM3Eqn::EQ_MOMENTUM, THM3Eqn::EQ_ENERGY) = dp2_drhoE2;

    dFL_dUR(THM3Eqn::EQ_ENERGY, THM3Eqn::EQ_MASS) = (u2 * dp2_drho2 - u2 / rho2 * (rhoE2 + p2));
    dFL_dUR(THM3Eqn::EQ_ENERGY, THM3Eqn::EQ_MOMENTUM) = ((rhoE2 + p2) / rho2 + u2 * dp2_drhou2);
    dFL_dUR(THM3Eqn::EQ_ENERGY, THM3Eqn::EQ_ENERGY) = u2 * (1.0 + dp2_drhoE2);
  ...
  else // star (left or right) region
  {
    ...
    if (s1 <= 0.0 && sm > 0.0) // left star region
    {
      ...
      dFL_dUL(THM3Eqn::EQ_MASS, THM3Eqn::EQ_MASS) = sm * drhoLs_drho1 + rhoLs * dsm_drho1;
      dFL_dUL(THM3Eqn::EQ_MASS, THM3Eqn::EQ_MOMENTUM) = sm * drhoLs_drhou1 + rhoLs * dsm_drhou1;
      dFL_dUL(THM3Eqn::EQ_MASS, THM3Eqn::EQ_ENERGY) = sm * drhoLs_drhoE1 + rhoLs * dsm_drhoE1;

      dFL_dUL(THM3Eqn::EQ_MOMENTUM, THM3Eqn::EQ_MASS) =
          sm * drhouLs_drho1 + rhouLs * dsm_drho1 + nx * dps_drho1;
      dFL_dUL(THM3Eqn::EQ_MOMENTUM, THM3Eqn::EQ_MOMENTUM) =
          sm * drhouLs_drhou1 + rhouLs * dsm_drhou1 + nx * dps_drhou1;
      dFL_dUL(THM3Eqn::EQ_MOMENTUM, THM3Eqn::EQ_ENERGY) =
          sm * drhouLs_drhoE1 + rhouLs * dsm_drhoE1 + nx * dps_drhoE1;

      dFL_dUL(THM3Eqn::EQ_ENERGY, THM3Eqn::EQ_MASS) =
          sm * (drhoELs_drho1 + dps_drho1) + (rhoELs + ps) * dsm_drho1;
      dFL_dUL(THM3Eqn::EQ_ENERGY, THM3Eqn::EQ_MOMENTUM) =
          sm * (drhoELs_drhou1 + dps_drhou1) + (rhoELs + ps) * dsm_drhou1;
      dFL_dUL(THM3Eqn::EQ_ENERGY, THM3Eqn::EQ_ENERGY) =
      ...
      dFL_dUR(THM3Eqn::EQ_MASS, THM3Eqn::EQ_MASS) = sm * drhoLs_drho2 + rhoLs * dsm_drho2;
      dFL_dUR(THM3Eqn::EQ_MASS, THM3Eqn::EQ_MOMENTUM) = sm * drhoLs_drhou2 + rhoLs * dsm_drhou2;
      dFL_dUR(THM3Eqn::EQ_MASS, THM3Eqn::EQ_ENERGY) = sm * drhoLs_drhoE2 + rhoLs * dsm_drhoE2;

      dFL_dUR(THM3Eqn::EQ_MOMENTUM, THM3Eqn::EQ_MASS) =
          sm * drhouLs_drho2 + rhouLs * dsm_drho2 + nx * dps_drho2;
      dFL_dUR(THM3Eqn::EQ_MOMENTUM, THM3Eqn::EQ_MOMENTUM) =
          sm * drhouLs_drhou2 + rhouLs * dsm_drhou2 + nx * dps_drhou2;
      dFL_dUR(THM3Eqn::EQ_MOMENTUM, THM3Eqn::EQ_ENERGY) =
          sm * drhouLs_drhoE2 + rhouLs * dsm_drhoE2 + nx * dps_drhoE2;

      dFL_dUR(THM3Eqn::EQ_ENERGY, THM3Eqn::EQ_MASS) =
          sm * (drhoELs_drho2 + dps_drho2) + (rhoELs + ps) * dsm_drho2;
      dFL_dUR(THM3Eqn::EQ_ENERGY, THM3Eqn::EQ_MOMENTUM) =
          sm * (drhoELs_drhou2 + dps_drhou2) + (rhoELs + ps) * dsm_drhou2;
      dFL_dUR(THM3Eqn::EQ_ENERGY, THM3Eqn::EQ_ENERGY) =
    ...
    else if (sm <= 0.0 && s2 >= 0.0) // right star region
    {
      ...
      dFL_dUL(THM3Eqn::EQ_MASS, THM3Eqn::EQ_MASS) = sm * drhoRs_drho1 + rhoRs * dsm_drho1;
      dFL_dUL(THM3Eqn::EQ_MASS, THM3Eqn::EQ_MOMENTUM) = sm * drhoRs_drhou1 + rhoRs * dsm_drhou1;
      dFL_dUL(THM3Eqn::EQ_MASS, THM3Eqn::EQ_ENERGY) = sm * drhoRs_drhoE1 + rhoRs * dsm_drhoE1;
      ...
      dFL_dUR(THM3Eqn::EQ_MASS, THM3Eqn::EQ_MASS) = sm * drhoRs_drho2 + rhoRs * dsm_drho2;
      dFL_dUR(THM3Eqn::EQ_MASS, THM3Eqn::EQ_MOMENTUM) = sm * drhoRs_drhou2 + rhoRs * dsm_drhou2;
      dFL_dUR(THM3Eqn::EQ_MASS, THM3Eqn::EQ_ENERGY) = sm * drhoRs_drhoE2 + rhoRs * dsm_drhoE2;

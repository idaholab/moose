...
class JunctionMomentumConstraint;
class JunctionStagnationEnthalpyUserObject;
class SinglePhaseFluidProperties;

template <>
InputParameters validParams<JunctionMomentumConstraint>();

/**
 * Adds momentum boundary fluxes for a junction
 *
 ...
 */
class JunctionMomentumConstraint : public NodalConstraint
{
public:
  JunctionMomentumConstraint(const InputParameters & parameters);

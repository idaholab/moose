#ifndef JUNCTIONMASSCONSTRAINT_H
#define JUNCTIONMASSCONSTRAINT_H

#include "NodalConstraint.h"

class JunctionMassConstraint;
class JunctionStagnationEnthalpyUserObject;
class SinglePhaseFluidProperties;

template <>
InputParameters validParams<JunctionMassConstraint>();

/**
 * Adds mass boundary fluxes for a junction
 *
 ...
 */
class JunctionMassConstraint : public NodalConstraint
{
public:
  JunctionMassConstraint(const InputParameters & parameters);
...
#endif /* JUNCTIONMASSCONSTRAINT_H */

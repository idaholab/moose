...
FluidStructureInteractionTestApp::FluidStructureInteractionTestApp(InputParameters parameters) : MooseApp(parameters)
{
...
void
FluidStructureInteractionTestApp::registerAll(Factory & f, ActionFactory & af, Syntax & s, bool use_test_objs)
{

...
# Initial condition = sin(3.141*x) + sin(3*3.141*x) + sin(5*3.141*x) + sin(7*3.141*x) + sin(9*3.141*x)
# Fluid domain = true
...
[Functions]
  [./initial_cond]
    type = ParsedFunction
    value = 'sin(3.141*x) + sin(3*3.141*x) + sin(5*3.141*x) + sin(7*3.141*x) + sin(9*3.141*x)'
  [../]
[]

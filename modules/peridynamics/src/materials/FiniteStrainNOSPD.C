...
registerMooseObject("PeridynamicsApp", FiniteStrainNOSPD);

MooseEnum
FiniteStrainNOSPD::decompositionType()
{
...
FiniteStrainNOSPD::FiniteStrainNOSPD(const InputParameters & parameters)
...
void
FiniteStrainNOSPD::computeQpStrain()
{
...
void
FiniteStrainNOSPD::computeQpFhat()
{
...
void
FiniteStrainNOSPD::computeQpStrainRotationIncrements(RankTwoTensor & total_strain_increment,
                                                     RankTwoTensor & rotation_increment)
{
  switch (_decomposition_method)
  {
    ...
    default:
      mooseError("FiniteStrainNOSPD Error: Invalid decomposition type! Please specify : "
                 "TaylorExpansion or "
                 "EigenSolution.");
  }
}
...
void
FiniteStrainNOSPD::subtractEigenstrainIncrementFromStrain(RankTwoTensor & strain)
{

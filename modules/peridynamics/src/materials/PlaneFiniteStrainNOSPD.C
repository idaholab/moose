...
#include "PlaneFiniteStrainNOSPD.h"
#include "RankTwoTensor.h"

registerMooseObject("PeridynamicsApp", PlaneFiniteStrainNOSPD);

template <>
InputParameters
validParams<PlaneFiniteStrainNOSPD>()
{
  InputParameters params = validParams<FiniteStrainNOSPD>();
...
PlaneFiniteStrainNOSPD::PlaneFiniteStrainNOSPD(const InputParameters & parameters)
  : FiniteStrainNOSPD(parameters),
...
void
PlaneFiniteStrainNOSPD::computeQpFhat()
{
...
Real
PlaneFiniteStrainNOSPD::computeQpOutOfPlaneDeformationGradient()
{
...
Real
PlaneFiniteStrainNOSPD::computeQpOutOfPlaneDeformationGradientOld()
{
  if (_scalar_out_of_plane_strain_coupled)

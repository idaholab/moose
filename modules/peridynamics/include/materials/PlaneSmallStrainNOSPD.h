...
#ifndef PLANESMALLSTRAINNOSPD_H
#define PLANESMALLSTRAINNOSPD_H

#include "SmallStrainNOSPD.h"
#include "RankTwoTensor.h"

class PlaneSmallStrainNOSPD;

template <>
InputParameters validParams<PlaneSmallStrainNOSPD>();
 ...
 */
class PlaneSmallStrainNOSPD : public SmallStrainNOSPD
{
public:
  PlaneSmallStrainNOSPD(const InputParameters & parameters);

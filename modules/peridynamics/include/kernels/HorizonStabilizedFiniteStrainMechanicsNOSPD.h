 ...
 */
class HorizonStabilizedFiniteStrainMechanicsNOSPD : public MechanicsBaseNOSPD
{
public:
  static InputParameters validParams();

  HorizonStabilizedFiniteStrainMechanicsNOSPD(const InputParameters & parameters);

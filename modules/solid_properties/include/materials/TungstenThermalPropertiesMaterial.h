 ...
 */
template <bool is_ad>
class TungstenThermalPropertiesMaterialTempl : public Material
{
public:
...
typedef TungstenThermalPropertiesMaterialTempl<false> TungstenThermalPropertiesMaterial;
typedef TungstenThermalPropertiesMaterialTempl<true> ADTungstenThermalPropertiesMaterial;

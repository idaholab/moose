...
/**
 * Common class for mechanical solid properties that are a function of temperature
 */
class MechanicalSolidProperties : public SolidProperties
{
public:
  static InputParameters validParams();

  MechanicalSolidProperties(const InputParameters & parameters);
...
#pragma GCC diagnostic ignored "-Woverloaded-virtual"
  ...
  /**
   * @brief Compute a mechanical solid property as a function of temperature (Kelvin)
   *
   ...
   *
   * Properties/parameters used in these functions are listed below with their units:
   *
   * @begincode

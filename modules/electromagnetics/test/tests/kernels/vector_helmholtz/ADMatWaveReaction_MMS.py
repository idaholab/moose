...
omega_r, omega_i, mu_r, mu_i, epsilon_r, epsilon_i = symbols('omega_r omega_i mu_r mu_i epsilon_r epsilon_i', real=True)
...
f, e = mms.evaluate('curl(curl(E)) - '+mu+'*'+omega+'*'+omega+'*'+epsilon+'*E', E, variable='E', vel=E, scalars=['mu_r', 'omega_r', 'epsilon_r','mu_i', 'omega_i', 'epsilon_i'])

...
df1 = mms.run_spatial('aux_microwave_heating.i', 6, console=False, executable=executable, x_pp='h', y_pp=['error_real', 'error_imag','error_n','error_aux_heating'],mpi=1)
...
df1.to_csv('aux_microwave_heating_convergence.csv')

...
omega_r, omega_i, mu_r, mu_i, epsilon_r, epsilon_i, sigma_r, sigma_i = symbols(
    "omega_r omega_i mu_r mu_i epsilon_r epsilon_i sigma_r sigma_i", real=True
)

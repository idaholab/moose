...
InputParameters validParams<ZPolarizedWave>()
{
  ...
  params.addClassDescription("Z-polarized wave function in 1D, at a particular angle of incidence relative to the x-axis, on a plane parallel to the y-axis.");
  ...
  params.addParam<bool>("sign_flip", false, "Flag to flip sign/direction of function/wave (default = false -- into slab).");
  return params;
}

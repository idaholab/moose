...
!equation
\sigma_S \left. \frac{\text{d} \phi_S}{\text{d} x} \right|_{x = 2} = \sigma_G \left. \frac{\text{d} \phi_G}{\text{d} x} \right|_{x = 2}
...
!equation
\sigma_S \left[ \frac{-C_E \sigma_G}{\sigma_G \sigma_S + C_E \sigma_G + C_E \sigma_S} \right] = \sigma_G A_G

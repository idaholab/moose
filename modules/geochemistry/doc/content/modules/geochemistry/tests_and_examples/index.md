...
The theory behind the `geochemistry` module has been described mostly in the [theory page](theory/index.md).  It is hoped that the descriptions of tests and examples found below will help users actually implement their geochemical models.

...
public:
  GeochemicalSystemTest()
    : _db_calcite("database/moose_testdb.json", true, true, false),
      ...
      _swapper7(7, 1e-6),
      _swapper8(8, 1e-6),
      _cm_calcite({GeochemicalSystem::ConstraintMeaningEnum::ACTIVITY,
      ...
      _cm_redox({GeochemicalSystem::ConstraintMeaningEnum::ACTIVITY,
...
protected:
  ...
  const std::vector<GeochemicalSystem::ConstraintMeaningEnum> _cm_calcite;
  ...
  const std::vector<GeochemicalSystem::ConstraintMeaningEnum> _cm_dummy;
  const PertinentGeochemicalSystem _model_redox;
  ModelGeochemicalDatabase _mgd_redox;
  std::vector<GeochemicalSystem::ConstraintMeaningEnum> _cm_redox;

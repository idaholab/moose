...
GeochemistryReactorBase::sharedParams()
{
  ...
  params.addRequiredParam<MultiMooseEnum>(
      ...
      "well as the amount found in secondary species, and units must be moles or mass (kg, g, "
      "etc).  free_concentration: can be applied to all basis species that are not gas and not H2O "
      "and not mineral, and represents the total amount of the basis species existing freely (not "
      "as secondary species) within the solution, and units must be molal or mass_per_kg_solvent.  "
      "free_mineral: can be applied to all mineral basis species, and represents the total amount "
      "of the mineral existing freely (precipitated) within the solution, and units must be moles, "
      "mass or cm3.  activity and log10activity: can be applied to basis species that are not gas "
      "and not mineral and not sorbing sites, and represents the activity of the basis species "
      "(recall pH = -log10activity), and units must be dimensionless.  fugacity and log10fugacity: "
      "can be applied to gases, and units must be dimensionless");

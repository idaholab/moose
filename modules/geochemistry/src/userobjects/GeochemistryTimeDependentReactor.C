...
unsigned
GeochemistryTimeDependentReactor::getSolverIterations(dof_id_type /*node_id*/) const
{
  return _tot_iter[0];
}

Real
GeochemistryTimeDependentReactor::getSolverResidual(dof_id_type /*node_id*/) const
{

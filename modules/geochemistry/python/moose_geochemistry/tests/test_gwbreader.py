...
from moose_geochemistry.readers import gwb_reader
...
class TestGWBReader(unittest.TestCase):
    ...
    def testActivityModel(self):
        ...
        self.readDatabase()
        gold = "debye-huckel"
        adhgold = [0.4913, 0.5092, 0.5450, 0.5998, 0.6898, 0.8099, 0.9785, 1.2555]
        bdhgold = [0.3247, 0.3283, 0.3343, 0.3422, 0.3533, 0.3655, 0.3792, 0.3965]
        bdotgold = [0.0174, 0.0410, 0.0440, 0.0460, 0.0470, 0.0470, 0.0340, 0.0000]
    ...
    def testNeutralSpecies(self):
        ...
        gold = {
            ...
            "h2o": {
                "a": [1.4203, 1.45397, 1.5012, 1.5551, 1.6225, 1.6899, 1.7573, 1.8247],
    ...
    def testElements(self):
        ...
        self.readDatabase()
        gold = {
            "Ag": {"name": "Silver", "molecular weight": 107.8680},
    ...
    def testMineralSpecies(self):
        ...
        gold = {
            "Akermanite": {
                "molar volume": 92.8100,
                "molecular weight": 272.6318,
                "species": {
                    "H2O": 3.000,
                    "Ca++": 2.000,
                    "Mg++": 1.000,
            ...
            "Bieberite": {
                "molar volume": 144.3000,
                "molecular weight": 281.0972,
    ...
    def testOxidess(self):
        ...
        gold = {
            "Cu2O": {
                "species": {"H+": -2.000, "Cu+": 2.000, "H2O": 1.000},
    ...
    def testSorptionMinerals(self):
        ...
        gold = {
            "Fe(OH)3(ppd)": {
                ...
                "sorbing sites": {">(s)FeOH": 0.0050, ">(w)FeOH": 0.2000},
            },
            "Hematite": {
                "surface area": 123.0000,
                "sorbing sites": {">(sblah)FeOH": 0.0100, ">(wasdf)FeOH": 0.4000},
            },
        }
    ...
    def testSurfaceSpecies(self):
        ...
        gold = {
            ">(s)FeO-": {
                ...
                "log K": 8.9300,
                "dlogK/dT": 0.0000,
                "species": {">(s)FeOH": 1.000, "H+": -1.000},
            },
            ">(s)FeOAg": {
                "charge": 0,
                "molecular weight": 179.7144,
                "log K": 1.7200,
                "dlogK/dT": -1.234,
                "species": {">(sas)FeOH": 1.3, "Ag+": -1.111, "H+king": 0.000},
            },
        }

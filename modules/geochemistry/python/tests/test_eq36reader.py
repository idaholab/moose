...
class TestGWBReader(unittest.TestCase):
    ...
    def testTemperature(self):
        ...
        """
        self.readDatabase()
        gold = ['0.0100', '25.0000', '60.0000', '100.0000',
    ...
    def testPressure(self):
        ...
        """
        self.readDatabase()
        gold = ['1.0132', '1.0132', '1.0132', '1.0132',
    ...
    def testActivityModel(self):
        ...
        self.readDatabase()
        gold = 'debye-huckel'
        adhgold = ['0.4939', '0.5114', '0.5465', '0.5995',
                   '0.6855', '0.7994', '0.9593', '1.2180']
        bdhgold = ['0.3253', '0.3288', '0.3346', '0.3421',
                   '0.3525', '0.3639', '0.3766', '0.3925']
        bdotgold = ['0.0394', '0.0410', '0.0438', '0.0460',
    ...
    def testSecondarySpecies(self):
        ...
        gold = {'(NH4)2Sb2S4(aq)': {'charge': '0.0', 'radius': '3.0', 'molecular weight': '407.841',
                         ...
                         'species': {'H2O': '-6.0000', 'NH3(aq)': '2.0000', 'Sb(OH)3(aq)': '2.0000',
                                     'H+': '4.0000', 'HS-': '4.0000'},
                         'logk': ['-74.5361', '-67.6490', '-59.8877', '-52.5457',
                                  '-45.0674', '-38.8180', '500.0000', '500.0000']}}
    ...
    def testMineralSpecies(self):
        ...
        gold = {'Calcite': {'molar volume': '36.934',
                            ...
                            'logk': ['2.2257', '1.8487', '1.3330', '0.7743',
                                     '0.0999', '-0.5838', '-1.3262', '-2.2154']}}
    ...
    def testGasSpecies(self):
        ...
        gold = {'Ag(g)': {'species': {'H+': '-1.0000', 'O2(g)': '-0.2500', 'Ag+': '1.0000', 'H2O': '0.5000'},
                          ...
                          'logk': ['55.5420', '50.3678', '44.4606', '39.1093',
                                   '33.8926', '29.8196', '500.0000', '500.0000']}}
    ...
    def testRedoxCouples(self):
        ...
        gold = {'HS-': {'species': {'SO4--': '1.0000', 'H+': '1.0000', 'O2(g)': '-2.0000'},
                               ...
                               'logk': ['146.7859', '132.5203', '116.0105', '100.8144',
                                        '85.7147', '73.6540', '63.7280', '55.2988']}}

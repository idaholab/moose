...
#include "LoadCovarianceDataActionTorched.h"
...
void
LoadCovarianceDataActionTorched::act()
{
  ...
  {
    auto * gp_gen = dynamic_cast<GaussianProcessSurrogateTorched *>(model_ptr);
...
void
LoadCovarianceDataActionTorched::load(GaussianProcessSurrogateTorched & model)
{

...
void
AffineInvariantDES::proposeSamples(const unsigned int seed_value, std::size_t & rn_ind)
{
  unsigned int j = 0;
  bool indicator;
  ...
  {
    indicator = 0;
    randomIndexPair(_num_parallel_proposals, j, seed_value, rn_ind, index_req1, index_req2);

...
void
Polynomial::store(std::ostream & /*stream*/, std::any /*context*/) const
{
...
void
Legendre::store(std::ostream & stream, std::any context) const
{
...
void
Hermite::store(std::ostream & stream, std::any context) const
{

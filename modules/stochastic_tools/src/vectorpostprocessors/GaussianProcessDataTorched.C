...
#include "GaussianProcessDataTorched.h"

registerMooseObject("StochasticToolsApp", GaussianProcessDataTorched);

InputParameters
GaussianProcessDataTorched::validParams()
{
...
GaussianProcessDataTorched::GaussianProcessDataTorched(const InputParameters & parameters)
  : GeneralVectorPostprocessor(parameters),
    SurrogateModelInterface(this),
    _gp_surrogate(getSurrogateModel<GaussianProcessSurrogateTorched>("gp_name"))
{
}

void
GaussianProcessDataTorched::initialize()
{

...
ExponentialCovarianceFunction::ExponentialCovarianceFunction(
...
void
ExponentialCovarianceFunction::getHyperParameters(std::vector<std::vector<Real>> & vec) const
{
  vec.resize(4);
...
RealEigenMatrix
ExponentialCovarianceFunction::computeCovarianceMatrix(const RealEigenMatrix & x,

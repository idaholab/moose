...
registerMooseObjectReplaced("StochasticToolsApp", BoostLognormal, "07/01/2020 00:00", Lognormal);

InputParameters
BoostLognormal::validParams()
{
...
BoostLognormal::BoostLognormal(const InputParameters & parameters)

...
#include "LMCTorched.h"
#include "MooseRandom.h"
#include "MathUtils.h"

registerMooseObject("StochasticToolsApp", LMCTorched);

InputParameters
LMCTorched::validParams()
{
...
LMCTorched::LMCTorched(const InputParameters & parameters)
...
void
LMCTorched::computeCovarianceMatrix(RealEigenMatrix & K,
...
bool
LMCTorched::computedKdhyper(RealEigenMatrix & dKdhp,
                            const RealEigenMatrix & x,
...
void
LMCTorched::computeBMatrix(RealEigenMatrix & Bmat, const unsigned int exp_i) const
{
...
void
LMCTorched::computeAGradient(RealEigenMatrix & grad,
...
void
LMCTorched::computeLambdaGradient(RealEigenMatrix & grad,
                                  const unsigned int /*exp_i*/,
                                  const unsigned int index) const
{
  grad.setZero();

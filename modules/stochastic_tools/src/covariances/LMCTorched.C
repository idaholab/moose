...
void
LMCTorched::computeCovarianceMatrix(torch::Tensor & K,
...
bool
LMCTorched::computedKdhyper(torch::Tensor & dKdhp,
                            const torch::Tensor & x,
...
void
LMCTorched::computeBMatrix(torch::Tensor & Bmat, const unsigned int exp_i) const
{
...
void
LMCTorched::computeAGradient(torch::Tensor & grad,
...
void
LMCTorched::computeLambdaGradient(torch::Tensor & grad,
                                  const unsigned int /*exp_i*/,
                                  const unsigned int index) const
{
  // grad.setZero();

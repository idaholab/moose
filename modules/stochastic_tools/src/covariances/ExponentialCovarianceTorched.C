...
void
ExponentialCovarianceTorched::computeCovarianceMatrix(torch::Tensor & K,
...
void
ExponentialCovarianceTorched::ExponentialFunction(torch::Tensor & K,
                                                  const torch::Tensor & x,
                                                  const torch::Tensor & xp,
...
bool
ExponentialCovarianceTorched::computedKdhyper(torch::Tensor & dKdhp,
                                              const torch::Tensor & x,
...
void
ExponentialCovarianceTorched::computedKdlf(torch::Tensor & K,
                                           const torch::Tensor & x,
                                           const std::vector<Real> & length_factor,
                                           const Real sigma_f_squared,
                                           const Real gamma,

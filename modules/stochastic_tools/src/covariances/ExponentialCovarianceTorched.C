...
#include "ExponentialCovarianceTorched.h"
#include <cmath>

registerMooseObject("StochasticToolsApp", ExponentialCovarianceTorched);

InputParameters
ExponentialCovarianceTorched::validParams()
{
...
ExponentialCovarianceTorched::ExponentialCovarianceTorched(const InputParameters & parameters)
...
void
ExponentialCovarianceTorched::computeCovarianceMatrix(RealEigenMatrix & K,
...
void
ExponentialCovarianceTorched::ExponentialFunction(RealEigenMatrix & K,
                                                  const RealEigenMatrix & x,
                                                  const RealEigenMatrix & xp,
...
bool
ExponentialCovarianceTorched::computedKdhyper(RealEigenMatrix & dKdhp,
                                              const RealEigenMatrix & x,
...
void
ExponentialCovarianceTorched::computedKdlf(RealEigenMatrix & K,
                                           const RealEigenMatrix & x,
                                           const std::vector<Real> & length_factor,
                                           const Real sigma_f_squared,
                                           const Real gamma,

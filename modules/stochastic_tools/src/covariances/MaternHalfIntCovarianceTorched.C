...
#include "MaternHalfIntCovarianceTorched.h"
#include <cmath>

registerMooseObject("StochasticToolsApp", MaternHalfIntCovarianceTorched);

InputParameters
MaternHalfIntCovarianceTorched::validParams()
{
...
MaternHalfIntCovarianceTorched::MaternHalfIntCovarianceTorched(const InputParameters & parameters)

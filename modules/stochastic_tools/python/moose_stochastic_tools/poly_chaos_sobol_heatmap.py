...
def command_line_options():
    ...
    parser = argparse.ArgumentParser(
        description="Plot a 2D bar graph of sobol statistics from a polynomial chaos surrogate."
    )
    parser.add_argument(
        "filename",
        type=str,
        help="The Postprocessor file with polynomial chaos sobol statistics",
    )
    parser.add_argument("--vector", default=None, type=str, help="QoI vector name.")
    parser.add_argument(
        "--names", default=[], nargs="+", type=str, help="Names to show on axes."
    )
    parser.add_argument(

...
/**
 * PMCMCDecision will help make sample accept/reject decisions in MCMC
...
protected:
   ...
   *
   * @param the evidence vector to be filled
   * @param the matrix of proposed inputs that are provided
   */
   ...
   *
   * @param the transition probability vector to be filled
   * @param the vector of evidences provided
   */
   ...
   *
   * @param the vector of accepted samples to be filled
   * @param the matrix of proposed inputs provided
   * @param the vector of transition probabilities provided
   * @param the current parallel proposal index provided
   */

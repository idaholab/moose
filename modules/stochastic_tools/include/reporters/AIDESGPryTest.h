...
/**
 * AIDESGPryTest will help making sample accept/reject decisions in MCMC
 * schemes (for e.g., when performing Bayesian inference).
 */
class AIDESGPryTest : public GeneralReporter, public SurrogateModelInterface
{
public:
  static InputParameters validParams();
  AIDESGPryTest(const InputParameters & parameters);

...
// Proposed by Mohammadi and Challenor 2024
class VarianceImprovementGlobalFit : public ParallelAcquisitionFunctionBase
{
public:
  static InputParameters validParams();
  VarianceImprovementGlobalFit(const InputParameters & parameters);

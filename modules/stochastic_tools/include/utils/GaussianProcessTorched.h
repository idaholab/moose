 ...
 */
class GaussianProcessTorched
{
public:
  GaussianProcessTorched();
   ...
   */
  const StochasticToolsTorched::StandardizerTorched & getParamStandardizer() const
  {
    return _param_standardizer;
  }
  const StochasticToolsTorched::StandardizerTorched & getDataStandardizer() const
  {
...
protected:
  ...
  StochasticToolsTorched::StandardizerTorched _param_standardizer;

...
// Template implementations for Eigen::LLT (outside namespace since Eigen is not in StochasticTools)
// These must be defined before the GaussianProcess templates use them
template <typename Context>
void
dataStore(std::ostream & stream, Eigen::LLT<RealEigenMatrix> & decomp, Context context)
{
...
template <typename Context>
void
dataLoad(std::istream & stream, Eigen::LLT<RealEigenMatrix> & decomp, Context context)
{
  RealEigenMatrix L;
...
// Template implementations for GaussianProcess serialization
template <typename Context>
void

...
class GaussianProcessDataGeneral : public GeneralVectorPostprocessor, public SurrogateModelInterface
{
public:
  static InputParameters validParams();

  GaussianProcessDataGeneral(const InputParameters & parameters);

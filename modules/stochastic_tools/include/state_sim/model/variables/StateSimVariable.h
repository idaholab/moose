...
public:
  ...
  VAR_SCOPE_ENUM getScope() {return _var_scope;};
  VAR_TYPE getVarType(){return _var_type;};
  ...
  void setTimespan(const TimespanH & value) {_value = std::to_string(value);};
  void setString(const std::string & value) {_value = value;};
  void setBool(const bool & value) {_value = value ? "true" : "false";};
  void setRealPtrVal(const Real & value) {*_value_ptr = value;};

...
class GaussianProcessTrainerGeneral : public SurrogateTrainer, public CovarianceInterface
{
public:
  static InputParameters validParams();
  GaussianProcessTrainerGeneral(const InputParameters & parameters);
  virtual void preTrain() override;
  virtual void train() override;
  virtual void postTrain() override;

  StochasticTools::GaussianProcessGeneral & gp() { return _gp; }
  const StochasticTools::GaussianProcessGeneral & gp() const { return _gp; }

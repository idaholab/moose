...
class TwoLayerGaussianProcessTrainer : public SurrogateTrainer, public CovarianceInterface
{
public:
  static InputParameters validParams();
  TwoLayerGaussianProcessTrainer(const InputParameters & parameters);
...
private:
  ...
  const StochasticTools::TwoLayerGaussianProcess::TGPOptimizerOptions _optimization_opts;

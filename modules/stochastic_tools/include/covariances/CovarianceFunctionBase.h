...
public:
   ...
   */
  virtual void computeCovarianceFD(torch::Tensor & K_fd,
                                   const torch::Tensor & x,
   ...
   * @param dim   Input dimension for the derivative
   */
  virtual void computeCovarianceDf(torch::Tensor & K_df,
                                   const torch::Tensor & xd,
                                   const torch::Tensor & xp,
                                   unsigned int dim) const;
   ...
   */
  virtual void computeCovarianceDD(torch::Tensor & K_dd,
                                   const torch::Tensor & xd,
   ...
   */
  virtual void computedKdhyper_cross(torch::Tensor & dKdhp,
                                     const torch::Tensor & x,

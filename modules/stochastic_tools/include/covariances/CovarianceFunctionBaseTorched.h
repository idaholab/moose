 ...
 */
class CovarianceFunctionBaseTorched : public MooseObject, public CovarianceInterfaceTorched
{
public:
  static InputParameters validParams();
  CovarianceFunctionBaseTorched(const InputParameters & parameters);
...
protected:
  ...
  std::vector<CovarianceFunctionBaseTorched *> _covariance_functions;
};

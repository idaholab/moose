...
The specific parameter study performed in this tutorial can also done using the [ParameterStudy/index.md] syntax, shown in the code block below. However, it is very useful to learn each aspect of the doing a stochastic simulation in the stochastic tools module, which is described in the following sub-sections.

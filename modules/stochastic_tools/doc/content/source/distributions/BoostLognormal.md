...
!alert warning
The BoostLognormal object requires that libMesh be configured to utilize an external
...
!syntax parameters /Distributions/BoostLognormal

!syntax inputs /Distributions/BoostLognormal

!syntax children /Distributions/BoostLognormal

...
[OptimizationReporter]
  ...
  parameter_names = 'D_batch_material'
  num_values = '4'
...
[MultiApps]
  [forward]
    ...
    input_files = forward_batch.i
    cli_args = 'Outputs/csv=false;Outputs/console=false'
    execute_on = FORWARD
  []
  [adjoint]
    type = FullSolveMultiApp
    input_files = gradient_batch.i
    cli_args = 'Outputs/console=false;UserObjects/load_u/mesh=optimize_grad_batch_out_forward0.e'
    execute_on = ADJOINT
  []
[]
...
[Transfers]
  [to_forward]
    ...
    from_reporters = 'OptimizationReporter/measurement_xcoord
                      ...
                      OptimizationReporter/D_batch_material'
  ...
  [from_adjoint]
    ...
    to_reporters = 'OptimizationReporter/grad_D_batch_material'
  []
[]

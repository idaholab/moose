...
`OptimizationData` will create and store the half of the L2 Norm of the misfit
values. This can be useful for running an inverse optimization problem with the

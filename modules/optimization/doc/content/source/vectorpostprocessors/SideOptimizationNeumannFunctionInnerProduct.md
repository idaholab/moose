...
This function is primarily used for computing the gradient in an optimization routine where the value of a [Neumann boundary condition](FunctionNeumannBC.md) is being optimized. See [!file](bc_load_linearFunction/adjoint.i) as an example.

...
class OptimizationBatchPropertyDerivativeTest : public OptimizationBatchPropertyDerivativeTestParent
{
public:
  static InputParameters validParams();

  OptimizationBatchPropertyDerivativeTest(const InputParameters & params);

# Same inverse problem as forward.i/adjoint.i, with the adjoint solved automatically
# by SteadyAndAdjoint instead of in a separate sub-application.
...
[VectorPostprocessors]
  [grad_bc_left]
    type = SideOptimizationDirichletFunctionInnerProduct
    variable = temperature_adjoint
    function = left_function
    boundary = left
    diffusivity = thermal_conductivity
    # the adjoint solution only exists after the adjoint solve

...
#include "OptimizationBatchPropertyDerivativeTest.h"
#include "libmesh/int_range.h"

registerMooseObject("OptimizationTestApp", OptimizationBatchPropertyDerivativeTest);

InputParameters
OptimizationBatchPropertyDerivativeTest::validParams()
{
  auto params = OptimizationBatchPropertyDerivativeTestParent::validParams();
...
OptimizationBatchPropertyDerivativeTest::OptimizationBatchPropertyDerivativeTest(const InputParameters & params)
  : OptimizationBatchPropertyDerivativeTestParent(
        params,
...
void
OptimizationBatchPropertyDerivativeTest::batchCompute()
{

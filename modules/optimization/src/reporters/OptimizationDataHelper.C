...
InputParameters
OptimizationDataHelper::validParams()
{
...
OptimizationDataHelper::OptimizationDataHelper(const InputParameters & parameters)
...
void
OptimizationDataHelper::computeMisfit()
{
  if (_var_vec.empty())
    return;
...
void
OptimizationDataHelper::readMeasurementsFromFile()
{
...
void
OptimizationDataHelper::readMeasurementsFromInput()
{
...
void
OptimizationDataHelper::errorCheckDataSize()
{
  const std::size_t nvals = _measurement_values.size();
  std::string msg = "";

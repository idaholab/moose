...
protected:
  ...
  /// Wrap PK1 -> sigma. Overridden here because PK2's PK1 = F_ust * S has a direct F_ust
  /// dependence (Term A in dPK1/d(F_ust)) that PK1 base's sigma-chain (which assumes

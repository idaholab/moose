...
**  AUTHORS: ANSEL C. UGURAL, SAUL K. FENSTER PG. 505 APPENDIX B1 AND B2              **
****************************************************************************************
****************************************************************************************

      SUBROUTINE SPRIND(S, PS, AN, LSTR, NDI, NSHR)

      INTEGER LSTR, NDI, NSHR, K1
      DIMENSION S(6), PS(3), A(3), B(3), C(3), K(3), L(3), M(3),
     1     N(3), AN(3,3)
      REAL I1, I2, I3, J1, J2, J3, R, T, Q, ALP, SCALC, PRINC1, PRINC2, 
     1     PRINC3
...
C
      DO K1=1, 3
         A(K1)=((S(2)-S(K1))*(S(3)-S(K1)))-(S(5)**2)
         B(K1)=-(S(4)*(S(3)-S(K1)))-(S(5)*S(6))
         C(K1)=(S(4)*S(5))-((S(2)-S(K1))*S(6))
      END DO
...
C      PRINT *, C
      ...
      DO K1=1, 3
         K(K1)=1/SQRT(A(K1)**2+B(K1)**2+C(K1)**2)
      END DO
C      PRINT *, K
C

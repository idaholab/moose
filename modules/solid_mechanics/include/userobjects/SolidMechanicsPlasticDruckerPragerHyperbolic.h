 ...
 * SolidMechanicsPlasticDruckerPrager.  Note df_dsig is over-ridden
 */
class SolidMechanicsPlasticDruckerPragerHyperbolic : public SolidMechanicsPlasticDruckerPrager
{
public:

...
[Executioner]
  ...
  start_time = 0.0
  end_time = 1.55      # change end_time = 2.5 for more cycles of kinematic hardening
  dt = 0.00375         # keep dt = 0.000125 for a finer non linear kinematic plot
  dtmin = 0.0001
[]

...
p.add_option(
    ...
    default="-1:1:2",
    dest="xgrid",
    help="X grid specified as xstart:xstop:number or x0,x1,x2,... (Default = %default)",
)
p.add_option(
    "-y",
    "--ygrid",
    ...
    default="-1:1:2",
    dest="ygrid",
    help="Y grid specified as ystart:ystop:number or y0,y1,y2,... (Default = %default)",
)
p.add_option(
    "-z",
    "--zgrid",
    ...
    default="0",
    dest="zgrid",
    help="Z grid specified as zstart:xstop:number or z0,z1,z2,... (Default = %default)",
)

...
`PorousViscoplasticityStressUpdate` implements the [Gurson-Tvergaard-Needleman](Gurson:1977gg) (GTN) and
...
!syntax inputs /Materials/PorousViscoplasticityStressUpdate

!syntax children /Materials/PorousViscoplasticityStressUpdate

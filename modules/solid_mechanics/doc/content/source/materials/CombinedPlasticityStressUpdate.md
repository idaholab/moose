# Combined Plasticity Stress Update

!syntax description /Materials/CombinedPlasticityStressUpdate
...
[BackstressRadialReturnStressUpdate.md] to compute the radial return stress
increment.  This plasticity class also computes the plastic strain as a stateful material
property.

This class is based on the implicit integration algorithm in [!cite](dunne2005introduction)
pg. 146--149.

The `ADCombinedPlasticityStressUpdate` version of this class uses forward mode automatic
...
`CombinedPlasticityStressUpdate` must be run in conjunction with the inelastic strain return mapping stress calculator as shown below:
...
!syntax parameters /Materials/CombinedPlasticityStressUpdate

!syntax inputs /Materials/CombinedPlasticityStressUpdate

!syntax children /Materials/CombinedPlasticityStressUpdate

...
- Passes nodal coordinates, solution values, increments, and optional external fields (PREDEF) to
  the plugin; receives residuals, Jacobian, state variables, and (optionally) energy.
...
- `external_fields`: optional list of AuxVariables to pass as PREDEF fields to the UEL.

...
InputParameters
SolidMechanicsPlasticMohrCoulombMulti::validParams()
{
...
unsigned int
SolidMechanicsPlasticMohrCoulombMulti::numberSurfaces() const
{
  return 6;
}

void
SolidMechanicsPlasticMohrCoulombMulti::yieldFunctionV(const RankTwoTensor & stress,
                                                      Real intnl,
...
void
SolidMechanicsPlasticMohrCoulombMulti::yieldFunctionEigvals(
...
void
SolidMechanicsPlasticMohrCoulombMulti::perturbStress(const RankTwoTensor & stress,
                                                     std::vector<Real> & eigvals,
...
void
SolidMechanicsPlasticMohrCoulombMulti::df_dsig(const RankTwoTensor & stress,
                                               Real sin_angle,
...
void
SolidMechanicsPlasticMohrCoulombMulti::dyieldFunction_dstressV(
...
void
SolidMechanicsPlasticMohrCoulombMulti::dyieldFunction_dintnlV(const RankTwoTensor & stress,
                                                              Real intnl,
...
void
SolidMechanicsPlasticMohrCoulombMulti::flowPotentialV(const RankTwoTensor & stress,
                                                      Real intnl,
...
void
SolidMechanicsPlasticMohrCoulombMulti::dflowPotential_dstressV(
...
void
SolidMechanicsPlasticMohrCoulombMulti::dflowPotential_dintnlV(
...
void
SolidMechanicsPlasticMohrCoulombMulti::activeConstraints(const std::vector<Real> & f,
...
Real
SolidMechanicsPlasticMohrCoulombMulti::cohesion(const Real internal_param) const
{
  return _cohesion.value(internal_param);
}

Real
SolidMechanicsPlasticMohrCoulombMulti::dcohesion(const Real internal_param) const
{
  return _cohesion.derivative(internal_param);
}

Real
SolidMechanicsPlasticMohrCoulombMulti::phi(const Real internal_param) const
{
  return _phi.value(internal_param);
}

Real
SolidMechanicsPlasticMohrCoulombMulti::dphi(const Real internal_param) const
{
  return _phi.derivative(internal_param);
}

Real
SolidMechanicsPlasticMohrCoulombMulti::psi(const Real internal_param) const
{
  return _psi.value(internal_param);
}

Real
SolidMechanicsPlasticMohrCoulombMulti::dpsi(const Real internal_param) const
{
  return _psi.derivative(internal_param);
}

std::string
SolidMechanicsPlasticMohrCoulombMulti::modelName() const
{
  return "MohrCoulombMulti";
}

bool
SolidMechanicsPlasticMohrCoulombMulti::returnMap(const RankTwoTensor & trial_stress,
                                                 Real intnl_old,
...
bool
SolidMechanicsPlasticMohrCoulombMulti::doReturnMap(const RankTwoTensor & trial_stress,
                                                   Real intnl_old,
                                                   const RankFourTensor & E_ijkl,
                                                   Real ep_plastic_tolerance,
                                                   RankTwoTensor & returned_stress,
...
bool
SolidMechanicsPlasticMohrCoulombMulti::returnTip(const std::vector<Real> & eigvals,
...
bool
SolidMechanicsPlasticMohrCoulombMulti::returnPlane(const std::vector<Real> & eigvals,
                                                   const std::vector<RealVectorValue> & n,
                                                   std::vector<Real> & dpm,
                                                   RankTwoTensor & returned_stress,
                                                   Real intnl_old,
...
bool
SolidMechanicsPlasticMohrCoulombMulti::returnEdge000101(const std::vector<Real> & eigvals,
                                                        const std::vector<RealVectorValue> & n,
                                                        std::vector<Real> & dpm,
                                                        RankTwoTensor & returned_stress,
                                                        Real intnl_old,
...
bool
SolidMechanicsPlasticMohrCoulombMulti::returnEdge010100(const std::vector<Real> & eigvals,
                                                        const std::vector<RealVectorValue> & n,
                                                        std::vector<Real> & dpm,
                                                        RankTwoTensor & returned_stress,
                                                        Real intnl_old,
...
bool
SolidMechanicsPlasticMohrCoulombMulti::KuhnTuckerOK(const std::vector<Real> & yf,
...
bool
SolidMechanicsPlasticMohrCoulombMulti::useCustomReturnMap() const
{

...
#include "SolidMechanicsHardeningCubic.h"
...
registerMooseObjectRenamed("SolidMechanicsApp",
                           ...
                           "01/01/2025 00:00",
                           SolidMechanicsHardeningCubic);

InputParameters
SolidMechanicsHardeningCubic::validParams()
{
...
SolidMechanicsHardeningCubic::SolidMechanicsHardeningCubic(const InputParameters & parameters)
...
Real
SolidMechanicsHardeningCubic::value(Real intnl) const
{
...
Real
SolidMechanicsHardeningCubic::derivative(Real intnl) const
{
  const Real x = intnl - _intnl_0;
  if (x <= 0.0)
    return 0.0;
...
std::string
SolidMechanicsHardeningCubic::modelName() const
{
  return "Cubic";
}

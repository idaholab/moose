...
Real
SolidMechanicsPlasticMeanCapTC::yieldFunction(const RankTwoTensor & stress, Real intnl) const
{
...
RankTwoTensor
SolidMechanicsPlasticMeanCapTC::dyieldFunction_dstress(const RankTwoTensor & stress,
                                                       Real intnl) const
{
...
Real
SolidMechanicsPlasticMeanCapTC::dyieldFunction_dintnl(const RankTwoTensor & stress,
                                                      Real intnl) const
{
  const Real tr = stress.trace();
  const Real t_str = tensile_strength(intnl);
...
RankTwoTensor
SolidMechanicsPlasticMeanCapTC::df_dsig(const RankTwoTensor & stress, Real intnl) const
{
  const Real tr = stress.trace();
  const Real t_str = tensile_strength(intnl);
  if (tr >= t_str)
...
RankTwoTensor
SolidMechanicsPlasticMeanCapTC::flowPotential(const RankTwoTensor & stress, Real intnl) const
{
  return df_dsig(stress, intnl);
}

RankFourTensor
SolidMechanicsPlasticMeanCapTC::dflowPotential_dstress(const RankTwoTensor & stress,
                                                       Real intnl) const
{
  const Real tr = stress.trace();
  const Real t_str = tensile_strength(intnl);
...
RankTwoTensor
SolidMechanicsPlasticMeanCapTC::dflowPotential_dintnl(const RankTwoTensor & stress,
                                                      Real intnl) const
{
  const Real tr = stress.trace();
  const Real t_str = tensile_strength(intnl);
...
Real
SolidMechanicsPlasticMeanCapTC::hardPotential(const RankTwoTensor & stress, Real intnl) const
{
...
RankTwoTensor
SolidMechanicsPlasticMeanCapTC::dhardPotential_dstress(const RankTwoTensor & stress,
                                                       Real intnl) const
{
  const Real tr = stress.trace();
  const Real t_str = tensile_strength(intnl);
...
Real
SolidMechanicsPlasticMeanCapTC::dhardPotential_dintnl(const RankTwoTensor & stress,
                                                      Real intnl) const
{
  const Real tr = stress.trace();
  const Real t_str = tensile_strength(intnl);
...
Real
SolidMechanicsPlasticMeanCapTC::tensile_strength(const Real internal_param) const
{
  return _strength.value(internal_param);
}

Real
SolidMechanicsPlasticMeanCapTC::dtensile_strength(const Real internal_param) const
{
  return _strength.derivative(internal_param);
}

Real
SolidMechanicsPlasticMeanCapTC::compressive_strength(const Real internal_param) const
{
  return _c_strength.value(internal_param);
}

Real
SolidMechanicsPlasticMeanCapTC::dcompressive_strength(const Real internal_param) const
{
  return _c_strength.derivative(internal_param);
}

void
SolidMechanicsPlasticMeanCapTC::activeConstraints(const std::vector<Real> & f,
...
bool
SolidMechanicsPlasticMeanCapTC::returnMap(const RankTwoTensor & trial_stress,
                                          Real intnl_old,
...
bool
SolidMechanicsPlasticMeanCapTC::useCustomReturnMap() const
{
  return _use_custom_returnMap;
}

bool
SolidMechanicsPlasticMeanCapTC::useCustomCTO() const
{
  return _use_custom_cto;
}

std::string
SolidMechanicsPlasticMeanCapTC::modelName() const
{
  return "MeanCapTC";
}

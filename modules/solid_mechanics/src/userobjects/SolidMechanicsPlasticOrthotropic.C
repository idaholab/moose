...
InputParameters
SolidMechanicsPlasticOrthotropic::validParams()
{
  InputParameters params = SolidMechanicsPlasticIsotropicSD::validParams();
...
SolidMechanicsPlasticOrthotropic::SolidMechanicsPlasticOrthotropic(
  ...
  : SolidMechanicsPlasticIsotropicSD(parameters),
...
Real
SolidMechanicsPlasticOrthotropic::yieldFunction(const RankTwoTensor & stress, Real intnl) const
{
...
RankTwoTensor
SolidMechanicsPlasticOrthotropic::dyieldFunction_dstress(const RankTwoTensor & stress,
                                                         Real /*intnl*/) const
{
  const RankTwoTensor j2prime = _l1 * stress;
  const RankTwoTensor j3prime = _l2 * stress;
...
RankFourTensor
SolidMechanicsPlasticOrthotropic::dflowPotential_dstress(const RankTwoTensor & stress,
                                                         Real /*intnl*/) const
{
  if (_associative)
  {
...
RankTwoTensor
SolidMechanicsPlasticOrthotropic::flowPotential(const RankTwoTensor & stress, Real intnl) const
{
  if (_associative)
  {

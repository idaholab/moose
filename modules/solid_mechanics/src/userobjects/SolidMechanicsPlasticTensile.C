...
InputParameters
SolidMechanicsPlasticTensile::validParams()
{
...
Real
SolidMechanicsPlasticTensile::yieldFunction(const RankTwoTensor & stress, Real intnl) const
{
...
RankTwoTensor
SolidMechanicsPlasticTensile::dyieldFunction_dstress(const RankTwoTensor & stress,
                                                     Real /*intnl*/) const
{
  Real mean_stress = stress.trace() / 3.0;
...
Real
SolidMechanicsPlasticTensile::dyieldFunction_dintnl(const RankTwoTensor & /*stress*/,
                                                    Real intnl) const
{
...
RankTwoTensor
SolidMechanicsPlasticTensile::flowPotential(const RankTwoTensor & stress, Real intnl) const
{
...
RankFourTensor
SolidMechanicsPlasticTensile::dflowPotential_dstress(const RankTwoTensor & stress,
                                                     Real /*intnl*/) const
{
  Real mean_stress = stress.trace() / 3.0;
  RankTwoTensor dmean_stress = stress.dtrace() / 3.0;
...
RankTwoTensor
SolidMechanicsPlasticTensile::dflowPotential_dintnl(const RankTwoTensor & /*stress*/,
                                                    Real /*intnl*/) const
{
...
Real
SolidMechanicsPlasticTensile::tensile_strength(const Real internal_param) const
{
  return _strength.value(internal_param);
}

Real
SolidMechanicsPlasticTensile::dtensile_strength(const Real internal_param) const
{
  return _strength.derivative(internal_param);
}

Real
SolidMechanicsPlasticTensile::smooth(const RankTwoTensor & stress) const
{
...
Real
SolidMechanicsPlasticTensile::dsmooth(const RankTwoTensor & stress) const
{
  Real dsmoother2 = 0;
  if (_tip_scheme == "cap")
  {
...
Real
SolidMechanicsPlasticTensile::d2smooth(const RankTwoTensor & stress) const
{
  Real d2smoother2 = 0;
  if (_tip_scheme == "cap")
  {
...
std::string
SolidMechanicsPlasticTensile::modelName() const
{
  return "Tensile";
}

...
InputParameters
SolidMechanicsPlasticWeakPlaneShear::validParams()
{
...
SolidMechanicsPlasticWeakPlaneShear::SolidMechanicsPlasticWeakPlaneShear(
...
Real
SolidMechanicsPlasticWeakPlaneShear::yieldFunction(const RankTwoTensor & stress, Real intnl) const
{
...
RankTwoTensor
SolidMechanicsPlasticWeakPlaneShear::df_dsig(const RankTwoTensor & stress,
...
RankTwoTensor
SolidMechanicsPlasticWeakPlaneShear::dyieldFunction_dstress(const RankTwoTensor & stress,
                                                            Real intnl) const
{
...
Real
SolidMechanicsPlasticWeakPlaneShear::dyieldFunction_dintnl(const RankTwoTensor & stress,
                                                           Real intnl) const
{
...
RankTwoTensor
SolidMechanicsPlasticWeakPlaneShear::flowPotential(const RankTwoTensor & stress, Real intnl) const
{
  return df_dsig(stress, tan_psi(intnl));
}

RankFourTensor
SolidMechanicsPlasticWeakPlaneShear::dflowPotential_dstress(const RankTwoTensor & stress,
                                                            Real /*intnl*/) const
{
...
RankTwoTensor
SolidMechanicsPlasticWeakPlaneShear::dflowPotential_dintnl(const RankTwoTensor & /*stress*/,
                                                           Real intnl) const
{
...
Real
SolidMechanicsPlasticWeakPlaneShear::cohesion(const Real internal_param) const
{
  return _cohesion.value(internal_param);
}

Real
SolidMechanicsPlasticWeakPlaneShear::dcohesion(const Real internal_param) const
{
  return _cohesion.derivative(internal_param);
}

Real
SolidMechanicsPlasticWeakPlaneShear::tan_phi(const Real internal_param) const
{
  return _tan_phi.value(internal_param);
}

Real
SolidMechanicsPlasticWeakPlaneShear::dtan_phi(const Real internal_param) const
{
  return _tan_phi.derivative(internal_param);
}

Real
SolidMechanicsPlasticWeakPlaneShear::tan_psi(const Real internal_param) const
{
  return _tan_psi.value(internal_param);
}

Real
SolidMechanicsPlasticWeakPlaneShear::dtan_psi(const Real internal_param) const
{
  return _tan_psi.derivative(internal_param);
}

Real
SolidMechanicsPlasticWeakPlaneShear::smooth(const RankTwoTensor & stress) const
{
...
Real
SolidMechanicsPlasticWeakPlaneShear::dsmooth(const RankTwoTensor & stress) const
{
  Real dsmoother2 = 0;
  if (_tip_scheme == "cap")
  {
...
Real
SolidMechanicsPlasticWeakPlaneShear::d2smooth(const RankTwoTensor & stress) const
{
  Real d2smoother2 = 0;
  if (_tip_scheme == "cap")
  {
...
void
SolidMechanicsPlasticWeakPlaneShear::activeConstraints(const std::vector<Real> & f,
...
std::string
SolidMechanicsPlasticWeakPlaneShear::modelName() const
{

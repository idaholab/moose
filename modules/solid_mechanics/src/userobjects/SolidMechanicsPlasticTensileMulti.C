...
InputParameters
SolidMechanicsPlasticTensileMulti::validParams()
{
...
SolidMechanicsPlasticTensileMulti::SolidMechanicsPlasticTensileMulti(
...
unsigned int
SolidMechanicsPlasticTensileMulti::numberSurfaces() const
{
  return 3;
}

void
SolidMechanicsPlasticTensileMulti::yieldFunctionV(const RankTwoTensor & stress,
                                                  Real intnl,
...
void
SolidMechanicsPlasticTensileMulti::dyieldFunction_dstressV(
...
void
SolidMechanicsPlasticTensileMulti::dyieldFunction_dintnlV(const RankTwoTensor & /*stress*/,
                                                          Real intnl,
...
void
SolidMechanicsPlasticTensileMulti::flowPotentialV(const RankTwoTensor & stress,
                                                  Real intnl,
...
void
SolidMechanicsPlasticTensileMulti::dflowPotential_dstressV(
...
void
SolidMechanicsPlasticTensileMulti::dflowPotential_dintnlV(
...
Real
SolidMechanicsPlasticTensileMulti::tensile_strength(const Real internal_param) const
{
  return _strength.value(internal_param);
}

Real
SolidMechanicsPlasticTensileMulti::dtensile_strength(const Real internal_param) const
{
  return _strength.derivative(internal_param);
}

void
SolidMechanicsPlasticTensileMulti::activeConstraints(const std::vector<Real> & f,
...
Real
SolidMechanicsPlasticTensileMulti::dot(const std::vector<Real> & a,
...
Real
SolidMechanicsPlasticTensileMulti::triple(const std::vector<Real> & a,
...
std::string
SolidMechanicsPlasticTensileMulti::modelName() const
{
  return "TensileMulti";
}

bool
SolidMechanicsPlasticTensileMulti::returnMap(const RankTwoTensor & trial_stress,
                                             Real intnl_old,
...
bool
SolidMechanicsPlasticTensileMulti::doReturnMap(const RankTwoTensor & trial_stress,
                                               Real intnl_old,
                                               const RankFourTensor & E_ijkl,
                                               Real ep_plastic_tolerance,
                                               RankTwoTensor & returned_stress,
...
bool
SolidMechanicsPlasticTensileMulti::returnTip(const std::vector<Real> & eigvals,
...
bool
SolidMechanicsPlasticTensileMulti::returnEdge(const std::vector<Real> & eigvals,
                                              const std::vector<RealVectorValue> & n,
                                              std::vector<Real> & dpm,
                                              RankTwoTensor & returned_stress,
                                              Real intnl_old,
...
bool
SolidMechanicsPlasticTensileMulti::returnPlane(const std::vector<Real> & eigvals,
                                               const std::vector<RealVectorValue> & n,
                                               std::vector<Real> & dpm,
                                               RankTwoTensor & returned_stress,
                                               Real intnl_old,
...
bool
SolidMechanicsPlasticTensileMulti::KuhnTuckerOK(const RankTwoTensor & returned_diagonal_stress,
...
RankFourTensor
SolidMechanicsPlasticTensileMulti::consistentTangentOperator(
...
bool
SolidMechanicsPlasticTensileMulti::useCustomReturnMap() const
{
  return _use_custom_returnMap;
}

bool
SolidMechanicsPlasticTensileMulti::useCustomCTO() const
{

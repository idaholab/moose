...
InputParameters
SolidMechanicsPlasticMohrCoulomb::validParams()
{
...
SolidMechanicsPlasticMohrCoulomb::SolidMechanicsPlasticMohrCoulomb(
...
Real
SolidMechanicsPlasticMohrCoulomb::yieldFunction(const RankTwoTensor & stress, Real intnl) const
{
...
RankTwoTensor
SolidMechanicsPlasticMohrCoulomb::df_dsig(const RankTwoTensor & stress, const Real sin_angle) const
{
  Real mean_stress = stress.trace() / 3.0;
...
RankTwoTensor
SolidMechanicsPlasticMohrCoulomb::dyieldFunction_dstress(const RankTwoTensor & stress,
                                                         Real intnl) const
{
  Real sinphi = std::sin(phi(intnl));
...
Real
SolidMechanicsPlasticMohrCoulomb::dyieldFunction_dintnl(const RankTwoTensor & stress,
                                                        Real intnl) const
{
...
RankTwoTensor
SolidMechanicsPlasticMohrCoulomb::flowPotential(const RankTwoTensor & stress, Real intnl) const
{
...
RankFourTensor
SolidMechanicsPlasticMohrCoulomb::dflowPotential_dstress(const RankTwoTensor & stress,
                                                         Real intnl) const
{
...
RankTwoTensor
SolidMechanicsPlasticMohrCoulomb::dflowPotential_dintnl(const RankTwoTensor & stress,
                                                        Real intnl) const
{
  Real sin_angle = std::sin(psi(intnl));
...
Real
SolidMechanicsPlasticMohrCoulomb::cohesion(const Real internal_param) const
{
  return _cohesion.value(internal_param);
}

Real
SolidMechanicsPlasticMohrCoulomb::dcohesion(const Real internal_param) const
{
  return _cohesion.derivative(internal_param);
}

Real
SolidMechanicsPlasticMohrCoulomb::phi(const Real internal_param) const
{
  return _phi.value(internal_param);
}

Real
SolidMechanicsPlasticMohrCoulomb::dphi(const Real internal_param) const
{
  return _phi.derivative(internal_param);
}

Real
SolidMechanicsPlasticMohrCoulomb::psi(const Real internal_param) const
{
  return _psi.value(internal_param);
}

Real
SolidMechanicsPlasticMohrCoulomb::dpsi(const Real internal_param) const
{
  return _psi.derivative(internal_param);
}

void
SolidMechanicsPlasticMohrCoulomb::abbo(
...
void
SolidMechanicsPlasticMohrCoulomb::dabbo(
...
Real
SolidMechanicsPlasticMohrCoulomb::smooth(const RankTwoTensor & stress) const
{
...
Real
SolidMechanicsPlasticMohrCoulomb::dsmooth(const RankTwoTensor & stress) const
{
  Real dsmoother2 = 0;
  if (_tip_scheme == "cap")
  {
...
Real
SolidMechanicsPlasticMohrCoulomb::d2smooth(const RankTwoTensor & stress) const
{
  Real d2smoother2 = 0;
  if (_tip_scheme == "cap")
  {
...
std::string
SolidMechanicsPlasticMohrCoulomb::modelName() const
{
  return "MohrCoulomb";
}

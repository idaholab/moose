...
InputParameters
SolidMechanicsPlasticDruckerPragerHyperbolic::validParams()
{
  InputParameters params = SolidMechanicsPlasticDruckerPrager::validParams();
...
SolidMechanicsPlasticDruckerPragerHyperbolic::SolidMechanicsPlasticDruckerPragerHyperbolic(
    const InputParameters & parameters)
  : SolidMechanicsPlasticDruckerPrager(parameters),
...
Real
SolidMechanicsPlasticDruckerPragerHyperbolic::yieldFunction(const RankTwoTensor & stress,
                                                            Real intnl) const
{
  Real aaa;
  Real bbb;
...
RankTwoTensor
SolidMechanicsPlasticDruckerPragerHyperbolic::df_dsig(const RankTwoTensor & stress, Real bbb) const
{
...
RankFourTensor
SolidMechanicsPlasticDruckerPragerHyperbolic::dflowPotential_dstress(const RankTwoTensor & stress,
                                                                     Real /*intnl*/) const
{
...
std::string
SolidMechanicsPlasticDruckerPragerHyperbolic::modelName() const
{
  return "DruckerPragerHyperbolic";
}

bool
SolidMechanicsPlasticDruckerPragerHyperbolic::returnMap(const RankTwoTensor & trial_stress,
                                                        Real intnl_old,
...
RankFourTensor
SolidMechanicsPlasticDruckerPragerHyperbolic::consistentTangentOperator(
...
bool
SolidMechanicsPlasticDruckerPragerHyperbolic::useCustomReturnMap() const
{
  return _use_custom_returnMap;
}

bool
SolidMechanicsPlasticDruckerPragerHyperbolic::useCustomCTO() const
{

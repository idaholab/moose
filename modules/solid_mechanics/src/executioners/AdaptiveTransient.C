...
AdaptiveTransient::AdaptiveTransient(const InputParameters & parameters) :
...
AdaptiveTransient::AdaptiveTransient(const std::string & deprecated_name, InputParameters parameters) :

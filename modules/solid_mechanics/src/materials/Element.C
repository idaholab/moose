...
Element::fillMatrix( unsigned int qp,
                     ...
                     ColumnMajorMatrix & A )
{
  A(0,0) = grad_x[qp](0); A(0,1) = grad_x[qp](1); A(0,2) = grad_x[qp](2);
  A(1,0) = grad_y[qp](0); A(1,1) = grad_y[qp](1); A(1,2) = grad_y[qp](2);
  A(2,0) = grad_z[qp](0); A(2,1) = grad_z[qp](1); A(2,2) = grad_z[qp](2);
}

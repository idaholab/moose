...
SolidModel::SolidModel( const std::string & name,
  ...
  _poissons_ratio( _poissons_ratio_set ?  getParam<Real>("poissons_ratio") : GetPoissonsRatio() ),
  _shear_modulus( _shear_modulus_set ? getParam<Real>("shear_modulus") : -1 ),
  _youngs_modulus( _youngs_modulus_set ? getParam<Real>("youngs_modulus") : GetYoungsModulus() ),

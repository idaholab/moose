...
template <bool is_ad>
InputParameters
BackstressRadialReturnStressUpdateTempl<is_ad>::validParams()
{
...
template <bool is_ad>
BackstressRadialReturnStressUpdateTempl<is_ad>::BackstressRadialReturnStressUpdateTempl(
...
template <bool is_ad>
void
BackstressRadialReturnStressUpdateTempl<is_ad>::propagateQpStatefulProperties()
{
...
template <bool is_ad>
void
BackstressRadialReturnStressUpdateTempl<is_ad>::updateState(
...
template class BackstressRadialReturnStressUpdateTempl<false>;
template class BackstressRadialReturnStressUpdateTempl<true>;

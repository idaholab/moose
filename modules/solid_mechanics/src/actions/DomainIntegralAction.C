...
DomainIntegralAction::act()
{
  ...
  if (_current_task == "add_user_object")
  {
    ...
    params.set<MultiMooseEnum>("execute_on") = "initial timestep_end"; // was "initial nonlinear"
    ...
    if (_treat_as_2d)
      params.set<unsigned int>("num_crack_front_points") = 1;
    else
      params.set<unsigned int>("num_crack_front_points") = num_crack_front_points;

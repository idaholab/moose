...
data_block_w_line_x_n0_25 = mooseutils.VectorPostprocessorReader(
    "csv/block_w_line_x_n0_25_*.csv"
)

data_block_w_bar_x_0_25 = mooseutils.VectorPostprocessorReader(
    "csv/block_w_bar_x_0_25_*.csv"
)
data_block_w_bar_x_n0_25 = mooseutils.VectorPostprocessorReader(
    "csv/block_w_bar_x_n0_25_*.csv"
)
...
for step in time:
    ...
    data_strip.data.data.plot(
        ax=ax, x="id", y="temperature", label="strip", color="red", ls="-", lw=1
    )
...
for step in time:
    ...
    data_rectangle_w_line_x_025.data.data.plot(
        ax=ax,
        x="id",
        y="temperature",
        label="Embedded line x=0.25",
        marker="o",
        mfc="none",
        ms=2,
        color="black",
    ...
    data_rectangle_w_line_x_n025.data.data.plot(
        ax=ax,
        x="id",
        y="temperature",
        label="Embedded line x=-0.25",
    ...
    data_rectangle_w_strip_x_025.data.data.plot(
        ax=ax, x="id", y="temperature", label="Strip x=0.25", color="red", ls="-", lw=1
    )
    data_rectangle_w_strip_x_n025.data.data.plot(
        ax=ax,
        x="id",
        y="temperature",
        label="Strip x=-0.25",
...
for step in time:
    ...
    data_block_w_line_x_0_25.data.data.plot(
        ax=ax,
        x="id",
        y="temperature",
        label="Embedded line x=0.25",
    ...
    data_block_w_line_x_n0_25.data.data.plot(
        ax=ax,
        x="id",
        y="temperature",
        label="Embedded line x=-0.25",
    ...
    data_block_w_bar_x_0_25.data.data.plot(
        ax=ax, x="id", y="temperature", label="Bar x=0.25", color="red", ls="-", lw=1
    )
    data_block_w_bar_x_n0_25.data.data.plot(
        ax=ax, x="id", y="temperature", label="Bar x=-0.25", color="red", ls="--", lw=1
    )
plt.xlabel("Y coordinate")
plt.ylabel("Temperature ($\degree$C)")

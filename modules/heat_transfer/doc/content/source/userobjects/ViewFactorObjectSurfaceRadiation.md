...
View factors for `ViewFactorObjectSurfaceRadiation` are provided by a [ViewFactorBase.md] object, e.g. [UnobstructedPlanarViewFactor](UnobstructedPlanarViewFactor.md).

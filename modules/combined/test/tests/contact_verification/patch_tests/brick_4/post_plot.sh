...
# Create plot files for Gnuplot
    ...
    echo "plot \"${datfile}\" using 1:5 t \"Node 59 (x-disp,curr)\" $cfmt,\\" >> ${pltfile}
    echo "\"gold/${datfile}\" using 1:5 t \"Node 59 (x-disp,gold)\" $gfmt" >> ${pltfile}
    echo "plot \"${datfile}\" using 1:6 t \"Node 64 (x-disp,curr)\" $cfmt,\\" >> ${pltfile}
    echo "\"gold/${datfile}\" using 1:6 t \"Node 64 (x-disp,gold)\" $gfmt" >> ${pltfile}
    echo "plot \"${datfile}\" using 1:7 t \"Node 59 (y-disp,curr)\" $cfmt,\\" >> ${pltfile}
    echo "\"gold/${datfile}\" using 1:7 t \"Node 59 (y-disp,gold)\" $gfmt" >> ${pltfile}
    echo "plot \"${datfile}\" using 1:8 t \"Node 64 (y-disp,curr)\" $cfmt,\\" >> ${pltfile}
    echo "\"gold/${datfile}\" using 1:8 t \"Node 64 (y-disp,gold)\" $gfmt" >> ${pltfile}

...
set output "stress_strain_nl1h.ps"
set autoscale
set key top right
...
"nafems_nl1h_out.txt" using 1:8 title "{/Symbol s}_{xx} (MOOSE)" with line lt 1 lc 0 lw 1,\
"nafems_nl1h_out.txt" using 1:9 title "{/Symbol s}_{yy} (MOOSE)" with line lt 1 lc 1 lw 1,\
"nafems_nl1h_out.txt" using 1:10 title "{/Symbol s}_{zz} (MOOSE)" with line lt 1 lc 2 lw 1,\
"nafems_nl1h_out.txt" using 1:12 title "{/Symbol s}_{mises} (MOOSE)" with line lt 1 lc 3 lw 1

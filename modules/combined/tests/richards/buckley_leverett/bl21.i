...
[Preconditioning]
  ...
  [./exact]
    ...
    petsc_options_iname = '-ksp_type -ksp_pc_side -pc_type -pc_factor_shift_type -snes_atol -snes_rtol -snes_max_it -ksp_rtol -ksp_atol'
    petsc_options_value = 'bcgs lu NONZERO 1E-10 1E-10 50 1E-20 1E-20'
  [../]
  ...
  [./gmres]
    ...
    full = true
    petsc_options = '-snes_converged_reason -ksp_gmres_modifiedgramschmidt'
    petsc_options_iname = '-ksp_type -ksp_gmres_restart -pc_type -snes_atol -snes_rtol -snes_max_it -ksp_rtol -ksp_atol'
    petsc_options_value = 'gmres 100 bjacobi 1E-10 1E-10 50 1E-20 1E-20'
  [../]

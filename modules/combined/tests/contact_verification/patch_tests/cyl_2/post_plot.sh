...
# Create plot files for Gnuplot
    ...
    echo "plot \"${datfile}\" using 1:5 t \"Node 5 (x-disp,curr)\" $cfmt,\\" >> ${pltfile}
    echo "\"gold/${datfile}\" using 1:5 t \"Node 5 (x-disp,gold)\" $gfmt" >> ${pltfile}
    echo "plot \"${datfile}\" using 1:7 t \"Node 5 (y-disp,curr)\" $cfmt,\\" >> ${pltfile}
    echo "\"gold/${datfile}\" using 1:7 t \"Node 5 (y-disp,gold)\" $gfmt" >> ${pltfile}

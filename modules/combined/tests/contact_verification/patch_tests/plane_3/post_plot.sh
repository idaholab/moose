...
# Create plot files for Gnuplot
    ...
    echo "plot \"${datfile}\" using 1:5 t \"Node 2 (x-disp,curr)\" $cfmt,\\" >> ${pltfile}
    echo "\"gold/${datfile}\" using 1:5 t \"Node 2 (x-disp,gold)\" $gfmt" >> ${pltfile}
    echo "plot \"${datfile}\" using 1:7 t \"Node 2 (y-disp,curr)\" $cfmt,\\" >> ${pltfile}
    echo "\"gold/${datfile}\" using 1:7 t \"Node 2 (y-disp,gold)\" $gfmt" >> ${pltfile}

...
INSTALLABLE_DIRS        := $(foreach module,$(INSTALLABLE_MODULE_DIRS),../$(shell basename $(module))/test/tests->$(shell basename $(module))) ../../tutorials/tutorial04_meshing/app/test/tests->reactor_tutorial ../../tutorials/shield_multiphysics/inputs->shield_multiphysics

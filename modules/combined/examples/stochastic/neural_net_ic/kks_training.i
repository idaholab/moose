...
[Materials]
  [constants]
    ...
    prop_values = '1.5      1e2     1e8                          10                  '
                  '1.09412844417051e-9' #1.09412844417051e-11
  []
  [energy_constants]
    type = GenericConstantMaterial
    prop_names = 'kB            T     n  E0_Ni_metal  E0_Ni_melt    E0_N_metal   E0_N_melt  '
                 'E0_Cr_metal  E0_Cr_melt k_metal k_melt'
    prop_values = '8.6173324e-5  1000  2  -0.4643      0.4817        -0.5441      -2.9913     -0.32  '
                  '     -0.88      3       3'
  []
  #PARAMETERS
  ...
  [f_metal]
    ...
    function = '(E0_Ni_metal*c_Ni_metal + E0_Cr_metal*c_Cr + E0_N_metal*(1-c_Ni_metal -c_Cr_metal) '
               '+k_metal*kB*T*(c_Ni_metal*plog(c_Ni_metal,1e-3) + c_Cr_metal*plog(c_Cr_metal,1e-3) + '
               '(1-c_Ni_metal-c_Cr_metal)*plog(1-c_Ni_metal-c_Cr_metal,1e-3) ) )'
    outputs = exodus
  []
  [f_melt]
    type = DerivativeParsedMaterial
    ...
    function = '(E0_Ni_melt*c_Ni_melt + E0_Cr_melt*c_Cr_melt + E0_N_melt*(1-c_Ni_melt -c_Cr_melt) '
               '+k_melt*kB*T*(c_Ni_melt*plog(c_Ni_melt,1e-3) + c_Cr_melt*plog(c_Cr_melt,1e-3) + '
               '(1-c_Ni_melt-c_Cr_melt)*plog(1-c_Ni_melt-c_Cr_melt,1e-3) ) )'
    outputs = exodus
  []
  ...
  [susceptibility_Ni]
    ...
    material_property_names = 'f_metal chi_inv_metal:=D[f_metal,c_Ni_metal,c_Ni_metal] f_melt '
                              'chi_inv_melt:=D[f_melt,c_Ni_melt,c_Ni_melt] h_metal'
  ...
  [mobility_Ni]
    ...
    function = '(D0_Ni_metal*exp(-E0_Ni_metal/kB/T)*h_metal + '
               'D0_Ni_melt*exp(-E0_Ni_melt/kB/T)*(1-h_metal) )*chi_Ni'
    outputs = 'exodus'
    derivative_order = 2
  []
  ...
  [susceptibility_Cr]
    ...
    material_property_names = 'f_metal chi_inv_metal:=D[f_metal,c_Cr_metal,c_Cr_metal] f_melt '
                              'chi_inv_melt:=D[f_melt,c_Cr_melt,c_Cr_melt] h_metal'
    function = 'h_metal/chi_inv_metal + (1-h_metal)/chi_inv_melt'
    outputs = exodus
  []
  ...
  [mobility_Cr]
    ...
    function = '(D0_Ni_metal*exp(-E0_Ni_metal/kB/T)*h_metal + '
               'D0_Ni_melt*exp(-E0_Ni_melt/kB/T)*(1-h_metal) )*chi_Cr'
    outputs = 'exodus'
    derivative_order = 2
  []
[]

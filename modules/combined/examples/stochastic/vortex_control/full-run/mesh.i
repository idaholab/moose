[Mesh]
  ...
  [new_boundaries_1]
    ...
    bottom_left = '-0.008682409 0.049240388 0'
    top_right = '0.008682409 0.5 0'
    boundary_new = 'top_gap'
    included_boundaries = 'circle'
    replace = true
  []
  [new_boundaries_2]
    type = SideSetsFromBoundingBoxGenerator
    input = new_boundaries_1
    bottom_left = '-0.008682409 -0.5 0'
    top_right = '0.008682409 -0.049240388 0'
    boundary_new = 'bottom_gap'
    included_boundaries = 'circle'
    replace = true
  []
[]

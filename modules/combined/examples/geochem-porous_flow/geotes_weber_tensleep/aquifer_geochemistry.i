...
[AuxKernels]
  ...
  [rate_H_per_1l_auxk]
    type = ParsedAux
    variable_names = 'pf_rate_H nodal_void_volume'
  ...
  [rate_SO4_per_1l_auxk]
    type = ParsedAux
    variable_names = 'pf_rate_SO4 nodal_void_volume'
  ...
  [rate_HCO3_per_1l_auxk]
    type = ParsedAux
    variable_names = 'pf_rate_HCO3 nodal_void_volume'
  ...
  [rate_SiO2aq_per_1l_auxk]
    type = ParsedAux
    variable_names = 'pf_rate_SiO2aq nodal_void_volume'
  ...
  [rate_Al_per_1l_auxk]
    type = ParsedAux
    variable_names = 'pf_rate_Al nodal_void_volume'
  ...
  [rate_Ca_per_1l_auxk]
    type = ParsedAux
    variable_names = 'pf_rate_Ca nodal_void_volume'
  ...
  [rate_Mg_per_1l_auxk]
    type = ParsedAux
    variable_names = 'pf_rate_Mg nodal_void_volume'
  ...
  [rate_Fe_per_1l_auxk]
    type = ParsedAux
    variable_names = 'pf_rate_Fe nodal_void_volume'
  ...
  [rate_K_per_1l_auxk]
    type = ParsedAux
    variable_names = 'pf_rate_K nodal_void_volume'
  ...
  [rate_Sr_per_1l_auxk]
    type = ParsedAux
    variable_names = 'pf_rate_Sr nodal_void_volume'
  ...
  [rate_F_per_1l_auxk]
    type = ParsedAux
    variable_names = 'pf_rate_F nodal_void_volume'
  ...
  [rate_BOH_per_1l_auxk]
    type = ParsedAux
    variable_names = 'pf_rate_BOH nodal_void_volume'
  ...
  [rate_Br_per_1l_auxk]
    type = ParsedAux
    variable_names = 'pf_rate_Br nodal_void_volume'
  ...
  [rate_Ba_per_1l_auxk]
    type = ParsedAux
    variable_names = 'pf_rate_Ba nodal_void_volume'
  ...
  [rate_Li_per_1l_auxk]
    type = ParsedAux
    variable_names = 'pf_rate_Li nodal_void_volume'
  ...
  [rate_NO3_per_1l_auxk]
    type = ParsedAux
    variable_names = 'pf_rate_NO3 nodal_void_volume'
  ...
  [rate_O2aq_per_1l_auxk]
    type = ParsedAux
    variable_names = 'pf_rate_O2aq nodal_void_volume'
  ...
  [massfrac_H_auxk]
    type = ParsedAux
    variable_names = 'transported_H transported_mass'
    variable = massfrac_H
  ...
  [massfrac_SO4_auxk]
    type = ParsedAux
    variable_names = 'transported_SO4 transported_mass'
  ...
  [massfrac_HCO3_auxk]
    type = ParsedAux
    variable_names = 'transported_HCO3 transported_mass'
  ...
  [massfrac_SiO2aq_auxk]
    type = ParsedAux
    variable_names = 'transported_SiO2aq transported_mass'
  ...
  [massfrac_Al_auxk]
    type = ParsedAux
    variable_names = 'transported_Al transported_mass'
  ...
  [massfrac_Ca_auxk]
    type = ParsedAux
    variable_names = 'transported_Ca transported_mass'
  ...
  [massfrac_Mg_auxk]
    type = ParsedAux
    variable_names = 'transported_Mg transported_mass'
  ...
  [massfrac_Fe_auxk]
    type = ParsedAux
    variable_names = 'transported_Fe transported_mass'
  ...
  [massfrac_K_auxk]
    type = ParsedAux
    variable_names = 'transported_K transported_mass'
    variable = massfrac_K
  ...
  [massfrac_Sr_auxk]
    type = ParsedAux
    variable_names = 'transported_Sr transported_mass'
  ...
  [massfrac_F_auxk]
    type = ParsedAux
    variable_names = 'transported_F transported_mass'
    variable = massfrac_F
  ...
  [massfrac_BOH_auxk]
    type = ParsedAux
    variable_names = 'transported_BOH transported_mass'
  ...
  [massfrac_Br_auxk]
    type = ParsedAux
    variable_names = 'transported_Br transported_mass'
  ...
  [massfrac_Ba_auxk]
    type = ParsedAux
    variable_names = 'transported_Ba transported_mass'
  ...
  [massfrac_Li_auxk]
    type = ParsedAux
    variable_names = 'transported_Li transported_mass'
  ...
  [massfrac_NO3_auxk]
    type = ParsedAux
    variable_names = 'transported_NO3 transported_mass'
  ...
  [massfrac_O2aq_auxk]
    type = ParsedAux
    variable_names = 'transported_O2aq transported_mass'

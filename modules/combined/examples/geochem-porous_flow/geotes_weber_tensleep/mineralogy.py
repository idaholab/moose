...
for mineral in all_minerals:
    del_rel[mineral] = [
        (cm - cm3[mineral][0]) / cm3[mineral][0] if (cm3[mineral][0] != 0) else 0
        for cm in cm3[mineral]
    ]
...
plt.tight_layout()
plt.savefig(
    "../../../../geochemistry/doc/content/media/geochemistry/geotes_weber_tensleep_mineralogy_abs.png"
)
...
plt.tight_layout()
plt.savefig(
    "../../../../geochemistry/doc/content/media/geochemistry/geotes_weber_tensleep_mineralogy_rel.png"
)
plt.show()

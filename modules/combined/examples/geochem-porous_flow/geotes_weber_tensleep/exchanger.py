...
for i in range(len(all_minerals)):
    cum_mols[all_minerals[i]] = [
        x[index["cumulative_moles_precipitated_" + all_minerals[i]]] for x in data
    ]
cum_cm3 = {}
for i in range(len(all_minerals)):
...
plt.tight_layout()
plt.savefig(
    "../../../../geochemistry/doc/content/media/geochemistry/geotes_weber_tensleep_exchanger.png"
)

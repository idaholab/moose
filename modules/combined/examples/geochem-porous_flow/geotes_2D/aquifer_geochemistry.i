...
[AuxKernels]
  [porosity]
    type = ParsedAux
    variable_names = free_cm3_QuartzLike
  ...
  [rate_H2O_per_1l_auxk]
    type = ParsedAux
    variable_names = 'pf_rate_H2O nodal_void_volume'
...
# pf_rate * 1000 / molar_mass / (nodal_void_volume_in_m^3 * 1000) = change in moles per litre of aqueous solution
  ...
  [rate_Na_per_1l]
    type = ParsedAux
    variable_names = 'pf_rate_Na nodal_void_volume'
  ...
  [rate_Cl_per_1l]
    type = ParsedAux
    variable_names = 'pf_rate_Cl nodal_void_volume'
  ...
  [rate_SiO2_per_1l]
    type = ParsedAux
    variable_names = 'pf_rate_SiO2 nodal_void_volume'
  ...
  [transported_mass_auxk]
    type = ParsedAux
    variable_names = 'transported_H2O transported_Na transported_Cl transported_SiO2'
  ...
  [massfrac_H2O]
    type = ParsedAux
    variable_names = 'transported_H2O transported_mass'
  ...
  [massfrac_Na]
    type = ParsedAux
    variable_names = 'transported_Na transported_mass'
  ...
  [massfrac_Cl]
    type = ParsedAux
    variable_names = 'transported_Cl transported_mass'
  ...
  [massfrac_SiO2]
    type = ParsedAux
    variable_names = 'transported_SiO2 transported_mass'

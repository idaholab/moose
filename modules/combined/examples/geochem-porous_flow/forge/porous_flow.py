...
k_percentage = [
    100 * k_rate[i] / mass_rate[i] if mass_rate[i] != 0 else 0.0
    for i in range(len(mass_rate))
]
...
plt.tight_layout()
plt.savefig(
    "../../../../geochemistry/doc/content/media/geochemistry/forge_production_temperature.png"
)
...
plt.tight_layout()
plt.savefig(
    "../../../../geochemistry/doc/content/media/geochemistry/forge_production_rate.png"
)
...
plt.tight_layout()
plt.savefig(
    "../../../../geochemistry/doc/content/media/geochemistry/forge_production_rate_SiO2.png"
)
plt.show()

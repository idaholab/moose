...
percentage_change = {}
for mineral in all_minerals:
    percentage_change[mineral] = [
        100 * (c - cm3[mineral][0]) / cm3[mineral][0] for c in cm3[mineral]
    ]
...
plt.tight_layout()
plt.savefig(
    "../../../../geochemistry/doc/content/media/geochemistry/natural_reservoir_minerals.png"
)

# Plot the percentage changes in mineral volume
sortit = sorted(
    [[percentage_change[mineral][-1], mineral] for mineral in all_minerals[:-1]]
)
plotorder = [m[1] for m in sortit]
...
plt.tight_layout()
plt.savefig(
    "../../../../geochemistry/doc/content/media/geochemistry/natural_reservoir_mineral_percentage.png"
)
...
plt.tight_layout()
plt.savefig(
    "../../../../geochemistry/doc/content/media/geochemistry/natural_reservoir_solution.png"
)

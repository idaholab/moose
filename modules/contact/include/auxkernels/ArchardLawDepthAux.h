...
/**
 * Computes the accumulated worn depth due to frictional dissipation based on Archard's law.
 */
class ArchardLawDepthAux : public AuxKernel
{
public:
  static InputParameters validParams();

  ArchardLawDepthAux(const InputParameters & parameters);

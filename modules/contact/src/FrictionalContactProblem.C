...
FrictionalContactProblem::FrictionalContactProblem(const std::string & deprecated_name, InputParameters params) :
    ReferenceResidualProblem(deprecated_name, params),
    _refResidContact(0.0),
    _slip_residual(0.0),
    _do_slip_update(false),
    _num_slip_iterations(0),

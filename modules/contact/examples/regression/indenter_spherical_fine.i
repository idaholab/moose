[Mesh]
  [generated_mesh]
    ...
    file = spherical_indenter_fine.e
  []
...
[Controls]
  [period0]
    type = TimePeriod
    disable_objects = 'BCs::topz'
    start_time = '0.032' # 0.08
    end_time = '70.0'
...
[Executioner]
  ...
  # end_time = 1.8
  end_time = 0.04
  nl_rel_tol = 1e-8 # -8, -6 to avoid many iterations. Switch it March 2021
...
[Contact]
  [ind_base]
    ...
    penalty = 1e7
    normal_smoothing_distance = 0.02
  []
[]

...
# terms are exercised. Note this is a residual-only check -- it confirms the
# converged solution is consistent with Newton's third law, but a residual
# comparison cannot by itself distinguish a Jacobian term, so it does not
# verify the Jacobian contribution from those terms.
#

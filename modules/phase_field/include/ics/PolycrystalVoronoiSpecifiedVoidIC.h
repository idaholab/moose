...
/**
 * PolycrystalVoronoiSpecifiedVoidIC initializes either grain or void values for a
 * voronoi tesselation with voids distributed at specified x, y, z positions
 * inherited from MultiSmoothCircleIC
 */
class PolycrystalVoronoiSpecifiedVoidIC : public SpecifiedSmoothCircleIC
{
public:
  static InputParameters validParams();

  PolycrystalVoronoiSpecifiedVoidIC(const InputParameters & parameters);

...
{
inline std::vector<Real> AssignPointsToVariables(const std::vector<Point> centerpoints, const Real op_num, const MooseMesh & mesh, const MooseVariable & var)
{
...
inline unsigned int AssignPointToGrain(const Point & p, const std::vector<Point> centerpoints, const MooseMesh & mesh, const MooseVariable & var, const Real maxsize)
{

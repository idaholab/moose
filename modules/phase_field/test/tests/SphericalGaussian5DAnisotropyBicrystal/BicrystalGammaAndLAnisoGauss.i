...
[Materials]
  [5DGaussian]
    ...
    Library_file_name = "MinimaLibraryBicrystalMob" # Name given to the minima library file
    ...
    L_BASE = 0.0001 # (nm^3/eV.ns); Base value of L from which gaussian is subtracted or added
    alphaswitch = 3 # Range of variation for switch 1
    betaswitch = 3 # Range of variation for switch 2
    libnum = 1 # Number of lines in minima library file
    ...
    ADDGaussianL = true # 'true' to add to base value; 'false' to subtract from base value [L]

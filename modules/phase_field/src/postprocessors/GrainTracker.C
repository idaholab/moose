...
template <>
void
dataStore(std::ostream & stream, GrainTracker::PartialFeatureData & feature, std::any context)
{
...
template <>
void
dataLoad(std::istream & stream, GrainTracker::PartialFeatureData & feature, std::any context)
{

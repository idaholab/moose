...
InputParameters validParams<GrainBoundaryArea>()
{
  ...
  params.addParam<Real>("grains_per_side", 2.0, "Number of order parameters contacting a boundary (should be 2.0 in polycrystals and 1.0 for dispersed particles)");

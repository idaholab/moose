...
PFCRFFMaterial::PFCRFFMaterial(const std::string & name,
  ...
  :Material(name, parameters),
   ...
   _alpha_R_3(declareProperty<Real>("alpha_R_2")),
   _alpha_I_3(declareProperty<Real>("alpha_I_2")),
   _A_R_3(declareProperty<Real>("A_R_2")),
   _A_I_3(declareProperty<Real>("A_I_2")),
   _alpha_R_4(declareProperty<Real>("alpha_R_2")),
   _alpha_I_4(declareProperty<Real>("alpha_I_2")),
   _A_R_4(declareProperty<Real>("A_R_2")),
   _A_I_4(declareProperty<Real>("A_I_2")),

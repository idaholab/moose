...
InputParameters validParams<SwitchingFunction3PhaseMaterial>()
{
  ...
  params.addClassDescription("Material for switching function that prevents formation of a third phase at a two-phase interface: h_i = eta_i^2/4 * [15 (1-eta_i) [1 + eta_i - (eta_k - eta_j)^2] + eta_i * (9eta_i^2 - 5)]");

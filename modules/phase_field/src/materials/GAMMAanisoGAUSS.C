...
GAMMAanisoGAUSS::validParams()
{
  ...
  params.addRequiredParam<MaterialPropertyName>("dGgammadx_name",
                                                "The name of dGgammadx, WRT grad eta");
  params.addRequiredParam<MaterialPropertyName>("dGgammadx_EN_name",
                                                "The name of dGgammadx_EN, WRT grad eta");

  params.addRequiredParam<MaterialPropertyName>("dGgammady_name",
                                                "The name of dGgammady, WRT grad eta");
  params.addRequiredParam<MaterialPropertyName>("dGgammady_EN_name",
                                                "The name of dGgammady_EN, WRT grad eta");

  params.addRequiredParam<MaterialPropertyName>("dGgammadz_name",
                                                "The name of dGgammadz, WRT grad eta");
  params.addRequiredParam<MaterialPropertyName>("dGgammadz_EN_name",
                                                "The name of dGgammadz_EN, WRT grad eta");

  params.addRequiredParam<MaterialPropertyName>("dGgammadxplus_name",
                                                "The name of dGgammadx, WRT grad eta");
  params.addRequiredParam<MaterialPropertyName>("dGgammadxplus_EN_name",
                                                "The name of dGgammadx_EN, WRT grad eta");
  params.addRequiredParam<MaterialPropertyName>("dGgammadyplus_name",
                                                "The name of dGgammady, WRT grad eta");
  params.addRequiredParam<MaterialPropertyName>("dGgammadyplus_EN_name",
                                                "The name of dGgammady_EN, WRT grad eta");
  params.addRequiredParam<MaterialPropertyName>("dGgammadzplus_name",
                                                "The name of dGgammadz, WRT grad eta");
  params.addRequiredParam<MaterialPropertyName>("dGgammadzplus_EN_name",
                                                "The name of dGgammadz_EN, WRT grad eta");
  ...
  params.addRequiredParam<MaterialPropertyName>("dgammadx_name",
                                                "The name of dgammadx, WRT grad eta");
  params.addRequiredParam<MaterialPropertyName>("dgammadx_EN_name",
                                                "The name of dgammadx_EN, WRT grad eta");

  params.addRequiredParam<MaterialPropertyName>("dgammady_name",
                                                "The name of dgammady, WRT grad eta");
  params.addRequiredParam<MaterialPropertyName>("dgammady_EN_name",
                                                "The name of dgammady_EN, WRT grad eta");

  params.addRequiredParam<MaterialPropertyName>("dgammadz_name",
                                                "The name of dgammadz, WRT grad eta");
  params.addRequiredParam<MaterialPropertyName>("dgammadz_EN_name",
                                                "The name of dgammadz_EN, WRT grad eta");

  params.addRequiredParam<MaterialPropertyName>("dgammadxplus_name",
                                                "The name of dgammadx, WRT grad eta");
  params.addRequiredParam<MaterialPropertyName>("dgammadxplus_EN_name",
                                                "The name of dgammadx_EN, WRT grad eta");
  params.addRequiredParam<MaterialPropertyName>("dgammadyplus_name",
                                                "The name of dgammady, WRT grad eta");
  params.addRequiredParam<MaterialPropertyName>("dgammadyplus_EN_name",
                                                "The name of dgammady_EN, WRT grad eta");
  params.addRequiredParam<MaterialPropertyName>("dgammadzplus_name",
                                                "The name of dgammadz, WRT grad eta");
  params.addRequiredParam<MaterialPropertyName>("dgammadzplus_EN_name",
                                                "The name of dgammadz_EN, WRT grad eta");
  ...
  params.addRequiredParam<MaterialPropertyName>("sigma_EN_name",
                                                "Grain boundary energy, in eV/nm^2");

  params.addRequiredParam<MaterialPropertyName>("sigmaORIUNIT_name",
                                                "Grain boundary energy, in J/m^2");
  params.addRequiredParam<MaterialPropertyName>("sigmaORIUNIT_EN_name",
                                                "Grain boundary energy, in J/m^2");
  ...
  params.addRequiredParam<MaterialPropertyName>("Ggammabar_name",
                                                "The name of the average anisotropy");

  params.addRequiredParam<MaterialPropertyName>("Ggammamin2grains_name",
                                                "The name of the 2grains minimum Ggamma");
...
GAMMAanisoGAUSS::GAMMAanisoGAUSS(const InputParameters & parameters)
  : ADMaterial(parameters),
    ...
    _dGgammadxplus_EN(
        declareProperty<Real>(getParam<MaterialPropertyName>("dGgammadxplus_EN_name"))),
    _dGgammadyplus(declareADProperty<Real>(getParam<MaterialPropertyName>("dGgammadyplus_name"))),
    _dGgammadyplus_EN(
        declareProperty<Real>(getParam<MaterialPropertyName>("dGgammadyplus_EN_name"))),
    _dGgammadzplus(declareADProperty<Real>(getParam<MaterialPropertyName>("dGgammadzplus_name"))),
    _dGgammadzplus_EN(
        declareProperty<Real>(getParam<MaterialPropertyName>("dGgammadzplus_EN_name"))),
    ...
    _Ggammamin2grains(
        declareADProperty<Real>(getParam<MaterialPropertyName>("Ggammamin2grains_name"))),
...
GAMMAanisoGAUSS::computeQpProperties()
{
          ...
          if (b == op_to_grains[m])
          {
            ...
            if (a == op_to_grains[n])
            {
              ...
              for (unsigned int l = 0; l < _libnum; ++l)
              {
                ...
                ADReal Ggamma_Minima = (MinimaEnergy[l] * _JtoeV * _length_scale * _length_scale) /
                ...
                ADReal p_Minima = -(3.0944 * (g2_Minima * g2_Minima * g2_Minima * g2_Minima)) -
                                  (1.8169 * (g2_Minima * g2_Minima * g2_Minima)) +
                                  (10.323 * (g2_Minima * g2_Minima)) - (8.1819 * (g2_Minima)) +
                                  2.0033;
                ...
                ADReal Inversegamma_Minima3 =
                    Inversegamma_Minima * Inversegamma_Minima * Inversegamma_Minima;
                ADReal Inversegamma_Minima4 = Inversegamma_Minima * Inversegamma_Minima *
                                              Inversegamma_Minima * Inversegamma_Minima;
                ADReal Inversegamma_Minima5 = Inversegamma_Minima * Inversegamma_Minima *
                                              Inversegamma_Minima * Inversegamma_Minima *
                                              Inversegamma_Minima;
                ADReal Inversegamma_Minima6 = Inversegamma_Minima * Inversegamma_Minima *
                                              Inversegamma_Minima * Inversegamma_Minima *
                                              Inversegamma_Minima * Inversegamma_Minima;

                ADReal f0gamma_Minima =
                    (0.0788 * Inversegamma_Minima6) - (0.4955 * Inversegamma_Minima5) +
                    (1.2244 * Inversegamma_Minima4) - (1.5281 * Inversegamma_Minima3) +
                    (1.0686 * Inversegamma_Minima2) - (0.5563 * Inversegamma_Minima1) + 0.2907;
                ...
                if (std::fabs(normvsmallba) > tol) // if R < tol, no contributions from gaussians 1e-20
                {
                  ...
                  ADReal Gaussian =
                      _amplitudeScale * amplitudes * _S_switch[_qp] * std::exp(exponent);
                  Gaussian = _ADDGaussian ? Gaussian : -Gaussian; // yes = add, false = subtract

                  ADReal Gaussian2 = _amplitudeScale * amplitudes * _S_switch[_qp] * _sharpness *
                                     std::exp(exponent) *
                  ...
                  ADReal Gaussian3 = _amplitudeScale * amplitudes * _S_switch[_qp] * _sharpness *
                                     std::exp(exponent) *
                  ...
                  ADReal Gaussian4 = _amplitudeScale * amplitudes * _S_switch[_qp] * _sharpness *
                                     std::exp(exponent) *
                  ...
                  ADReal Gaussian2plus = _amplitudeScale * amplitudes * _S_switch[_qp] *
                  ...
                  ADReal Gaussian3plus = _amplitudeScale * amplitudes * _S_switch[_qp] *
                                         _sharpness * std::exp(exponent) *
                                         (((((1) * miubalibyR * normvsmallba) -
                                            (miubalibyR * vsmalbay * (1 / (2 * normvsmallba)) *
                                             ((1) * 2 * vsmalbay))) /
                  ...
                  ADReal Gaussian4plus = _amplitudeScale * amplitudes * _S_switch[_qp] *
                                         _sharpness * std::exp(exponent) *
                                         (((((1) * miubalibzR * normvsmallba) -
                                            (miubalibzR * vsmalbaz * (1 / (2 * normvsmallba)) *
                                             ((1) * 2 * vsmalbaz))) /
  ...
  ADReal p = -(3.0944 * (g2 * g2 * g2 * g2)) - (1.8169 * (g2 * g2 * g2)) + (10.323 * (g2 * g2)) -
             (8.1819 * (g2)) + 2.0033;

  ADReal dpdg2 = -((3.0944 * 4) * (g2 * g2 * g2)) - ((1.8169 * 3) * (g2 * g2)) +
                 ((10.323 * 2) * (g2)) - 8.1819;
  ...
  _dgammadx_EN[_qp] = MetaPhysicL::raw_value((-2) * (_Ggamma[_qp]) * (_gamma[_qp] * _gamma[_qp]) *
                                             (dpdg2)*_dGgammadx[_qp]);
  _dgammady_EN[_qp] = MetaPhysicL::raw_value((-2) * (_Ggamma[_qp]) * (_gamma[_qp] * _gamma[_qp]) *
                                             (dpdg2)*_dGgammady[_qp]);
  _dgammadz_EN[_qp] = MetaPhysicL::raw_value((-2) * (_Ggamma[_qp]) * (_gamma[_qp] * _gamma[_qp]) *
                                             (dpdg2)*_dGgammadz[_qp]);

  _dgammadxplus[_qp] =
      (-2) * (_Ggamma[_qp]) * (_gamma[_qp] * _gamma[_qp]) * (dpdg2)*_dGgammadxplus[_qp];
  _dgammadyplus[_qp] =
      (-2) * (_Ggamma[_qp]) * (_gamma[_qp] * _gamma[_qp]) * (dpdg2)*_dGgammadyplus[_qp];
  _dgammadzplus[_qp] =
      (-2) * (_Ggamma[_qp]) * (_gamma[_qp] * _gamma[_qp]) * (dpdg2)*_dGgammadzplus[_qp];
  _dgammadxplus_EN[_qp] = MetaPhysicL::raw_value(
      (-2) * (_Ggamma[_qp]) * (_gamma[_qp] * _gamma[_qp]) * (dpdg2)*_dGgammadxplus[_qp]);
  _dgammadyplus_EN[_qp] = MetaPhysicL::raw_value(
      (-2) * (_Ggamma[_qp]) * (_gamma[_qp] * _gamma[_qp]) * (dpdg2)*_dGgammadyplus[_qp]);
  _dgammadzplus_EN[_qp] = MetaPhysicL::raw_value(
      (-2) * (_Ggamma[_qp]) * (_gamma[_qp] * _gamma[_qp]) * (dpdg2)*_dGgammadzplus[_qp]);
  ...
  _sigmaORIUNIT_EN[_qp] =
      MetaPhysicL::raw_value((_sigma[_qp]) / (_JtoeV * _length_scale * _length_scale));
  ...
  ADReal Inversegamma6 =
      Inversegamma * Inversegamma * Inversegamma * Inversegamma * Inversegamma * Inversegamma;

  ADReal f0gamma = (0.0788 * Inversegamma6) - (0.4955 * Inversegamma5) + (1.2244 * Inversegamma4) -
                   (1.5281 * Inversegamma3) + (1.0686 * Inversegamma2) - (0.5563 * Inversegamma1) +
                   0.2907;

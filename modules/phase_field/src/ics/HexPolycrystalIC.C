...
HexPolycrystalIC::initialSetup()
{
  ...
  //    mooseError("ERROR in PolycrystalReducedIC: Number of order parameters (op_num) can't be
  //    larger "
  ...
  //  _assigned_op = PolycrystalICTools::assignPointsToVariables(_centerpoints, _op_num, _mesh,
  //  _var);
}

...
# Uncomment the commented out parts of teh input file to activate teh simultaneous
# solve of the same problem with the BCs applied instead of the InterfaceKernel.
#

...
Flow streamlines computed with the [Navier-Stokes](modules/navier_stokes/index.md) module, through a digital rock reconstructed with the [Image Reader](framework/doc/content/source/functions/ImageFunction.md) from a stack of microCT scans. The framework is described in [Lesueur et al. (2017)](http://doi.org/10.1016/j.gete.2017.08.001).

...
Next, it is necessary to load the desired application environment.

```bash
module load use.moose moose-apps {{ApplicationLower}}
```

At this point you should be able to run the executable. For this example, the {{ApplicationName}} executable
...
The available applications such as {{ApplicationName}} will depend on being granted access to the specific

...
printed and we no longer print the stack trace which finished in frames related
...
- The [Bounds system](Bounds/index.md) was extended from supporting only first order Lagrange variables to also
  supporting constant monomial variables. This currently does not include support for finite volume variables.
...
The [DirectCentralDifference.md] time integrator was improved to support mixed-order time integration scheme, using central difference for some variables and first-order Euler for others. This mixed-order approach can avoid using an unstable second-order scheme for equations known to have these issues.

...
The `use_scalar_variables` parameter in `Junctions` has been removed.
...
- Automatic differentiation was added to [EqualValueEmbeddedConstraint.md] in MOOSE. This enables a numerically-perfect Jacobians without hand-coding the Jacobian.

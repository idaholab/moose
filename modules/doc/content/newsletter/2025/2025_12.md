...
- Changed time-dependent equation system and operator classes to set up problems described in terms of the state of the
  system at the next timestep, instead of time derivatives

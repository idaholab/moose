...
Component-based convergence was added to all flow channels. Using convergence objects, the convergence criteria
can be tailored for each component, to avoid over- or under-solving the equations created for the flow in the channel.
Similar efforts will provide these capabilities to heat structures and junctions in the near future.

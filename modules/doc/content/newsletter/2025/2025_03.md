...
After it was cleared for release as open-source software, the Subchannel application was merged in MOOSE as the Subchannel module (SCM). SCM is a Subchannel Module for performing reactor core, single-phase thermal-hydraulic subchannel simulations, for bare pin, square lattice bundles or wire-wrapped/bare pin, triangular lattice bundles. It can model water cooled or metal cooled (lead, sodium, LBE) bundles.

The subchannel documentation may be found at this [link](subchannel/doc/content/index.md).
...
The pressure drops are computed by the [BernouilliPressureVariable.md].
...
heat conduction in the solution may be solved using finite element, while fluid dynamics may be solved using the finite volume

...
The [`SmoothMesh MeshModifier`](http://www.mooseframework.inl.gov/source/meshmodifiers/SmoothMesh.html) can
...
The [`ElementQualityAux` AuxKernel](http://www.mooseframework.inl.gov/source/auxkernels/ElementQualityAux.html)

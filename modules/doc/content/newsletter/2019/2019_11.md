...
[!file](interface_value_material.i), [!file](interface_value_material_split_mesh.i), and
[!file](interface_value_material_split_mesh_stateful.i). Source examples of
`InterfaceMaterial` derived objects are [!file](InterfaceValueMaterial.C) and
[!file](/JumpInterfaceMaterial.C). Header examples can be found at
[!file](InterfaceValueMaterial.h) and [!file](/JumpInterfaceMaterial.h).

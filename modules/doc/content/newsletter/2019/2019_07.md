...
A complete input file with an array variable can be found [!file](/array_diffusion_test.i).
Array variables can be coupled into standard kernels and vice versa as showed in [!file](array_diffusion_reaction_coupling.i) and [!file](array_diffusion_reaction_other_coupling.i)

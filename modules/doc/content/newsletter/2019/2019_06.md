...
`MeshGenerator`s to be combined into a single mesh.  This is somewhat similar to [StitchMeshGenerator.md]
...
- [!file](test/tests/interfacekernels/2d_interface/vector_2d.i)
- [!file](test/tests/interfacekernels/3d_interface/vector_3d.i)

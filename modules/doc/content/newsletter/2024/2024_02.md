...
and stop the setup of the simulation. The `Application` block supports Multiapp and can be used to
replace the commandline option `--app <AppName>`. When a combined application is given, the user can

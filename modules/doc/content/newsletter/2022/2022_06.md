...
[framework:NonlinearSystem.md#resid_and_jac_together].
...
More information about the new module can be found on the [module documentation page](electromagnetics:modules/electromagnetics/index.md).

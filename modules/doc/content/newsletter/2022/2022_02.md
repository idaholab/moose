...
The system
[documentation](modules/solid_mechanics/BalanceOfLinearMomentum.md)
...
- A [new material system](modules/solid_mechanics/ObjectiveStressRates.md), which provides new options for implementing
...
- Changes to MooseDocs parameter descriptions generated by `!syntax parameters` and other similar
  ...
  - Removed empty "Options" fields, i.e., for parameter types that do not inherit from
    [!file text=`MooseEnumBase`](framework/include/utils/MooseEnumBase.h)

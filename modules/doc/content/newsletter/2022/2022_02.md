...
MOOSE [Thermal Hydraulics](thermal_hydraulics:modules/thermal_hydraulics/index.md) module. Some
key features of this module include:

- The [Components system](thermal_hydraulics:Components/index.md), which provides a higher-level
...
- The [Control logic system](thermal_hydraulics:ControlLogic/index.md) provides a similar capability
  as MOOSE's [Controls system](framework:Controls/index.md) but integrates with the `Components`
  system.
...
[tensor mechanics](tensor_mechanics:modules/tensor_mechanics/index.md) module.
...
The system
[documentation](tensor_mechanics:modules/tensor_mechanics/LagrangianKernelTheory.md)
...
- Cartesian versions of a reformulated [updated Lagrangian](tensor_mechanics:source/kernels/lagrangian/UpdatedLagrangianStressDivergence.md) kernel and a new
  [total Lagrangian](tensor_mechanics:source/kernels/lagrangian/TotalLagrangianStressDivergence.md) kernel, both with exact large deformation Jacobians.
- [Stabilization](tensor_mechanics:modules/tensor_mechanics/Stabilization.md) for linear triangular and tetraheadral elements.
- A [new material system](tensor_mechanics:modules/tensor_mechanics/NewMaterialSystem.md), which provides new options for implementing
...
- [Partial compatibility](tensor_mechanics:source/materials/lagrangian/ComputeLagrangianWrappedStress.md) with the current MOOSE materials system.
- A [new homogenization subsystem](tensor_mechanics:modules/tensor_mechanics/Homogenization.md) for applying cell-average stress or
...
The Lagrangian kernel system is included in the updated [tensor mechanics action](tensor_mechanics:TensorMechanicsAction.md)
...
Check out [`BodyForce`](framework:BodyForce.md) and
[`CoupledValueFunctionMaterial`](framework:CoupledValueFunctionMaterial.md) for
...
[thermal_hydraulics:thermal_hydraulics/modeling_guide/brayton_cycle/brayton_cycle.md].
...
equations was reworked to feature a [navier_stokes:INSFVRhieChowInterpolator.md], which handles face
...
The [navier_stokes:ReynoldsNumberFunctorAux.md] auxliary kernels and [navier_stokes:RayleighNumber.md] postprocessor were
...
- Missing documentation for the [framework:LibmeshPartitioner.md] and for how to perform a field split using
  preconditioning, see the [framework:FieldSplitPreconditioner.md], was added

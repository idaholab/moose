...
- MOOSE now supports the hypre Auxiliary-space Maxwell Solver (AMS) and the hypre Auxiliary-space Divergence Solver (ADS) for curl-curl and grad-div problems,

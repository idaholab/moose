...
!media tutorial04_meshing/adv_ex_pcg_and_xyd.png
       ...
       caption=An example of using [XYDelaunayGenerator.md] with curve meshes generated by [ParsedCurveGenerator.md].
       style=width:50%;display:block;margin-left:auto;margin-right:auto;

!listing sec14_adv/pcg_xyd.i
         id=tutorial04-pcg_xyd.i
         caption=[XYDelaunayGenerator.md] with curve meshes example.
         block=Mesh/xydg2

...
!media large_media/examples/ex6-1-out.png
       ...
       alt=The distribition of the diffused quantity at the start of the simulation.

!media large_media/examples/ex6-2-out.png
       style=width:47%;display:inline-flex;margin-left:3%
       alt=The distribition of the diffused quantity at the end of the simulation.

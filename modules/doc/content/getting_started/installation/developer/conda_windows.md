# Conda Windows Development Environment
...
The following instructions describe the use of [Conda](https://docs.conda.io) to install the required dependencies for building MOOSE and a MOOSE-based application on Windows.

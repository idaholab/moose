...
ThermalContactMaterialsAction::act()
{
  ...
  if (isParamValid("gap_conductivity_function"))
    params.set<FunctionName>("gap_conductivity_function") =
        getParam<FunctionName>("gap_conductivity_function");

  if (isParamValid("gap_conductivity_function_variable"))
    params.set<std::vector<VariableName>>("gap_conductivity_function_variable") = {
        getParam<VariableName>("gap_conductivity_function_variable")};

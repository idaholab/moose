...
as well as the dependencies and limitations of the ray tracing module. The Heat
Conduction module does not support modeling heat transfer due to convection,

...
validParams<FEValuePenaltyBC>()
{
  ...
  params.addClassDescription(
      "Sets a value boundary condition, evaluated using a FunctionSeries"
      " instance. This does not fix the value, but rather 'strongly encourages'"
      " value agreement by penalizing the differences through contributions to"
      " the residual.");

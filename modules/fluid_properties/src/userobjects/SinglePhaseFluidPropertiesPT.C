...
void
SinglePhaseFluidPropertiesPT::p_from_v_e(Real, Real, Real &, Real &, Real &) const
{
  mooseError(name(), ": ", __PRETTY_FUNCTION__, " not implemented.");
}
...
void
SinglePhaseFluidPropertiesPT::T_from_v_e(Real, Real, Real &, Real &, Real &) const
{
  mooseError(name(), ": ", __PRETTY_FUNCTION__, " not implemented.");
}
...
void
SinglePhaseFluidPropertiesPT::c_from_v_e(Real, Real, Real &, Real &, Real &) const
{
  mooseError(name(), ": ", __PRETTY_FUNCTION__, " not implemented.");
}
...
void
SinglePhaseFluidPropertiesPT::s_from_v_e(Real, Real, Real &, Real &, Real &) const
{
  mooseError(name(), ": ", __PRETTY_FUNCTION__, " not implemented.");
}
...
void
SinglePhaseFluidPropertiesPT::s_from_h_p(Real, Real, Real &, Real &, Real &) const
{
  mooseError(name(), ": ", __PRETTY_FUNCTION__, " not implemented.");
}
...
void
SinglePhaseFluidPropertiesPT::rho_from_p_s(Real, Real, Real &, Real &, Real &) const
{
  mooseError(name(), ": ", __PRETTY_FUNCTION__, " not implemented.");
}
...
void
SinglePhaseFluidPropertiesPT::e_from_v_h(Real, Real, Real &, Real &, Real &) const
{
  mooseError(name(), ": ", __PRETTY_FUNCTION__, " not implemented.");
}
...
void
SinglePhaseFluidPropertiesPT::rho_from_p_T(Real, Real, Real &, Real &, Real &) const
{
  mooseError(name(), ": ", __PRETTY_FUNCTION__, " not implemented.");
}
...
void
SinglePhaseFluidPropertiesPT::e_from_p_rho(Real, Real, Real &, Real &, Real &) const
{
  mooseError(name(), ": ", __PRETTY_FUNCTION__, " not implemented.");
}
...
void
SinglePhaseFluidPropertiesPT::h_from_p_T(Real, Real, Real &, Real &, Real &) const
{
  mooseError(name(), ": ", __PRETTY_FUNCTION__, " not implemented.");
}
...
void
SinglePhaseFluidPropertiesPT::p_from_h_s(Real, Real, Real &, Real &, Real &) const
{
  mooseError(name(), ": ", __PRETTY_FUNCTION__, " not implemented.");
}

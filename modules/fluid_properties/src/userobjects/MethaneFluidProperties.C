...
{
  /// Check the temperatue is in the range of validity (280 K <= T <= 1080 K)
  if (temperature <= 280.0 || temperature >= 1080.0)
    mooseError("Temperatue " << temperature << "K out of range (280K, 1080K) in " << name() << ":cp()");
...
MethaneFluidProperties::s(Real /*pressure*/, Real temperature) const
{
  /// Check the temperatue is in the range of validity (280 K <= t <= 1080 K)
  if (temperature <= 280.0 || temperature >= 1080.0)
    mooseError("Temperatue " << temperature << "K out of range (280K, 1080K) in " << name() << ":s()");
...
std::vector<Real>
MethaneFluidProperties::henryConstants()
{

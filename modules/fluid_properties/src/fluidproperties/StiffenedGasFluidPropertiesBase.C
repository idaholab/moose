...
InputParameters
StiffenedGasFluidPropertiesBase::validParams()
{
...
StiffenedGasFluidPropertiesBase::StiffenedGasFluidPropertiesBase(const InputParameters & parameters)
  : SinglePhaseFluidProperties(parameters), NaNInterface(this)
{
}

StiffenedGasFluidPropertiesBase::~StiffenedGasFluidPropertiesBase() {}

void
StiffenedGasFluidPropertiesBase::initialSetup()
{
...
Real
StiffenedGasFluidPropertiesBase::p_from_v_e(Real v, Real e) const
{
  return p_from_v_e_template(v, e);
}

void
StiffenedGasFluidPropertiesBase::p_from_v_e(
...
ADReal
StiffenedGasFluidPropertiesBase::p_from_v_e(const ADReal & v, const ADReal & e) const
{
  return p_from_v_e_template(v, e);
}
...
Real
StiffenedGasFluidPropertiesBase::T_from_v_e(Real v, Real e) const
{
  return T_from_v_e_template(v, e);
}

void
StiffenedGasFluidPropertiesBase::T_from_v_e(
...
ADReal
StiffenedGasFluidPropertiesBase::T_from_v_e(const ADReal & v, const ADReal & e) const
{
  return T_from_v_e_template(v, e);
}
...
Real
StiffenedGasFluidPropertiesBase::T_from_p_h(Real v, Real e) const
{
  return T_from_p_h_template(v, e);
}

void
StiffenedGasFluidPropertiesBase::T_from_p_h(
    Real v, Real e, Real & T, Real & dT_dv, Real & dT_de) const
{
...
ADReal
StiffenedGasFluidPropertiesBase::T_from_p_h(const ADReal & v, const ADReal & e) const
{
  return T_from_p_h_template(v, e);
}
...
Real
StiffenedGasFluidPropertiesBase::c_from_v_e(Real v, Real e) const
{
...
void
StiffenedGasFluidPropertiesBase::c_from_v_e(
...
Real
StiffenedGasFluidPropertiesBase::cp_from_v_e(Real, Real) const
{
  return _cp;
}

void
StiffenedGasFluidPropertiesBase::cp_from_v_e(
...
Real
StiffenedGasFluidPropertiesBase::cv_from_v_e(Real, Real) const
{
  return _cv;
}

void
StiffenedGasFluidPropertiesBase::cv_from_v_e(
...
Real
StiffenedGasFluidPropertiesBase::mu_from_v_e(Real, Real) const
{
  return _mu;
}

void
StiffenedGasFluidPropertiesBase::mu_from_v_e(
...
Real
StiffenedGasFluidPropertiesBase::k_from_v_e(Real, Real) const
{
  return _k;
}

void
StiffenedGasFluidPropertiesBase::k_from_v_e(
...
Real
StiffenedGasFluidPropertiesBase::s_from_v_e(Real v, Real e) const
{
  return s_from_v_e_template(v, e);
}

void
StiffenedGasFluidPropertiesBase::s_from_v_e(
...
ADReal
StiffenedGasFluidPropertiesBase::s_from_v_e(const ADReal & v, const ADReal & e) const
{
  return s_from_v_e_template(v, e);
}
...
Real
StiffenedGasFluidPropertiesBase::s_from_h_p(Real h, Real p) const
{
...
void
StiffenedGasFluidPropertiesBase::s_from_h_p(
...
Real
StiffenedGasFluidPropertiesBase::s_from_p_T(Real p, Real T) const
{
  return s_from_p_T_template(p, T);
}

void
StiffenedGasFluidPropertiesBase::s_from_p_T(
...
ADReal
StiffenedGasFluidPropertiesBase::s_from_p_T(const ADReal & p, const ADReal & T) const
{
  return s_from_p_T_template(p, T);
}
...
Real
StiffenedGasFluidPropertiesBase::rho_from_p_s(Real p, Real s) const
{
...
void
StiffenedGasFluidPropertiesBase::rho_from_p_s(
...
Real
StiffenedGasFluidPropertiesBase::e_from_v_h(Real v, Real h) const
{
  return (h + (_gamma - 1.0) * _q + _gamma * _p_inf * v) / _gamma;
}

void
StiffenedGasFluidPropertiesBase::e_from_v_h(
...
Real
StiffenedGasFluidPropertiesBase::rho_from_p_T(Real p, Real T) const
{
  return rho_from_p_T_template(p, T);
}

void
StiffenedGasFluidPropertiesBase::rho_from_p_T(
...
ADReal
StiffenedGasFluidPropertiesBase::rho_from_p_T(const ADReal & p, const ADReal & T) const
{
  return rho_from_p_T_template(p, T);
}
...
Real
StiffenedGasFluidPropertiesBase::e_from_p_rho(Real p, Real rho) const
{
  return e_from_p_rho_template(p, rho);
}

void
StiffenedGasFluidPropertiesBase::e_from_p_rho(
...
ADReal
StiffenedGasFluidPropertiesBase::e_from_p_rho(const ADReal & p, const ADReal & rho) const
{
  return e_from_p_rho_template(p, rho);
}
...
Real
StiffenedGasFluidPropertiesBase::e_from_T_v(Real T, Real v) const
{
  return _cv * T + _q + _p_inf * v;
}

void
StiffenedGasFluidPropertiesBase::e_from_T_v(
...
Real
StiffenedGasFluidPropertiesBase::p_from_T_v(Real T, Real v) const
{
...
void
StiffenedGasFluidPropertiesBase::p_from_T_v(
    Real T, Real v, Real & p, Real & dp_dT, Real & dp_dv) const
{
...
Real
StiffenedGasFluidPropertiesBase::h_from_T_v(Real T, Real /*v*/) const
{
  return _gamma * _cv * T + _q;
}

void
StiffenedGasFluidPropertiesBase::h_from_T_v(
...
Real
StiffenedGasFluidPropertiesBase::s_from_T_v(Real T, Real v) const
{
  Real e = e_from_T_v(T, v);
...
void
StiffenedGasFluidPropertiesBase::s_from_T_v(
    Real T, Real v, Real & s, Real & ds_dT, Real & ds_dv) const
{
...
Real
StiffenedGasFluidPropertiesBase::cv_from_T_v(Real /*T*/, Real /*v*/) const
{
  return _cv;
}

Real
StiffenedGasFluidPropertiesBase::e_spndl_from_v(Real /*v*/) const
{
  return _e_c;
}

void
StiffenedGasFluidPropertiesBase::v_e_spndl_from_T(Real /*T*/, Real & v, Real & e) const
{
  v = 1. / _rho_c;
  e = _e_c;
}
...
Real
StiffenedGasFluidPropertiesBase::h_from_p_T(Real /*p*/, Real T) const
{
  return _gamma * _cv * T + _q;
}

void
StiffenedGasFluidPropertiesBase::h_from_p_T(
...
Real
StiffenedGasFluidPropertiesBase::e_from_p_T(Real p, Real T) const
{
  return (p + _gamma * _p_inf) / (p + _p_inf) * _cv * T + _q;
}

void
StiffenedGasFluidPropertiesBase::e_from_p_T(
...
Real
StiffenedGasFluidPropertiesBase::p_from_h_s(Real h, Real s) const
{
...
void
StiffenedGasFluidPropertiesBase::p_from_h_s(
...
Real
StiffenedGasFluidPropertiesBase::g_from_v_e(Real v, Real e) const
{
...
Real
StiffenedGasFluidPropertiesBase::c2_from_p_rho(Real pressure, Real rho) const
{
  return _gamma * (pressure + _p_inf) / rho;
}

Real
StiffenedGasFluidPropertiesBase::molarMass() const
{
  return _molar_mass;
}

Real
StiffenedGasFluidPropertiesBase::criticalTemperature() const
{
  return _T_c;
}

Real
StiffenedGasFluidPropertiesBase::criticalDensity() const
{
  return _rho_c;
}

Real
StiffenedGasFluidPropertiesBase::criticalInternalEnergy() const
{
  return _e_c;
}

Real
StiffenedGasFluidPropertiesBase::cv_from_p_T(Real /* pressure */, Real /* temperature */) const
{
  return _cv;
}

void
StiffenedGasFluidPropertiesBase::cv_from_p_T(
...
Real
StiffenedGasFluidPropertiesBase::cp_from_p_T(Real /* pressure */, Real /* temperature */) const
{
  return _cp;
}

void
StiffenedGasFluidPropertiesBase::cp_from_p_T(
...
Real
StiffenedGasFluidPropertiesBase::mu_from_p_T(Real /* pressure */, Real /* temperature */) const
{
  return _mu;
}

void
StiffenedGasFluidPropertiesBase::mu_from_p_T(
...
Real
StiffenedGasFluidPropertiesBase::k_from_p_T(Real /* pressure */, Real /* temperature */) const
{
  return _k;
}

void
StiffenedGasFluidPropertiesBase::k_from_p_T(
...
Real
StiffenedGasFluidPropertiesBase::beta_from_p_T(Real /* pressure */, Real temperature) const
{
  return 1 / temperature;
}
void
StiffenedGasFluidPropertiesBase::beta_from_p_T(
...
Real
StiffenedGasFluidPropertiesBase::pp_sat_from_p_T(Real /*p*/, Real /*T*/) const
{

 ...
 */
class StiffenedGasFluidPropertiesBase : public SinglePhaseFluidProperties, public NaNInterface
{
public:
  static InputParameters validParams();

  StiffenedGasFluidPropertiesBase(const InputParameters & parameters);
  virtual ~StiffenedGasFluidPropertiesBase();
...
protected:
  /// Inner body of initialSetup(); initialize parameters if not already
  virtual void initialSetupInner() = 0;
...
CppType
StiffenedGasFluidPropertiesBase::rho_from_p_T_template(const CppType & p, const CppType & T) const
{
...
template <typename CppType>
void
StiffenedGasFluidPropertiesBase::rho_from_p_T_template(
...
template <typename CppType>
CppType
StiffenedGasFluidPropertiesBase::e_from_p_rho_template(const CppType & p, const CppType & rho) const
{
...
template <typename CppType>
void
StiffenedGasFluidPropertiesBase::e_from_p_rho_template(
...
template <typename CppType>
CppType
StiffenedGasFluidPropertiesBase::T_from_v_e_template(const CppType & v, const CppType & e) const
{
...
template <typename CppType>
void
StiffenedGasFluidPropertiesBase::T_from_v_e_template(
...
template <typename CppType>
CppType
StiffenedGasFluidPropertiesBase::T_from_p_h_template(const CppType & /*p*/, const CppType & h) const
{
...
template <typename CppType>
void
StiffenedGasFluidPropertiesBase::T_from_p_h_template(
...
template <typename CppType>
CppType
StiffenedGasFluidPropertiesBase::p_from_v_e_template(const CppType & v, const CppType & e) const
{
...
template <typename CppType>
void
StiffenedGasFluidPropertiesBase::p_from_v_e_template(
...
template <typename CppType>
CppType
StiffenedGasFluidPropertiesBase::s_from_v_e_template(const CppType & v, const CppType & e) const
{
...
template <typename CppType>
void
StiffenedGasFluidPropertiesBase::s_from_v_e_template(
...
template <typename CppType>
CppType
StiffenedGasFluidPropertiesBase::s_from_p_T_template(const CppType & p, const CppType & T) const
{
  CppType n = std::pow(T, _gamma) / std::pow(p + _p_inf, _gamma - 1.0);
  if (n <= 0.0)
    return getNaN();
...
template <typename CppType>
void
StiffenedGasFluidPropertiesBase::s_from_p_T_template(

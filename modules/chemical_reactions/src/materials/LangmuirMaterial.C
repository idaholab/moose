...
InputParameters validParams<LangmuirMaterial>()
{
  ...
  params.addCoupledVar("desorption_time_const_change", 1.0, "An auxillary variable describing time_const changes.  time_const = mat_time_const/time_const_change.  If this is not provided, unity is used.  If the total time_const is nonpositive, no desorption takes place.");
  params.addCoupledVar("adsorption_time_const_change", 1.0, "An auxillary variable describing time_const changes.  time_const = mat_time_const/time_const_change.  If this is not provided, zero is used.  If the total time_const is nonpositive then no adsorption takes place");
...
LangmuirMaterial::LangmuirMaterial(const std::string & name,
    ...
    _desorption_time_const_change(&coupledValue("desorption_time_const_change")), // coupledValue returns a reference (an alias) to a VariableValue, and the & turns it into a pointer
    _adsorption_time_const_change(&coupledValue("adsorption_time_const_change")), // coupledValue returns a reference (an alias) to a VariableValue, and the & turns it into a pointer
    ...
    _one_over_desorption_time_const(declareProperty<Real>("one_over_desorption_time_const")),
    _one_over_adsorption_time_const(declareProperty<Real>("one_over_adsorption_time_const")),
...
{
  _one_over_desorption_time_const[_qp] = (*_desorption_time_const_change)[_qp]/_mat_desorption_time_const;
  _one_over_adsorption_time_const[_qp] = (*_adsorption_time_const_change)[_qp]/_mat_adsorption_time_const;

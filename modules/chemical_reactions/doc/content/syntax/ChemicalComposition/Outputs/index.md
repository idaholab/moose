...
energies, enthalpies, entropies, heat capacities, and constituent fractions on phase sublattices.
Each leaf block creates one scalar auxiliary variable using the leaf-block name, unless its

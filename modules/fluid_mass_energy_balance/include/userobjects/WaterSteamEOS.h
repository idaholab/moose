...
public:
  WaterSteamEOS(const std::string & name, InputParameters params);
    ...
    Real steamEquationOfStatePH (Real enth_in, Real press_in, Real temp_sat, Real& temp2, Real& dens2, Real& enth2) const;

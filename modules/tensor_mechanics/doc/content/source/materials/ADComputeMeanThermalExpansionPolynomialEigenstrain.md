...
!syntax description /Materials/ADComputeMeanThermalExpansionPolynomialEigenstrain

## Description

This model computes the eigenstrain tensor resulting from isotropic thermal expansion where the
temperature-dependent thermal expansion is defined by a user-supplied coefficients that are then used to generate a polynomial with respect to temperature
 that describes the
...
!listing modules/tensor_mechanics/test/tests/ad_thermal_expansion_function/polynomial.i
         block=Materials/thermal_expansion_strain

!syntax parameters /Materials/ADComputeMeanThermalExpansionPolynomialEigenstrain

!syntax inputs /Materials/ADComputeMeanThermalExpansionPolynomialEigenstrain

!syntax children /Materials/ADComputeMeanThermalExpansionPolynomialEigenstrain

# Scalar torque reaction TimestepSize
...
# Because the applied force direction vector is perpendicular to the axis of rotation
# in the undeformed mesh, the resulting acting torque sum is small.

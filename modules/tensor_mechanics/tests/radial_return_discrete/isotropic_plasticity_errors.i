...
[Materials]
  ...
  [./isotropic_plasticity_discrete]
    type = DiscreteRRIsotropicPlasticity
    block = 0
  ...
  [./radial_return_stress]
    type = ComputeRadialReturnMappingStress
    block = 0
    outputs = all
    discrete_radial_material = 'isotropic_plasticity_discrete'
  [../]
[]

...
class TangentialDisplacementCylinderAux : public AuxKernel
{
public:
  static InputParameters validParams();

  TangentialDisplacementCylinderAux(const InputParameters & parameters);

  virtual ~TangentialDisplacementCylinderAux() {}

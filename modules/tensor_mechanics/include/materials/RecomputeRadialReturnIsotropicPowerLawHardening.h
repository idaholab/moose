...
/****************************************************************/
#ifndef RECOMPUTERADIALRETURNISOTROPICPOWERLAWHARDENING_H
#define RECOMPUTERADIALRETURNISOTROPICPOWERLAWHARDENING_H
 ...
 * Parameters from the parent class, RecomputeRadialReturnIsotropicPlasticity, are
 * suppressed to enable this class to solve for yield stress:
 * \f$ \sigma_y = \left( \frac{E^n}{K} \right)^{1/(n-1)} \f$
 */

class RecomputeRadialReturnIsotropicPowerLawHardening : public RecomputeRadialReturnIsotropicPlasticity
{
public:
  RecomputeRadialReturnIsotropicPowerLawHardening(const InputParameters & parameters);
...
#endif //RECOMPUTERADIALRETURNISOTROPICPOWERLAWHARDENING_H

 ...
 */
class ComputeEigenstrainTrussFromInitialStress : public ComputeEigenstrainTrussBase
{
public:
  static InputParameters validParams();

  ComputeEigenstrainTrussFromInitialStress(const InputParameters & parameters);

...
/****************************************************************/
#ifndef DISCRETERRISOTROPICPLASTICITY_H
#define DISCRETERRISOTROPICPLASTICITY_H
...
/**
 * This class uses the Discrete material in a radial return (abbreviated in the
 * class name as RR) isotropic plasticity model.  This class is one of the basic
 * radial return constitutive models; more complex constitutive models combine
 * creep and plasticity.
 *
 * This class inherits from DiscreteRadialReturnStressIncrement and must be used
 ...
 * these values are passed to the DiscreteRadialReturnStressIncrement to compute
...
class DiscreteRRIsotropicPlasticity : public DiscreteRadialReturnStressIncrement
{
public:
  DiscreteRRIsotropicPlasticity( const InputParameters & parameters);

protected:
  void resetQpProperties(); /// Values for the resetQpProperties need to be set to a constant, ideally zero
...
#endif //DISCRETERRISOTROPICPLASTICITY_H

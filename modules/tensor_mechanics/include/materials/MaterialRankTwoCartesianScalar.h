...
class MaterialRankTwoCartesianScalar;

template <>
InputParameters validParams<MaterialRankTwoCartesianScalar>();

/**
 * MaterialRankTwoCylindricalScalar uses the namespace RankTwoScalarTools to compute scalar
 * values from Rank-2 tensors.
 */
class MaterialRankTwoCartesianScalar : public Material
{
public:
  static InputParameters validParams();

  MaterialRankTwoCartesianScalar(const InputParameters & parameters);

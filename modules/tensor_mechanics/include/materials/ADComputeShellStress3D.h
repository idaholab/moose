...
class ADComputeShellStress3D : public ADMaterial
{
public:
  static InputParameters validParams();

  ADComputeShellStress3D(const InputParameters & parameters);
...
protected:
  ...
  std::vector<const ADMaterialProperty<RankTwoTensor> *> _rotation_matrix;

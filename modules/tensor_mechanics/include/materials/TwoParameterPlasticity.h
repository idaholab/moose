...
/****************************************************************/
#ifndef TWOPARAMETERPLASTICITY_H
#define TWOPARAMETERPLASTICITY_H

#include "StateUpdateBase.h"

#include <array>

class TwoParameterPlasticity;

template <>
InputParameters validParams<TwoParameterPlasticity>();

/**
 * TwoParameterPlasticity performs the return-map
 ...
 */
class TwoParameterPlasticity : public StateUpdateBase
{
public:
  TwoParameterPlasticity(const InputParameters & parameters, unsigned num_yf, unsigned num_intnl);
...
protected:
   ...
   */
  virtual void finaliseReturnProcess(const RankTwoTensor & rotation_increment);
...
#endif // TWOPARAMETERPLASTICITY_H

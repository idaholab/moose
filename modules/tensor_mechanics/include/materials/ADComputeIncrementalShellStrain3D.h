...
class ADComputeIncrementalShellStrain3D : public ADMaterial
{
public:
  static InputParameters validParams();

  ADComputeIncrementalShellStrain3D(const InputParameters & parameters);
...
protected:
  ...
  /// Mechanical strain increment in the covariant coordinate system
  std::vector<ADMaterialProperty<RankTwoTensor> *> _mechanical_strain;

  /// Old mechanical strain increment in the covariant coordinate system
  std::vector<const MaterialProperty<RankTwoTensor> *> _mechanical_strain_old;
  ...
  std::vector<ADMaterialProperty<RankTwoTensor> *> _rotation_matrix;

  /// Total strain in global coordinate system
  std::vector<ADMaterialProperty<RankTwoTensor> *> _total_global_strain;
  ...
  RankTwoTensor _unrotated_mechanical_strain;
};

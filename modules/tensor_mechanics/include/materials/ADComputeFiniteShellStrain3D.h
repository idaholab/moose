...
/**
 * ADComputeFiniteShellStrain3D computes the strain increment term for shell elements under finite
 * displacement/rotation scenarios.
 **/

class ADComputeFiniteShellStrain3D : public ADComputeIncrementalShellStrain
{
public:
  static InputParameters validParams();

  ADComputeFiniteShellStrain3D(const InputParameters & parameters);

...
//
class StVenantKirchhoffStressUpdate : public ComputeLagrangianStressPK2, public GuaranteeConsumer
{
public:
  static InputParameters validParams();
  StVenantKirchhoffStressUpdate(const InputParameters & parameters);

...
class AnisotropicReturnStressUpdate : public StressUpdateBase,
                                      public MultiVariableReturnMappingSolution
{
public:
  static InputParameters validParams();

  AnisotropicReturnStressUpdate(const InputParameters & parameters);
  ...
  virtual Real
  maximumPermissibleValue(const DenseVector<Real> & effective_trial_stress) const override;
...
protected:
   ...
   */
  void computeHillTensorEigenDecomposition(DenseMatrix<Real> & hill_tensor);
  ...
  DenseVector<Real> _eigenvalues_hill;
  DenseMatrix<Real> _eigenvectors_hill;
};

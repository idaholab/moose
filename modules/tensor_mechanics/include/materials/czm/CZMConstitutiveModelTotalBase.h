 ...
 * directions.
 */
class CZMConstitutiveModelTotalBase : public InterfaceMaterial
{
public:
  static InputParameters validParams();
  CZMConstitutiveModelTotalBase(const InputParameters & parameters);

protected:
  void computeQpProperties() override;

  // method used to compute the traction and its derivatives

...
class CZMConstitutiveModelIncrementalBase : public CZMConstitutiveModelTotalBase
{
public:
  static InputParameters validParams();
  CZMConstitutiveModelIncrementalBase(const InputParameters & parameters);

protected:
  void initQpStatefulProperties() override;

  /// method used to compute the total traction
  virtual void computeInterfaceTractionAndDerivatives() final;

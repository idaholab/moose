...
class CZMEquilibriumTractionCalculatorSmallStrain : public CZMEquilibriumTractionCalculatorBase
{
public:
  static InputParameters validParams();
  CZMEquilibriumTractionCalculatorSmallStrain(const InputParameters & parameters);

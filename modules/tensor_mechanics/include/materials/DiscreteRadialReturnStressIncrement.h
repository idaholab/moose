...
/****************************************************************/
#ifndef DISCRETERADIALRETURNSTRESSINCREMENT_H
#define DISCRETERADIALRETURNSTRESSINCREMENT_H
...
//Forward declaration
class DiscreteRadialReturnStressIncrement;

template<>
InputParameters validParams<DiscreteRadialReturnStressIncrement>();

/**
 * DiscreteRadialReturnStressIncrement computes the radial return stress increment for
 ...
 * The stress increment computed by DiscreteRadialReturnStressIncrement is used by
...
class DiscreteRadialReturnStressIncrement : public DiscreteMaterial
{
public:
  DiscreteRadialReturnStressIncrement(const InputParameters & parameters);

protected:
  void computeQpProperties();

  /// Values for the discrete material Material Properties resetQpProperties need to be set to a constant, ideally zero
  ...
  MaterialProperty<RankTwoTensor> & _radial_return_stress;
...
#endif //DISCRETERADIALRETURNSTRESSINCREMENT_H

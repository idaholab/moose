#ifndef TENSORMECHANICSPLASTICTENSILEMULTI2
#define TENSORMECHANICSPLASTICTENSILEMUTLI2

#include "TensorMechanicsPlasticModel.h"
#include "TensorMechanicsHardeningModel.h"


class TensorMechanicsPlasticTensileMulti2;
...
/**
 * FiniteStrainTensileMulti2 implements rate-independent associative tensile failure
 * with hardening/softening in the finite-strain framework, using planar (non-smoothed) surfaces
 */
class TensorMechanicsPlasticTensileMulti2 : public TensorMechanicsPlasticModel
{
 public:
  TensorMechanicsPlasticTensileMulti2(const std::string & name, InputParameters parameters);
...
#endif // TENSORMECHANICSPLASTICTENSILEMULTI2

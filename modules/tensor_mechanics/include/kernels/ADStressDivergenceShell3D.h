...
/**
 * ADStressDivergenceShell3D computes the stress divergence term for shell elements.
 **/

class ADStressDivergenceShell3D : public ADKernel
{
public:
  static InputParameters validParams();

  ADStressDivergenceShell3D(const InputParameters & parameters);

...
[Modules/TensorMechanics/Master]
  [all]
    strain = FINITE
    generate_output = 'elastic_strain_yy stress_yy strain_yy'
    add_variables = true
  []
[]
...
[Materials]
  ...
  [elasticity_tensor]
    ...
    C_ijkl = '10.0e4 15.0e4 20.0e4 2.0e4 2.0e4 2.0e4 0.2 0.2 0.2 0.13333333333333333 0.1 0.15'
  []
  ...
  [trial_plasticity]
    type = HillElastoPlasticityStressUpdate

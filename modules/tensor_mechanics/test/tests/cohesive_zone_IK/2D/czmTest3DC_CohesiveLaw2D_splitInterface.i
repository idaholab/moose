...
[InterfaceKernels]
  [./interface_x]
    ...
    disp_index = 0
    boundary = 'czm_bM1_bS2 czm_bM1_bS3 czm_bM2_bS4 czm_bM3_bS4'
...
[UserObjects]
  [./TractionSeparationTest_12_13]
    type = CohesiveLaw_3DC
    boundary = 'czm_bM1_bS2 czm_bM1_bS3'
    DeltaU0 = '1 0.5'
    MaxAllowableTraction = '1e2 5e1'
  [../]

  [./TractionSeparationTest_24_34]
    type = CohesiveLaw_3DC
    boundary = 'czm_bM2_bS4 czm_bM3_bS4'
    DeltaU0 = '1 0.5'
...
[Materials]
  ...
  [./interface_12_13]
    ...
    boundary = 'czm_bM1_bS2 czm_bM1_bS3'
    uo_TractionSeparationLaw = 'TractionSeparationTest_12_13'
    disp_x = disp_x
  ...
  [./interface_24_34]
    type = DisplacementJumpBasedCohesiveInterfaceMaterial
    boundary = 'czm_bM2_bS4 czm_bM3_bS4'
    uo_TractionSeparationLaw = 'TractionSeparationTest_24_34'
    disp_x = disp_x
    disp_x_neighbor = disp_x
    disp_y = disp_y
    disp_y_neighbor = disp_y

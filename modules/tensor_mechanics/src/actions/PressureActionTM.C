...
PressureActionTM::PressureActionTM(const InputParameters & params) :
  Action(params),
...
PressureActionTM::PressureActionTM(const std::string & deprecated_name, InputParameters params) :

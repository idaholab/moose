...
ADInertialForceShell<RESIDUAL>::computeResidual()
{
  ...
  Moose::out << " Call to computeResidual() \n";
  if (_dt == 0)
  ...
  if (_dt != 0.0)
  {
    ...
    Moose::out << " translational velocities and accelerations \n";
    ...
    Moose::out << " rotational velocities and accelerations \n";
    ...
    for (unsigned int qp_xy = 0; qp_xy < _2d_points.size(); ++qp_xy)
    {
      ...
      Moose::out << " Get all GX matrices of the shell element \n";
      Moose::out << " Matrix G4: " << G4 << " \n";
      ...
      Moose::out << "Before local_rot_. \n";
      Moose::out << "End of defining local_rot_accel_dv. ZZZZZZZZZZZ \n";
      Moose::out << "local_acc[0]: " << local_acc[0](2) << "\n";
      Moose::out << "local_acc[1]: " << local_acc[1](2) << "\n";
      Moose::out << "local_acc[2]: " << local_acc[2](2) << "\n";
      Moose::out << "local_acc[3]: " << local_acc[3](2) << "\n";
      ...
      Moose::out << "local_rot push back. \n";

      // _local_force for each of the nodes. Try vector form first (containing three displacement
      // components)

      Real factor_qxy = _2d_weights[qp_xy] * _J_map[qp_xy] * _thickness/ (_ad_JxW[qp_xy] * _ad_coord[qp_xy]);

      Moose::out << "After factor_qxy. \n";
        ...
        if (_eta[0] > TOLERANCE * TOLERANCE)
          _local_force[0](dim) +=
              ...
              (_phi_map[0][qp_xy] * _phi_map[0][qp_xy] * local_vel[0](dim) +
               _phi_map[0][qp_xy] *
                   (G1(dim, 0) * local_rot_vel[0](0) + G1(dim, 1) * local_rot_vel[0](1)) +
               _phi_map[0][qp_xy] * _phi_map[1][qp_xy] * local_vel[1](dim) +
               _phi_map[0][qp_xy] *
                   (G2(dim, 0) * local_rot_vel[1](0) + G2(dim, 1) * local_rot_vel[1](1)) +
               _phi_map[0][qp_xy] * _phi_map[2][qp_xy] * local_vel[2](dim) +
               _phi_map[0][qp_xy] *
                   (G3(dim, 0) * local_rot_vel[2](0) + G3(dim, 1) * local_rot_vel[2](1)) +
               _phi_map[0][qp_xy] * _phi_map[3][qp_xy] * local_vel[3](dim) +
               _phi_map[0][qp_xy] *
                   (G4(dim, 0) * local_rot_vel[3](0) + G4(dim, 1) * local_rot_vel[3](1)));

        Moose::out << "End of first terms _local_force[0](dim): \n";
      ...
      Moose::out << "After for loop filling out local forces. \n";
      ...
      Moose::out << "After filling out moment of inertia. \n";
      ...
      //      if (_component < 3)
      //      {
      //        _local_re(0) = 0.00001 * _accel_0(_component);
      //        _local_re(1) = 0.00001 * _accel_1(_component);
      //        _local_re(2) = 0.00001 * _accel_2(_component);
      //        _local_re(3) = 0.00001 * _accel_3(_component);
      //      }
      //      else
      //      {
      //        _local_re(0) = 0.00001 * _rot_accel_0(_component - 3);
      //        _local_re(1) = 0.00001 * _rot_accel_1(_component - 3);
      //        _local_re(2) = 0.00001 * _rot_accel_2(_component - 3);
      //        _local_re(3) = 0.00001 * _rot_accel_3(_component - 3);
      //      }
    }

    if (_component < 3)
    {
      _global_force_0 = _original_local_config * _local_force[0];
      _global_force_1 = _original_local_config * _local_force[1];
      _global_force_2 = _original_local_config * _local_force[2];
      _global_force_3 = _original_local_config * _local_force[3];
    ...
    {
      _global_moment_0 = _original_local_config * _local_moment[0];
      _global_moment_1 = _original_local_config * _local_moment[1];
      _global_moment_2 = _original_local_config * _local_moment[2];
      _global_moment_3 = _original_local_config * _local_moment[3];
    ...
    Moose::out << "_component: " << _component << "\n";
    Moose::out << "_local_re(0): " << _local_re(0) << "\n";
    Moose::out << "_local_re(1): " << _local_re(1) << "\n";
    Moose::out << "_local_re(2): " << _local_re(2) << "\n";
    Moose::out << "_local_re(3): " << _local_re(3) << "\n";
  }
  ...
  Moose::out << " Beginning of Tagging computeResidual() \n";
  ...
  Moose::out << " End of Call to computeResidual() \n";
}

...
void
TensorMechanicsPlasticModel::yieldFunctionV(const RankTwoTensor & stress, Real intnl, std::vector<Real> & f) const
{
  f.assign(1, yieldFunction(stress, intnl));
}

RankTwoTensor
TensorMechanicsPlasticModel::dyieldFunction_dstress(const RankTwoTensor & /*stress*/, Real /*intnl*/) const
{
  return RankTwoTensor();
}

void
TensorMechanicsPlasticModel::dyieldFunction_dstressV(const RankTwoTensor & stress, Real intnl, std::vector<RankTwoTensor> & df_dstress) const
{
  df_dstress.assign(1, dyieldFunction_dstress(stress, intnl));
}

Real
TensorMechanicsPlasticModel::dyieldFunction_dintnl(const RankTwoTensor & /*stress*/, Real /*intnl*/) const
{
  return 0.0;
}
void
TensorMechanicsPlasticModel::dyieldFunction_dintnlV(const RankTwoTensor & stress, Real intnl, std::vector<Real> & df_dintnl) const
{
...
void
TensorMechanicsPlasticModel::flowPotentialV(const RankTwoTensor & stress, Real intnl, std::vector<RankTwoTensor> & r) const
{
  return r.assign(1, flowPotential(stress, intnl));
}

RankFourTensor
TensorMechanicsPlasticModel::dflowPotential_dstress(const RankTwoTensor & /*stress*/, Real /*intnl*/) const
{
  return RankFourTensor();
}
void
TensorMechanicsPlasticModel::dflowPotential_dstressV(const RankTwoTensor & stress, Real intnl, std::vector<RankFourTensor> & dr_dstress) const
{
  return dr_dstress.assign(1, dflowPotential_dstress(stress, intnl));
}

RankTwoTensor
TensorMechanicsPlasticModel::dflowPotential_dintnl(const RankTwoTensor & /*stress*/, Real /*intnl*/) const
{
  return RankTwoTensor();
}
void
TensorMechanicsPlasticModel::dflowPotential_dintnlV(const RankTwoTensor & stress, Real intnl, std::vector<RankTwoTensor> & dr_dintnl) const
{
...
void
TensorMechanicsPlasticModel::hardPotentialV(const RankTwoTensor & stress, Real intnl, std::vector<Real> & h) const
{
...
void
TensorMechanicsPlasticModel::dhardPotential_dstressV(const RankTwoTensor & stress, Real intnl, std::vector<RankTwoTensor> & dh_dstress) const
{
  dh_dstress.assign(numberSurfaces(), dhardPotential_dstress(stress, intnl));
}

Real
TensorMechanicsPlasticModel::dhardPotential_dintnl(const RankTwoTensor & /*stress*/, Real /*intnl*/) const
{
  return 0.0;
}
void
TensorMechanicsPlasticModel::dhardPotential_dintnlV(const RankTwoTensor & stress, Real intnl, std::vector<Real> & dh_dintnl) const
{
...
bool
TensorMechanicsPlasticModel::returnMap(const RankTwoTensor & trial_stress, Real intnl_old, const RankFourTensor & /*E_ijkl*/,

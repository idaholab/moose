...
InputParameters validParams<TensorMechanicsPlasticMohrCoulombCubic>()
{
  ...
  params.addRangeCheckedParam<Real>("cohesion_limit", 1, "cohesion_limit>0", "Cohesion = cubic between cohesion (at zero internal parameter) and cohesion_residual (at internal_parameter = cohesion_limit).  Set to zero for perfect plasticity");
  params.addRangeCheckedParam<Real>("friction_angle_limit", 1, "friction_angle_limit>0", "friction_angle = cubic between friction_angle (at zero internal parameter) and friction_angle_residual (at internal_parameter = friction_angle_limit).  Set to zero for perfect plasticity");
  params.addRangeCheckedParam<Real>("dilation_angle_limit", 1, "dilation_angle_limit>0", "dilation_angle =cubic between dilation_angle (at zero internal parameter) and dilation_angle_residual (at internal_parameter = dilation_angle_limit).  Set to zero for perfect plasticity");

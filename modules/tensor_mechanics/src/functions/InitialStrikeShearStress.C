...
InitialStrikeShearStress::value(Real /*t*/, const Point & p) const
{
  ...
  double T1_o = 0.0;
  if ((x_coord <= (_xcoord_middlepatchcenter + _len)) && (x_coord >= (_xcoord_middlepatchcenter - _len)))
  {
    T1_o = _Tso_centerpatch;
  }
  else if ((x_coord <= (_xcoord_leftpatchcenter + _len)) && (x_coord >= (_xcoord_leftpatchcenter - _len)))
  {
    T1_o = _Tso_leftpatch;
  }
  else if ((x_coord <= (_xcoord_rightpathcenter + _len)) && (x_coord >= (_xcoord_rightpathcenter - _len)))
  {

...
{
  //if (!isParamValid("return_mapping_stress_model"))
  //  mooseWarning("You have chosen to run this material without an interative recompute material; define return_mapping_stress_model to calculate inelastic stress and strain");
}

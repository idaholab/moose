...
#include "GeneralizedReturnStressUpdate.h"

#include "MooseMesh.h"
#include "ElasticityTensorTools.h"

InputParameters
GeneralizedReturnStressUpdate::validParams()
{
...
GeneralizedReturnStressUpdate::GeneralizedReturnStressUpdate(const InputParameters & parameters)
...
void
GeneralizedReturnStressUpdate::initQpStatefulProperties()
{
  _effective_inelastic_strain[_qp] = 0;
}

void
GeneralizedReturnStressUpdate::propagateQpStatefulPropertiesRadialReturn()
{
  _effective_inelastic_strain[_qp] = _effective_inelastic_strain_old[_qp];
}

void
GeneralizedReturnStressUpdate::updateState(RankTwoTensor & strain_increment,
...
Real
GeneralizedReturnStressUpdate::maximumPermissibleValue(
...
Real
GeneralizedReturnStressUpdate::computeTimeStepLimit()
{
...
void
GeneralizedReturnStressUpdate::computeHillTensorEigenDecomposition(DenseMatrix<Real> & hill_tensor)
{
...
void
GeneralizedReturnStressUpdate::outputIterationSummary(std::stringstream * iter_output,

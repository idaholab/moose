...
CZMComputeGlobalTractionTotalLagrangian::CZMComputeGlobalTractionTotalLagrangian(
  ...
  : CZMComputeGlobalTractionBase(parameters),
    ...
    _interface_traction_old(
        getMaterialPropertyOldByName<RealVectorValue>(_base_name + "interface_traction_old")),
    _czm_total_rotation(
        getMaterialPropertyByName<RankTwoTensor>(_base_name + "czm_total_rotation")),
    _czm_total_rotation_inc(
        getMaterialPropertyByName<RankTwoTensor>(_base_name + "czm_total_rotation_inc")),
    ...
    _PK1traction_inc(declarePropertyByName<RealVectorValue>(_base_name + "PK1traction_inc")),
    _PK1traction_old(getMaterialPropertyOldByName<RealVectorValue>(_base_name + "PK1traction")),

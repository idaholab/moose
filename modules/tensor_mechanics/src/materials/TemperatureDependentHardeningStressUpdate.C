...
TemperatureDependentHardeningStressUpdate::TemperatureDependentHardeningStressUpdate(const InputParameters & parameters) :
...
Real
TemperatureDependentHardeningStressUpdate::computeHardeningDerivative(Real /*scalar*/)
{

...
template<>
InputParameters validParams<ComputeIncrementalCosseratSmallStrain>()
{
...
ComputeIncrementalCosseratSmallStrain::ComputeIncrementalCosseratSmallStrain(const InputParameters & parameters) :
...
void
ComputeIncrementalCosseratSmallStrain::initQpStatefulProperties()
{
...
void
ComputeIncrementalCosseratSmallStrain::computeQpProperties()
{

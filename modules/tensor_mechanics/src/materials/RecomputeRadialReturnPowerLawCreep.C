...
RecomputeRadialReturnPowerLawCreep::RecomputeRadialReturnPowerLawCreep(const InputParameters & parameters) :
...
void
RecomputeRadialReturnPowerLawCreep::initQpStatefulProperties()
{
...
Real
RecomputeRadialReturnPowerLawCreep::computeResidual(Real effectiveTrialStress, Real scalar)
{
...
Real
RecomputeRadialReturnPowerLawCreep::computeDerivative(Real effectiveTrialStress, Real scalar)
{
...
void
RecomputeRadialReturnPowerLawCreep::computeStressFinalize(const RankTwoTensor & plasticStrainIncrement)
{

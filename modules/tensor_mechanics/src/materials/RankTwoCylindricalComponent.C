...
RankTwoCylindricalComponentTempl<is_ad>::RankTwoCylindricalComponentTempl(
  ...
  : Material(parameters),
    ...
    _cylindrical_component(this->template getParam<MooseEnum>("cylindrical_component")),
    _cylindrical_axis_point1(isParamValid("cylindrical_axis_point1")
                                 ? this->template getParam<Point>("cylindrical_axis_point1")
                                 : Point(0, 0, 0)),
    _cylindrical_axis_point2(isParamValid("cylindrical_axis_point2")
                                 ? this->template getParam<Point>("cylindrical_axis_point2")
                                 : Point(0, 1, 0))
{
}

...
Real
IsotropicPlasticityStressUpdate::computeDerivative(Real /*effectiveTrialStress*/, Real /*scalar*/)
{
  Real derivative = 1.0;
...
Real
IsotropicPlasticityStressUpdate::computeHardeningDerivative(Real /*scalar*/)
{

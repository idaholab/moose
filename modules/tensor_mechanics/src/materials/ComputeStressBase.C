...
InputParameters validParams<ComputeStressBase>()
{
  ...
  params.addParam<bool>("store_stress_old", false, "Parameter which indicates whether the old stress state, required for dynamics and rayleigh damping, needs to be stored");
  return params;
}
...
{
  // Declares old stress is the parameter _store_stress_old is true. This parameter can be set from the input file using any of the child classes of ComputeStressBase.

...
void
AbaqusCreepMaterial::computeQpStress()
{
  ...
  // Update Stress
  _stress[_qp] =
      RankTwoTensor(_stress_component[0], _stress_component[1], _stress_component[2], _stress_component[3], _stress_component[4], _stress_component[5]);

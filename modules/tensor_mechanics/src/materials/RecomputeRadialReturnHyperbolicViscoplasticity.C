...
RecomputeRadialReturnHyperbolicViscoplasticity::RecomputeRadialReturnHyperbolicViscoplasticity(const InputParameters & parameters) :
...
void
RecomputeRadialReturnHyperbolicViscoplasticity::initQpStatefulProperties()
{
...
void
RecomputeRadialReturnHyperbolicViscoplasticity::resetQpProperties()
{
...
Real
RecomputeRadialReturnHyperbolicViscoplasticity::computeResidual(Real effectiveTrialStress, Real scalar)
{
  Real residual = 0.;
...
Real
RecomputeRadialReturnHyperbolicViscoplasticity::computeDerivative(Real /*effectiveTrialStress*/, Real /*scalar*/)
{
  Real derivative = 1.0;
...
void
RecomputeRadialReturnHyperbolicViscoplasticity::iterationFinalize(Real scalar)
{
  if (_yield_condition > 0.0)
...
void
RecomputeRadialReturnHyperbolicViscoplasticity::computeStressFinalize(const RankTwoTensor & plasticStrainIncrement)
{

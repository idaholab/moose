...
GeneralizedMaxwellModel::GeneralizedMaxwellModel(const InputParameters & parameters)
  : GeneralizedMaxwellBase(parameters),
...
void
GeneralizedMaxwellModel::initQpStatefulProperties()
{
  GeneralizedMaxwellBase::initQpStatefulProperties();

...
registerMooseObject("TensorMechanicsApp", CZMDisplacementJumpProviderSmallStrain);

InputParameters
CZMDisplacementJumpProviderSmallStrain::validParams()
{
  InputParameters params = CZMDisplacementJumpProviderBase::validParams();
...
CZMDisplacementJumpProviderSmallStrain::CZMDisplacementJumpProviderSmallStrain(
    const InputParameters & parameters)
  : CZMDisplacementJumpProviderBase(parameters)
{
...
void
CZMDisplacementJumpProviderSmallStrain::computeLocalDisplacementJump()
{

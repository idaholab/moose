...
#include "CZMDisplacementJumpProviderIncrementalTotalLagrangian.h"

registerMooseObject("TensorMechanicsApp", CZMDisplacementJumpProviderIncrementalTotalLagrangian);

InputParameters
CZMDisplacementJumpProviderIncrementalTotalLagrangian::validParams()
{
  InputParameters params = CZMDisplacementJumpProviderSmallStrain::validParams();
...
CZMDisplacementJumpProviderIncrementalTotalLagrangian::
    CZMDisplacementJumpProviderIncrementalTotalLagrangian(const InputParameters & parameters)
  : CZMDisplacementJumpProviderSmallStrain(parameters),
...
void
CZMDisplacementJumpProviderIncrementalTotalLagrangian::initialSetup()
{
  ///intialize displacementes vectors
  CZMDisplacementJumpProviderSmallStrain::initialSetup();
...
void
CZMDisplacementJumpProviderIncrementalTotalLagrangian::initQpStatefulProperties()
{
  CZMDisplacementJumpProviderSmallStrain::initQpStatefulProperties();
...
void
CZMDisplacementJumpProviderIncrementalTotalLagrangian::computeLocalDisplacementJump()
{
  computeFandR();
...
void
CZMDisplacementJumpProviderIncrementalTotalLagrangian::computeFandR()
{
  RankTwoTensor F =

...
InputParameters validParams<LineMaterialRankTwoScalarSampler>()
{
  ...
  params.addParam<MooseEnum>("scalar_type", RankTwoScalarTools::scalarOptions(), "A scalar to ouput");
...
Real
LineMaterialRankTwoScalarSampler::getScalarFromProperty(const RankTwoTensor & property, const Point & curr_point)
{
  return RankTwoScalarTools::getQuantity(property, _scalar_type, _point1, _point2, curr_point, _direction);
}

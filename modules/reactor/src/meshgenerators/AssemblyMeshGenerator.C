  ...
  {
    {
      ...
      params.set<BoundaryName>("new_top_boundary") = _assembly_boundary_name;
      params.set<BoundaryName>("new_left_boundary") = _assembly_boundary_name;
      params.set<BoundaryName>("new_bottom_boundary") = _assembly_boundary_name;
      params.set<BoundaryName>("new_right_boundary") = _assembly_boundary_name;

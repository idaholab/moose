...
PatternedCartesianMeshGenerator::PatternedCartesianMeshGenerator(const InputParameters & parameters)
  : PolygonMeshGeneratorBase(parameters),
    ...
    _square_center_trimmability(declareMeshProperty<bool>("square_center_trimmability", true)),
    _peripheral_modifier_compatible(declareMeshProperty<bool>("peripheral_modifier_compatible",

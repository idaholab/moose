...
protected:
   ...
   */
  std::vector<std::reference_wrapper<const CSG::CSGSurface>> getHexCartSurfaces(
      unsigned int radial_index, Real halfpitch, std::unique_ptr<CSG::CSGBase> & csg_obj);
   ...
   * @param radial_surfaces List of references to surfaces used to define inner region
   * @return inner region defined by surfaces
   */
  CSG::CSGRegion getInnerRegion(

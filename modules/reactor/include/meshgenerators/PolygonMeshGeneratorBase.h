...
protected:
   ...
   * @param create_interface_boundaries whether interface boundaries are created or not
  ...
  buildSimpleSlice(std::vector<Real> ring_radii,
                   ...
                   const bool create_interface_boundaries = true,
   ...
   * @param create_interface_boundaries whether the interface boundaries are created

...
#  type = TriSubChannel1PhaseProblem
  ...
  fuel_inner_radius = 1.0e-8
  fuel_outer_radius = '${fparse 0.18*scale_factor}'
  clad_inner_radius = '${fparse 0.19*scale_factor}'
  gap_conductance = 1.0e+5
  pu_weight_fr = 0.1
  zr_weight_fr = 0.1
  por_fr = 0.2
  solidus_temp = 1400.0
  liquidus_temp = 1450.0
  fusion_heat = 3E+6
  fuel_radial_nodes = 10
  normalized_min_radius = 0.2
  breach_size = 1.0e-3
  breach_diameter_ref = 1.0e-3
  plenum_gas_to_coolant_ratio_ref = 50.0
  two_phase_radius_oil = 0.1
  two_phase_slope_oil = 0.2
  max_two_phase_radius = 1.0
  initial_plenum_pressure = 10.0e+6
  initial_plenum_temperature = 800.0
  plenum_to_fuel_ratio = 1.6
  upper_limit_cdf = 10.0
  molar_gas_mass = 130.0e-3
  jet_length = 1.42e-3
  mean_of_cdf = 0.0
  sigma_of_cdf = 1.0
[]

...
!listing /subchannel/examples/sodium-test-with-new-solver/ORNL_19.i block=TriSubChannelMesh language=cpp

### Variables

This block defines the subchannel variables for the subchannel solve. This block is not necessary for the solver to run.

!listing /subchannel/examples/sodium-test-with-new-solver/ORNL_19.i block=AuxVariables language=cpp
...
!listing /subchannel/examples/sodium-test-with-new-solver/ORNL_19.i block=FluidProperties language=cpp
...
!listing /subchannel/examples/sodium-test-with-new-solver/ORNL_19.i block=Problem language=cpp
...
!listing /subchannel/examples/sodium-test-with-new-solver/ORNL_19.i block=ICs language=cpp

### Auxiliary Kernels

Auxiliary kernels are used ton apply the boundary conditions on pressure, temperature, and mass flow rate.

!listing /subchannel/examples/sodium-test-with-new-solver/ORNL_19.i block=AuxKernels language=cpp
...
!listing /subchannel/examples/sodium-test-with-new-solver/ORNL_19.i block=Executioner language=cpp

...
!listing /Users/kyriv/moose_projects/subchannel/examples/sodium-test-with-new-solver/ORNL_19.i block=TriSubChannelMesh language=cpp

### Variables

This block defines the subchannel variables for the subchannel solve. This block is not necessary for the solver to run.

!listing /Users/kyriv/moose_projects/subchannel/examples/sodium-test-with-new-solver/ORNL_19.i block=AuxVariables language=cpp
...
!listing /Users/kyriv/moose_projects/subchannel/examples/sodium-test-with-new-solver/ORNL_19.i block=FluidProperties language=cpp
...
!listing /Users/kyriv/moose_projects/subchannel/examples/sodium-test-with-new-solver/ORNL_19.i block=Problem language=cpp
...
!listing /Users/kyriv/moose_projects/subchannel/examples/sodium-test-with-new-solver/ORNL_19.i block=ICs language=cpp

### Auxiliary Kernels

Auxiliary kernels are used ton apply the boundary conditions on pressure, temperature, and mass flow rate.

!listing /Users/kyriv/moose_projects/subchannel/examples/sodium-test-with-new-solver/ORNL_19.i block=AuxKernels language=cpp
...
!listing /Users/kyriv/moose_projects/subchannel/examples/sodium-test-with-new-solver/ORNL_19.i block=Executioner language=cpp

### MultiApp system

A *MultiApp* is used for transfering the subchannel solution into a detailed mesh.

!listing /Users/kyriv/moose_projects/subchannel/examples/sodium-test-with-new-solver/ORNL_19.i block=MultiApps language=cpp

A custom transfer, *MultiAppDetailedSolutionTransfer*, is used for this purpose.

!listing /Users/kyriv/moose_projects/subchannel/examples/sodium-test-with-new-solver/ORNL_19.i block=Transfers language=cpp

The detailed mesh uses a *DetailedTriSubChannelMeshGenerator* and the solution variables are populated by the transfer.

!listing /Users/kyriv/moose_projects/subchannel/examples/sodium-test-with-new-solver/ORNL_19.i language=cpp

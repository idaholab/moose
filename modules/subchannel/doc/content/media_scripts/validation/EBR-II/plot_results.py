...
os.chdir(SCRIPT_DIR)
DATA = os.path.join(SCRIPT_DIR, "../../../../../validation/EBR-II")
...
massflow_SHRT17 = np.genfromtxt(
    os.path.join(DATA, "massflow_SHRT17.csv"), skip_header=1, delimiter=","
)
massflow_SHRT45 = np.genfromtxt(
    os.path.join(DATA, "massflow_SHRT45.csv"), skip_header=1, delimiter=","
)
power_SHRT17 = np.genfromtxt(
    os.path.join(DATA, "power_history_SHRT17.csv"), skip_header=0, delimiter=","
)
power_SHRT45 = np.genfromtxt(
    os.path.join(DATA, "power_history_SHRT45.csv"), skip_header=0, delimiter=","
)

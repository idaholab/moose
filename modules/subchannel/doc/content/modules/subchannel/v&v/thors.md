...
!media subchannel/v&v/FFM-3A.png
    style=width:60%;margin-bottom:2%;margin:auto;
    id=fig:thors_val
...
!media subchannel/v&v/FFM-3A2.png
    style=width:60%;margin-bottom:2%;margin:auto;
    id=fig:thors_val2
...
!media subchannel/v&v/vector_field.png
    style=width:60%;margin-bottom:2%;margin:auto;
    id=fig:CFD-vector
    caption= CFD velocity vector field.

!media subchannel/v&v/velocity_field.png
    style=width:60%;margin-bottom:2%;margin:auto;
    id=fig:CFD-velocity
    caption= CFD average axial velocity field.

!media subchannel/v&v/temperature_field.png
    style=width:60%;margin-bottom:2%;margin:auto;
...
!media subchannel/v&v/FFM-5B.png
    style=width:60%;margin-bottom:2%;margin:auto;
    id=fig:FFM-5B
...
!media subchannel/v&v/FFM-5B2.png
    style=width:60%;margin-bottom:2%;margin:auto;
    id=fig:FFM-5B2

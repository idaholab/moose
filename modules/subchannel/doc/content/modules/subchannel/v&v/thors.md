...
!media media_scripts/validation/Blockage/THORS/plot3A.py
    image_name=FFM-3A.png
    style=width:60%;margin-bottom:2%;margin:auto;
    id=fig:thors_val
...
!media media_scripts/validation/Blockage/THORS/plot5B.py
    image_name=FFM-5B_high.png
    style=width:60%;margin-bottom:2%;margin:auto;
    id=fig:FFM-5B

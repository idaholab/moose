...
!media subchannel/v&v/enthalpy/enthalpy.png
...
!listing /v&v/verification/enthalpy_mixing_verification/two_channel.i language=cpp

The solution will be projected to the 3D mesh created by the following input file:

!listing /v&v/verification/enthalpy_mixing_verification/3d.i language=cpp
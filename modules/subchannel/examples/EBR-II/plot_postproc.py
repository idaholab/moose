...
plt.plot(NETFLOW[:, 0], NETFLOW[:, 1], ":g",
...
plt.plot(scData45[6:, 0], scData45[6:, 1], "k",
         label="SC at TTC-31")
plt.plot(EXP45[:, 0], EXP45[:, 1], ":r", label="Measurement at TTC-31")
plt.plot(NETFLOW45[:, 0], NETFLOW45[:, 1], ":g",
         label="NETFLOW++/COBRA-IV-I at TTC-31")
...
plt.figure()
plt.plot(TTC_EXP45[:, 1], "r", marker='D',
         markerfacecolor="r", label="EXP")
plt.plot(SC_TTC45[1:], "k", marker='D',
         markerfacecolor="k", label="SC")

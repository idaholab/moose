...
fuel_pin_pitch = '${fparse 1.5528*scale_factor}' #'${fparse 1.52*scale_factor}'
fuel_pin_diameter = '${fparse 1.5514*scale_factor}' #'${fparse 1.5*scale_factor}'   #'${fparse 1.5514*scale_factor}'

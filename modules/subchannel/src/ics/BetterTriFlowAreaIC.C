#include "BetterTriFlowAreaIC.h"
#include "BetterTriSubChannelMesh.h"

registerMooseObject("SubChannelApp", BetterTriFlowAreaIC);

InputParameters
BetterTriFlowAreaIC::validParams()
{
  InputParameters params = BetterTriSubChannelBaseIC::validParams();
  return params;
}

BetterTriFlowAreaIC::BetterTriFlowAreaIC(const InputParameters & params) : BetterTriSubChannelBaseIC(params) {}

Real
BetterTriFlowAreaIC::value(const Point & p)
{

#include "BetterTriPowerIC.h"
#include "Function.h"
#include "BetterTriSubChannelMesh.h"

registerMooseObject("SubChannelApp", BetterTriPowerIC);

InputParameters
BetterTriPowerIC::validParams()
{
  InputParameters params = BetterTriSubChannelBaseIC::validParams();
...
BetterTriPowerIC::BetterTriPowerIC(const InputParameters & params)
  : BetterTriSubChannelBaseIC(params),
...
Real
BetterTriPowerIC::value(const Point & p)
{

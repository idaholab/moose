...
#include "SCMDetailedQuadInterWrapperMeshGenerator.h"
#include <array>
#include <cmath>
...
SCMDetailedQuadInterWrapperMeshGenerator::SCMDetailedQuadInterWrapperMeshGenerator(
...
SCMDetailedQuadInterWrapperMeshGenerator::generate()
{

...
#include "SCMDetailedQuadPinMeshGenerator.h"
...
SCMDetailedQuadPinMeshGenerator::SCMDetailedQuadPinMeshGenerator(const InputParameters & parameters)
...
SCMDetailedQuadPinMeshGenerator::generate()
{

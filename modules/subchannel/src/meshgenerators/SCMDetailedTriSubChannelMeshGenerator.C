...
SCMDetailedTriSubChannelMeshGenerator::SCMDetailedTriSubChannelMeshGenerator(
...
SCMDetailedTriSubChannelMeshGenerator::generate()
{
...
Point
SCMDetailedTriSubChannelMeshGenerator::rotatePoint(Point b, Real theta)
{
...
Point
SCMDetailedTriSubChannelMeshGenerator::translatePoint(Point & b, Point & translation_vector)
{
  // Translating point

#include "TriInterWrapperMeshGenerator.h"
#include "TriInterWrapperMesh.h"
#include <cmath>
#include "libmesh/edge_edge2.h"
#include "libmesh/unstructured_mesh.h"

registerMooseObject("SubChannelApp", TriInterWrapperMeshGenerator);
...
TriInterWrapperMeshGenerator::TriInterWrapperMeshGenerator(const InputParameters & params)
    ...
    _duct_to_rod_gap(getParam<Real>("side_bypass"))
{
  ...
  TriInterWrapperMesh::rodPositions(_rod_position, _n_rings, _assembly_pitch, Point(0, 0));
  _n_assemblies = _rod_position.size();
...
TriInterWrapperMeshGenerator::generate()
{

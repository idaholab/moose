#include "BetterNormalSliceValues.h"
#include "SolutionHandle.h"
#include "FEProblemBase.h"

registerMooseObject("SubChannelApp", BetterNormalSliceValues);

InputParameters
BetterNormalSliceValues::validParams()
{
...
BetterNormalSliceValues::BetterNormalSliceValues(const InputParameters & parameters)
...
void
BetterNormalSliceValues::output(const ExecFlagType & /*type*/)
{

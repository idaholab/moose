#include "BetterNormalSliceValuesCSV.h"
#include "SolutionHandle.h"
#include "FEProblemBase.h"

registerMooseObject("SubChannelApp", BetterNormalSliceValuesCSV);

InputParameters
BetterNormalSliceValuesCSV::validParams()
{
...
BetterNormalSliceValuesCSV::BetterNormalSliceValuesCSV(const InputParameters & parameters)
  : FileOutput(parameters),
    _mesh(dynamic_cast<BetterQuadSubChannelMesh &>(*_mesh_ptr)),
...
void
BetterNormalSliceValuesCSV::output(const ExecFlagType & /*type*/)
{

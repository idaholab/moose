...
public:
  ...
  bool pinMeshExist() const override { return _pin_mesh_exist; }
  bool ductMeshExist() const override { return _duct_mesh_exist; }
   ...
   *
   */
  Node * getDuctNodeFromChannel(Node * channel_node) const override
  {
   ...
   *
   */
  Node * getChannelNodeFromDuct(Node * duct_node) const override
  {

...
class BetterQuadSubChannelMesh : public BetterSubChannelMeshBase
{
public:
  BetterQuadSubChannelMesh(const InputParameters & parameters);
  BetterQuadSubChannelMesh(const BetterQuadSubChannelMesh & other_mesh);

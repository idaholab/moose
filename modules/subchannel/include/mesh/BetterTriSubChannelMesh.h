 ...
 */
class BetterTriSubChannelMesh : public SubChannelMesh
{
public:
  /**
  ...
  BetterTriSubChannelMesh(const InputParameters & parameters);
  BetterTriSubChannelMesh(const BetterTriSubChannelMesh & other_mesh);

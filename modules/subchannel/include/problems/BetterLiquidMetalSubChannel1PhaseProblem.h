...
class BetterLiquidMetalSubChannel1PhaseProblem;
class BetterTriSubChannelMesh;
/**
 * Steady state subchannel solver for 1-phase liquid metal coolants
 */
class BetterLiquidMetalSubChannel1PhaseProblem : public SubChannel1PhaseProblem
{
public:
  BetterLiquidMetalSubChannel1PhaseProblem(const InputParameters & params);
...
protected:
  ...
  Real _dpz_error;
  BetterTriSubChannelMesh & _tri_sch_mesh;

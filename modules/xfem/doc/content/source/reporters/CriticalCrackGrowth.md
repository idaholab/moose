...
!syntax description /Reporters/CriticalCrackGrowth
...
\Delta a_i =
\begin{cases}
\Delta a_{\mathrm{max}}, & K_{\mathrm{eff},i} > K_{\mathrm{critical}} \text{ and } K_{I,i} > 0, \\
0, & \text{otherwise},
\end{cases}
\end{equation}

where $\Delta a_{\mathrm{max}}$ is [!param](/Reporters/CriticalCrackGrowth/max_growth_increment) and $K_{\mathrm{critical}}$ is set by the required [!param](/Reporters/CriticalCrackGrowth/k_critical) parameter.

...
// #include <iostream>
// #define EFAError(msg) do {std::c o u t, "CutElemMesh ERROR: ", msg, std::endl; exit(1);} while
// (0) #define EFAWarning(msg) do {std::c o u t<<"CutElemMesh WARNING: "<<msg<<std::endl;} while (0)

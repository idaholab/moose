  ...
  [ThermalHydraulics]
    [CompressibleEuler]
      [all]
        ...
        scaling_factor_volume_junctions = '1 1e-2 1e-2 1e-2 1e-4'
...
[AuxKernels]
  [set_T_wall_core]
    ...
    variable = T_wall
    user_object = layered_side_average_core
    block = core_chan
  []
  [set_T_wall_hx]
    type = ParsedAux
...
[UserObjects]
  [layered_side_average_core]
    type = LayeredSideAverage
    direction = z
    num_layers = ${core_n_elems}
    variable = T_solid
    execute_on = linear
    boundary = core_hs:inner
  []
[]

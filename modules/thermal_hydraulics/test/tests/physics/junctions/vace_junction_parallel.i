...
# The results are not great for this junction. This is likely because the flow is
# somewhat symmetric and the junction ends up with two inlets out from numerical
# precision, which modifies its behavior a lot (blocks the flow in a way)

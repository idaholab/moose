...
plt.plot(
    time, T_in_turb, linestyle="-", marker="", color="indianred", label="Turbine Inlet"
)
plt.plot(
    time,
    T_out_turb,
...
plt.plot(
    ...
    marker="",
    color="darkslategrey",
    label="Hot Leg Outlet",
)
plt.plot(
    time, T_out_comp, linestyle="-", marker="", color="blue", label="Compressor Outlet"
)

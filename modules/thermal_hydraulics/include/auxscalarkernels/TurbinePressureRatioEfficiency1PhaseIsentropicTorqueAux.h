...
/**
 * Isentropic torque computed in the 1-phase pressure ratio and efficiency turbine
 */
class TurbinePressureRatioEfficiency1PhaseIsentropicTorqueAux : public AuxScalarKernel
{
public:

 ...
 */
class ADWallHeatTransferCoefficient3EqnDittusBoelterFunctorMaterial : public FunctorMaterial
{
public:
  static InputParameters validParams();

  ADWallHeatTransferCoefficient3EqnDittusBoelterFunctorMaterial(const InputParameters & parameters);

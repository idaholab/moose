 ...
 */
class ADWallHeatTransferCoefficientLyonFunctorMaterial : public FunctorMaterial
{
public:
  static InputParameters validParams();

  ADWallHeatTransferCoefficientLyonFunctorMaterial(const InputParameters & parameters);

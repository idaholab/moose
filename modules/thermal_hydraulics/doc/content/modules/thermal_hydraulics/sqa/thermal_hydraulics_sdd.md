!template load file=sqa/module_sdd.md.template module=Thermal Hydraulics category=thermal_hydraulics
...
!syntax complete subsystems=False actions=False objects=False groups=ThermalHydraulicsApp

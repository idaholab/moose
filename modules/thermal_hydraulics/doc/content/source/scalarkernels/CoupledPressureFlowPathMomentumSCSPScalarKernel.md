# CoupledPressureFlowPathMomentumSCSPScalarKernel

!syntax description /ScalarKernels/CoupledPressureFlowPathMomentumSCSPScalarKernel
...
This kernel is intended for the use case of creating a closed loop flow path with one or more complementary instances of [`FlowPathMomentumSCSPScalarKernel`](scalarkernels/FlowPathMomentumSCSPScalarKernel.md) and a [`ParsedODEKernel`](scalarkernels/ParsedODEKernel.md) defining the relationship between mass flow rates in the different flow paths, as shown in the INSERT EXAMPLE HERE model.
...
Some consideration should be given to the [!param](/ScalarKernels/CoupledPressureFlowPathMomentumSCSPScalarKernel/is_implicit) parameter. This term allows the user to select whether the solve
...
!syntax parameters /ScalarKernels/CoupledPressureFlowPathMomentumSCSPScalarKernel

!syntax inputs /ScalarKernels/CoupledPressureFlowPathMomentumSCSPScalarKernel

!syntax children /ScalarKernels/CoupledPressureFlowPathMomentumSCSPScalarKernel

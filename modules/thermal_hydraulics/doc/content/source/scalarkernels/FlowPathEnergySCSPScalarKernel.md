# FlowPathEnergySCSPScalarKernel

!syntax description /ScalarKernels/FlowPathEnergySCSPScalarKernel
...
Some consideration should be given to the [!param](/ScalarKernels/FlowPathEnergySCSPScalarKernel/is_implicit) parameter. This term allows the user to select whether the solve
...
!syntax parameters /ScalarKernels/FlowPathEnergySCSPScalarKernel

!syntax inputs /ScalarKernels/FlowPathEnergySCSPScalarKernel

!syntax children /ScalarKernels/FlowPathEnergySCSPScalarKernel

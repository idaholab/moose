...
#include "VolumeJunction1PhasePressureAux.h"
#include "SinglePhaseFluidProperties.h"
#include "Numerics.h"

registerMooseObject("ThermalHydraulicsApp", VolumeJunction1PhasePressureAux);

InputParameters
VolumeJunction1PhasePressureAux::validParams()
{
  ...
  params.addClassDescription("Computes pressure from the 1-phase volume junction variables.");
  return params;
}

VolumeJunction1PhasePressureAux::VolumeJunction1PhasePressureAux(const InputParameters & parameters)
...
Real
VolumeJunction1PhasePressureAux::computeValue()
{
  Real vJ, dvJ_drhoV;

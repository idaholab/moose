...
MeshAlignment::MeshAlignment(const MooseMesh & mesh) : _mesh(mesh), _meshes_are_coincident(false) {}
...
void
MeshAlignment::extractFrom1DElements(const std::vector<dof_id_type> & elem_ids,
...
void
MeshAlignment::extractFromBoundaryInfo(

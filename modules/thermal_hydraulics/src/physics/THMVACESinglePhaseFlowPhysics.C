...
const std::string THMVACESinglePhaseFlowPhysics::DENSITY = "rho";
const std::string THMVACESinglePhaseFlowPhysics::FRICTION_FACTOR_DARCY = "f_D";
const std::string THMVACESinglePhaseFlowPhysics::DYNAMIC_VISCOSITY = "mu";
const std::string THMVACESinglePhaseFlowPhysics::HEAT_TRANSFER_COEFFICIENT_WALL = "Hw";
const std::string THMVACESinglePhaseFlowPhysics::HYDRAULIC_DIAMETER = "D_h";
const std::string THMVACESinglePhaseFlowPhysics::PRESSURE = "p";
const std::string THMVACESinglePhaseFlowPhysics::RHOA = "rhoA";
const std::string THMVACESinglePhaseFlowPhysics::RHOEA = "rhoEA";
const std::string THMVACESinglePhaseFlowPhysics::RHOUA = "rhouA";
const std::string THMVACESinglePhaseFlowPhysics::SOUND_SPEED = "c";
const std::string THMVACESinglePhaseFlowPhysics::SPECIFIC_HEAT_CONSTANT_PRESSURE = "cp";
const std::string THMVACESinglePhaseFlowPhysics::SPECIFIC_HEAT_CONSTANT_VOLUME = "cv";
const std::string THMVACESinglePhaseFlowPhysics::SPECIFIC_INTERNAL_ENERGY = "e";
const std::string THMVACESinglePhaseFlowPhysics::SPECIFIC_TOTAL_ENTHALPY = "H";
const std::string THMVACESinglePhaseFlowPhysics::SPECIFIC_VOLUME = "v";
const std::string THMVACESinglePhaseFlowPhysics::TEMPERATURE = "T";
const std::string THMVACESinglePhaseFlowPhysics::THERMAL_CONDUCTIVITY = "k";
const std::string THMVACESinglePhaseFlowPhysics::VELOCITY = "vel";
const std::string THMVACESinglePhaseFlowPhysics::VELOCITY_X = "vel_x";
const std::string THMVACESinglePhaseFlowPhysics::VELOCITY_Y = "vel_y";
const std::string THMVACESinglePhaseFlowPhysics::VELOCITY_Z = "vel_z";
const std::string THMVACESinglePhaseFlowPhysics::REYNOLDS_NUMBER = "Re";
...
THMVACESinglePhaseFlowPhysics::validParams()
{
  ...
  // Note: we might have to vectorize that one for each component

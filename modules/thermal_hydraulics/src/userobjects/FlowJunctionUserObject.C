...
FlowJunctionUserObject::FlowJunctionUserObject(const InputParameters & parameters)
...
unsigned int
FlowJunctionUserObject::getBoundaryIDIndex()
{
...
void
FlowJunctionUserObject::checkValidConnectionIndex(const unsigned int & connection_index) const
{

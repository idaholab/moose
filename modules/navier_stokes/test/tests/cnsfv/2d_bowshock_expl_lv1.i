...
[Executioner]
  ...
  num_steps = 1 # 1 | 500000 for complete run
[]
############################################################
[Outputs]
  [./Exodus]
    ...
    file_base = 2d_bowshock_expl_lv1_out
    elemental_as_nodal = true
    interval = 1 # 1 | 500 for complete run
  [../]

  [./CSV]
    type = CSV
    file_base = 2d_bowshock_expl_lv1_res
    interval = 50
  [../]

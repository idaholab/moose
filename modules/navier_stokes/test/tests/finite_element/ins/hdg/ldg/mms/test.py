...
class TestLidLagrange(unittest.TestCase):
    def test(self):
        df1 = run_spatial(
            "lid.i", 6, "--error", "--error-unused", y_pp=["L2u", "L2v", "L2p"], mpi=4
        )
...
class TestLidHierarchic(unittest.TestCase):
    def test(self):
        df1 = run_spatial(
            ...
            "Variables/vel_x/family=L2_HIERARCHIC",
            "Variables/vel_y/family=L2_HIERARCHIC",
            "Variables/grad_vel_x/family=L2_HIERARCHIC_VEC",
            "Variables/grad_vel_y/family=L2_HIERARCHIC_VEC",
            y_pp=["L2u", "L2v", "L2p"],
            mpi=4,
        )

...
[Transfers]
  ...
  [T_solid_to_FLuid2]
    ...
    to_blocks = '2'
  []
  [T_solid_wall_from_Fluid2]
    type = MultiAppGeneralFieldNearestLocationTransfer
    from_multi_app = sub
    source_variable = T_solid
    variable = T_solid_wall
    from_blocks = '2'
    to_blocks = '2'
  []
  [T_solid_wall_to_Fluid2]
    type = MultiAppGeneralFieldNearestLocationTransfer
    to_multi_app = sub
    source_variable = T_solid
    variable = T_solid_wall

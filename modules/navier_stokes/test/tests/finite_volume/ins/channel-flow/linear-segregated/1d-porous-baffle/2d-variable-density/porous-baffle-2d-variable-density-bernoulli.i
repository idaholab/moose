...
density_factor = 1e-3
density_slope_exact = '${fparse -0.05e3 * density_factor}'
rho_in_exact = '${fparse 1e3 * density_factor}'
mass_flux_exact = '${fparse rho_in_exact * u_in}'
rho_baffle_exact = '${fparse (1e3 - 0.05e3 * length_left) * density_factor}'
rho_out_exact = '${fparse (1e3 - 0.05e3 * (length_left + length_right)) * density_factor}'
u_prime_baffle_exact = '${fparse -mass_flux_exact * density_slope_exact / (rho_baffle_exact * rho_baffle_exact)}'
u_prime_out_exact = '${fparse -mass_flux_exact * density_slope_exact / (rho_out_exact * rho_out_exact)}'
transport_baffle_left_exact = '${fparse mass_flux_exact * mass_flux_exact / (rho_baffle_exact * epsilon_left * epsilon_left) - mu * u_prime_baffle_exact / epsilon_left}'
transport_baffle_right_exact = '${fparse mass_flux_exact * mass_flux_exact / (rho_baffle_exact * epsilon_right * epsilon_right) - mu * u_prime_baffle_exact / epsilon_right}'
transport_out_right_exact = '${fparse mass_flux_exact * mass_flux_exact / (rho_out_exact * epsilon_right * epsilon_right) - mu * u_prime_out_exact / epsilon_right}'
bernoulli_jump_exact = '${fparse 0.5 * mass_flux_exact * mass_flux_exact * (1 / (rho_baffle_exact * epsilon_right * epsilon_right) - 1 / (rho_baffle_exact * epsilon_left * epsilon_left))}'
pressure_right_constant_exact = '${fparse p_out + transport_out_right_exact}'
pressure_left_constant_exact = '${fparse pressure_right_constant_exact - transport_baffle_right_exact + bernoulli_jump_exact + transport_baffle_left_exact}'
...
[FunctorMaterials]
  ...
  [u_superficial_exact]
    ...
    functor_names = 'rho_exact'
    expression = '${mass_flux_exact} / rho_exact'
  []
  [u_superficial_prime_exact]
    type = ParsedFunctorMaterial
    property_name = u_superficial_prime_exact
    functor_names = 'rho_exact'
    expression = '-${mass_flux_exact} * ${density_slope_exact} / (rho_exact * rho_exact)'
  []
  [p_exact]
    type = ParsedFunctorMaterial
    property_name = p_exact
    functor_names = 'rho_exact u_superficial_prime_exact'
    expression = 'if(x < ${length_left}, ${pressure_left_constant_exact} - ${mass_flux_exact} * ${mass_flux_exact} / (rho_exact * ${epsilon_left} * ${epsilon_left}) + ${mu} * u_superficial_prime_exact / ${epsilon_left}, ${pressure_right_constant_exact} - ${mass_flux_exact} * ${mass_flux_exact} / (rho_exact * ${epsilon_right} * ${epsilon_right}) + ${mu} * u_superficial_prime_exact / ${epsilon_right})'
  []
[]
...
[Postprocessors]
  ...
  [L2_porosity]
    type = ElementL2FunctorError
    approximate = porosity_aux
    exact = porosity_exact
  []
  [L2_superficial_u]
    type = ElementL2FunctorError
    approximate = superficial_u
    exact = u_superficial_exact
  []
  [L2_pressure]
    type = ElementL2FunctorError

...
class TestSymmetricVortexRZOrthogonal(unittest.TestCase):
    def test(self):
        ...
        df1 = run_spatial('2d-symmetric-vortex-rz.i', 4, y_pp=labels, mpi=2, file_base='2d-symmetric-vortex-rz')
...
class TestSymmetricVortexRZOrthogonalNonconst(unittest.TestCase):
    def test(self):
        ...
        pressure_labels = ['L2p']
        labels = velocity_labels + pressure_labels
        df1 = run_spatial('2d-symmetric-vortex-rz-spacedependent.i', 4, y_pp=labels, mpi=2, file_base='2d-symmetric-vortex-rz-spacedependent')

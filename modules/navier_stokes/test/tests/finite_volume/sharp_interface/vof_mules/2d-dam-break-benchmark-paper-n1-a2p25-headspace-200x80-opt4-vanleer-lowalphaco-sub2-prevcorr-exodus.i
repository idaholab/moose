...
# Option 4: Van Leer alpha correction, lower alpha Courant, two minimum
# subcycles, and previous-correction reuse.
c_alpha := 0.1
...
[Outputs]
  console := false
  file_base := '2d-dam-break-benchmark-paper-n1-a2p25-headspace-200x80-opt4-vanleer-lowalphaco-sub2-prevcorr-exodus'
  [exo]
    type = Exodus
  file_base := '2d-dam-break-benchmark-paper-n1-a2p25-headspace-200x80-opt4-vanleer-lowalphaco-sub2-prevcorr-exodus'

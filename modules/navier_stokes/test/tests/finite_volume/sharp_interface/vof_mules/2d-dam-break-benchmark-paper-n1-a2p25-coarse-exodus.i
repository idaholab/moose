...
#   n^2 = 1, a = 2.25 in.
#
# This coarse variant is intended for quick field export to Exodus.
...
cell_dx = ${fparse domain_dims_x / 120.0}
cell_dy = ${fparse domain_dims_y / 25.0}
...
[Outputs]
  ...
  csv = true
  file_base = '2d-dam-break-benchmark-paper-n1-a2p25-coarse-exodus'
  [exodus]
    type = Exodus
    file_base = '2d-dam-break-benchmark-paper-n1-a2p25-coarse-exodus'

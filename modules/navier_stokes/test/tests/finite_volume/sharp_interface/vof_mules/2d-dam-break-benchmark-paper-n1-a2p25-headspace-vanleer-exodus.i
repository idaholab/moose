...
# Matched Martin-Moyce comparison case using the new Van Leer alpha correction
# on top of the donor/upwind base flux.
c_alpha := 0.1
...
[Outputs]
  console := false
  file_base := '2d-dam-break-benchmark-paper-n1-a2p25-headspace-vanleer-exodus'
  [exo]
    type = Exodus
    file_base = '2d-dam-break-benchmark-paper-n1-a2p25-headspace-vanleer-exodus'

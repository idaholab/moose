# Startup-stage pressure audit for the sharp-interface dam-break benchmark.
# Samples the reduced pressure and reconstructed total pressure along a
# horizontal cut at INITIAL, during NONLINEAR execution hooks, and at the end
# of the first timestep. This is intended to catch any distortion introduced by
# startup CorrectPhi cleanup before the first completed timestep.
...
[Executioner]
  ...
  startup_pressure_cut_audit_file_base = '/tmp/dam_break_pressure_startup_hook'
  startup_pressure_cut_audit_y = ${cut_y}
  startup_pressure_cut_audit_liquid_density = ${rho_l}
  startup_pressure_cut_audit_gas_density = ${rho_g}
  startup_pressure_cut_audit_gravity = '0 -${g} 0'
  startup_pressure_cut_audit_reference_pressure_point = '0 ${domain_dims_y} 0'

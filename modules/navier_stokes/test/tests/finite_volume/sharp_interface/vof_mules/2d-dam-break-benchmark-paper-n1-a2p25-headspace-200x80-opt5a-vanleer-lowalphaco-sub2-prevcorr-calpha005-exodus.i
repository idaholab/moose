...
# Option 5 sweep low end: as option 4, but with a smaller compression factor.
c_alpha := 0.05
...
[Outputs]
  console := false
  file_base := '2d-dam-break-benchmark-paper-n1-a2p25-headspace-200x80-opt5a-vanleer-lowalphaco-sub2-prevcorr-calpha005-exodus'
  [exo]
    type = Exodus
  file_base := '2d-dam-break-benchmark-paper-n1-a2p25-headspace-200x80-opt5a-vanleer-lowalphaco-sub2-prevcorr-calpha005-exodus'

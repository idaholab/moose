# Initial-state pressure audit for the sharp-interface dam-break benchmark.
# Samples the solved reduced pressure and reconstructed total pressure along a
# horizontal cut through the water column to verify the discrete hydrostatic jump.

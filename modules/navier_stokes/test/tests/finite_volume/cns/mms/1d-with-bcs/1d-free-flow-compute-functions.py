...
f_rho, e_rho = mms.evaluate(
    "div(mass_flux)", rho, variable="rho", rho_u=rho_u, mass_flux=mass_flux
)
f_rho_u, e_rho_u = mms.evaluate(
    "div(mass_flux * u) + grad(p).dot(e_i)",
    rho_u,
    variable="rho_u",
    rho=rho,
    rho_u=rho_u,
...
f_rho_et, e_rho_et = mms.evaluate(
    "div(mass_flux * ht)",
    rho_et,
    variable="rho_et",
    rho_et=rho_et,
...
_, e_T = mms.evaluate(
    "T", T, variable="T", rho=rho, rho_et=rho_et, rho_u=rho_u, u=u, vel=vel, e=e, T=T
)
_, e_p = mms.evaluate(
    "p", p, variable="p", rho=rho, rho_et=rho_et, rho_u=rho_u, u=u, vel=vel, e=e, p=p
)

...
#include "MassAdvectionIPHDGOutflowBC.h"

registerMooseObject("MooseApp", MassAdvectionIPHDGOutflowBC);

InputParameters
MassAdvectionIPHDGOutflowBC::validParams()
{
...
MassAdvectionIPHDGOutflowBC::MassAdvectionIPHDGOutflowBC(const InputParameters & parameters)
  : IPHDGBC(parameters),
...
void
MassAdvectionIPHDGOutflowBC::compute()
{

...
NavierStokesFlowPhysicsBase::processAdditionalParameters(const InputParameters & other_params)
{
  ...
  _momentum_inlet_types.merge(createMapFromVectorAndMultiMooseEnum<BoundaryName>(
      other_params.get<std::vector<BoundaryName>>("inlet_boundaries"),
      other_params.get<MultiMooseEnum>("momentum_inlet_types")));
  ...
  _momentum_outlet_types.merge(createMapFromVectorAndMultiMooseEnum<BoundaryName>(
      other_params.get<std::vector<BoundaryName>>("outlet_boundaries"),
      other_params.get<MultiMooseEnum>("momentum_outlet_types")));
  ...
  _blocks.insert(_blocks.end(),
                 other_params.get<std::vector<SubdomainName>>("block").begin(),
                 other_params.get<std::vector<SubdomainName>>("block").end());
}

...
#include "WCNSLinearFVSharpInterfaceVOFPhysics.h"

#include "NS.h"

registerNavierStokesPhysicsBaseTasks("NavierStokesApp", WCNSLinearFVSharpInterfaceVOFPhysics);
registerMooseAction("NavierStokesApp", WCNSLinearFVSharpInterfaceVOFPhysics, "add_variables_physics");
registerMooseAction("NavierStokesApp", WCNSLinearFVSharpInterfaceVOFPhysics, "add_fv_ic");
registerMooseAction("NavierStokesApp", WCNSLinearFVSharpInterfaceVOFPhysics, "add_linear_fv_kernel");
registerMooseAction("NavierStokesApp", WCNSLinearFVSharpInterfaceVOFPhysics, "add_linear_fv_bc");
registerMooseAction("NavierStokesApp", WCNSLinearFVSharpInterfaceVOFPhysics, "add_material");
registerMooseAction("NavierStokesApp", WCNSLinearFVSharpInterfaceVOFPhysics, "add_user_object");

InputParameters
WCNSLinearFVSharpInterfaceVOFPhysics::validParams()
{
...
WCNSLinearFVSharpInterfaceVOFPhysics::WCNSLinearFVSharpInterfaceVOFPhysics(
...
void
WCNSLinearFVSharpInterfaceVOFPhysics::addSolverVariables()
{
  ...
  else if (_define_variables)
  {
    ...
    paramError("volume_fraction_variable",
               "Variable (" + _alpha_name +
                   ") supplied to the WCNSLinearFVSharpInterfaceVOFPhysics does not exist!");

  saveSolverVariableName(_alpha_name);
}

void
WCNSLinearFVSharpInterfaceVOFPhysics::addFVKernels()
{
  if (isTransient())
    addAlphaTimeKernels();
...
void
WCNSLinearFVSharpInterfaceVOFPhysics::addInitialConditions()
{
  if (!_define_variables && parameters().isParamSetByUser("initial_volume_fraction"))
    paramError("initial_volume_fraction",
               ...
               "WCNSLinearFVSharpInterfaceVOFPhysics, so should its initial condition.");
...
void
WCNSLinearFVSharpInterfaceVOFPhysics::addFVBCs()
{
  addAlphaInletBC();
  addAlphaOutletBC();
}
...
void
WCNSLinearFVSharpInterfaceVOFPhysics::addMaterials()
{
...
void
WCNSLinearFVSharpInterfaceVOFPhysics::addUserObjects()
{
  if (!_use_mules_correction)
    return;

  const std::string object_type = "SharpInterfaceVOFMULESCorrector";
...
void
WCNSLinearFVSharpInterfaceVOFPhysics::addAlphaTimeKernels()
{
...
void
WCNSLinearFVSharpInterfaceVOFPhysics::addAlphaAdvectionKernels()
{
...
void
WCNSLinearFVSharpInterfaceVOFPhysics::addAlphaCompressionKernels()
{
...
void
WCNSLinearFVSharpInterfaceVOFPhysics::addAlphaInletBC()
{
...
void
WCNSLinearFVSharpInterfaceVOFPhysics::addAlphaOutletBC()
{

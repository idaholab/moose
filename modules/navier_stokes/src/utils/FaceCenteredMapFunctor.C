...
FaceCenteredMapFunctor<T, Map>::evaluate(const ElemArg & elem_arg, const TimeArg &) const
{
...
template <typename T, typename Map>
typename FaceCenteredMapFunctor<T, Map>::ValueType
FaceCenteredMapFunctor<T, Map>::evaluate(const FaceArg & face, const TimeArg &) const
{

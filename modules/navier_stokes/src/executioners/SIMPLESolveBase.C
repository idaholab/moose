    ...
    _print_fields(getParam<bool>("print_fields"))
{
  ...
  Moose::PetscSupport::processPetscPairs(momentum_petsc_pair_options,
  ...
  Moose::PetscSupport::processPetscPairs(pressure_petsc_pair_options,
                                         _problem.mesh().dimension(),
                                         "-",
                                         *this,
  ...
  if (_has_energy_system)
  {
    ...
    Moose::PetscSupport::processPetscFlags(energy_petsc_options, "-", *this, _energy_petsc_options);

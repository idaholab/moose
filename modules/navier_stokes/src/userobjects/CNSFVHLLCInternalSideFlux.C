...
template <>
InputParameters
validParams<CNSFVHLLCInternalSideFlux>()
{
...
CNSFVHLLCInternalSideFlux::CNSFVHLLCInternalSideFlux(const InputParameters & parameters)
  : InternalSideFluxBase(parameters),
    _fp(getUserObject<SinglePhaseFluidProperties>("fluid_properties"))
{
}

CNSFVHLLCInternalSideFlux::~CNSFVHLLCInternalSideFlux() {}

                                                ...
                                                DenseMatrix<Real> & jac1) const
{
  ...
  if (std::abs(mach1) < 1.)
  {
    ...
    jac1(0, 0) = fmass_rhob  * rhob_rho1
               + fmass_uadvb * uadvb_rho1
               + fmass_vadvb * vadvb_rho1
               + fmass_wadvb * wadvb_rho1
               + fmass_presb * presb_rho1;

    jac1(0, 1) = fmass_rhob  * rhob_rhou1
               + fmass_uadvb * uadvb_rhou1
               + fmass_vadvb * vadvb_rhou1
               + fmass_wadvb * wadvb_rhou1
               + fmass_presb * presb_rhou1;

    jac1(0, 2) = fmass_rhob  * rhob_rhov1
               + fmass_uadvb * uadvb_rhov1
               + fmass_vadvb * vadvb_rhov1
               + fmass_wadvb * wadvb_rhov1
               + fmass_presb * presb_rhov1;

    jac1(0, 3) = fmass_rhob  * rhob_rhow1
               + fmass_uadvb * uadvb_rhow1
               + fmass_vadvb * vadvb_rhow1
               + fmass_wadvb * wadvb_rhow1
               + fmass_presb * presb_rhow1;

    jac1(0, 4) = fmass_rhob  * rhob_rhoe1
               + fmass_uadvb * uadvb_rhoe1
               + fmass_vadvb * vadvb_rhoe1
               + fmass_wadvb * wadvb_rhoe1
               + fmass_presb * presb_rhoe1;

    /// calc a(F_momx)/a(U_1)

    jac1(1, 0) = fmomx_rhob  * rhob_rho1
               + fmomx_uadvb * uadvb_rho1
               + fmomx_vadvb * vadvb_rho1
               + fmomx_wadvb * wadvb_rho1
               + fmomx_presb * presb_rho1;

    jac1(1, 1) = fmomx_rhob  * rhob_rhou1
               + fmomx_uadvb * uadvb_rhou1
               + fmomx_vadvb * vadvb_rhou1
               + fmomx_wadvb * wadvb_rhou1
               + fmomx_presb * presb_rhou1;

    jac1(1, 2) = fmomx_rhob  * rhob_rhov1
               + fmomx_uadvb * uadvb_rhov1
               + fmomx_vadvb * vadvb_rhov1
               + fmomx_wadvb * wadvb_rhov1
               + fmomx_presb * presb_rhov1;

    jac1(1, 3) = fmomx_rhob  * rhob_rhow1
               + fmomx_uadvb * uadvb_rhow1
               + fmomx_vadvb * vadvb_rhow1
               + fmomx_wadvb * wadvb_rhow1
               + fmomx_presb * presb_rhow1;

    jac1(1, 4) = fmomx_rhob  * rhob_rhoe1
               + fmomx_uadvb * uadvb_rhoe1
               + fmomx_vadvb * vadvb_rhoe1
               + fmomx_wadvb * wadvb_rhoe1
               + fmomx_presb * presb_rhoe1;

    /// calc a(F_momy)/a(U_1)

    jac1(2, 0) = fmomy_rhob  * rhob_rho1
               + fmomy_uadvb * uadvb_rho1
               + fmomy_vadvb * vadvb_rho1
               + fmomy_wadvb * wadvb_rho1
               + fmomy_presb * presb_rho1;

    jac1(2, 1) = fmomy_rhob  * rhob_rhou1
               + fmomy_uadvb * uadvb_rhou1
               + fmomy_vadvb * vadvb_rhou1
               + fmomy_wadvb * wadvb_rhou1
               + fmomy_presb * presb_rhou1;

    jac1(2, 2) = fmomy_rhob  * rhob_rhov1
               + fmomy_uadvb * uadvb_rhov1
               + fmomy_vadvb * vadvb_rhov1
               + fmomy_wadvb * wadvb_rhov1
               + fmomy_presb * presb_rhov1;

    jac1(2, 3) = fmomy_rhob  * rhob_rhow1
               + fmomy_uadvb * uadvb_rhow1
               + fmomy_vadvb * vadvb_rhow1
               + fmomy_wadvb * wadvb_rhow1
               + fmomy_presb * presb_rhow1;

    jac1(2, 4) = fmomy_rhob  * rhob_rhoe1
               + fmomy_uadvb * uadvb_rhoe1
               + fmomy_vadvb * vadvb_rhoe1
               + fmomy_wadvb * wadvb_rhoe1
               + fmomy_presb * presb_rhoe1;

    /// calc a(F_momz)/a(U_1)

    jac1(3, 0) = fmomz_rhob  * rhob_rho1
               + fmomz_uadvb * uadvb_rho1
               + fmomz_vadvb * vadvb_rho1
               + fmomz_wadvb * wadvb_rho1
               + fmomz_presb * presb_rho1;

    jac1(3, 1) = fmomz_rhob  * rhob_rhou1
               + fmomz_uadvb * uadvb_rhou1
               + fmomz_vadvb * vadvb_rhou1
               + fmomz_wadvb * wadvb_rhou1
               + fmomz_presb * presb_rhou1;

    jac1(3, 2) = fmomz_rhob  * rhob_rhov1
               + fmomz_uadvb * uadvb_rhov1
               + fmomz_vadvb * vadvb_rhov1
               + fmomz_wadvb * wadvb_rhov1
               + fmomz_presb * presb_rhov1;

    jac1(3, 3) = fmomz_rhob  * rhob_rhow1
               + fmomz_uadvb * uadvb_rhow1
               + fmomz_vadvb * vadvb_rhow1
               + fmomz_wadvb * wadvb_rhow1
               + fmomz_presb * presb_rhow1;

    jac1(3, 4) = fmomz_rhob  * rhob_rhoe1
               + fmomz_uadvb * uadvb_rhoe1
               + fmomz_vadvb * vadvb_rhoe1
               + fmomz_wadvb * wadvb_rhoe1
               + fmomz_presb * presb_rhoe1;

    /// calc a(F_etot)/a(U_1)

    jac1(4, 0) = fetot_rhob  * rhob_rho1
               + fetot_uadvb * uadvb_rho1
               + fetot_vadvb * vadvb_rho1
               + fetot_wadvb * wadvb_rho1
               + fetot_presb * presb_rho1;

    jac1(4, 1) = fetot_rhob  * rhob_rhou1
               + fetot_uadvb * uadvb_rhou1
               + fetot_vadvb * vadvb_rhou1
               + fetot_wadvb * wadvb_rhou1
               + fetot_presb * presb_rhou1;

    jac1(4, 2) = fetot_rhob  * rhob_rhov1
               + fetot_uadvb * uadvb_rhov1
               + fetot_vadvb * vadvb_rhov1
               + fetot_wadvb * wadvb_rhov1
               + fetot_presb * presb_rhov1;

    jac1(4, 3) = fetot_rhob  * rhob_rhow1
               + fetot_uadvb * uadvb_rhow1
               + fetot_vadvb * vadvb_rhow1
               + fetot_wadvb * wadvb_rhow1
               + fetot_presb * presb_rhow1;

    jac1(4, 4) = fetot_rhob  * rhob_rhoe1
               + fetot_uadvb * uadvb_rhoe1
               + fetot_vadvb * vadvb_rhoe1
               + fetot_wadvb * wadvb_rhoe1
               + fetot_presb * presb_rhoe1;
  }
  else if (mach1 <= -1.)
  {
    /// supersonic inflow

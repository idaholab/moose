...
registerADMooseObject("MooseApp", INSConvectedMesh);
...
INSConvectedMesh<compute_stage>::INSConvectedMesh(const InputParameters & parameters)
...
template <ComputeStage compute_stage>
ADResidual
INSConvectedMesh<compute_stage>::precomputeQpResidual()
{
  return -_rho[_qp] *

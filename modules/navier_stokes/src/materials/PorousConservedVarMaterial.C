...
PorousConservedVarMaterial::computeQpProperties()
{
  ...
  Real dp_dv, dp_de;
  _fluid.p_from_v_e(_v[_qp].value(),
                    _specific_internal_energy[_qp].value(),
                    _pressure[_qp].value(),
                    dp_dv,
                    dp_de);
  _pressure[_qp].derivatives() =
      dp_dv * _v[_qp].derivatives() + dp_de * _specific_internal_energy[_qp].derivatives();
  ...
  Real dT_dv, dT_de;
  _fluid.T_from_v_e(
      _v[_qp].value(), _specific_internal_energy[_qp].value(), _T_fluid[_qp].value(), dT_dv, dT_de);
  _T_fluid[_qp].derivatives() =
      dT_dv * _v[_qp].derivatives() + dT_de * _specific_internal_energy[_qp].derivatives();

...
#include "ConservativeSharpInterfaceVolumetricFluxConsistencyError.h"

#include "FaceInfo.h"
#include "MooseMesh.h"
#include "metaphysicl/raw_type.h"

registerMooseObject("NavierStokesApp", ConservativeSharpInterfaceVolumetricFluxConsistencyError);

InputParameters
ConservativeSharpInterfaceVolumetricFluxConsistencyError::validParams()
{
...
ConservativeSharpInterfaceVolumetricFluxConsistencyError::ConservativeSharpInterfaceVolumetricFluxConsistencyError(
...
void
ConservativeSharpInterfaceVolumetricFluxConsistencyError::initialize()
{
  _error = 0.0;
}

void
ConservativeSharpInterfaceVolumetricFluxConsistencyError::execute()
{
...
void
ConservativeSharpInterfaceVolumetricFluxConsistencyError::finalize()
{
...
Real
ConservativeSharpInterfaceVolumetricFluxConsistencyError::getValue() const
{
  return _error;
}

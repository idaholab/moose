 ...
 */
class LinearFVCHTOrdTwoBC : public LinearFVAdvectionDiffusionFunctorRobinBC, public LinearFVConjugateHeatTransferBC
{
public:
   ...
   */
  LinearFVCHTOrdTwoBC(const InputParameters & parameters);
  ...
  virtual bool includesMaterialPropertyMultiplier() const override { return false;}

...
protected:
  ...
  /// Optional total pressure-predictor flux. When provided it supersedes H/A.
  ...
  mutable Moose::SolutionIterationType _cached_iteration_type = Moose::SolutionIterationType::Time;

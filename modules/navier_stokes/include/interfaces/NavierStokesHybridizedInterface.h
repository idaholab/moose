...
protected:
   ...
   */
  template <typename NSHybridized>
  static void scalarVolumeResidual(NSHybridized & obj,
   ...
   */
  template <typename NSHybridized>
  static void scalarVolumeJacobian(NSHybridized & obj,
                                   const unsigned int i_offset,
   ...
   */
  template <typename NSHybridized>
  static void pressureVolumeResidual(NSHybridized & obj,
                                     const unsigned int i_offset,
   ...
   */
  template <typename NSHybridized>
  static void pressureVolumeJacobian(NSHybridized & obj,
                                     const unsigned int i_offset,
                                     const unsigned int u_j_offset,
                                     const unsigned int v_j_offset,
                                     const unsigned int p_j_offset,
  ...
  template <typename NSHybridized>
  static void pressureDirichletResidual(NSHybridized & obj,
                                        const unsigned int i_offset,
                                        const std::array<const Function *, 3> & dirichlet_vel);

  template <typename NSHybridized>
  static void scalarDirichletResidual(NSHybridized & obj,
                                      const unsigned int i_offset,
                                      const MooseArray<Gradient> & vector_sol,
                                      const MooseArray<Number> & scalar_sol,
                                      const unsigned int vel_component,
  ...
  template <typename NSHybridized>
  static void scalarDirichletJacobian(NSHybridized & obj,
                                      const unsigned int i_offset,
                                      const unsigned int vector_j_offset,
                                      const unsigned int scalar_j_offset,
                                      const unsigned int p_j_offset,
...
template <typename NSHybridized>
void
NavierStokesHybridizedInterface::scalarVolumeResidual(NSHybridized & obj,
                                                      const unsigned int i_offset,
                                                      const MooseArray<Gradient> & vel_gradient,
                                                      const unsigned int vel_component,
                                                      const Function & body_force)
{
  DiffusionHybridizedInterface::scalarVolumeResidual(obj, i_offset, vel_gradient, body_force);
...
template <typename NSHybridized>
void
NavierStokesHybridizedInterface::scalarVolumeJacobian(NSHybridized & obj,
                                                      const unsigned int i_offset,
                                                      const unsigned int vel_gradient_j_offset,
                                                      const unsigned int p_j_offset,
                                                      const unsigned int vel_component,
                                                      ...
                                                      const unsigned int v_j_offset)
{
  DiffusionHybridizedInterface::scalarVolumeJacobian(obj, i_offset, vel_gradient_j_offset);
...
template <typename NSHybridized>
void
NavierStokesHybridizedInterface::pressureVolumeResidual(
    NSHybridized & obj,
    const unsigned int i_offset,
    const unsigned int global_lm_i_offset,
    const Function & pressure_mms_forcing_function)
...
template <typename NSHybridized>
void
NavierStokesHybridizedInterface::pressureVolumeJacobian(NSHybridized & obj,
                                                        const unsigned int i_offset,
                                                        const unsigned int u_j_offset,
                                                        const unsigned int v_j_offset,
                                                        const unsigned int p_j_offset,
...
NavierStokesHybridizedInterface::velCrossVelResidual(const MooseArray<Number> & u_sol,
                                                     const MooseArray<Number> & v_sol,
                                                     const unsigned int qp,
                                                     const unsigned int vel_component)
{
...
inline RealVectorValue
NavierStokesHybridizedInterface::velCrossVelJacobian(const MooseArray<Number> & u_sol,
                                                     const MooseArray<Number> & v_sol,
                                                     const unsigned int qp,
                                                     const unsigned int vel_component,
                                                     const unsigned int vel_j_component,
...
template <typename NSHybridized>
void
NavierStokesHybridizedInterface::pressureFaceResidual(NSHybridized & obj,
                                                      const unsigned int i_offset)
{
...
template <typename NSHybridized>
void
NavierStokesHybridizedInterface::pressureFaceJacobian(NSHybridized & obj,
                                                      const unsigned int i_offset,
                                                      const unsigned int lm_u_j_offset,
                                                      const unsigned int lm_v_j_offset)
{
...
template <typename NSHybridized>
void
NavierStokesHybridizedInterface::scalarFaceResidual(NSHybridized & obj,
                                                    const unsigned int i_offset,
                                                    const MooseArray<Gradient> & vector_sol,
                                                    const MooseArray<Number> & scalar_sol,
                                                    const MooseArray<Number> & lm_sol,
...
template <typename NSHybridized>
void
NavierStokesHybridizedInterface::scalarFaceJacobian(NSHybridized & obj,
                                                    const unsigned int i_offset,
                                                    const unsigned int vector_j_offset,
                                                    const unsigned int scalar_j_offset,
                                                    const unsigned int lm_j_offset,
...
template <typename NSHybridized>
void
NavierStokesHybridizedInterface::lmFaceResidual(NSHybridized & obj,
                                                const unsigned int i_offset,
                                                const MooseArray<Gradient> & vector_sol,
                                                const MooseArray<Number> & scalar_sol,
                                                const MooseArray<Number> & lm_sol,
...
template <typename NSHybridized>
void
NavierStokesHybridizedInterface::lmFaceJacobian(NSHybridized & obj,
                                                const unsigned int i_offset,
                                                const unsigned int vector_j_offset,
                                                const unsigned int scalar_j_offset,
                                                const unsigned int lm_j_offset,
...
template <typename NSHybridized>
void
NavierStokesHybridizedInterface::pressureDirichletResidual(
    NSHybridized & obj,
    const unsigned int i_offset,
    const std::array<const Function *, 3> & dirichlet_vel)
{
...
template <typename NSHybridized>
void
NavierStokesHybridizedInterface::scalarDirichletResidual(
    NSHybridized & obj,
    const unsigned int i_offset,
    const MooseArray<Gradient> & vector_sol,
    const MooseArray<Number> & scalar_sol,
...
template <typename NSHybridized>
void
NavierStokesHybridizedInterface::scalarDirichletJacobian(NSHybridized & obj,
                                                         const unsigned int i_offset,
                                                         const unsigned int vector_j_offset,
                                                         const unsigned int scalar_j_offset,
                                                         const unsigned int p_j_offset,

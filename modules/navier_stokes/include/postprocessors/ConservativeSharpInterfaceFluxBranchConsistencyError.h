...
class ConservativeSharpInterfaceFluxBranchConsistencyError : public GeneralPostprocessor
{
public:
  static InputParameters validParams();

  ConservativeSharpInterfaceFluxBranchConsistencyError(const InputParameters & parameters);

 ...
 * equation.
 */
class INSADMomentumConservativeAdvectionImplicitBC : public ADVectorIntegratedBC
{
public:
  static InputParameters validParams();

  INSADMomentumConservativeAdvectionImplicitBC(const InputParameters & parameters);

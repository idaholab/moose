...
public:
  ...
  bool supportsQpBasedLoops() const override { return _qp_calculations; }
...
private:
  ...
  /// objects. This can be changed to true if objects request variable values in a way that is
  /// generated by quadrature point based calculations
  mutable bool _qp_calculations;
};

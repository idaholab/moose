...
# 1/h,   u1-Dirichlet  u2-Dirichlet  u1-Natural  u2-Natural
data = [
  6,     4.593313e-01, 1.411345e-01, 4.524177e-01, 2.371472e-01,
  12,    5.400647e-02, 1.517583e-02, 1.651529e-01, 2.011751e-01,
  24,    6.734848e-03, 1.681848e-03, 1.654026e-01, 2.016113e-01,
  48,    8.400521e-04, 2.035659e-04, 1.658418e-01, 2.016884e-01,
  96,    1.107319e-04, 2.562933e-05, 1.658707e-01, 2.016973e-01,
  ]

xdata = np.log10(data[0::5])
vel_x_dirichlet = np.log10(data[1::5])
vel_y_dirichlet = np.log10(data[2::5])
vel_x_natural = np.log10(data[3::5])
vel_y_natural = np.log10(data[4::5])

...
[Preconditioning]
  ...
  [FSP]
    ...
    [up]
      ...
      petsc_options_value = 'diag                            selfp'
    ...
    [u]
      ...
      # petsc_options_value = 'hypre    boomeramg      gmres    1e-3       20'
      # Option 1:
      # petsc_options_iname = '-pc_type -pc_hypre_type -ksp_type -ksp_atol -ksp_rtol -ksp_gmres_restart -ksp_max_it'
      # petsc_options_value = 'hypre    boomeramg      gmres     1e-4      1e-3      30                 20'
      # Option 2:
      # petsc_options_iname = '-pc_type -pc_hypre_type -pc_hypre_boomeramg_agg_nl -ksp_type -ksp_atol -ksp_rtol -ksp_max_it'
      # petsc_options_value = 'hypre    boomeramg      3                          bcgs      1e-4      1e-3      20'
      # Option 3:
      petsc_options_iname = '-pc_type   -ksp_atol -ksp_rtol -ksp_gmres_restart -ksp_max_it'
      petsc_options_value = 'telescope  1e-4      1e-3      30                 20'
    ...
    [p]
      ...
      # petsc_options_iname = '-pc_type -ksp_type -ksp_atol -ksp_rtol -ksp_max_it'
      # petsc_options_value = 'jacobi   ibcgs     1e-4      1e-3      20'
      petsc_options_iname = '-pc_type -ksp_type -ksp_atol -ksp_rtol -ksp_max_it'
      petsc_options_value = 'sor      bcgs      1e-4      1e-3      20'
      # petsc_options = '-ksp_monitor'

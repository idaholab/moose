...
class KokkosBlockSolutionOutput : public Moose::Kokkos::ElementVectorPostprocessor
{
public:
  static InputParameters validParams();

  KokkosBlockSolutionOutput(const InputParameters & parameters);
...
KokkosBlockSolutionOutput::execute(Datum & datum) const
{
  Real sum = 0;

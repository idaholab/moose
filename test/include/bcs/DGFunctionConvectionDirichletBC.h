...
class DGFunctionConvectionDirichletBC : public BoundaryCondition
{
public:
   ...
   */
  DGFunctionConvectionDirichletBC( const std::string & name, MooseSystem & moose_system, InputParameters parameters);

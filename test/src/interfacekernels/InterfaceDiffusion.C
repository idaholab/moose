...
validParams<InterfaceDiffusion>()
{
  ...
  params.addParam<MaterialPropertyName>("D", 1., "The diffusion coefficient.");
  params.addParam<MaterialPropertyName>("D_neighbor", 1., "The neighboring diffusion coefficient.");
  return params;
}

...
InputParameters validParams<TestSteady>()
{
  ...
  params.addParam<MooseEnum>("test_type", test_type, "The type of test that this object should perform");
  return params;
}

TestSteady::TestSteady(const std::string & name, InputParameters parameters) :

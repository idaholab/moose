...
#include "GaussContForcingTest.h"

registerMooseObject("MooseTestApp", GaussContForcingTest);

InputParameters
GaussContForcingTest::validParams()
{
...
GaussContForcingTest::GaussContForcingTest(const InputParameters & parameters)
  : Kernel(parameters),
...
Real
GaussContForcingTest::computeQpResidual()
{

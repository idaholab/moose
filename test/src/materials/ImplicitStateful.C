...
InputParameters validParams<ImplicitStateful>()
{
  ...
  params.addRequiredParam<std::string>("prop_name", "name of property to be generated by this material");
  params.addRequiredParam<std::string>("coupled_prop_name", "name of a property for which Old/Older stateful values will be used as prop_name's value");
  params.addRequiredParam<bool>("add_time", "true to add the current sim time to the value of the prop_name property");
  params.addRequiredParam<bool>("older", "true to use couple_prop_name older values instead of old");
  return params;
}

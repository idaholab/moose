...
"""
Run a basic simulation of a MOOSE-generated FMU via pyfmi.
...
- The FMU's integration step (dt) is fixed at FMU build time in MOOSE and cannot
  be changed at runtime by the co-simulation master.
...
- If you need a different dt or exact alignment at the final time (t1), either:
  ...
  (b) drive the FMU step-by-step (manual do_step loop).
"""
...
if __name__ == "__main__":
    ...
    logger.info("Results from FMU run:")

...
def runConvergenceTest(input_file, additional_cli_args, dt, image_filename):
    ...
    fig.plot(
        df3, label="SSP Runge-Kutta 1", marker="o", markersize=8, markerfacecolor="none"
    )
...
runConvergenceTest(
    ...
    additional_cli_args,
    0.00390625,
    "ssprk_convergence_with_bc.png",
)

additional_cli_args = "Outputs/show=l2_err"
runConvergenceTest(
    "../explicit_ssp_runge_kutta/explicit_ssp_runge_kutta.i",
    additional_cli_args,
    0.1,
    "ssprk_convergence_no_bc.png",
)

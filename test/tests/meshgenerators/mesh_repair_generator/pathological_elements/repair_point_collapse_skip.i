...
# vertices would collapse the other to a repeated node, so the point-collapse repair conservatively
# leaves both in place and reports them (cluster removal is not implemented). A later routine may
# still act on them; this test only checks the point-collapse routine's "left in place" report.
[Mesh]
  [healthy]

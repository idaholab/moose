...
result = chigger.exodus.ExodusResult(
    reader, camera=camera, color=[0, 0.85, 0.85], edges=True, edge_color=[0, 0, 0]
)
...
window.setOptions(
    size=[600, 600],
    background=[0.7058823529411765, 0.7058823529411765, 0.7058823529411765],
    background2=[0.43529411764705883, 0.43529411764705883, 0.43529411764705883],

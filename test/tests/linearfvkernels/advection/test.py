...
class TestAdvection1DLinear(unittest.TestCase):
    def test(self):
        df1 = run_spatial('advection-1d.i', 6, "LinearFVKernels/advection/advected_interp_method='average' LinearFVBCs/outflow/use_two_term_expansion=true Convergence/linear/max_iterations=10", mpi=1, file_base="advection-1d_csv")
...
class TestAdvection2DLinear(unittest.TestCase):
    def test(self):
        df1 = run_spatial('advection-2d.i', 6, "LinearFVKernels/advection/advected_interp_method='average' LinearFVBCs/outflow/use_two_term_expansion=true Convergence/linear/max_iterations=2", mpi=1, file_base="advection-2d_csv")
...
class TestAdvection2DLinearTris(unittest.TestCase):
    def test(self):
        df1 = run_spatial('advection-2d.i', 6, "Mesh/gmg/elem_type=TRI3 LinearFVKernels/advection/advected_interp_method='average' LinearFVBCs/outflow/use_two_term_expansion=true Convergence/linear/max_iterations=4", mpi=1, file_base="advection-2d_csv")

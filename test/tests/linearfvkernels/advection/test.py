...
class TestAdvection1DLinear(unittest.TestCase):
    def test(self):
        df1 = run_spatial(
            "advection-1d.i",
            6,
            "LinearFVKernels/advection/advected_interp_method='average' LinearFVBCs/outflow/use_two_term_expansion=true Convergence/linear/max_iterations=15",
            mpi=1,
...
<<<<<<< HEAD
        df1 = run_spatial(
            "advection-2d.i",
            6,
            "LinearFVKernels/advection/advected_interp_method='average' LinearFVBCs/outflow/use_two_term_expansion=true Convergence/linear/max_iterations=10",
            mpi=1,
...
<<<<<<< HEAD
        df1 = run_spatial(
            "advection-2d.i",
            6,
            "Mesh/gmg/elem_type=TRI3 LinearFVKernels/advection/advected_interp_method='average' LinearFVBCs/outflow/use_two_term_expansion=true Convergence/linear/max_iterations=10",
            mpi=1,
            file_base="advection-2d_csv",
        )
=======
...
class TestAdvection2DRZ(unittest.TestCase):
    def test(self):
        df1 = run_spatial(
            "advection-2d-rz.i", 6, mpi=1, file_base="advection-2d-rz_csv"
        )

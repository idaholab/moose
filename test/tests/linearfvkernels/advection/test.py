...
class TestAdvection1DLinear(unittest.TestCase):
    def test(self):
        df1 = run_spatial('advection-1d.i', 6, "LinearFVKernels/advection/advected_interp_method_name=average LinearFVBCs/outflow/use_two_term_expansion=true Convergence/linear/max_iterations=15", mpi=1, file_base="advection-1d_csv")

...
class TestDiffusion1DNeumann(unittest.TestCase):
    def test(self):
        df1 = run_spatial(
            "diffusion-1d_neumann.i", 6, file_base="diffusion-1d_neumann_csv"
        )
...
class TestDiffusion2DNonorthogonal(unittest.TestCase):
    def test(self):
        df1 = run_spatial(
            "diffusion-2d.i",
            5,
            "Mesh/gmg/elem_type=TRI3 LinearFVKernels/diffusion/use_nonorthogonal_correction=true Convergence/linear/max_iterations=10",
            file_base="diffusion-2d_csv",
        )
...
class TestDiffusion2DOrthogonalNeumann(unittest.TestCase):
    def test(self):
        df1 = run_spatial(
            "diffusion-2d_neumann.i", 5, file_base="diffusion-2d_neumann_csv"
        )
...
class TestDiffusion2DNonorthogonalNeumann(unittest.TestCase):
    def test(self):
        df1 = run_spatial(
            "diffusion-2d_neumann.i",
            5,
            "Mesh/gmg/elem_type=TRI3 LinearFVKernels/diffusion/use_nonorthogonal_correction=true Convergence/linear/max_iterations=10",
            file_base="diffusion-2d_neumann_csv",
        )
...
class TestDiffusion2DRZNonorthogonal(unittest.TestCase):
    def test(self):
        df1 = run_spatial(
            ...
            5,
            "Mesh/gmg/elem_type=TRI3 LinearFVKernels/diffusion/use_nonorthogonal_correction=true Convergence/linear/max_iterations=10",
            file_base="diffusion-2d-rz-nonorthogonal_csv",
        )

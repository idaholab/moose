###########################################################
# This is a spatial convergence test of the ADScaledCoupledTimeDerivative kernel
...
# u(t,x,y) = t*exp(x+y) and v(x,y) = sin(2*pi*x)*cos(2*pi*y)
###########################################################

...
class TestSkewnessCorrectedStencil(unittest.TestCase):
    def test(self):
        df1 = mms.run_spatial('advection-outflow.i', 5, 'FVKernels/diffusion/variable_interp_method=skewness-corrected Variables/v/face_interp_method=skewness-corrected')

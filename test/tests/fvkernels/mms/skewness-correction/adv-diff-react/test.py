...
class TestSkewnessCorrectedStencil(unittest.TestCase):
    def test(self):
        df1 = mms.run_spatial('skewed.i', 5, 'FVKernels/diff_v/variable_interp_method=skewness-corrected')
...
class TestSkewnessCorrectedDiffAdvStencil(unittest.TestCase):
    def test(self):
        df1 = mms.run_spatial('skewed.i', 5, 'FVKernels/diff_v/variable_interp_method=skewness-corrected Variables/v/face_interp_method=skewness-corrected', 'FVKernels/advection/advected_interp_method=skewness-corrected')

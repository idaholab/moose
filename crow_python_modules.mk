...
CROW_PMODULES=$(CROW_DIR)/crow_modules
...
$(CROW_DIR)/crow_modules/_distribution1Dpy2.so : $(CROW_DIR)/crow_modules/distribution1Dpy2.i \
...
# Compile
	...
	$(libmesh_CXX) $(libmesh_CPPFLAGS) $(PYTHON2_INCLUDE)\
	 ...
	 -c  $(CROW_PMODULES)/distribution1Dpy2_wrap.cxx -o $(CROW_DIR)/crow_modules/distribution1Dpy2_wrap.lo
...
$(CROW_DIR)/crow_modules/_distribution1Dpy3.so : $(CROW_DIR)/crow_modules/distribution1Dpy3.i \
                                                 $(CROW_DIR)/src/distributions/distribution_1D.$(obj-suffix) \
                                                 $(CROW_DIR)/src/distributions/DistributionContainer.$(obj-suffix) \
                                                 $(CROW_DIR)/src/distributions/distributionFunctions.$(obj-suffix) \
                                                 $(CROW_DIR)/src/distributions/distribution_base_ND.$(obj-suffix) \
...
# Compile
	...
	$(libmesh_CXX) $(libmesh_CPPFLAGS) $(PYTHON_INCLUDE)\
         -I$(CROW_DIR)/include/distributions/ -I$(CROW_DIR)/include/utilities/ -I$(CROW_LIB_INCLUDE_DIR) \
	 -c  $(CROW_PMODULES)/distribution1Dpy3_wrap.cxx -o $(CROW_DIR)/crow_modules/distribution1Dpy3_wrap.lo
	$(libmesh_LIBTOOL) --tag=CXX $(LIBTOOLFLAGS) --mode=link \
	 $(libmesh_CXX) $(libmesh_CXXFLAGS) \
...
$(CROW_DIR)/crow_modules/_interpolationNDpy2.so : $(CROW_DIR)/crow_modules/interpolationNDpy2.i \
                                                 $(CROW_DIR)/src/utilities/ND_Interpolation_Functions.$(obj-suffix) \
                                                 $(CROW_DIR)/src/utilities/NDspline.$(obj-suffix) \
                                                 $(CROW_DIR)/src/utilities/microSphere.$(obj-suffix) \
                                                 $(CROW_DIR)/src/utilities/inverseDistanceWeigthing.$(obj-suffix) \
...
# Compile
	...
	$(libmesh_CXX) $(libmesh_CPPFLAGS) $(PYTHON2_INCLUDE)\
	 ...
	 -c  $(CROW_PMODULES)/interpolationNDpy2_wrap.cxx -o $(CROW_DIR)/crow_modules/interpolationNDpy2_wrap.lo
	$(libmesh_LIBTOOL) --tag=CXX $(LIBTOOLFLAGS) --mode=link \
	 $(libmesh_CXX) $(libmesh_CXXFLAGS) \
...
$(CROW_DIR)/crow_modules/_interpolationNDpy3.so : $(CROW_DIR)/crow_modules/interpolationNDpy3.i \
                                                 $(CROW_DIR)/src/utilities/ND_Interpolation_Functions.$(obj-suffix) \
                                                 $(CROW_DIR)/src/utilities/NDspline.$(obj-suffix) \
                                                 $(CROW_DIR)/src/utilities/microSphere.$(obj-suffix) \
                                                 $(CROW_DIR)/src/utilities/inverseDistanceWeigthing.$(obj-suffix) \
...
# Compile
	...
	$(libmesh_CXX) $(libmesh_CPPFLAGS) $(PYTHON_INCLUDE)\
         -I$(CROW_DIR)/include/utilities/ -I$(CROW_LIB_INCLUDE_DIR) \
	 -c  $(CROW_PMODULES)/interpolationNDpy3_wrap.cxx -o $(CROW_DIR)/crow_modules/interpolationNDpy3_wrap.lo
	$(libmesh_LIBTOOL) --tag=CXX $(LIBTOOLFLAGS) --mode=link \
	 $(libmesh_CXX) $(libmesh_CXXFLAGS) \

...
ifneq ($(PETSC_HAVE_CUDA),)
  ...
  KOKKOS_CXXFLAGS    = $(CXXFLAGS) $(libmesh_CXXFLAGS)
  KOKKOS_CPPFLAGS    = $(libmesh_CPPFLAGS) $(ADDITIONAL_CPPFLAGS) ${ADDITIONAL_KOKKOS_CPPFLAGS}
  KOKKOS_LDFLAGS     =
  KOKKOS_ENABLE_GPU := false
endif

ifeq ($(KOKKOS_ENABLE_GPU),false)
  KOKKOS_DEVICE := CPU
  KOKKOS_ARCH   := OpenMP
else
  CXXFLAGS      += -DMOOSE_KOKKOS_ENABLE_GPU=1
endif

CXXFLAGS        += -DMOOSE_HAVE_KOKKOS=1
KOKKOS_CXXFLAGS += -fPIC -DMOOSE_KOKKOS_SCOPE=1

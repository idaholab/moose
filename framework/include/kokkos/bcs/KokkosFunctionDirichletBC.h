...
protected:
  ...
  /// hostValue() reads it on host at a point libMesh's constraint machinery reports beyond a mesh
  /// node (e.g. a HIERARCHIC edge or face mode)
  const Moose::Kokkos::ReferenceWrapper<const KokkosParsedFunction> _function;
};

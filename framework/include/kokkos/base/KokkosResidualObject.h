...
protected:
   ...
   */
  ///@{
  std::shared_ptr<DispatcherBase> _residual_dispatcher;
  std::shared_ptr<DispatcherBase> _jacobian_dispatcher;
  std::shared_ptr<DispatcherBase> _offdiag_jacobian_dispatcher;
  ///@}

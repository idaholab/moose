...
public:
  ...
  {
    return _need_second || _need_second_old || _need_second_older;
  }
  ...
  {
    return _nodal_du_dot_du_neighbor;
  }
  ...
  {
    return _dof_indices_neighbor.size();
  }

...
class GPUKernelGrad : public GPUKernel<Kernel>
{
...
public:
  ...
  // Constructor
  GPUKernelGrad(const InputParameters & parameters) : GPUKernel<Kernel>(parameters) {}
...
protected:
  ...
  {
    return &Kernel::precomputeQpJacobian == &GPUKernelGrad::precomputeQpJacobian;
  }
};

#define usingGPUKernelGradMembers(T) usingGPUKernelMembers(T)

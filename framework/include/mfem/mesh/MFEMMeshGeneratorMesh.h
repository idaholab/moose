 ...
 *
 * Common MFEM mesh infrastructure lives in the MFEMMesh base class; this class
 * implements buildSerialMFEMMesh() to extract the mfem::Mesh from the
 * MFEMMeshCarrier produced by the generator pipeline.
 */

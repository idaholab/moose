 ...
 */
class DivAux : public AuxKernel
{
public:
  static InputParameters validParams();

  DivAux(const InputParameters & parameters);

  virtual ~DivAux() = default;
...
protected:
  /// Name of source Moose::MFEM::Variable to take the divergence of.

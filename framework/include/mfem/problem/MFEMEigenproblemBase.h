 ...
 * naming convention, the right-hand-side scaling coefficient, and the variable/solver registration
 * common to both. Concrete subclasses constrain the numeric type (real or complex).
 */

...
typedef MooseVariableFV<VectorValue<Real>> VectorMooseVariableFV;
class Assembly;

/**
 * Base class for deriving element dampers
 */
class ElementDamperFV : public Damper, protected MaterialPropertyInterface
{
public:
  static InputParameters validParams();

  ElementDamperFV(const InputParameters & parameters);
   ...
   */
  MooseVariableFVReal * getVariable() { return &_var; }

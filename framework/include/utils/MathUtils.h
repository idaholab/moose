 ...
 * @param b0,b1,b2 is the center point in barycentric coordinates, e.g. (1/3,1/3,1/3) for a centriod
 * @return the center point of triangle in Cartesian coordinates
 */
libMesh::Point barycentricToCartesian2D(const libMesh::Point & p0,
 ...
 * @param b0,b1,b2,b3 is the center point in barycentric coordinates, e.g. (1/4,1/4,1/4,1/4) for a
 * centriod
 * @return the center point of tetrahedron in Cartesian coordinates
 */
libMesh::Point barycentricToCartesian3D(const libMesh::Point & p0,
                                        const libMesh::Point & p1,
                                        const libMesh::Point & p2,
 ...
 * @return the circumcenter in Cartesian coordinates
 */
libMesh::Point circumcenter3D(const libMesh::Point & p0,
                              const libMesh::Point & p1,
                              const libMesh::Point & p2,
                              const libMesh::Point & p3);

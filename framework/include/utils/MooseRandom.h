...
private:
  ...
  friend void
  dataStore<MooseRandom>(std::ostream & stream, MooseRandom & v, Moose::AnyPointer context);
  friend void
  dataLoad<MooseRandom>(std::istream & stream, MooseRandom & v, Moose::AnyPointer context);
...
template <>
inline void
dataStore(std::ostream & stream, MooseRandom & v, Moose::AnyPointer context)
{
  storeHelper(stream, v._states, context);
}
template <>
inline void
dataLoad(std::istream & stream, MooseRandom & v, Moose::AnyPointer context)
{

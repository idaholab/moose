...
private:
   ...
   */
  InputParameters &
  addInputParameters(const std::string & name, const InputParameters & parameters, THREAD_ID tid = 0);
  ...
  Factory::create(const std::string &, const std::string &, const InputParameters &, THREAD_ID, bool);

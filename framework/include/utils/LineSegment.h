...
class LineSegment
{
 public:
   ...
   */
  bool closest_normal_point (const Point & p, Point & closest_p);
  ...
  bool intersect(const Plane & pl, Point & intersect_p);
    
 private:
  bool closest_point(const Point & p, bool clamp_to_segment, Point & closest_p);

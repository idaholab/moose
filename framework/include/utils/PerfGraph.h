...
protected:
  ...
  friend void dataLoad(std::istream &, PerfGraph &, Moose::AnyPointer);
...
void dataStore(std::ostream & stream, PerfGraph & perf_graph, Moose::AnyPointer context);
void dataLoad(std::istream & stream, PerfGraph & perf_graph, Moose::AnyPointer context);

...
public:
   ...
   */
  explicit ColumnMajorMatrix(const unsigned int rows = LIBMESH_DIM, const unsigned int cols = LIBMESH_DIM);
...
inline ColumnMajorMatrix &
    ColumnMajorMatrix::
    operator=(const TypeTensor<Real> & rhs)
{
...
inline ColumnMajorMatrix &
    ColumnMajorMatrix::
    operator=(const ColumnMajorMatrix & rhs)
{
  _n_rows = rhs._n_rows;
  _n_cols = rhs._n_cols;
...
inline ColumnMajorMatrix
    ColumnMajorMatrix::
    operator*(const TypeVector<Real> & rhs) const
{
...
inline ColumnMajorMatrix
    ColumnMajorMatrix::
    operator*(const ColumnMajorMatrix & rhs) const
{

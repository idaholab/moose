...
protected:
  ...
  // @{ An enum class for the type of elements at the cut interface
  CreateMooseEnumClass(CutInterfaceElement, TETRAHEDRA, POLYHEDRA);
  const CutInterfaceElement _cut_interface;
  // @}

...
protected:
  ...
  std::unique_ptr<MeshBase> &
  addMeshSubgenerator(const std::string & generator_name,
...
MeshGenerator::addMeshSubgenerator (const std::string & generator_name,
                                    ...
                                    Ts... extra_input_parameters)
{
  InputParameters subgenerator_params =
    _app.getFactory().getValidParams(generator_name);

  subgenerator_params.setParameters(extra_input_parameters...);

  _app.addMeshGenerator(generator_name, name, subgenerator_params);

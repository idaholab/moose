...
#ifndef GENERATESIDESETSBASE_H
#define GENERATESIDESETSBASE_H
...
template <>
InputParameters validParams<GenerateSideSetsBase>();

class GenerateSideSetsBase : public MeshGenerator
{
public:
  GenerateSideSetsBase(const InputParameters & parameters);
  virtual ~GenerateSideSetsBase(); // dtor required for unique_ptr with forward declarations

...
protected:
  ...
  std::vector<std::map<std::tuple<std::string, int>, std::set<BoundaryID>>> _boundary_ics;
  std::vector<std::map<std::tuple<std::string, int>, std::set<SubdomainID>>> _block_ics;
  ///@}
};

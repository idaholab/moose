...
{
public:
  MeshMetaDataInterface(const MooseObject * moose_object, const MooseMesh & mesh);
...
{
  mooseAssert(_mgi_mesh_props.have_parameter<T>(name),
              std::string("Property ") + name + " doesn't exist in this instance.");

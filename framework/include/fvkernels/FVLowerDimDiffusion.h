...
/// FVLowerDimDiffusion implements a standard diffusion term:
///
///     - strong form: \nabla \cdot k \nabla u
///
...
class FVLowerDimDiffusion : public FVFluxKernel
{
public:
  static InputParameters validParams();
  FVLowerDimDiffusion(const InputParameters & params);

 ...
 */
template <bool is_ad>
class ScalarLMKernelGTempl : public GenericKernelScalar<is_ad>
{
public:
  static InputParameters validParams();

  ScalarLMKernelGTempl(const InputParameters & parameters);
...
typedef ScalarLMKernelGTempl<false> ScalarLMKernelG;
typedef ScalarLMKernelGTempl<true> ADScalarLMKernelG;

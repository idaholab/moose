...
public:
   ...
   * Constructor.
   */
  MooseObjectTagWarehouse(THREAD_ID num_threads = libMesh::n_threads());
...
template <typename T>
MooseObjectTagWarehouse<T>::MooseObjectTagWarehouse(THREAD_ID num_threads /*=libMesh::n_threads()*/)

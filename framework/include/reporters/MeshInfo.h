...
void
dataStore(std::ostream & stream, MeshInfo::SubdomainInfo & sideset_info, Moose::AnyPointer context);
void
dataLoad(std::istream & stream, MeshInfo::SubdomainInfo & sideset_info, Moose::AnyPointer context);

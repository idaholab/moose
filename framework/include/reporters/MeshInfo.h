...
template <typename Context>
void
dataStore(std::ostream & stream, MeshInfo::SubdomainInfo & sideset_info, Context context);
template <typename Context>
void
dataLoad(std::istream & stream, MeshInfo::SubdomainInfo & sideset_info, Context context);

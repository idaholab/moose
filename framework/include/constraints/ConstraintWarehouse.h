...
public:
  ...
  getActiveNodeElemConstraints(SubdomainID secondary_id, SubdomainID primary_id, bool displaced) const;
  ///@}
  ...
  bool
  hasActiveNodeElemConstraints(SubdomainID secondary_id, SubdomainID primary_id, bool displaced) const;
  ///@}

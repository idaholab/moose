...
#ifndef NODEFACECONSTRAINTBASE_H
#define NODEFACECONSTRAINTBASE_H
...
template <>
InputParameters validParams<NodeFaceConstraintBase>();

/**
 * A NodeFaceConstraintBase is used when you need to create constraints between
...
{
public:
  NodeFaceConstraintBase(const InputParameters & parameters);
  virtual ~NodeFaceConstraintBase();

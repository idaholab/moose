...
capabilities $(capabilities_LIB) : $(capabilities_srcfiles)
	...
	@bash -c '(cd "$(CAPABILITIES_DIR)" && $(libmesh_CXX) -DNO_LIBMESH -std=c++17 -w -fPIC -lstdc++ -shared $(capabilities_srcfiles) $(capabilities_COMPILEFLAGS) $(capabilities_LDFLAGS) -o $(capabilities_LIB))'

...
BasicMultiDimensionalCartesianSpline::BasicMultiDimensionalCartesianSpline(
    ...
    bool cdf_provided)
  : _interpolator(data_filename, alpha, beta)
{
...
BasicMultiDimensionalCartesianSpline::BasicMultiDimensionalCartesianSpline(
    std::string data_filename, bool cdf_provided)
  : _interpolator(data_filename)
{
  _cdf_provided = cdf_provided;
  basicMultiDimensionalCartesianSplineInit();
}
...
BasicMultiDimensionalCartesianSpline::BasicMultiDimensionalCartesianSpline(
    const char * data_filename, bool cdf_provided)
  : _interpolator(data_filename)
{
  _cdf_provided = cdf_provided;
  basicMultiDimensionalCartesianSplineInit();
...
BasicMultiDimensionalCartesianSpline::BasicMultiDimensionalCartesianSpline(
    ...
    std::vector<double> beta,
    bool cdf_provided)
  : _interpolator(discretizations, values, alpha, beta)
{
  _cdf_provided = cdf_provided;
  basicMultiDimensionalCartesianSplineInit();
}
...
void
BasicMultiDimensionalCartesianSpline::basicMultiDimensionalCartesianSplineInit()
{
  ...
  if (_cdf_provided)
  {
    ...
    if (LBcheck == false)
      throwError("BasicMultiDimensionalCartesianSpline Distribution error: CDF values given as "
                 "input contain element below 0.0");

    bool UBcheck = _interpolator.checkUB(1.0);
    if (UBcheck == false)
      throwError("BasicMultiDimensionalCartesianSpline Distribution error: CDF values given as "
                 "input contain element above 1.0");
  }

  if (_cdf_provided == false)
  { // PDF provided ---> create grid for CDF
    ...
    for (int i = 0; i < numberofValues; i++)
    {
      ...
      // std::cout<< nd_coordinate.at(0) << " " << nd_coordinate.at(1) << " : " << CDFvalues.at(i)
      // << std::endl;
    }
...
BasicMultiDimensionalCartesianSpline::cdf(std::vector<double> x)
{
  ...
  if (value > 1.0)
  {
    ...
    throwError("BasicMultiDimensionalCartesianSpline Distribution error: CDF value calculated is "
               "above 1.0");
  }
...
double
BasicMultiDimensionalCartesianSpline::inverseMarginal(double f, int dimension)
{
  double value = 0.0;
  ...
  if ((f < 1.0) and (f > 0.0))
  {
    if (_cdf_provided)
    {
      throwError("BasicMultiDimensionalCartesianSpline Distribution error: inverseMarginal "
                 "calculation not available if CDF provided");
    }
    else
    {
    ...
    throwError("BasicMultiDimensionalCartesianSpline Distribution error: CDF value for inverse "
               "marginal distribution is above 1.0");
...
void
BasicMultiDimensionalCartesianSpline::updateRNGparameter(double tolerance, double initial_divisions)
{
...
double
BasicMultiDimensionalCartesianSpline::marginal(double x, int dimension)
{
  double value = 0.0;
  if (_cdf_provided)
  {
    throwError("BasicMultiDimensionalCartesianSpline Distribution error: marginal calculation not "
               "available if CDF provided");
  }
  else
  {
...
double
BasicMultiDimensionalCartesianSpline::returnUpperBound(int dimension)
{
  /**
...
double
BasicMultiDimensionalCartesianSpline::returnLowerBound(int dimension)
{
  /**

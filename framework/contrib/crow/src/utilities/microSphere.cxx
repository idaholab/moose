...
double
MicroSphere::interpolateAt(std::vector<double> point_coordinate)
{
  double value = 0;
  double weight = 0;
  double cosValue = 0;
...
double
MicroSphere::cosValueBetweenVectors(std::vector<double> point1, std::vector<double> point2)
{
  double cosAngle = 0;
...
double
MicroSphere::getGradientAt(std::vector<double> /* point_coordinate */)
{
  if (not _completed_init)
  {

...
// https://connect.microsoft.com/VisualStudio/feedback/details/800328/std-is-copy-constructible-is-broken
  ...
  test(T1 &, typename T1::boost_move_no_copy_constructor_or_assign * = 0);
  ...
  BOOST_STATIC_CONSTANT(bool,
                        value = (sizeof(test(produce())) == sizeof(boost::type_traits::yes_type)));
#endif
};
...
struct is_copy_assignable_impl
{
  ...
  BOOST_STATIC_CONSTANT(bool,
                        value = (boost::detail::is_copy_assignable_impl2 <
                                         boost::is_base_and_derived<boost::noncopyable, T>::value ||
                                     boost::is_const<unreferenced_t>::value ||
...
struct is_copy_assignable
    : public integral_constant<bool, ::boost::detail::is_copy_assignable_impl<T>::value>
{
};
template <>

...
namespace BOOST_JOIN(BOOST_TT_TRAIT_NAME, _impl)
{
  ...
  // - operator BOOST_TT_TRAIT_OP returns void   -> (BOOST_TT_TRAIT_OP rhs, returns_void_t())
  ...
  struct operator_returns_void
  {
    ...
    BOOST_STATIC_CONSTANT(bool,
                          value = (sizeof(::boost::type_traits::yes_type) ==
                                   sizeof(returns_void((BOOST_TT_TRAIT_OP make<Rhs>(),
                                                        returns_void_t())))));
  };
  ...
  struct operator_returns_Ret<Rhs, Ret, false>
  {
    ...
    BOOST_STATIC_CONSTANT(bool,
                          value = (sizeof(is_convertible_to_Ret(BOOST_TT_TRAIT_OP make<Rhs>())) ==
  ...
  struct operator_exists
  {
    ...
    BOOST_STATIC_CONSTANT(bool,
                          value = (sizeof(s_check(((BOOST_TT_TRAIT_OP make<Rhs>()),
                                                   make<has_operator>()))) ==
                                   sizeof(::boost::type_traits::yes_type)));
  };
  ...
  struct trait_impl1<Rhs, Ret, false>
  {
    BOOST_STATIC_CONSTANT(
        bool,
        value = (operator_exists<Rhs>::value &&
  ...
  struct trait_impl
  {
    ...
    typedef typename ::boost::remove_cv<typename ::boost::remove_reference<
        typename ::boost::remove_pointer<Rhs_noref>::type>::type>::type Rhs_noptr;
    BOOST_STATIC_CONSTANT(bool,
                          value = (trait_impl1<Rhs_noref, Ret, BOOST_TT_FORBIDDEN_IF>::value));
  };
...
struct BOOST_TT_TRAIT_NAME
    : public integral_constant<bool,
                               (::boost::detail::BOOST_JOIN(BOOST_TT_TRAIT_NAME,
                                                            _impl)::trait_impl<Rhs, Ret>::value)>
{
};

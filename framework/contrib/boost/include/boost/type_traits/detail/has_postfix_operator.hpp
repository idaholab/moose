...
namespace BOOST_JOIN(BOOST_TT_TRAIT_NAME, _impl)
{
  ...
  // - operator BOOST_TT_TRAIT_OP returns void   -> (lhs BOOST_TT_TRAIT_OP, returns_void_t())
  // returns returns_void_t
  // - operator BOOST_TT_TRAIT_OP returns !=void -> (lhs BOOST_TT_TRAIT_OP, returns_void_t())
  // returns int
  ...
  struct operator_returns_void
  {
    ...
    BOOST_STATIC_CONSTANT(bool,
                          value = (sizeof(::boost::type_traits::yes_type) ==
                                   sizeof(returns_void((make<Lhs>() BOOST_TT_TRAIT_OP,
                                                        returns_void_t())))));
  };
  ...
  struct operator_returns_Ret<Lhs, Ret, false>
  {
    ...
    BOOST_STATIC_CONSTANT(bool,
                          value = (sizeof(is_convertible_to_Ret(make<Lhs>() BOOST_TT_TRAIT_OP)) ==
  ...
  struct operator_exists
  {
    ...
    BOOST_STATIC_CONSTANT(bool,
                          value = (sizeof(s_check(((make<Lhs>() BOOST_TT_TRAIT_OP),
                                                   make<has_operator>()))) ==
                                   sizeof(::boost::type_traits::yes_type)));
  };
  ...
  struct trait_impl1<Lhs, Ret, false>
  {
    BOOST_STATIC_CONSTANT(
        bool,
        value = (operator_exists<Lhs>::value &&
  ...
  struct trait_impl
  {
    ...
    typedef typename ::boost::remove_cv<typename ::boost::remove_reference<
        typename ::boost::remove_pointer<Lhs_noref>::type>::type>::type Lhs_noptr;
    BOOST_STATIC_CONSTANT(bool,
                          value = (trait_impl1<Lhs_noref, Ret, BOOST_TT_FORBIDDEN_IF>::value));
  };
...
struct BOOST_TT_TRAIT_NAME
    : public integral_constant<bool,
                               (::boost::detail::BOOST_JOIN(BOOST_TT_TRAIT_NAME,
                                                            _impl)::trait_impl<Lhs, Ret>::value)>
{
};

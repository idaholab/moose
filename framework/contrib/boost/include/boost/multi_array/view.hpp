...
public:
  ...
  reindex(const BaseList & values)
  {
    ...
    origin_offset_ = this->calculate_indexing_offset(stride_list_, index_base_list_);
  }
...
public: // should be protected
    ...
    : base_(base), origin_offset_(0)
  {
    ...
    boost::detail::multi_array::copy_n(extents.begin(), NumDims, extent_list_.begin());
    boost::detail::multi_array::copy_n(strides.begin(), NumDims, stride_list_.begin());

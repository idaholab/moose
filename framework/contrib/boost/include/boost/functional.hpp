...
struct binary_traits
{
  ...
  typedef
      typename detail::binary_traits_imp<Operation *>::second_argument_type second_argument_type;
};
...
{
public:
  explicit unary_negate(typename unary_traits<Predicate>::param_type x) : pred(x) {}
  bool operator()(
      typename call_traits<typename unary_traits<Predicate>::argument_type>::param_type x) const
  {
    return !pred(x);
  }
...
{
public:
  explicit binary_negate(typename binary_traits<Predicate>::param_type x) : pred(x) {}
  bool operator()(
...
// --------------------------------------------------------------------------
template <class Operation>
class binder2nd : public std::unary_function<typename binary_traits<Operation>::first_argument_type,
                                             typename binary_traits<Operation>::result_type>
{
public:
  binder2nd(
...
{
public:
  explicit mem_fun_t(S (T::*p)()) : ptr(p) {}
...
{
public:
  explicit mem_fun1_t(S (T::*p)(A)) : ptr(p) {}
...
{
public:
  explicit const_mem_fun_t(S (T::*p)() const) : ptr(p) {}
...
{
public:
  explicit const_mem_fun1_t(S (T::*p)(A) const) : ptr(p) {}
...
{
public:
  explicit mem_fun_ref_t(S (T::*p)()) : ptr(p) {}
  S operator()(T & p) const { return (p.*ptr)(); }
private:
  S (T::*ptr)();
};
...
{
public:
  explicit mem_fun1_ref_t(S (T::*p)(A)) : ptr(p) {}
  S operator()(T & p, typename call_traits<A>::param_type x) const { return (p.*ptr)(x); }
private:
  S (T::*ptr)(A);
};
...
{
public:
  explicit const_mem_fun_ref_t(S (T::*p)() const) : ptr(p) {}
...
{
public:
  explicit const_mem_fun1_ref_t(S (T::*p)(A) const) : ptr(p) {}
...
#ifndef BOOST_NO_POINTER_TO_MEMBER_CONST
template <class S, class T>
inline const_mem_fun_ref_t<S, T>
...
template <class S, class T, class A>
inline const_mem_fun1_ref_t<S, T, A>

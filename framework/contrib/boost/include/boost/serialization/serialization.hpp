...
inline void
serialize(Archive & ar, T & t, const unsigned int file_version)
{
...
template <class Archive, class T>
inline void
save_construct_data(Archive & /*ar*/, const T * /*t*/, const unsigned int /*file_version */
                    )
{
...
template <class Archive, class T>
inline void
load_construct_data(Archive & /*ar*/, T * t, const unsigned int /*file_version*/
                    )
{
...
template <class Archive, class T>
inline void
serialize_adl(Archive & ar, T & t, const unsigned int file_version)
{
...
template <class Archive, class T>
inline void
save_construct_data_adl(Archive & ar, const T * t, const unsigned int file_version)
{
  // see above
  const version_type v(file_version);
...
template <class Archive, class T>
inline void
load_construct_data_adl(Archive & ar, T * t, const unsigned int file_version)
{
  // see above comment
  const version_type v(file_version);

...
struct retagged_if : mpl::if_<detail::represents_impl<Components, IfTagged>,
...
struct cv_func_base : detail::retagged_if<Base, member_pointer_tag, function_tag>
{
  typedef typename mpl::remove<typename Base::types,
...
struct components_impl<T *, L>
    : mpl::if_<
          detail::represents_impl<detail::components_impl<T a_class::*, L>, member_pointer_tag>,
...
struct components_impl<T C::*, L>
    : detail::retagged_if<detail::components_impl<typename boost::remove_cv<T>::type *, L>,
                          pointer_tag,
...
{
  BOOST_STATIC_CONSTANT(std::size_t, value = sizeof(detail::mfp_cv_tester((T)0L)));
};
...
struct bcc_class_transform
    : bcc_class_transform_impl<
          typename decode_cv<T, ::boost::function_types::detail::encode_mfp_cv<D>::value>::type,
          L>
{
};
...
private:
  ...
  typedef typename mpl::advance<
      ...
      typename mpl::if_<mpl::equal_to<typename detail::classifier<OrigT>::function_arity,
                                      typename Base::function_arity>,
                        mpl::integral_c<int, 2>,
                        mpl::integral_c<int, 1>>::type>::type from;
...
public:
  typedef typename mpl::reverse_copy<types_view, mpl::front_inserter<mpl::vector0<>>>::type types;

  typedef typename function_types::tag<Base, detail::cv_tag_mfp<OrigT>>::bits bits;
...
template <typename T, typename OrigT, typename L>
struct components_bcc
    : mpl::if_<detail::represents_impl<detail::components_impl<T, L>, member_function_pointer_tag>,

...
{
  typedef BOOST_FT_syntax(BOOST_FT_cc, type BOOST_PP_EMPTY)(BOOST_FT_nullary_param BOOST_FT_ell)
      BOOST_FT_cv;
};
template <>
struct synthesize_impl_o<BOOST_FT_flags, BOOST_FT_cc_id, 1>
{
  ...
  public:
    typedef typename detail::BOOST_FT_make_type(BOOST_FT_flags,
                                                BOOST_FT_cc_id,
                                                0)<typename mpl::deref<iter_0>::type>::type type;
  };
};
...
struct synthesize_impl_o<BOOST_FT_flags, BOOST_FT_cc_id, 2>
{
  ...
  public:
    typedef typename detail::BOOST_FT_make_type(
        BOOST_FT_flags,
        BOOST_FT_cc_id,
        1)<typename mpl::deref<iter_0>::type, typename mpl::deref<iter_1>::type>::type type;
  };
};
...
{
  typedef BOOST_FT_syntax(BOOST_FT_cc, type BOOST_PP_EMPTY)(T0, T1, T2, T3 BOOST_FT_ell)
      BOOST_FT_cv;
};
template <>
...
{
  typedef BOOST_FT_syntax(BOOST_FT_cc, type BOOST_PP_EMPTY)(T0, T1, T2, T3, T4 BOOST_FT_ell)
      BOOST_FT_cv;
};
template <>
...
{
  typedef BOOST_FT_syntax(BOOST_FT_cc, type BOOST_PP_EMPTY)(T0, T1, T2, T3, T4, T5 BOOST_FT_ell)
      BOOST_FT_cv;
};
template <>
...
{
  typedef BOOST_FT_syntax(BOOST_FT_cc, type BOOST_PP_EMPTY)(T0, T1, T2, T3, T4, T5, T6 BOOST_FT_ell)
      BOOST_FT_cv;
};
template <>

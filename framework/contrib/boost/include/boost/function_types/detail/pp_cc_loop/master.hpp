...
#define BOOST_PP_FILENAME_1 <boost/function_types/detail/pp_cc_loop/master.hpp>
#define BOOST_PP_ITERATION_LIMITS (0, BOOST_PP_SEQ_SIZE(BOOST_FT_CC_NAMES_SEQ) - 1)
...
BOOST_PP_EXPAND(#)
ifndef BOOST_FT_config_valid BOOST_PP_EXPAND(#) define BOOST_FT_cc_id
    1 BOOST_PP_EXPAND(#) define BOOST_FT_cc_name implicit_cc
...
#undef _
    BOOST_PP_EXPAND(#) undef BOOST_FT_cond BOOST_PP_EXPAND(#) undef BOOST_FT_cc_name
    BOOST_PP_EXPAND(#) undef BOOST_FT_cc BOOST_PP_EXPAND(#) undef BOOST_FT_cc_id
    BOOST_PP_EXPAND(#) else BOOST_PP_EXPAND(#) undef BOOST_FT_config_valid BOOST_PP_EXPAND(#) endif
...
#define BOOST_FT_cc_inf BOOST_PP_SEQ_ELEM(BOOST_PP_FRAME_ITERATION(1), BOOST_FT_CC_NAMES_SEQ)
...
#define BOOST_FT_cc_inf BOOST_PP_SEQ_ELEM(BOOST_PP_ITERATION(), BOOST_FT_CC_NAMES_SEQ)

#define BOOST_FT_cc_pp_name BOOST_PP_TUPLE_ELEM(3, 0, BOOST_FT_cc_inf)

#define BOOST_FT_CC_DEF(name, index) name BOOST_PP_TUPLE_ELEM(3, index, BOOST_FT_cc_inf)
    BOOST_PP_EXPAND(#) define BOOST_FT_CC_DEF(BOOST_FT_cc_name, 1) BOOST_PP_EXPAND(#) define
    BOOST_FT_CC_DEF(BOOST_FT_cc, 2)
...
#undef BOOST_FT_cc_inf
    ...
    BOOST_PP_EXPAND(#) if BOOST_FT_cond BOOST_PP_EXPAND(#) define BOOST_FT_config_valid 1
#define _()
    BOOST_PP_EXPAND(#) include BOOST_FT_cc_file
#undef _
    ...
    BOOST_PP_EXPAND(#) undef BOOST_FT_cc_name BOOST_PP_EXPAND(#) undef BOOST_FT_cc

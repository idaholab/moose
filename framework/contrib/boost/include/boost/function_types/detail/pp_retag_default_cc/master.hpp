...
#include BOOST_PP_ASSIGN_SLOT(1)
  ...
  BOOST_STATIC_CONSTANT(
      bits_t,
      value = ((::boost::function_types::detail::bits<Tag>::value & BOOST_FT_default_cc) |
...
struct retag_default_cc
    : detail::compound_tag<Tag,
                           detail::default_cc_tag<
...
#define BOOST_FT_self <boost/function_types/detail/pp_retag_default_cc/master.hpp>

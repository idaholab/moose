...
struct is_non_narrowing_conversion
    : mpl::and_<boost::is_convertible<Source, Destination>,
                mpl::not_<mpl::and_<
                    boost::is_arithmetic<Source>,
                    boost::is_arithmetic<Destination>,
                    mpl::or_<mpl::and_<is_integral<Destination>, mpl::not_<is_integral<Source>>>,
...
public:
  ...
  quantity() : val_() { BOOST_UNITS_CHECK_LAYOUT_COMPATIBILITY(this_type, Y); }
...
// on sun.
  ...
  explicit quantity(
      ...
      typename boost::disable_if<mpl::and_<
                                 ...
                                 typename detail::disable_if_is_same<Unit, Unit2>::type>::type * =
          0)
  ...
  quantity(
      const quantity<Unit2, YY> & source,
      typename boost::enable_if<mpl::and_<typename is_implicitly_convertible<Unit2, Unit>::type,
                                          detail::is_non_narrowing_conversion<YY, Y>>,
  ...
  {
    BOOST_STATIC_ASSERT(
        (boost::is_same<typename add_typeof_helper<Unit, Unit2>::type, Unit>::value));
    val_ += source.value();
    return *this;
  }
  ...
  {
    BOOST_STATIC_ASSERT(
        (boost::is_same<typename subtract_typeof_helper<Unit, Unit2>::type, Unit>::value));
    val_ -= source.value();
    return *this;
  }
  ...
  {
    BOOST_STATIC_ASSERT(
        (boost::is_same<typename multiply_typeof_helper<Unit, Unit2>::type, Unit>::value));
    val_ *= source.value();
    return *this;
  }
  ...
  {
    BOOST_STATIC_ASSERT(
        (boost::is_same<typename divide_typeof_helper<Unit, Unit2>::type, Unit>::value));
    val_ /= source.value();
    return *this;
  }
...
public:
  ...
  quantity(value_type val) : val_(val) { BOOST_UNITS_CHECK_LAYOUT_COMPATIBILITY(this_type, Y); }
  ...
  quantity(const quantity<unit<dimensionless_type, System2>, Y2> & source,
           ...
           typename boost::enable_if<
               boost::mpl::and_<detail::is_non_narrowing_conversion<Y2, Y>,
...
#ifdef __SUNPRO_CC
      typename boost::enable_if<
          boost::mpl::and_<boost::mpl::not_<detail::is_non_narrowing_conversion<Y2, Y>>,
                           detail::is_dimensionless_system<System2>>>::type * = 0
#else
  ...
  explicit quantity(
    ...
    : val_(conversion_helper<quantity<unit<dimensionless_type, System2>, Y2>, this_type>::convert(
               source)
               .value())
  {
    BOOST_UNITS_CHECK_LAYOUT_COMPATIBILITY(this_type, Y);
...
template <class Unit, class Y>
inline void
swap(quantity<Unit, Y> & lhs, quantity<Unit, Y> & rhs)
{
  using std::swap;
...
inline typename multiply_typeof_helper<unit<Dim, System>, Y>::type
...
template <class System, class Dim, class Y>
inline typename divide_typeof_helper<unit<Dim, System>, Y>::type
operator/(const unit<Dim, System> &, const Y & rhs)
{
...
template <class System, class Dim, class Y>
inline typename multiply_typeof_helper<Y, unit<Dim, System>>::type
...
template <class System, class Dim, class Y>
inline typename divide_typeof_helper<Y, unit<Dim, System>>::type
operator/(const Y & lhs, const unit<Dim, System> &)
{
...
/// runtime quantity times scalar
template <class Unit, class X>
inline typename multiply_typeof_helper<quantity<Unit, X>, X>::type
...
/// runtime quantity divided by scalar
template <class Unit, class X>
inline typename divide_typeof_helper<quantity<Unit, X>, X>::type
operator/(const quantity<Unit, X> & lhs, const X & rhs)
{
...
inline typename multiply_typeof_helper<unit<Dim1, System1>, quantity<Unit2, Y>>::type
...
template <class System1, class Dim1, class Unit2, class Y>
inline typename divide_typeof_helper<unit<Dim1, System1>, quantity<Unit2, Y>>::type
operator/(const unit<Dim1, System1> &, const quantity<Unit2, Y> & rhs)
{
...
inline typename multiply_typeof_helper<quantity<Unit1, Y>, unit<Dim2, System2>>::type
...
template <class Unit1, class System2, class Dim2, class Y>
inline typename divide_typeof_helper<quantity<Unit1, Y>, unit<Dim2, System2>>::type
operator/(const quantity<Unit1, Y> & lhs, const unit<Dim2, System2> &)
{
...
template <class Unit1, class Unit2, class X, class Y>
inline typename add_typeof_helper<quantity<Unit1, X>, quantity<Unit2, Y>>::type
...
template <class Unit1, class Unit2, class X, class Y>
inline typename subtract_typeof_helper<quantity<Unit1, X>, quantity<Unit2, Y>>::type
operator-(const quantity<Unit1, X> & lhs, const quantity<Unit2, Y> & rhs)
{
...
template <class Unit1, class Unit2, class X, class Y>
inline typename multiply_typeof_helper<quantity<Unit1, X>, quantity<Unit2, Y>>::type
operator*(const quantity<Unit1, X> & lhs, const quantity<Unit2, Y> & rhs)
{
...
template <class Unit1, class Unit2, class X, class Y>
inline typename divide_typeof_helper<quantity<Unit1, X>, quantity<Unit2, Y>>::type
operator/(const quantity<Unit1, X> & lhs, const quantity<Unit2, Y> & rhs)
{
...
template <class Unit, class X, class Y>
inline bool
operator==(const quantity<Unit, X> & val1, const quantity<Unit, Y> & val2)
{

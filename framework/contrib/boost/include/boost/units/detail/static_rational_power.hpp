...
struct static_int_power_impl<1, false>
{
  ...
  struct apply
  {
    ...
    static type call(const Y & y, const R & r) { return (y * r); }
  };
};
...
struct static_int_power_impl<0, true>
{
  ...
  {
    typedef R type;
    static R call(const Y &, const R & r) { return (r); }
  };
};
...
struct static_rational_power_impl<static_rational<N, 1>, Y>
{
  ...
  typedef typename impl::type type;
  static type call(const Y & y) { return (impl::call(y)); }
};

template <class R, class Y>
typename detail::static_rational_power_impl<R, Y>::type
static_rational_power(const Y & y)
{

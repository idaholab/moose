...
struct insertion_sort_dims_impl
{
  ...
  {
    typedef
        typename insertion_sort_dims_impl<N - 1>::template apply<typename Begin::next>::type next;
    typedef typename insertion_sort_dims_insert<(
...
{
  typedef typename insertion_sort_dims_impl<list<T, Next>::size::value>::template apply<
      list<T, Next>>::type type;
};
...
struct merge_dimensions_func<true, false>
{
  ...
  struct apply
  {
    typedef list<typename Begin1::item,
                 typename merge_dimensions_impl<N1 - 1, N2>::template apply<typename Begin1::next,
                                                                            Begin2>::type>
        type;
  };
};
...
struct merge_dimensions_func<false, true>
{
  ...
  struct apply
  {
    typedef list<typename Begin2::item,
                 typename merge_dimensions_impl<N2 - 1, N1>::template apply<typename Begin2::next,
                                                                            Begin1>::type>
        type;
  };
};
...
struct merge_dimensions_func<false, false>
{
  ...
  struct apply
  {
    ...
    typedef typename push_front_if<!is_empty_dim<combined>::value>::template apply<
        typename merge_dimensions_impl<N1 - 1, N2 - 1>::template apply<typename Begin1::next,
...
struct merge_dimensions_impl
{
  ...
  struct apply
  {
    ...
    typedef
        typename merge_dimensions_func<(mpl::less<dim1, dim2>::value == true),
                                       (mpl::less<dim2, dim1>::value ==
                                        true)>::template apply<Begin1, Begin2, N1, N2>::type type;
  };
};
...
struct iterator_to_list
{
  ...
  struct apply
  {
    typedef list<typename Begin::item,
...
struct static_inverse_impl
{
  ...
  struct apply
  {
    typedef list<typename mpl::negate<typename Begin::item>::type,

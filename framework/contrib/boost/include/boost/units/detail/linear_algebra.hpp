...
struct eliminate_from_pair_of_equations_impl
{
  ...
  struct apply
  {
    typedef list<typename mpl::minus<typename mpl::times<typename Begin1::item, X2>::type,
                                     typename mpl::times<typename Begin2::item, X1>::type>::type,
                 typename eliminate_from_pair_of_equations_impl<N - 1>::
                     template apply<typename Begin1::next, typename Begin2::next, X1, X2>::type>
        type;
  };
};
...
struct eliminate_from_pair_of_equations
{
  typedef E1 begin1;
  typedef E2 begin2;
  typedef typename eliminate_from_pair_of_equations_impl<(
      E1::size::value - 1)>::template apply<typename begin1::next,
...
{
  typedef list<static_rational<0>,
               typename create_row_of_identity<Column - 1, TotalColumns - 1>::type>
      type;
};
  ...
  struct apply
  {
    ...
    typedef typename determine_extra_equations_skip_zeros_impl<
        ...
        RowsBegin::size::value == 1>::template apply<RowsBegin,
                                                     ...
                                                     Result>
        column_info;
    typedef typename determine_extra_equations<RemainingColumns - 1,
                                               column_info::next_equations::size::value == 0>::
        template apply<typename column_info::next_equations,
                       TotalColumns,
...
struct determine_extra_equations<RemainingColumns, true>
{
  ...
  struct apply
  {
    typedef typename determine_extra_equations<RemainingColumns - 1, true>::template apply<
        RowsBegin,
        TotalColumns,
        list<typename create_row_of_identity<TotalColumns - RemainingColumns, TotalColumns>::type,
             Result>>::type type;
  };
};
...
struct invert_handle_inital_rows
{
  ...
  struct apply
  {
    typedef typename invert_handle_inital_rows<N - 1>::template apply<typename RowsBegin::next,
    ...
    typedef list<typename eliminate_from_pair_of_equations_impl<(
                     current_row::size::value)-1>::template apply<typename current_row::next,
                                                                  pivot_row,
        ...
        new_matrix;
    typedef list<typename eliminate_from_pair_of_equations_impl<(
                     current_identity_row::size::value)>::template apply<current_identity_row,
                                                                         identity_pivot_row,
                                                                         typename current_row::item,
                                                                         static_rational<1>>::type,
...
struct invert_handle_inital_rows<0>
{
  ...
  {
    typedef typename RowsBegin::item current_row;
    typedef typename invert_strip_leading_zeroes<(current_row::item::Numerator == 0),
                                                 (RowsBegin::size::value ==
                                                  1)>::template apply<RowsBegin, IdentityBegin>
        next;
    // results
...
struct invert_strip_leading_zeroes<false, false>
{
  ...
  struct apply
  {
    ...
    typedef typename divide_equation<(IdentityBegin::item::size::value)>::template apply<
        typename IdentityBegin::item,
        current_value>::type transformed_identity_equation;
    typedef typename invert_handle_after_pivot_row<(
        RowsBegin::size::value - 1)>::template apply<typename RowsBegin::next,
                                                     typename IdentityBegin::next,
                                                     new_equation,
...
struct invert_strip_leading_zeroes<true, false>
{
  ...
  struct apply
  {
    typedef typename RowsBegin::item current_row;
    typedef typename RowsBegin::next::item next_row;
    typedef typename invert_strip_leading_zeroes<next_row::item::Numerator == 0,
                                                 RowsBegin::size::value == 2>::
        template apply<typename RowsBegin::next, typename IdentityBegin::next>
            next;
    typedef typename IdentityBegin::item current_identity_row;
...
struct invert_handle_after_pivot_row
{
  ...
  {
    typedef
        typename invert_handle_after_pivot_row<N - 1>::template apply<typename RowsBegin::next,
                                                                      typename IdentityBegin::next,
                                                                      MatrixPivot,
                                                                      IdentityPivot>
            next;
...
struct invert_impl
{
  ...
  struct apply
  {
    typedef typename invert_handle_inital_rows<RowsBegin::size::value -
                                               N>::template apply<RowsBegin, IdentityBegin>
        process_column;
    typedef
        typename invert_impl<N - 1>::template apply<typename process_column::new_matrix,
                                                    typename process_column::identity_result>::type
            type;
  };
};
...
struct make_identity
{
  ...
  struct apply
  {
    typedef list<typename create_row_of_identity<Size - N, Size>::type,
...
struct make_square_and_invert
{
  ...
  typedef typename invert_impl<invertible::size::value>::template apply<
      invertible,
      typename make_identity<invertible::size::value>::template apply<
          invertible::size::value>::type>::type type;
};
...
struct find_base_dimensions_impl_impl
{
  ...
  struct apply
  {
    typedef typename find_base_dimensions_impl_impl<N - 1>::template apply<typename Begin::next,
                                                                           S>::type next;
...
struct find_base_dimensions_impl
{
  ...
  struct apply
  {
    typedef typename find_base_dimensions_impl_impl<(Begin::item::dimension_type::size::value)>::
        template apply<typename Begin::item::dimension_type,
                       typename find_base_dimensions_impl<N - 1>::template apply<
  ...
  struct apply
  {
    typedef typename calculate_base_dimension_coefficients_func<
        ...
        template apply<typename BaseUnitDimensions::item>
            result;
    typedef typename calculate_base_dimension_coefficients_impl<N - 1>::
        template apply<typename BaseUnitDimensions::next, Dim, list<typename result::type, T>>
            next_;
  ...
  struct apply
  {
    typedef typename calculate_base_dimension_coefficients_func<
        ...
        template apply<DimensionIterator>
            result;
    typedef list<typename result::type,
                 typename expand_dimensions<N - 1>::template apply<typename Begin::next,
                                                                   typename result::next>::type>
        type;
  };
};
...
struct create_unit_matrix
{
  ...
  {
    typedef
        typename create_unit_matrix<N - 1>::template apply<typename Begin::next, Dimensions>::type
            next;
    typedef list<typename expand_dimensions<Dimensions::size::value>::
...
struct multiply_add_units_impl
{
  ...
  struct apply
  {
    typedef list<typename mpl::plus<typename mpl::times<typename Begin2::item, X>::type,
...
struct multiply_add_units
{
  ...
  struct apply
  {
    typedef typename multiply_add_units_impl<(Begin2::item::size::value)>::template apply<
        typename multiply_add_units<N - 1>::template apply<typename Begin1::next,
...
struct is_simple_system_impl
{
  ...
  struct apply
  {
    ...
    typedef mpl::and_<typename test::type,
                      mpl::less<Prev, typename test::base_dimension_type>,
                      typename is_simple_system_impl<N - 1>::
                          template apply<typename Begin::next, typename test::base_dimension_type>>
        type;
...
struct is_simple_system
{
  typedef T Begin;
  typedef is_base_dimension_unit<typename Begin::item::dimension_type> test;
  typedef typename mpl::and_<typename test::type,
                             typename is_simple_system_impl<T::size::value - 1>::template apply<
...
struct calculate_base_unit_exponents_impl<true>
{
  ...
  struct apply
  {
    typedef typename expand_dimensions<(T::size::value)>::
        template apply<typename find_base_dimensions<T>::type, Dimensions>::type type;
  };
};
...
struct calculate_base_unit_exponents_impl<false>
{
  ...
  struct apply
  {
    ...
    typedef typename multiply_add_units<dimensions::size::value>::
        template apply<dimensions, typename base_solutions::type>::type units;

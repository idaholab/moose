...
struct solve_normal
{
  ...
  struct apply
  {
    ...
    typedef list<typename mpl::minus<typename mpl::times<X1, Y>::type,
...
struct solve_leading_zeroes
{
  ...
  struct apply
  {
    typedef list<typename Begin::item, typename Next::template apply<typename Begin::next>::type>
        type;
  };
...
struct make_solve_list_leading_zeroes
{
  ...
  {
    typedef
        typename make_solve_list_first_non_zero<typename Begin::item>::template apply<Begin,
                                                                                      N>::type type;
  };
};
...
struct make_homogeneous_system_func<T, false>
{
  ...
  {
    typedef
        typename make_homogeneous_system_impl<N -
                                              1>::template apply<typename Begin::next,
                                                                 list<T, Current>,
...
struct make_homogeneous_system_impl
{
  ...
  struct apply
  {
    ...
    typedef
        typename try_add_unit_impl<Current::size::value>::template apply<Current, dimensions>::type
            new_element;
    typedef typename make_solve_list_leading_zeroes<new_element::size::value>::template apply<
        new_element>::type new_func;
    typedef typename make_homogeneous_system_func<new_func,
...
struct make_homogeneous_system
{
  ...
  typedef homogeneous_system<typename insertion_sort<
      typename make_homogeneous_system_impl<Units::size::value>::
          template apply<Units, dimensionless_type, dimensionless_type, base_dimensions>::type>::
                                 type>
      type;
};
...
struct extract_base_units
{
  ...
  struct apply
  {
    typedef list<typename Begin::item::tag_type,

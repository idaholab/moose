...
/// INTERNAL ONLY
template <>
struct less_impl<boost::units::heterogeneous_system_dim_tag,
...
/// INTERNAL ONLY
template <>
struct plus_impl<boost::units::heterogeneous_system_dim_tag,
                 boost::units::heterogeneous_system_dim_tag>
{
  template <class T0, class T1>
  struct apply
...
/// INTERNAL ONLY
template <>
struct times_impl<boost::units::heterogeneous_system_dim_tag,
...
/// INTERNAL ONLY
template <>
struct divides_impl<boost::units::heterogeneous_system_dim_tag,
                    boost::units::detail::static_rational_tag>
{
  template <class T0, class T1>
  struct apply
...
struct negate_impl<boost::units::heterogeneous_system_dim_tag>
{
  ...
  struct apply
  {
    typedef boost::units::heterogeneous_system_dim<
        typename T::tag_type,
        typename mpl::negate<typename T::value_type>::type>
        type;
  };
};
...
struct make_heterogeneous_system_impl
{
  ...
  {
    typedef
        typename push_front_if<!(is_zero<typename ExponentsBegin::item>::value)>::template apply<
            typename make_heterogeneous_system_impl<N - 1>::
                template apply<typename UnitsBegin::next, typename ExponentsBegin::next>::type,
            heterogeneous_system_dim<typename UnitsBegin::item,
                                     typename ExponentsBegin::item>>::type type;
  };
};
...
struct make_heterogeneous_system
{
  ...
  BOOST_MPL_ASSERT_MSG((!boost::is_same<exponents, inconsistent>::value),
...
struct unscale_heterogeneous_system_impl
{
  ...
  struct apply
  {
    typedef typename push_front_or_add<typename unscale_heterogeneous_system_impl<
                                           N - 1>::template apply<typename Begin::next>::type,
...
struct unscale<heterogeneous_system<T>>
{
  typedef heterogeneous_system<
      heterogeneous_system_impl<typename detail::unscale_heterogeneous_system_impl<
...
struct get_scale_list_of_heterogeneous_system_impl
{
  ...
  struct apply
  {
    typedef typename mpl::times<typename get_scale_list_of_heterogeneous_system_impl<
                                    N - 1>::template apply<typename Begin::next>::type,
...
{
  typedef typename mpl::times<typename detail::get_scale_list_of_heterogeneous_system_impl<
                                  T::type::size::value>::template apply<typename T::type>::type,
...
struct check_system<heterogeneous_system<heterogeneous_system_impl<System, Dimension, Scale>>,
                    Dimension> : mpl::true_
{
};

...
#define BOOST_PP_ENUM_TRAILING                                                                     \
  BOOST_PP_CAT(BOOST_PP_ENUM_TRAILING_, BOOST_PP_AUTO_REC(BOOST_PP_REPEAT_P, 4))
#
...
#define BOOST_PP_ENUM_TRAILING_M_1(z, n, md)                                                       \
  BOOST_PP_ENUM_TRAILING_M_1_IM(z, n, BOOST_PP_TUPLE_REM_2 md)
#define BOOST_PP_ENUM_TRAILING_M_2(z, n, md)                                                       \
  BOOST_PP_ENUM_TRAILING_M_2_IM(z, n, BOOST_PP_TUPLE_REM_2 md)
#define BOOST_PP_ENUM_TRAILING_M_3(z, n, md)                                                       \
  BOOST_PP_ENUM_TRAILING_M_3_IM(z, n, BOOST_PP_TUPLE_REM_2 md)
...
#else
#define BOOST_PP_ENUM_TRAILING_M_1(z, n, md)                                                       \
  BOOST_PP_ENUM_TRAILING_M_1_I(z, n, BOOST_PP_TUPLE_ELEM(2, 0, md), BOOST_PP_TUPLE_ELEM(2, 1, md))
#define BOOST_PP_ENUM_TRAILING_M_2(z, n, md)                                                       \
  BOOST_PP_ENUM_TRAILING_M_2_I(z, n, BOOST_PP_TUPLE_ELEM(2, 0, md), BOOST_PP_TUPLE_ELEM(2, 1, md))
#define BOOST_PP_ENUM_TRAILING_M_3(z, n, md)                                                       \
  BOOST_PP_ENUM_TRAILING_M_3_I(z, n, BOOST_PP_TUPLE_ELEM(2, 0, md), BOOST_PP_TUPLE_ELEM(2, 1, md))
#endif
#

...
struct static_gcd_helper2_t
{
  ...
  struct helper
  {
    BOOST_STATIC_CONSTANT(
        static_gcd_type,
        value = static_gcd_helper2_t<Value2>::BOOST_NESTED_TEMPLATE helper<Value1 % Value2>::value);
  };
...
struct static_gcd_helper_t
{
  BOOST_STATIC_CONSTANT(
      static_gcd_type,
      value = static_gcd_helper2_t<Value1>::BOOST_NESTED_TEMPLATE helper<Value2>::value);
};
#endif
...
struct static_lcm_helper_t
{
  BOOST_STATIC_CONSTANT(
      static_gcd_type,
      value = static_lcm_helper2_t<Value1>::BOOST_NESTED_TEMPLATE helper<Value2>::value);
};
#endif
...
template <static_gcd_type Value1, static_gcd_type Value2>
struct static_gcd
    : public mpl::integral_c<static_gcd_type, (detail::static_gcd_helper_t<Value1, Value2>::value)>
{
...
template <static_gcd_type Value1, static_gcd_type Value2>
struct static_lcm
    : public mpl::integral_c<static_gcd_type, (detail::static_lcm_helper_t<Value1, Value2>::value)>
{

...
#define BOOST_MATH_META_INT(type, name, Default)                                                   \
  ...
  template <class T>                                                                               \
  struct is_##name                                                                                 \
      : public boost::mpl::bool_<::boost::math::policies::detail::is_##name##_imp<T>::value>       \
  {                                                                                                \
  };
...
#define BOOST_MATH_META_INT(Type, name, Default)                                                   \
  ...
  {                                                                                                \
    ...
    BOOST_STATIC_CONSTANT(                                                                         \
        bool,                                                                                      \
        value = sizeof(::boost::math::policies::detail::is_##name##_tester<T>::test(inst)) == 1);  \
  };                                                                                               \
  }                                                                                                \
  template <class T>                                                                               \
  struct is_##name                                                                                 \
...
struct precision
{
  ...
  //
  typedef typename mpl::if_c<(Digits10::value == 0),
                             digits2<0>,
...
public:
  ...
  typedef typename mpl::if_c<
      (Digits2::value >
       ::boost::math::policies::detail::precision<Digits10, Digits2>::digits2_type::value),
      Digits2,
      digits2_type>::type type;
#else
  typedef
      typename mpl::if_c<(Digits2::value > digits2_type::value), Digits2, digits2_type>::type type;
#endif
};
...
public:
  typedef
      typename select_result<DefaultType, iter, ::boost::is_same<iter, end_type>::value>::type type;
};
...
struct is_valid_policy_imp
{
  BOOST_STATIC_CONSTANT(
      bool,
      value = sizeof(::boost::math::policies::detail::test_is_valid_arg(static_cast<T *>(0))) == 1);
};
...
struct is_valid_policy
    : public mpl::bool_<::boost::math::policies::detail::is_valid_policy_imp<T>::value>
{
};

template <class T>
struct is_default_policy
    : public mpl::bool_<::boost::math::policies::detail::is_default_policy_imp<T>::value>
{
  template <class U>
  struct apply
  {
...
public:
  ...
  typedef typename detail::find_arg<arg_list, is_denorm_error<mpl::_1>, denorm_error<>>::type
      denorm_error_type;
  typedef
      typename detail::find_arg<arg_list, is_evaluation_error<mpl::_1>, evaluation_error<>>::type
...
private:
  ...
  typedef
      typename detail::find_arg<arg_list, is_digits2<mpl::_1>, digits2<>>::type bits_precision_type;
...
public:
  ...
  //
  typedef
      typename detail::find_arg<arg_list, is_discrete_quantile<mpl::_1>, discrete_quantile<>>::type
          discrete_quantile_type;
  //
  // Mathematically undefined properties:
  //
  typedef
      typename detail::find_arg<arg_list, is_assert_undefined<mpl::_1>, assert_undefined<>>::type
...
private:
  ...
  typedef
      typename detail::find_arg<arg_list,
                                ...
                                typename Policy::underflow_error_type>::type underflow_error_type;
  typedef typename detail::find_arg<arg_list,
  ...
  typedef
      typename detail::find_arg<arg_list,
                                ...
                                typename Policy::evaluation_error_type>::type evaluation_error_type;
  typedef typename detail::find_arg<arg_list,
  ...
  typedef
      typename detail::find_arg<arg_list,
                                ...
                                typename Policy::assert_undefined_type>::type assert_undefined_type;
  //
  // Max iterations:
  //
  typedef typename detail::find_arg<arg_list,
  ...
  //
  typedef mpl::vector<domain_error_type,
                      pole_error_type,
                      overflow_error_type,
                      underflow_error_type,
                      denorm_error_type,
  ...
  //
  typedef
      typename mpl::remove_if<result_list, detail::is_default_policy<mpl::_>>::type reduced_list;
  //
  // Pad out the list with defaults:
  //
  typedef
      typename detail::append_N<reduced_list,
                                default_policy,
...
inline BOOST_MATH_CONSTEXPR policy<>
make_policy() BOOST_NOEXCEPT
{
  return policy<>();
}
...
make_policy(
    const A1 &, const A2 &, const A3 &, const A4 &, const A5 &, const A6 &, const A7 &, const A8 &)
    BOOST_NOEXCEPT
{
...
template <class A1,
          ...
          class A11>
inline BOOST_MATH_CONSTEXPR
    typename normalise<policy<>, A1, A2, A3, A4, A5, A6, A7, A8, A9, A10, A11>::type
    make_policy(const A1 &,
                const A2 &,
                const A3 &,
                const A4 &,
...
{
  typedef
      typename normalise<policy<>, A1, A2, A3, A4, A5, A6, A7, A8, A9, A10, A11>::type result_type;
  return result_type();
}
...
struct precision
{
  ...
  typedef
      typename mpl::if_<mpl::equal_to<digits_t, mpl::int_<0>>,
                        // Possibly unknown precision:
                        precision_type,
                        typename mpl::if_<mpl::or_<mpl::less_equal<digits_t, precision_type>,
...
struct precision
{
  ...
  typedef typename mpl::if_c<
      ...
      // Possibly unknown precision:
      precision_type,
      typename mpl::if_c<((::std::numeric_limits<Real>::digits <= precision_type::value) ||
...
digits_imp(mpl::true_ const &) BOOST_NOEXCEPT
{
...
template <class T, class Policy>
inline BOOST_MATH_CONSTEXPR int
digits_imp(mpl::false_ const &) BOOST_NOEXCEPT
{
...
{
  static T get() BOOST_MATH_NOEXCEPT(T) { return ldexp(T(1.0), 1 - Digits::value); }
};
...
{
  BOOST_STATIC_CONSTANT(boost::uintmax_t,
                        v = static_cast<boost::uintmax_t>(1u) << (Digits::value - 1));

  static BOOST_MATH_CONSTEXPR T get() BOOST_MATH_NOEXCEPT(T) { return 1 / static_cast<T>(v); }
};
template <class T, class Digits>
...
get_epsilon_imp(mpl::true_ const &) BOOST_MATH_NOEXCEPT(T)
{
#ifndef BOOST_NO_LIMITS_COMPILE_TIME_CONSTANTS
  BOOST_STATIC_ASSERT(::std::numeric_limits<T>::is_specialized);
...
template <class T, class Policy>
inline BOOST_MATH_CONSTEXPR T
get_epsilon_imp(mpl::false_ const &) BOOST_MATH_NOEXCEPT(T)
{
...
struct is_policy_imp
{
  BOOST_STATIC_CONSTANT(
      bool,
      value = (sizeof(::boost::math::policies::detail::test_is_policy(static_cast<P *>(0))) == 1));
};
}

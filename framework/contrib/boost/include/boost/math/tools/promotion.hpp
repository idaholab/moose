  ...
  typedef typename mpl::if_<
      ...
      typename mpl::if_<
          typename mpl::or_<is_same<__float128, T1P>,
                            is_same<__float128, T2P>>::type, // either long double?
          __float128,
#endif
          typename mpl::if_<
              ...
              typename mpl::if_<typename mpl::or_<is_same<double, T1P>,
                                                  is_same<double, T2P>>::type, // either double?
      ...
      typename mpl::if_<
          typename mpl::and_<mpl::not_<is_floating_point<T2P>>, ::boost::is_convertible<T1P, T2P>>,
          T2P,
          T1P>::type>::type type;
}; // promote_arg2
// These full specialisations reduce mpl::if_ usage and speed up
...
struct promote_args
{
  typedef typename promote_args_2<
      ...
      typename promote_args_2<
          ...
          typename promote_args_2<
              ...
              typename promote_args_2<typename remove_cv<T4>::type,
                                      typename promote_args_2<typename remove_cv<T5>::type,
                                                              typename remove_cv<T6>::type>::type>::
  ...
  //
  BOOST_STATIC_ASSERT_MSG((0 == ::boost::is_same<type, long double>::value),

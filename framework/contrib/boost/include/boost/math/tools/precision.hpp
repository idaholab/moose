...
#endif
  return std::numeric_limits<T>::radix == 2 ? std::numeric_limits<T>::digits
...
log_max_value(const mpl::int_<128> & BOOST_MATH_APPEND_EXPLICIT_TEMPLATE_TYPE(T))
...
template <class T>
inline BOOST_MATH_CONSTEXPR T
log_min_value(const mpl::int_<128> & BOOST_MATH_APPEND_EXPLICIT_TEMPLATE_TYPE(T))
    BOOST_MATH_NOEXCEPT(T)
{
  return -87.0f;
}
...
template <class T>
inline BOOST_MATH_CONSTEXPR T
log_max_value(const mpl::int_<1024> & BOOST_MATH_APPEND_EXPLICIT_TEMPLATE_TYPE(T))
    BOOST_MATH_NOEXCEPT(T)
{
  return 709.0;
}
...
template <class T>
inline BOOST_MATH_CONSTEXPR T
log_min_value(const mpl::int_<1024> & BOOST_MATH_APPEND_EXPLICIT_TEMPLATE_TYPE(T))
    BOOST_MATH_NOEXCEPT(T)
{
  return -708.0;
}
...
template <class T>
inline BOOST_MATH_CONSTEXPR T
log_max_value(const mpl::int_<16384> & BOOST_MATH_APPEND_EXPLICIT_TEMPLATE_TYPE(T))
    BOOST_MATH_NOEXCEPT(T)
{
  return 11356.0L;
}
...
template <class T>
inline BOOST_MATH_CONSTEXPR T
log_min_value(const mpl::int_<16384> & BOOST_MATH_APPEND_EXPLICIT_TEMPLATE_TYPE(T))
    BOOST_MATH_NOEXCEPT(T)
{
  return -11355.0L;
}
...
template <class T>
inline T
log_max_value(const mpl::int_<0> & BOOST_MATH_APPEND_EXPLICIT_TEMPLATE_TYPE(T))
{
...
template <class T>
inline T
log_min_value(const mpl::int_<0> & BOOST_MATH_APPEND_EXPLICIT_TEMPLATE_TYPE(T))
{
  BOOST_MATH_STD_USING
#ifdef __SUNPRO_CC
...
template <class T>
inline BOOST_MATH_CONSTEXPR T
epsilon(const mpl::true_ & BOOST_MATH_APPEND_EXPLICIT_TEMPLATE_TYPE(T)) BOOST_MATH_NOEXCEPT(T)
{
...
template <>
inline BOOST_MATH_CONSTEXPR long double
epsilon<long double>(const mpl::true_ & BOOST_MATH_APPEND_EXPLICIT_TEMPLATE_TYPE(long double))
...
template <class T>
inline T
epsilon(const mpl::false_ & BOOST_MATH_APPEND_EXPLICIT_TEMPLATE_TYPE(T))
{
...
{
  typedef
      typename mpl::if_c<(std::numeric_limits<T>::radix == 2) &&
                             (std::numeric_limits<T>::max_exponent == 128 ||
                              std::numeric_limits<T>::max_exponent == 1024 ||
                              std::numeric_limits<T>::max_exponent == 16384),
                         mpl::int_<(std::numeric_limits<T>::max_exponent > INT_MAX
                                        ? INT_MAX
...
template <class T>
struct log_limit_noexcept_traits_imp<T, false> : public boost::integral_constant<bool, false>
{
};
...
template <class T>
inline BOOST_MATH_CONSTEXPR T log_max_value(BOOST_MATH_EXPLICIT_TEMPLATE_TYPE(T))
...
template <class T>
inline BOOST_MATH_CONSTEXPR T log_min_value(BOOST_MATH_EXPLICIT_TEMPLATE_TYPE(T))
    BOOST_NOEXCEPT_IF(detail::log_limit_noexcept_traits<T>::value)
{
#ifndef BOOST_NO_LIMITS_COMPILE_TIME_CONSTANTS
...
#else
  return ::std::numeric_limits<T>::is_specialized ? detail::epsilon<T>(mpl::true_())
...
template <class T>
inline BOOST_MATH_CONSTEXPR T
root_epsilon_imp(const mpl::int_<24> &) BOOST_MATH_NOEXCEPT(T)
{
...
template <class T>
inline BOOST_MATH_CONSTEXPR T
root_epsilon_imp(const T *, const mpl::int_<53> &) BOOST_MATH_NOEXCEPT(T)
{
...
template <class T>
inline BOOST_MATH_CONSTEXPR T
root_epsilon_imp(const T *, const mpl::int_<64> &) BOOST_MATH_NOEXCEPT(T)
{
...
template <class T>
inline BOOST_MATH_CONSTEXPR T
root_epsilon_imp(const T *, const mpl::int_<113> &) BOOST_MATH_NOEXCEPT(T)
{
...
inline T
root_epsilon_imp(const T *, const Tag &)
{
  BOOST_MATH_STD_USING
...
template <class T>
inline BOOST_MATH_CONSTEXPR T
cbrt_epsilon_imp(const mpl::int_<24> &) BOOST_MATH_NOEXCEPT(T)
{
...
template <class T>
inline BOOST_MATH_CONSTEXPR T
cbrt_epsilon_imp(const T *, const mpl::int_<53> &) BOOST_MATH_NOEXCEPT(T)
{
...
template <class T>
inline BOOST_MATH_CONSTEXPR T
cbrt_epsilon_imp(const T *, const mpl::int_<64> &) BOOST_MATH_NOEXCEPT(T)
{
...
template <class T>
inline BOOST_MATH_CONSTEXPR T
cbrt_epsilon_imp(const T *, const mpl::int_<113> &) BOOST_MATH_NOEXCEPT(T)
{
...
template <class T, class Tag>
inline T
cbrt_epsilon_imp(const T *, const Tag &)
{
  BOOST_MATH_STD_USING;
...
template <class T>
inline BOOST_MATH_CONSTEXPR T
forth_root_epsilon_imp(const T *, const mpl::int_<24> &) BOOST_MATH_NOEXCEPT(T)
{
...
template <class T>
inline BOOST_MATH_CONSTEXPR T
forth_root_epsilon_imp(const T *, const mpl::int_<53> &) BOOST_MATH_NOEXCEPT(T)
{
...
template <class T>
inline BOOST_MATH_CONSTEXPR T
forth_root_epsilon_imp(const T *, const mpl::int_<64> &) BOOST_MATH_NOEXCEPT(T)
{
...
template <class T>
inline BOOST_MATH_CONSTEXPR T
forth_root_epsilon_imp(const T *, const mpl::int_<113> &) BOOST_MATH_NOEXCEPT(T)
{
...
template <class T, class Tag>
inline T
forth_root_epsilon_imp(const T *, const Tag &)
{
  BOOST_MATH_STD_USING
...
{
  typedef mpl::int_<(::std::numeric_limits<T>::radix == 2) ? std::numeric_limits<T>::digits : 0>
      tag_type;
  BOOST_STATIC_CONSTANT(bool,
                        has_noexcept = (tag_type::value == 113) || (tag_type::value == 64) ||
                                       (tag_type::value == 53) || (tag_type::value == 24));
};
}
...
inline BOOST_MATH_CONSTEXPR T
root_epsilon()
    BOOST_NOEXCEPT_IF(BOOST_MATH_IS_FLOAT(T) && detail::root_epsilon_traits<T>::has_noexcept)
{
  return detail::root_epsilon_imp(static_cast<T const *>(0),
...
cbrt_epsilon()
    BOOST_NOEXCEPT_IF(BOOST_MATH_IS_FLOAT(T) && detail::root_epsilon_traits<T>::has_noexcept)
{
  return detail::cbrt_epsilon_imp(static_cast<T const *>(0),
                                  typename detail::root_epsilon_traits<T>::tag_type());
}
...
forth_root_epsilon()
    BOOST_NOEXCEPT_IF(BOOST_MATH_IS_FLOAT(T) && detail::root_epsilon_traits<T>::has_noexcept)
{
  return detail::forth_root_epsilon_imp(static_cast<T const *>(0),
                                        typename detail::root_epsilon_traits<T>::tag_type());
}

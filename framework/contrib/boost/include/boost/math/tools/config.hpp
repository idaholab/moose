...
#define BOOST_MATH_APPEND_EXPLICIT_TEMPLATE_TYPE(t) , BOOST_MATH_EXPLICIT_TEMPLATE_TYPE(t)
#define BOOST_MATH_APPEND_EXPLICIT_TEMPLATE_TYPE_SPEC(t) , BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(t)
...
#define BOOST_MATH_APPEND_EXPLICIT_TEMPLATE_NON_TYPE_SPEC(t, v)
    ...
    !defined(BOOST_MATH_SMALL_CONSTANT)
...
//
        ...
        !defined(BOOST_MATH_DISABLE_FLOAT128) ||                                                   \
    defined(BOOST_MATH_USE_FLOAT128)
//
...
#if defined(BOOST_INTEL) && defined(BOOST_INTEL_CXX_VERSION) &&                                    \
    (BOOST_INTEL_CXX_VERSION >= 1310) && defined(__GNUC__)
...
template <class T>
inline T max
BOOST_PREVENT_MACRO_SUBSTITUTION(T a, T b, T c) BOOST_MATH_NOEXCEPT(T)
{
...
template <class T>
inline T max
BOOST_PREVENT_MACRO_SUBSTITUTION(T a, T b, T c, T d) BOOST_MATH_NOEXCEPT(T)
{
...
template <class T>
void
suppress_unused_variable_warning(const T &) BOOST_MATH_NOEXCEPT(T)
{
}
...
#if ((defined(__linux__) && !defined(__UCLIBC__) && !defined(BOOST_MATH_HAVE_FIXED_GLIBC)) ||      \
     defined(__QNX__) || defined(__IBMCPP__)) &&                                                   \
    !defined(BOOST_NO_FENV_H)
//
// This code was introduced in response to this glibc bug:
// http://sourceware.org/bugzilla/show_bug.cgi?id=2445
// Basically powl and expl can return garbage when the result is small and certain exception flags
// are set
// on entrance to these functions.  This appears to have been fixed in Glibc 2.14 (May 2011).
// Much more information in this message thread:
// https://groups.google.com/forum/#!topic/boost-list/ZT99wtIFlb4
//

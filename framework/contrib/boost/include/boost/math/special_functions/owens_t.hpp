...
inline RealType
owens_t_znorm1(const RealType x)
{
...
template <typename RealType>
inline RealType
owens_t_znorm2(const RealType x)
{
  using namespace boost::math::constants;
...
owens_t_compute_code(const RealType h, const RealType a)
{
  ...
  */
  ...
  static const unsigned short select[] = {
      0,  0,  1,  12, 12, 12, 12, 12, 12, 12, 12, 15, 15, 15, 8,  0,  1,  1,  2,  2,
      4,  4,  13, 13, 14, 14, 15, 15, 15, 8,  1,  1,  2,  2,  2,  4,  4,  14, 14, 14,
      14, 15, 15, 15, 9,  1,  1,  2,  4,  4,  4,  4,  6,  6,  15, 15, 15, 15, 15, 9,
      1,  2,  2,  4,  4,  5,  5,  7,  7,  16, 16, 16, 11, 11, 10, 1,  2,  4,  4,  4,
      5,  5,  7,  7,  16, 16, 16, 11, 11, 11, 1,  2,  3,  3,  5,  5,  7,  7,  16, 16,
      16, 16, 16, 11, 11, 1,  2,  3,  3,  5,  5,  17, 17, 17, 17, 16, 16, 16, 11, 11};
...
template <typename RealType>
inline unsigned short
owens_t_get_order_imp(const unsigned short icode, RealType, const mpl::int_<53> &)
{
  static const unsigned short ord[] = {
      2, 3, 4, 5, 7, 10, 12, 18, 10, 20, 30, 0, 4, 7, 8, 20, 0, 0}; // 18 entries
...
template <typename RealType>
inline unsigned short
owens_t_get_order_imp(const unsigned short icode, RealType, const mpl::int_<64> &)
{
  // method ================>>>       {1, 1, 1, 1, 1,  1,  1,  1,  2,  2,  2,  3, 4,  4,  4,  4,  5,
  // 6}
  static const unsigned short ord[] = {
      3, 4, 5, 6, 8, 11, 13, 19, 10, 20, 30, 0, 7, 10, 11, 23, 0, 0}; // 18 entries
...
inline unsigned short
owens_t_get_order(const unsigned short icode, RealType r, const Policy &)
{
  typedef typename policies::precision<RealType, Policy>::type precision_type;
  typedef typename mpl::if_<mpl::or_<mpl::less_equal<precision_type, mpl::int_<0>>,
...
template <typename RealType, typename Policy>
inline RealType
owens_t_T1(const RealType h, const RealType a, const unsigned short m, const Policy & pol)
{
           ...
           const mpl::false_ &)
{
  ...
  return val;
} // RealType owens_t_T2(const RealType h, const RealType a, const unsigned short m, const RealType
  // ah)

// compute the value of Owen's T function with method T3 from the reference paper
template <typename RealType>
inline RealType
owens_t_T3_imp(const RealType h, const RealType a, const RealType ah, const mpl::int_<53> &)
{
  BOOST_MATH_STD_USING
  using namespace boost::math::constants;
  ...
  static const RealType c2[] = {static_cast<RealType>(0.99999999999999987510),
                                static_cast<RealType>(-0.99999999999988796462),
                                static_cast<RealType>(0.99999999998290743652),
                                static_cast<RealType>(-0.99999999896282500134),
                                static_cast<RealType>(0.99999996660459362918),
                                static_cast<RealType>(-0.99999933986272476760),
                                static_cast<RealType>(0.99999125611136965852),
                                static_cast<RealType>(-0.99991777624463387686),
                                static_cast<RealType>(0.99942835555870132569),
                                static_cast<RealType>(-0.99697311720723000295),
                                static_cast<RealType>(0.98751448037275303682),
                                static_cast<RealType>(-0.95915857980572882813),
                                static_cast<RealType>(0.89246305511006708555),
                                static_cast<RealType>(-0.76893425990463999675),
                                static_cast<RealType>(0.58893528468484693250),
                                static_cast<RealType>(-0.38380345160440256652),
                                static_cast<RealType>(0.20317601701045299653),
                                static_cast<RealType>(-0.82813631607004984866E-01),
                                static_cast<RealType>(0.24167984735759576523E-01),
                                static_cast<RealType>(-0.44676566663971825242E-02),
                                static_cast<RealType>(0.39141169402373836468E-03)};
...
inline RealType
owens_t_T3_imp(const RealType h, const RealType a, const RealType ah, const mpl::int_<64> &)
{
  BOOST_MATH_STD_USING
  using namespace boost::math::constants;
...
inline RealType
owens_t_T3(const RealType h, const RealType a, const RealType ah, const Policy &)
{
  typedef typename policies::precision<RealType, Policy>::type precision_type;
  typedef typename mpl::if_<mpl::or_<mpl::less_equal<precision_type, mpl::int_<0>>,
                                     mpl::greater<precision_type, mpl::int_<53>>>,
...
template <typename RealType>
inline RealType
owens_t_T4(const RealType h, const RealType a, const unsigned short m)
{
  BOOST_MATH_STD_USING
  using namespace boost::math::constants;
  ...
  unsigned short ii = 1;
  RealType ai = a * exp(-hs * (static_cast<RealType>(1) - as) * half<RealType>()) *
                one_div_two_pi<RealType>();
  RealType yi = 1;
  RealType val = 0;
...
template <typename RealType>
inline RealType
owens_t_T5_imp(const RealType h, const RealType a, const mpl::int_<53> &)
{
  BOOST_MATH_STD_USING
  /*
     NOTICE:
  ...
  static const RealType pts[] = {static_cast<RealType>(0.35082039676451715489E-02),
                                 static_cast<RealType>(0.31279042338030753740E-01),
                                 static_cast<RealType>(0.85266826283219451090E-01),
                                 static_cast<RealType>(0.16245071730812277011),
                                 static_cast<RealType>(0.25851196049125434828),
                                 static_cast<RealType>(0.36807553840697533536),
                                 static_cast<RealType>(0.48501092905604697475),
                                 static_cast<RealType>(0.60277514152618576821),
                                 static_cast<RealType>(0.71477884217753226516),
                                 static_cast<RealType>(0.81475510988760098605),
                                 static_cast<RealType>(0.89711029755948965867),
                                 static_cast<RealType>(0.95723808085944261843),
                                 static_cast<RealType>(0.99178832974629703586)};
  static const RealType wts[] = {static_cast<RealType>(0.18831438115323502887E-01),
                                 static_cast<RealType>(0.18567086243977649478E-01),
                                 static_cast<RealType>(0.18042093461223385584E-01),
                                 static_cast<RealType>(0.17263829606398753364E-01),
                                 static_cast<RealType>(0.16243219975989856730E-01),
                                 static_cast<RealType>(0.14994592034116704829E-01),
                                 static_cast<RealType>(0.13535474469662088392E-01),
                                 static_cast<RealType>(0.11886351605820165233E-01),
                                 static_cast<RealType>(0.10070377242777431897E-01),
                                 static_cast<RealType>(0.81130545742299586629E-02),
                                 static_cast<RealType>(0.60419009528470238773E-02),
                                 static_cast<RealType>(0.38862217010742057883E-02),
                                 static_cast<RealType>(0.16793031084546090448E-02)};
...
template <typename RealType>
inline RealType
owens_t_T5_imp(const RealType h, const RealType a, const mpl::int_<64> &)
{
  BOOST_MATH_STD_USING
  /*
    NOTICE:
  ...
  */
  ...
  static const RealType pts[] = {BOOST_MATH_BIG_CONSTANT(RealType, 64, 0.0016634282895983227941),
  ...
  static const RealType wts[] = {BOOST_MATH_BIG_CONSTANT(RealType, 64, 0.012975111395684900835),
...
template <class RealType, class Policy>
inline RealType
owens_t_T5(const RealType h, const RealType a, const Policy &)
{
  typedef typename policies::precision<RealType, Policy>::type precision_type;
  typedef typename mpl::if_<mpl::or_<mpl::less_equal<precision_type, mpl::int_<0>>,
                                     mpl::greater<precision_type, mpl::int_<53>>>,
...
template <typename RealType>
inline RealType
owens_t_T6(const RealType h, const RealType a)
{
  BOOST_MATH_STD_USING
  using namespace boost::math::constants;
...
std::pair<T, T>
owens_t_T1_accelerated(T h, T a, const Policy & pol)
{
  //
...
owens_t_T2_accelerated(const RealType h, const RealType a, const RealType ah, const Policy &)
{
  //
  ...
  for (int k = 0; k < n; ++k)
  {
    ...
    //
    if ((fabs(z) > last_z) // Series has gone divergent, abort
        ||
  ...
  return std::pair<RealType, RealType>(
      val * exp(-hs * half<RealType>()) / (d * root_two_pi<RealType>()), err);
} // RealType owens_t_T2_accelerated(const RealType h, const RealType a, const RealType ah, const
  // Policy&)

template <typename RealType, typename Policy>
inline RealType
T4_mp(const RealType h, const RealType a, const Policy & pol)
{
  BOOST_MATH_STD_USING
...
template <typename RealType, typename Policy>
inline RealType
owens_t_dispatch(const RealType h,
                 const RealType a,
                 const RealType ah,
                 const Policy & pol,
                 mpl::int_<64> const &)
{
  ...
  static const unsigned short meth[] = {
      1, 1, 1, 1, 1, 1, 1, 1, 2, 2, 2, 3, 4, 4, 4, 4, 5, 6}; // 18 entries
                 ...
                 const mpl::int_<65> &)
{
  ...
  typedef typename boost::math::policies::normalise<Policy,
                                                    boost::math::policies::evaluation_error<>>::type
      forwarding_policy;
  std::pair<RealType, RealType> p1(0, tools::max_value<RealType>()),
      p2(0, tools::max_value<RealType>());
...
inline RealType
owens_t_dispatch(
    const RealType h, const RealType a, const RealType ah, const Policy & pol, const mpl::int_<0> &)
{
...
template <typename RealType, typename Policy>
inline RealType
owens_t_dispatch(const RealType h, const RealType a, const RealType ah, const Policy & pol)
{
  ...
  typedef typename mpl::if_c<
      ...
      mpl::int_<0>,
      typename mpl::if_c<precision_type::value <= 64, mpl::int_<64>, mpl::int_<65>>::type>::type
      tag_type;
...
template <typename RealType, class Policy>
inline RealType
owens_t(RealType h, RealType a, const Policy & pol)
{
  BOOST_MATH_STD_USING
...
template <class T, class Policy, class tag>
const typename owens_t_initializer<T, Policy, tag>::init
    owens_t_initializer<T, Policy, tag>::initializer;

} // namespace detail

template <class T1, class T2, class Policy>
inline typename tools::promote_args<T1, T2>::type
owens_t(T1 h, T2 a, const Policy & pol)
{
  ...
  return policies::checked_narrowing_cast<result_type, Policy>(
      detail::owens_t(static_cast<value_type>(h), static_cast<value_type>(a), pol),
      "boost::math::owens_t<%1%>(%1%,%1%)");
}

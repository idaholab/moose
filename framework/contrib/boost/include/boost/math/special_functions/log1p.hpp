...
T
log1p_imp(T const & x, const Policy & pol, const mpl::int_<0> &)
{ // The function returns the natural logarithm of 1 + x.
  ...
  result_type zero = 0;
  result_type result =
      tools::sum_series(s, policies::get_epsilon<result_type, Policy>(), max_iter, zero);
#endif
...
template <class T, class Policy>
T
log1p_imp(T const & x, const Policy & pol, const mpl::int_<53> &)
{ // The function returns the natural logarithm of 1 + x.
  BOOST_MATH_STD_USING
  ...
  static const T P[] = {0.15141069795941984e-16L,
...
template <class T, class Policy>
T
log1p_imp(T const & x, const Policy & pol, const mpl::int_<64> &)
{ // The function returns the natural logarithm of 1 + x.
  BOOST_MATH_STD_USING
  ...
  static const T P[] = {BOOST_MATH_BIG_CONSTANT(T, 64, -0.807533446680736736712e-19),
...
template <class T, class Policy>
T
log1p_imp(T const & x, const Policy & pol, const mpl::int_<24> &)
{ // The function returns the natural logarithm of 1 + x.
  BOOST_MATH_STD_USING
  ...
  static const T Q[] = {
      1L, 1.46348272586988539733L, 0.497859871350117338894L, -0.00471666268910169651936L};
...
log1p(T x, const Policy &)
{
  ...
  return policies::checked_narrowing_cast<result_type, forwarding_policy>(
      detail::log1p_imp(static_cast<value_type>(x), forwarding_policy(), tag_type()),
...
inline float
log1p(float x, const Policy & pol)
{
  if (x < -1)
    return policies::raise_domain_error<float>(
        "log1p<%1%>(%1%)", "log1p(x) requires x > -1, but got x = %1%.", x, pol);
  if (x == -1)
    return -policies::raise_overflow_error<float>("log1p<%1%>(%1%)", 0, pol);
  return ::log1pf(x);
}
#ifndef BOOST_MATH_NO_LONG_DOUBLE_MATH_FUNCTIONS
template <class Policy>
inline long double
log1p(long double x, const Policy & pol)
{
  if (x < -1)
    return policies::raise_domain_error<long double>(
        "log1p<%1%>(%1%)", "log1p(x) requires x > -1, but got x = %1%.", x, pol);
  if (x == -1)
    return -policies::raise_overflow_error<long double>("log1p<%1%>(%1%)", 0, pol);
  return ::log1pl(x);
}
#endif
#else
...
template <class Policy>
inline double
log1p(double x, const Policy & pol)
{
  if (x < -1)
    return policies::raise_domain_error<double>(
        "log1p<%1%>(%1%)", "log1p(x) requires x > -1, but got x = %1%.", x, pol);
  if (x == -1)
    return -policies::raise_overflow_error<double>("log1p<%1%>(%1%)", 0, pol);
  return ::log1p(x);
}

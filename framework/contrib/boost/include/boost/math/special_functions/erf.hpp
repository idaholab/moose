...
template <class T>
inline float
erf_asymptotic_limit_N(const T &)
{
  return (std::numeric_limits<float>::max)();
}
inline float
erf_asymptotic_limit_N(const mpl::int_<24> &)
{
  return 2.8F;
}
inline float
erf_asymptotic_limit_N(const mpl::int_<53> &)
{
  return 4.3F;
}
inline float
erf_asymptotic_limit_N(const mpl::int_<64> &)
{
  return 4.8F;
}
inline float
erf_asymptotic_limit_N(const mpl::int_<106> &)
{
  return 6.5F;
}
inline float
erf_asymptotic_limit_N(const mpl::int_<113> &)
{
  return 6.8F;
}
...
inline T
erf_asymptotic_limit()
{
  typedef typename policies::precision<T, Policy>::type precision_type;
  typedef typename mpl::if_<
      mpl::less_equal<precision_type, mpl::int_<24>>,
      typename mpl::
          if_<mpl::less_equal<precision_type, mpl::int_<0>>, mpl::int_<0>, mpl::int_<24>>::type,
      typename mpl::if_<
          ...
          typename mpl::if_<
              ...
              mpl::int_<64>,
              typename mpl::if_<mpl::less_equal<precision_type, mpl::int_<106>>,
                                mpl::int_<106>,
                                typename mpl::if_<mpl::less_equal<precision_type, mpl::int_<113>>,
                                                  mpl::int_<113>,
                                                  mpl::int_<0>>::type>::type>::type>::type>::type
      tag_type;
...
T
erf_imp(T z, bool invert, const Policy & pol, const Tag & t)
{
  BOOST_MATH_STD_USING
...
template <class T, class Policy>
T
erf_imp(T z, bool invert, const Policy & pol, const mpl::int_<53> & t)
{
  BOOST_MATH_STD_USING
  ...
  if (z < 0.5)
  {
    ...
    if (z < 1e-10)
    {
      ...
      {
        static const T c =
            BOOST_MATH_BIG_CONSTANT(T, 53, 0.003379167095512573896158903121545171688);
  ...
  else if (invert ? (z < 28) : (z < 5.8f))
  {
    ...
    if (z < 1.5f)
    {
      ...
      result =
          Y + tools::evaluate_polynomial(P, T(z - 0.5)) / tools::evaluate_polynomial(Q, T(z - 0.5));
    ...
    else if (z < 2.5f)
    {
      ...
      result =
          Y + tools::evaluate_polynomial(P, T(z - 1.5)) / tools::evaluate_polynomial(Q, T(z - 1.5));
      result *= exp(-z * z) / z;
    }
    else if (z < 4.5f)
    {
      ...
      result =
          Y + tools::evaluate_polynomial(P, T(z - 3.5)) / tools::evaluate_polynomial(Q, T(z - 3.5));
      result *= exp(-z * z) / z;
    }
    else
    {
      ...
      result =
          Y + tools::evaluate_polynomial(P, T(1 / z)) / tools::evaluate_polynomial(Q, T(1 / z));
      result *= exp(-z * z) / z;
    }
  }
  else
  ...
  return result;
} // template <class T, class Lanczos>T erf_imp(T z, bool invert, const Lanczos& l, const
  // mpl::int_<53>& t)

template <class T, class Policy>
T
erf_imp(T z, bool invert, const Policy & pol, const mpl::int_<64> & t)
{
  BOOST_MATH_STD_USING
  ...
  if (z < 0.5)
  {
    ...
    else
    {
      ...
      result =
          z *
          (Y + tools::evaluate_polynomial(P, T(z * z)) / tools::evaluate_polynomial(Q, T(z * z)));
    }
  }
  else if (invert ? (z < 110) : (z < 6.4f))
  {
    ...
    if (z < 1.5)
    {
      ...
      result =
          Y +
          tools::evaluate_polynomial(P, T(z - 0.5f)) / tools::evaluate_polynomial(Q, T(z - 0.5f));
      result *= exp(-z * z) / z;
    }
    else if (z < 2.5)
    {
      ...
      result =
          Y +
          tools::evaluate_polynomial(P, T(z - 1.5f)) / tools::evaluate_polynomial(Q, T(z - 1.5f));
      result *= exp(-z * z) / z;
    }
    else if (z < 4.5)
    {
      ...
      result =
          Y +
          tools::evaluate_polynomial(P, T(z - 3.5f)) / tools::evaluate_polynomial(Q, T(z - 3.5f));
      result *= exp(-z * z) / z;
    }
    else
    {
...
template <class T, class Policy>
T
erf_imp(T z, bool invert, const Policy & pol, const mpl::int_<113> & t)
{
  BOOST_MATH_STD_USING
  ...
  else if (invert ? (z < 110) : (z < 8.65f))
  {
    ...
    else if (z < 1.5)
    {
      ...
      result =
          Y +
          tools::evaluate_polynomial(P, T(z - 1.0f)) / tools::evaluate_polynomial(Q, T(z - 1.0f));
      result *= exp(-z * z) / z;
    }
    else if (z < 2.25)
    {
    ...
    else if (z < 3)
    {
      ...
      result =
          Y +
          tools::evaluate_polynomial(P, T(z - 2.25f)) / tools::evaluate_polynomial(Q, T(z - 2.25f));
      result *= exp(-z * z) / z;
    }
    else if (z < 3.5)
    {
      ...
      result =
          Y +
          tools::evaluate_polynomial(P, T(z - 3.0f)) / tools::evaluate_polynomial(Q, T(z - 3.0f));
      result *= exp(-z * z) / z;
    }
    else if (z < 5.5)
    {
      ...
      result =
          Y +
          tools::evaluate_polynomial(P, T(z - 4.5f)) / tools::evaluate_polynomial(Q, T(z - 4.5f));
      result *= exp(-z * z) / z;
    }
    else if (z < 7.5)
    {
      ...
      result =
          Y +
          tools::evaluate_polynomial(P, T(z - 6.5f)) / tools::evaluate_polynomial(Q, T(z - 6.5f));
      result *= exp(-z * z) / z;
    }
    else if (z < 11.5)
    {
      ...
      result = Y +
               tools::evaluate_polynomial(P, T(z / 2 - 4.75f)) /
...
erf(T z, const Policy & /* pol */)
{
  ...
  return policies::checked_narrowing_cast<result_type, forwarding_policy>(
      detail::erf_imp(static_cast<value_type>(z), false, forwarding_policy(), tag_type()),
      "boost::math::erf<%1%>(%1%, %1%)");
}

template <class T, class Policy>
inline typename tools::promote_args<T>::type
erfc(T z, const Policy & /* pol */)
{
  typedef typename tools::promote_args<T>::type result_type;
  typedef typename policies::evaluation<result_type, Policy>::type value_type;
  typedef typename policies::precision<result_type, Policy>::type precision_type;
  ...
  return policies::checked_narrowing_cast<result_type, forwarding_policy>(
      detail::erf_imp(static_cast<value_type>(z), true, forwarding_policy(), tag_type()),

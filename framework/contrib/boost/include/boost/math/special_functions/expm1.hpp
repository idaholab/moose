...
struct expm1_initializer
{
  struct init
  {
    ...
    static void do_init(const mpl::int_<64> &) { expm1(T(0.5)); }
    static void do_init(const mpl::int_<113> &) { expm1(T(0.5)); }
...
T
expm1_imp(T x, const mpl::int_<0> &, const Policy & pol)
{
...
T
expm1_imp(T x, const mpl::int_<53> &, const P & pol)
{
  BOOST_MATH_STD_USING
...
template <class T, class P>
T
expm1_imp(T x, const mpl::int_<64> &, const P & pol)
{
  BOOST_MATH_STD_USING
  ...
  static const T n[] = {BOOST_MATH_BIG_CONSTANT(T, 64, -0.281276702880859375e-1),
  ...
  static const T d[] = {BOOST_MATH_BIG_CONSTANT(T, 64, 1.0),
...
template <class T, class P>
T
expm1_imp(T x, const mpl::int_<113> &, const P & pol)
{
  BOOST_MATH_STD_USING
...
expm1(T x, const Policy & /* pol */)
{
  ...
  typedef typename mpl::if_c<
      ...
      typename mpl::if_<
          ...
          typename mpl::if_<
              ...
              typename mpl::if_<typename mpl::less_equal<precision_type, mpl::int_<113>>::type,
  ...
  return policies::checked_narrowing_cast<result_type, forwarding_policy>(
      detail::expm1_imp(static_cast<value_type>(x), tag_type(), forwarding_policy()),
...
inline float
expm1(float x, const policies::policy<> &)
{
  return ::expm1f(x);
}
#ifndef BOOST_MATH_NO_LONG_DOUBLE_MATH_FUNCTIONS
inline long double
expm1(long double x, const policies::policy<> &)
{
  return ::expm1l(x);
}
#endif
...
#endif
inline double
expm1(double x, const policies::policy<> &)
{
  return ::expm1(x);
}
#endif

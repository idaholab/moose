...
template <class T>
T
equation_as_10_4_105(const T & z)
{
  ...
  const T fz(
      z_pow_two_thirds *
      (((((+(T(162375596875.0) / 334430208UL) * one_over_z_squared - (T(108056875.0) / 6967296UL)) *
              one_over_z_squared +
          (T(77125UL) / 82944UL)) *
             one_over_z_squared -
         (T(5U) / 36U)) *
...
public:
  ...
  boost::math::tuple<T, T> operator()(const T & x) const
  {
    ...
    return boost::math::make_tuple(boost::math::detail::airy_ai_imp(x, my_pol),
...
public:
  ...
  boost::math::tuple<T, T> operator()(const T & x) const
  {
    ...
    return boost::math::make_tuple(boost::math::detail::airy_bi_imp(x, my_pol),

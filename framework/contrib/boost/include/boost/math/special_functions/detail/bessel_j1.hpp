...
struct bessel_j1_initializer
{
  ...
  {
    init() { do_init(); }
    static void do_init() { bessel_j1(T(1)); }
...
bessel_j1(T x)
{
  ...
  static const T Q1[] = {static_cast<T>(BOOST_MATH_BIG_CONSTANT(T, 64, 4.1868604460820175290e+12)),
  ...
  static const T P2[] = {static_cast<T>(BOOST_MATH_BIG_CONSTANT(T, 64, -1.7527881995806511112e+16)),
  ...
  static const T Q2[] = {static_cast<T>(BOOST_MATH_BIG_CONSTANT(T, 64, 1.7253905888447681194e+18)),
                         ...
                         static_cast<T>(BOOST_MATH_BIG_CONSTANT(T, 64, 1.0))};
  static const T PC[] = {static_cast<T>(BOOST_MATH_BIG_CONSTANT(T, 64, -4.4357578167941278571e+06)),
                         ...
                         static_cast<T>(BOOST_MATH_BIG_CONSTANT(T, 64, 0.0))};
  static const T QC[] = {static_cast<T>(BOOST_MATH_BIG_CONSTANT(T, 64, -4.4357578167941278568e+06)),
                         ...
                         static_cast<T>(BOOST_MATH_BIG_CONSTANT(T, 64, 1.0))};
  static const T PS[] = {static_cast<T>(BOOST_MATH_BIG_CONSTANT(T, 64, 3.3220913409857223519e+04)),
                         ...
                         static_cast<T>(BOOST_MATH_BIG_CONSTANT(T, 64, 0.0))};
  static const T QS[] = {static_cast<T>(BOOST_MATH_BIG_CONSTANT(T, 64, 7.0871281941028743574e+05)),

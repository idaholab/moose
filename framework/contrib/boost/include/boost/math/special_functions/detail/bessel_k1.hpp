...
struct bessel_k1_initializer
{
  ...
  {
    init() { do_init(); }
    static void do_init() { bessel_k1(T(1), Policy()); }
...
template <typename T, typename Policy>
T
bessel_k1(T x, const Policy & pol)
{
  bessel_k1_initializer<T, Policy>::force_instantiate();

  static const T P1[] = {static_cast<T>(BOOST_MATH_BIG_CONSTANT(T, 64, -2.2149374878243304548e+06)),
  ...
  static const T Q1[] = {static_cast<T>(BOOST_MATH_BIG_CONSTANT(T, 64, -2.2149374878243304548e+06)),
  ...
  static const T Q2[] = {static_cast<T>(BOOST_MATH_BIG_CONSTANT(T, 64, -2.7062322985570842656e+06)),
                         ...
                         static_cast<T>(BOOST_MATH_BIG_CONSTANT(T, 64, 1.0))};
  static const T P3[] = {static_cast<T>(BOOST_MATH_BIG_CONSTANT(T, 64, 2.2196792496874548962e+00)),
  ...
  static const T Q3[] = {static_cast<T>(BOOST_MATH_BIG_CONSTANT(T, 64, 1.7710478032601086579e+00)),

...
template <class T, class Policy, class Lanczos>
T
lgamma_small_imp(T z, T zm1, T zm2, const mpl::int_<64> &, const Policy & /* l */, const Lanczos &)
{
...
template <class T, class Policy, class Lanczos>
T
lgamma_small_imp(T z, T zm1, T zm2, const mpl::int_<113> &, const Policy & /* l */, const Lanczos &)
{
  //
  // This version uses rational approximations for small
...
template <class T, class Policy, class Lanczos>
T
lgamma_small_imp(T z, T zm1, T zm2, const mpl::int_<0> &, const Policy & pol, const Lanczos &)
{
  //

...
struct bessel_j0_initializer
{
  ...
  {
    init() { do_init(); }
    static void do_init() { bessel_j0(T(1)); }
...
bessel_j0(T x)
{
  ...
  static const T Q1[] = {static_cast<T>(BOOST_MATH_BIG_CONSTANT(T, 64, 2.3883787996332290397e+12)),
  ...
  static const T P2[] = {static_cast<T>(BOOST_MATH_BIG_CONSTANT(T, 64, -1.8319397969392084011e+03)),
  ...
  static const T Q2[] = {static_cast<T>(BOOST_MATH_BIG_CONSTANT(T, 64, -3.5783478026152301072e+05)),
                         ...
                         static_cast<T>(BOOST_MATH_BIG_CONSTANT(T, 64, 1.0))};
  static const T PC[] = {static_cast<T>(BOOST_MATH_BIG_CONSTANT(T, 64, 2.2779090197304684302e+04)),
  ...
  static const T QC[] = {static_cast<T>(BOOST_MATH_BIG_CONSTANT(T, 64, 2.2779090197304684318e+04)),
  ...
  static const T QS[] = {static_cast<T>(BOOST_MATH_BIG_CONSTANT(T, 64, 5.7105024128512061905e+03)),

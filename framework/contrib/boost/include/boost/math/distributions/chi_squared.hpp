...
public:
  ...
  {
    RealType result;
    detail::check_df("boost::math::chi_squared_distribution<%1%>::chi_squared_distribution",
                     m_df,
                     &result,
                     Policy());
  ...
  static RealType find_degrees_of_freedom(RealType difference_from_variance,
                                          RealType alpha,
                                          RealType beta,
                                          RealType variance,
                                          RealType hint = 100);
...
range(const chi_squared_distribution<RealType, Policy> & /*dist*/)
...
template <class RealType, class Policy>
inline const std::pair<RealType, RealType>
support(const chi_squared_distribution<RealType, Policy> & /*dist*/)
...
template <class RealType, class Policy>
RealType
pdf(const chi_squared_distribution<RealType, Policy> & dist, const RealType & chi_square)
{
  ...
  if (false == detail::check_df(function, degrees_of_freedom, &error_result, Policy()))
    return error_result;
...
template <class RealType, class Policy>
inline RealType
cdf(const chi_squared_distribution<RealType, Policy> & dist, const RealType & chi_square)
{
  RealType degrees_of_freedom = dist.degrees_of_freedom();
  // Error check:
  RealType error_result;
...
template <class RealType, class Policy>
inline RealType
quantile(const chi_squared_distribution<RealType, Policy> & dist, const RealType & p)
{
  RealType degrees_of_freedom = dist.degrees_of_freedom();
...
template <class RealType, class Policy>
inline RealType
cdf(const complemented2_type<chi_squared_distribution<RealType, Policy>, RealType> & c)
{
...
template <class RealType, class Policy>
inline RealType
quantile(const complemented2_type<chi_squared_distribution<RealType, Policy>, RealType> & c)
{
  RealType const & degrees_of_freedom = c.dist.degrees_of_freedom();
...
template <class RealType, class Policy>
inline RealType
mean(const chi_squared_distribution<RealType, Policy> & dist)
...
template <class RealType, class Policy>
inline RealType
variance(const chi_squared_distribution<RealType, Policy> & dist)
...
template <class RealType, class Policy>
inline RealType
mode(const chi_squared_distribution<RealType, Policy> & dist)
{
  ...
  //   return policies::raise_domain_error<RealType>(
  //      function,
  //      "Chi-Squared distribution only has a mode for degrees of freedom >= 0, but got degrees of
  //      freedom = %1%.",
  //      df, Policy());
  //}
  // return (df <= 2) ? 0 : df - 2;
  ...
  if (df < 2)
    return policies::raise_domain_error<RealType>(function,
                                                  "Chi-Squared distribution only has a mode for "
                                                  "degrees of freedom >= 2, but got degrees of "
                                                  "freedom = %1%.",
                                                  df,
                                                  Policy());
  return df - 2;
...
//         "The Chi-Squared distribution only has a mode for degrees of freedom >= 2, but got
...
template <class RealType, class Policy>
inline RealType
skewness(const chi_squared_distribution<RealType, Policy> & dist)
{
...
template <class RealType, class Policy>
inline RealType
kurtosis(const chi_squared_distribution<RealType, Policy> & dist)
{
  RealType df = dist.degrees_of_freedom();
  return 3 + 12 / df;
}
...
template <class RealType, class Policy>
inline RealType
kurtosis_excess(const chi_squared_distribution<RealType, Policy> & dist)
{
  RealType df = dist.degrees_of_freedom();
  return 12 / df;
}
...
template <class RealType, class Policy>
RealType
chi_squared_distribution<RealType, Policy>::find_degrees_of_freedom(
    ...
    RealType hint)
{
  static const char * function =
      "boost::math::chi_squared_distribution<%1%>::find_degrees_of_freedom(%1%,%1%,%1%,%1%,%1%)";
  // Check for domain errors:
  RealType error_result;
  if (false == detail::check_probability(function, alpha, &error_result, Policy()) &&

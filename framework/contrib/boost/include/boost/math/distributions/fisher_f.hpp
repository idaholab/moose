...
public:
  ...
  fisher_f_distribution(const RealType & i, const RealType & j) : m_df1(i), m_df2(j)
  {
    ...
    RealType result;
    detail::check_df(function, m_df1, &result, Policy());
    detail::check_df(function, m_df2, &result, Policy());
  } // fisher_f_distribution

  RealType degrees_of_freedom1() const { return m_df1; }
  RealType degrees_of_freedom2() const { return m_df2; }
...
range(const fisher_f_distribution<RealType, Policy> & /*dist*/)
...
template <class RealType, class Policy>
inline const std::pair<RealType, RealType>
support(const fisher_f_distribution<RealType, Policy> & /*dist*/)
...
template <class RealType, class Policy>
RealType
pdf(const fisher_f_distribution<RealType, Policy> & dist, const RealType & x)
{
  ...
  if (false == (detail::check_df(function, df1, &error_result, Policy()) &&
                detail::check_df(function, df2, &error_result, Policy())))
    return error_result;
...
template <class RealType, class Policy>
inline RealType
cdf(const fisher_f_distribution<RealType, Policy> & dist, const RealType & x)
{
  ...
  //
  return v1x > df2 ? boost::math::ibetac(df2 / 2, df1 / 2, df2 / (df2 + v1x), Policy())
                   : boost::math::ibeta(df1 / 2, df2 / 2, v1x / (df2 + v1x), Policy());
} // cdf

template <class RealType, class Policy>
inline RealType
quantile(const fisher_f_distribution<RealType, Policy> & dist, const RealType & p)
{
...
template <class RealType, class Policy>
inline RealType
cdf(const complemented2_type<fisher_f_distribution<RealType, Policy>, RealType> & c)
{
  static const char * function = "boost::math::cdf(fisher_f_distribution<%1%> const&, %1%)";
  ...
  // to switch things around so we're passing 1-z instead.
  //
  return v1x > df2 ? boost::math::ibeta(df2 / 2, df1 / 2, df2 / (df2 + v1x), Policy())
                   : boost::math::ibetac(df1 / 2, df2 / 2, v1x / (df2 + v1x), Policy());
}

template <class RealType, class Policy>
inline RealType
quantile(const complemented2_type<fisher_f_distribution<RealType, Policy>, RealType> & c)
{
  static const char * function = "boost::math::quantile(fisher_f_distribution<%1%> const&, %1%)";
  RealType df1 = c.dist.degrees_of_freedom1();
  RealType df2 = c.dist.degrees_of_freedom2();
...
template <class RealType, class Policy>
inline RealType
mean(const fisher_f_distribution<RealType, Policy> & dist)
{ // Mean of F distribution = v.
  ...
  if (df2 <= 2)
  {
    return policies::raise_domain_error<RealType>(function,
                                                  "Second degree of freedom was %1% but must be > "
                                                  "2 in order for the distribution to have a mean.",
                                                  df2,
                                                  Policy());
  }
  return df2 / (df2 - 2);
...
template <class RealType, class Policy>
inline RealType
variance(const fisher_f_distribution<RealType, Policy> & dist)
{ // Variance of F distribution.
  ...
  if (df2 <= 4)
  {
    return policies::raise_domain_error<RealType>(function,
                                                  "Second degree of freedom was %1% but must be > "
                                                  "4 in order for the distribution to have a valid "
                                                  "variance.",
                                                  df2,
                                                  Policy());
  }
...
template <class RealType, class Policy>
inline RealType
mode(const fisher_f_distribution<RealType, Policy> & dist)
{
  ...
  if (df2 <= 2)
  {
    return policies::raise_domain_error<RealType>(function,
                                                  "Second degree of freedom was %1% but must be > "
                                                  "2 in order for the distribution to have a mode.",
                                                  df2,
                                                  Policy());
  }
...
//  return tools::domain_error<RealType>(BOOST_CURRENT_FUNCTION, "Median is not implemented, result
//  is %1%!", std::numeric_limits<RealType>::quiet_NaN());
//  } // median
...
template <class RealType, class Policy>
inline RealType
skewness(const fisher_f_distribution<RealType, Policy> & dist)
{
  ...
  if (df2 <= 6)
  {
    return policies::raise_domain_error<RealType>(function,
                                                  "Second degree of freedom was %1% but must be > "
                                                  "6 in order for the distribution to have a "
                                                  "skewness.",
                                                  df2,
                                                  Policy());
  }
...
template <class RealType, class Policy>
inline RealType
kurtosis(const fisher_f_distribution<RealType, Policy> & dist)
{
...
template <class RealType, class Policy>
inline RealType
kurtosis_excess(const fisher_f_distribution<RealType, Policy> & dist)
{
  ...
  if (df2 <= 8)
  {
    return policies::raise_domain_error<RealType>(function,
                                                  "Second degree of freedom was %1% but must be > "
                                                  "8 in order for the distribution to have a "
                                                  "kutosis.",
                                                  df2,
                                                  Policy());
  }
  ...
  RealType n = -16 + 20 * df2 - 8 * df2_2 + df2_2 * df2 + 44 * df1 - 32 * df2 * df1 +
               5 * df2_2 * df1 - 22 * df1_2 + 5 * df2 * df1_2;
  n *= 12;

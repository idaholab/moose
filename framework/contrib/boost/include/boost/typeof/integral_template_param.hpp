...
#define BOOST_TYPEOF_INTEGRAL_PARAM(Type) (INTEGRAL_PARAM)(Type)
...
#define BOOST_TYPEOF_INTEGRAL_PARAM_ENCODE(This, n)                                                \
  typedef typename boost::type_of::encode_integral<BOOST_PP_CAT(V, n),                             \
...
#define BOOST_TYPEOF_INTEGRAL_PARAM_DECODE(This, n)                                                \
  typedef boost::type_of::decode_integral<BOOST_TYPEOF_INTEGRAL_PARAM_GETTYPE(This),               \
                                          BOOST_PP_CAT(iter, n)>                                   \
      BOOST_PP_CAT(d, n);                                                                          \
  static const BOOST_TYPEOF_INTEGRAL_PARAM_GETTYPE(This) BOOST_PP_CAT(P, n) =                      \
      BOOST_PP_CAT(d, n)::value;                                                                   \

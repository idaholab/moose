...
#define BOOST_PP_LOCAL_LIMITS                                                                      \
  (BOOST_PP_DEC(BOOST_TYPEOF_PP_START_SIZE), BOOST_PP_DEC(BOOST_TYPEOF_LIMIT_SIZE))
...
#define BOOST_TYPEOF_typedef_item(z, n, _) typedef P##n item##n;

#define BOOST_TYPEOF_typedef_fake_item(z, n, _) typedef mpl::int_<1> item##n;
...
#define BOOST_PP_LOCAL_LIMITS (BOOST_TYPEOF_PP_START_SIZE, BOOST_TYPEOF_LIMIT_SIZE)
#include BOOST_PP_LOCAL_ITERATE()
}
}
...
#define BOOST_TYPEOF_spec_push_back(n)                                                             \
  ...
  {                                                                                                \
    typedef BOOST_PP_CAT(boost::type_of::vector,                                                   \
                         BOOST_PP_INC(n))<BOOST_PP_ENUM_PARAMS(n, P) BOOST_PP_COMMA_IF(n) T> type; \
  };

...
#define BOOST_TYPEOF_INDEX(T)                                                                      \
  (sizeof(*boost::type_of::encode_index((boost::type_of::encode_counter<1000> *)0)))
...
struct msvc_register_type : msvc_extract_type<ID>
{
  ...
  struct base_type::id2type // This uses nice VC6.5 and VC7.1 bugfeature, also works for Digital
                            // Mars
  {
    typedef T type;
  };
...
#define BOOST_TYPEOF_NESTED_TYPEDEF_TPL(name, expr)                                                \
  ...
  {                                                                                                \
    BOOST_STATIC_CONSTANT(                                                                         \
        int, _typeof_register_value = sizeof(boost::type_of::typeof_register_type<name>(expr)));   \

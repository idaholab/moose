...
struct cons_iterator : iterator_base<cons_iterator<Cons>>
{
  ...
  BOOST_CONSTEXPR
      BOOST_FUSION_GPU_ENABLED explicit cons_iterator(cons_type & in_cons) BOOST_NOEXCEPT
      : cons(in_cons)
  {
  }
...
struct nil_iterator : iterator_base<nil_iterator>
{
  ...
  BOOST_CONSTEXPR BOOST_FUSION_GPU_ENABLED explicit nil_iterator(nil_ const &) BOOST_NOEXCEPT {}
};
...
struct cons_iterator<nil_> : nil_iterator
{
  ...
  BOOST_CONSTEXPR BOOST_FUSION_GPU_ENABLED explicit cons_iterator(nil_ const &) BOOST_NOEXCEPT {}
};

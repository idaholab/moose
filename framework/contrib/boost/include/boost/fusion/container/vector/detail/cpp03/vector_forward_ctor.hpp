...
#define BOOST_PP_FILENAME_1 <boost/fusion/container/vector/detail/cpp03/vector_forward_ctor.hpp>
...
BOOST_CONSTEXPR
    ...
    explicit
#endif
    vector(BOOST_PP_ENUM_BINARY_PARAMS(M, typename detail::call_param<T, >::type arg))

...
#pragma wave option(                                                                               \
    preserve : 2, line : 0, output : "preprocessed/set" FUSION_MAX_SET_SIZE_STR "_fwd.hpp")
#endif
...
template <BOOST_PP_ENUM_PARAMS_WITH_A_DEFAULT(FUSION_MAX_SET_SIZE, typename T, void_)>
struct set;
}
}

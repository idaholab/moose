...
struct equal_to_impl
{
  ...
  struct apply : is_same<typename add_const<I1>::type, typename add_const<I2>::type>
  {
  };
};
...
struct equal_to_impl<iterator_facade_tag>
{
  ...
  struct apply : dispatch<It1, It2, typename It1::fusion_tag, typename It2::fusion_tag>
  {
  };
};
...
template <typename I1, typename I2>
struct equal_to
    : extension::equal_to_impl<typename detail::tag_of<I1>::type>::template apply<I1, I2>
{
};
}
...
BOOST_CONSTEXPR BOOST_FUSION_GPU_ENABLED inline
    typename boost::enable_if<mpl::and_<is_fusion_iterator<Iter1>, is_fusion_iterator<Iter2>>,
                              bool>::type

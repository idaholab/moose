...
#define BOOST_FUSION_ADAPT_STRUCT_UNPACK_NAME_TEMPLATE_PARAMS(SEQ)                                 \
  BOOST_PP_SEQ_HEAD(SEQ)<BOOST_PP_SEQ_ENUM(BOOST_PP_SEQ_TAIL(SEQ))> BOOST_PP_EMPTY()
...
#define BOOST_FUSION_ADAPT_STRUCT_UNPACK_TEMPLATE_PARAMS_IMPL_C(R, _, ELEM) (typename ELEM)
#define BOOST_FUSION_ADAPT_STRUCT_UNPACK_TEMPLATE_PARAMS_IMPL(SEQ)                                 \
  BOOST_PP_SEQ_ENUM(BOOST_PP_SEQ_FOR_EACH(                                                         \
      BOOST_FUSION_ADAPT_STRUCT_UNPACK_TEMPLATE_PARAMS_IMPL_C, _, BOOST_PP_SEQ_TAIL(SEQ)))
...
#define BOOST_FUSION_ATTRIBUTE_TYPEOF(                                                             \
  ...
  {                                                                                                \
    ...
    typedef BOOST_PP_IF(BOOST_FUSION_ADAPT_IS_TPL(TEMPLATE_PARAMS_SEQ), typename, )                \
        BOOST_TYPEOF(PREFIX() obj.BOOST_PP_TUPLE_ELEM(ATTRIBUTE_TUPLE_SIZE, 0, ATTRIBUTE)) type;   \
  };                                                                                               \
                                                                                                   \
  typedef BOOST_PP_IF(BOOST_FUSION_ADAPT_IS_TPL(TEMPLATE_PARAMS_SEQ), typename, )                  \
...
#define BOOST_FUSION_ATTRIBUTE_TYPEOF(                                                             \
  ...
  {                                                                                                \
    ...
    typedef BOOST_TYPEOF(PREFIX()                                                                  \
                             obj.BOOST_PP_TUPLE_ELEM(ATTRIBUTE_TUPLE_SIZE, 0, ATTRIBUTE)) type;    \
  };                                                                                               \
                                                                                                   \
  typedef BOOST_PP_IF(BOOST_FUSION_ADAPT_IS_TPL(TEMPLATE_PARAMS_SEQ), typename, )                  \
      deduced_attr_type::type attribute_type;
...
#define BOOST_FUSION_ATTRIBUTE_GIVENTYPE(                                                          \
    NAME_SEQ, ATTRIBUTE, ATTRIBUTE_TUPLE_SIZE, PREFIX, TEMPLATE_PARAMS_SEQ)                        \
  typedef BOOST_PP_TUPLE_ELEM(ATTRIBUTE_TUPLE_SIZE, 0, ATTRIBUTE) attribute_type;

#ifdef BOOST_NO_PARTIAL_SPECIALIZATION_IMPLICIT_DEFAULT_ARGS
#define BOOST_FUSION_ADAPT_STRUCT_TAG_OF_SPECIALIZATION(                                           \
    MODIFIER, TEMPLATE_PARAMS_SEQ, NAME_SEQ, TAG)                                                  \
                                                                                                   \
  template <BOOST_FUSION_ADAPT_STRUCT_UNPACK_TEMPLATE_PARAMS(TEMPLATE_PARAMS_SEQ)>                 \
  struct tag_of<BOOST_FUSION_ADAPT_STRUCT_UNPACK_NAME(NAME_SEQ) MODIFIER, void>                    \
  {                                                                                                \
    typedef TAG type;                                                                              \
  };
#else
...
#ifdef BOOST_MSVC
#define BOOST_FUSION_ADAPT_STRUCT_MSVC_REDEFINE_TEMPLATE_PARAM(R, _, ELEM) typedef ELEM ELEM;
#define BOOST_FUSION_ADAPT_STRUCT_MSVC_REDEFINE_TEMPLATE_PARAMS_IMPL(SEQ)                          \
  BOOST_PP_SEQ_FOR_EACH(                                                                           \
      BOOST_FUSION_ADAPT_STRUCT_MSVC_REDEFINE_TEMPLATE_PARAM, _, BOOST_PP_SEQ_TAIL(SEQ))
...
#define BOOST_FUSION_ADAPT_STRUCT_C_BASE(TEMPLATE_PARAMS_SEQ,                                      \
                                         ...
                                         DEDUCE_TYPE)                                              \
                                                                                                   \
  template <BOOST_FUSION_ADAPT_STRUCT_UNPACK_TEMPLATE_PARAMS(TEMPLATE_PARAMS_SEQ)>                 \
  struct access::struct_member<BOOST_FUSION_ADAPT_STRUCT_UNPACK_NAME(NAME_SEQ), I>                 \
  {                                                                                                \
    ...
    {                                                                                              \
      typedef                                                                                      \
          typename add_reference<typename mpl::eval_if<is_const<Seq>,                              \
      ...
      {                                                                                            \
        return seq.PREFIX()                                                                        \
            BOOST_PP_TUPLE_ELEM(ATTRIBUTE_TUPLE_SIZE, BOOST_PP_NOT(DEDUCE_TYPE), ATTRIBUTE);       \
      }                                                                                            \
    };                                                                                             \
  };                                                                                               \
                                                                                                   \
...
#define BOOST_FUSION_ADAPT_STRUCT_BASE(                                                            \
    TEMPLATE_PARAMS_SEQ, NAME_SEQ, TAG, IS_VIEW, ATTRIBUTES_SEQ, ATTRIBUTES_CALLBACK)              \
  \
namespace boost                                                                                    \
  \
{                                                                                             \
    ...
    BOOST_FUSION_ADAPT_STRUCT_TAG_OF_SPECIALIZATION(BOOST_PP_EMPTY(),                              \
                                                    ...
                                                    NAME_SEQ,                                      \
                                                    TAG)                                           \
    BOOST_FUSION_ADAPT_STRUCT_TAG_OF_SPECIALIZATION(const, TEMPLATE_PARAMS_SEQ, NAME_SEQ, TAG)     \
    }                                                                                              \
                                                                                                   \
    namespace extension                                                                            \
    {                                                                                              \

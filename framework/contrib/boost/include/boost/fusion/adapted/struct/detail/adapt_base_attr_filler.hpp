...
#define BOOST_FUSION_ADAPT_STRUCT_WRAP_ATTR(X, Y)                                                  \
  BOOST_PP_IIF(BOOST_MPL_PP_TOKEN_EQUAL(auto, BOOST_PP_EXPAND(X)), ((1, (Y))), ((2, (X, Y))))

#define BOOST_FUSION_ADAPT_STRUCT_WRAPPEDATTR_SIZE(ATTRIBUTE) BOOST_PP_TUPLE_ELEM(2, 0, ATTRIBUTE)

#define BOOST_FUSION_ADAPT_STRUCT_WRAPPEDATTR(ATTRIBUTE) BOOST_PP_TUPLE_ELEM(2, 1, ATTRIBUTE)
...
#define BOOST_FUSION_ADAPT_STRUCT_ATTRIBUTES_FILLER(VA_ARGS_SEQ)                                   \
  BOOST_PP_SEQ_PUSH_FRONT(                                                                         \
      BOOST_PP_SEQ_FOR_EACH(BOOST_FUSION_ADAPT_STRUCT_ATTRIBUTES_FILLER_OP, unused, VA_ARGS_SEQ),  \
      (0, 0))

...
#define BOOST_FUSION_ADAPT_STRUCT_C(TEMPLATE_PARAMS_SEQ, NAME_SEQ, IS_VIEW, I, ATTRIBUTE)          \
...
#define BOOST_FUSION_ADAPT_TPL_STRUCT(TEMPLATE_PARAMS_SEQ, NAME_SEQ, ...)                          \
  BOOST_FUSION_ADAPT_STRUCT_BASE(                                                                  \
      ...
      struct_tag,                                                                                  \
      0,                                                                                           \
      BOOST_FUSION_ADAPT_STRUCT_ATTRIBUTES_FILLER(BOOST_PP_VARIADIC_TO_SEQ(__VA_ARGS__)),          \
      BOOST_FUSION_ADAPT_STRUCT_C)

#define BOOST_FUSION_ADAPT_STRUCT(...)                                                             \
  BOOST_FUSION_ADAPT_STRUCT_BASE((0),                                                              \

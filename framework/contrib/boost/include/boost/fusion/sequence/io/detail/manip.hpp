...
#define FUSION_STRING_OF_STREAM(Stream)                                                            \
  std::basic_string<FUSION_GET_CHAR_TYPE(Stream), FUSION_GET_TRAITS_TYPE(Stream)>
...
struct stream_data
{
  ...
  static T const * get(Stream & stream) { return (T const *)stream.pword(get_xalloc_index<Tag>()); }
};
...
#define STD_TUPLE_DEFINE_MANIPULATOR_FUNCTIONS(name)                                               \
  ...
  inline detail::name##_type<Char, Traits> name(const std::basic_string<Char, Traits> & s)         \
  {                                                                                                \
...
#define STD_TUPLE_DEFINE_MANIPULATOR_FUNCTIONS(name)                                               \
  ...
  {                                                                                                \
    return detail::name##_type<Char, Traits>(s);                                                   \
                                                                                                   ...
                                                                                                   \
  template <typename Char>                                                                         \
  inline detail::name##_type<Char> name(Char s[])                                                  \
  {                                                                                                \
    return detail::name##_type<Char>(std::basic_string<Char>(s));                                  \
  }                                                                                                \
                                                                                                   \

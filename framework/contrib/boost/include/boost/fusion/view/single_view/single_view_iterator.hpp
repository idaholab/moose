...
struct single_view_iterator : iterator_base<single_view_iterator<SingleView, Pos>>
{
  ...
  BOOST_CONSTEXPR BOOST_FUSION_GPU_ENABLED explicit single_view_iterator(single_view_type & in_view)
    : view(in_view)
  {
  }

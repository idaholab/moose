...
struct transform_view_iterator : iterator_base<transform_view_iterator<First, F>>
{
  ...
  BOOST_CONSTEXPR BOOST_FUSION_GPU_ENABLED transform_view_iterator(First const & in_first,
                                                                   F const & in_f)
...
struct transform_view_iterator2 : iterator_base<transform_view_iterator2<First1, First2, F>>
{
  ...
  BOOST_CONSTEXPR BOOST_FUSION_GPU_ENABLED transform_view_iterator2(First1 const & in_first1,

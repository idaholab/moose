...
struct distance_impl<transform_view_iterator_tag>
{
  ...
  struct apply : result_of::distance<typename First::first_type, typename Last::first_type>
  {
...
{
  template <typename First, typename Last>
  struct apply : result_of::distance<typename First::first1_type, typename Last::first1_type>
  {
    BOOST_CONSTEXPR BOOST_FUSION_GPU_ENABLED static

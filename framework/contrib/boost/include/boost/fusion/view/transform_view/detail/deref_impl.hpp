...
struct deref_impl<transform_view_iterator_tag>
{
  ...
  struct apply
  {
    typedef typename result_of::deref<typename Iterator::first_type>::type value_type;
...
struct deref_impl<transform_view_iterator2_tag>
{
  ...
  struct apply
  {
    typedef typename result_of::deref<typename Iterator::first1_type>::type value1_type;
    typedef typename result_of::deref<typename Iterator::first2_type>::type value2_type;

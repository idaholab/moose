...
struct joint_view_iterator : iterator_base<joint_view_iterator<Category, First, Last, Concat>>
{
  ...
  BOOST_CONSTEXPR BOOST_FUSION_GPU_ENABLED joint_view_iterator(First const & in_first,

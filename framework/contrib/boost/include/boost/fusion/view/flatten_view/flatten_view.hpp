...
struct flatten_view : sequence_base<flatten_view<Sequence>>
{
  ...
  BOOST_CONSTEXPR BOOST_FUSION_GPU_ENABLED explicit flatten_view(Sequence & seq) : seq(seq) {}
...
struct begin_impl<flatten_view_tag>
{
  ...
  struct apply
  {
    ...
    typedef typename result_of::begin<mpl::single_view<typename Sequence::sequence_type>>::type
        root_iterator;
    ...
    BOOST_CONSTEXPR BOOST_FUSION_GPU_ENABLED static inline type call(Sequence & seq)
    {
...
struct end_impl<flatten_view_tag>
{
  ...
  struct apply
  {
    ...
    typedef typename result_of::end<mpl::single_view<typename Sequence::sequence_type>>::type type;

    BOOST_CONSTEXPR BOOST_FUSION_GPU_ENABLED static inline type call(Sequence &) { return type(); }
  };
};

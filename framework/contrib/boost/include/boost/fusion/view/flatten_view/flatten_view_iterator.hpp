...
struct flatten_view_iterator : iterator_base<flatten_view_iterator<First, Base>>
{
  ...
  BOOST_CONSTEXPR BOOST_FUSION_GPU_ENABLED flatten_view_iterator(First const & first,
                                                                 Base const & base)
...
struct make_descent_cons
{
  ...
  BOOST_CONSTEXPR BOOST_FUSION_GPU_ENABLED static inline type apply(Iterator const & it)
  {
    return type(it);
  }
};
...
struct make_descent_cons<
    Iterator,
    typename enable_if<traits::is_sequence<typename result_of::value_of<Iterator>::type>>::type>
{
  ...
  typedef typename remove_reference<typename result_of::deref<Iterator>::type>::type sub_sequence;
...
struct build_flatten_view_iterator<cons<Car>, Base>
{
  ...
  BOOST_CONSTEXPR BOOST_FUSION_GPU_ENABLED static inline type apply(cons<Car> const & cons,
                                                                    Base const & base)
  {
...
struct build_flatten_view_iterator<cons<Car, Cdr>, Base>
{
  ...
  BOOST_CONSTEXPR BOOST_FUSION_GPU_ENABLED static inline type apply(cons<Car, Cdr> const & cons,
                                                                    Base const & base)
  {
...
struct seek_descent
{
  ...
  typedef build_flatten_view_iterator<cons_type, Base> build_flatten_view_iterator_;
  typedef typename build_flatten_view_iterator_::type type;

  BOOST_CONSTEXPR BOOST_FUSION_GPU_ENABLED static inline type apply(Base const & base,
                                                                    Iterator const & it)
  {
    return build_flatten_view_iterator_::apply(make_descent_cons_::apply(it), base);
  }
};
...
struct seek_descent<
    ...
    typename enable_if<result_of::equal_to<
        Iterator,
        typename result_of::end<typename result_of::value_of<Base>::type>::type>>::type>
{
...
struct next_impl<flatten_view_iterator_tag>
{
  ...
  struct apply
  {
    ...
    BOOST_CONSTEXPR BOOST_FUSION_GPU_ENABLED static inline type call(Iterator const & it)
    {
...
struct value_of_impl<flatten_view_iterator_tag>
{
  ...
  struct apply
  {
    typedef typename result_of::value_of<typename Iterator::first_type>::type type;
  };
};
}
}

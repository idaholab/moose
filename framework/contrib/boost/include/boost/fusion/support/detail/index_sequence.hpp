...
struct index_sequence
{
  ...
  BOOST_CONSTEXPR BOOST_FUSION_GPU_ENABLED static std::size_t size() BOOST_NOEXCEPT
  {
    return sizeof...(Ints);
  }
...
struct _make_index_sequence_join<index_sequence<Left...>, index_sequence<Right...>>

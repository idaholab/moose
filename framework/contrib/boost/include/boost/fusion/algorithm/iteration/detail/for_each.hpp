...
{
  f(*first);
  detail::for_each_linear(fusion::next(first),
                          last,
                          f,
...
{
  detail::for_each_linear(fusion::begin(seq),
                          fusion::end(seq),
                          f,
...
struct for_each_unrolled
{
  ...
  BOOST_CXX14_CONSTEXPR BOOST_FUSION_GPU_ENABLED static void call(I0 const & i0, F const & f)
  {
    f(*i0);
...
struct for_each_unrolled<0>
{
  ...
  BOOST_CXX14_CONSTEXPR BOOST_FUSION_GPU_ENABLED static void call(It const &, F const &)
  {
  }
};

...
struct format_item
{
  ...
  format_item(Ch fill)
    : argN_(argN_no_posit), fmtstate_(fill), truncate_(max_streamsize()), pad_scheme_(0)
  {
  }
  void reset(Ch fill);
  void compute_states(); // sets states  according to truncate and pad_scheme.

  static std::streamsize max_streamsize() { return (std::numeric_limits<std::streamsize>::max)(); }
...
template <class Ch, class Tr>
void
stream_format_state<Ch, Tr>::apply_on(basic_ios & os,
...
template <class Ch, class Tr>
void
stream_format_state<Ch, Tr>::set_by_stream(const basic_ios & os)
{
...
void
apply_manip_body(stream_format_state<Ch, Tr> & self, T manipulator)
{
...
template <class Ch, class Tr>
inline void
stream_format_state<Ch, Tr>::reset(Ch fill)
{
...
template <class Ch, class Tr, class Alloc>
void
format_item<Ch, Tr, Alloc>::reset(Ch fill)
{
  argN_ = argN_no_posit;
...
template <class Ch, class Tr, class Alloc>
void
format_item<Ch, Tr, Alloc>::compute_states()
{

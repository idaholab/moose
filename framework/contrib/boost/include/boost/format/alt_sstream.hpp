...
class basic_altstringbuf : public ::std::basic_streambuf<Ch, Tr>
{
...
public:
  ...
  virtual ~basic_altstringbuf() { dealloc(); }
  ...
  size_type pcount() const { return static_cast<size_type>(pptr() - pbase()); }
...
public:
  ...
  basic_oaltstringstream(::boost::shared_ptr<stringbuf_t> buf) : pbase_type(buf), stream_t(rdbuf())
  {
  }

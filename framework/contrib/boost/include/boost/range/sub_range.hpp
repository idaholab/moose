...
class sub_range_base
    : public iterator_range<BOOST_DEDUCED_TYPENAME range_iterator<ForwardRange>::type>
{
...
public:
  ...
  sub_range_base(Iterator first, Iterator last) : base(first, last)
  {
  }
...
private:
  ...
  struct is_compatible_range
      : is_convertible<BOOST_DEDUCED_TYPENAME mpl::eval_if<has_range_iterator<Source>,
...
public:
  ...
  sub_range(
      ...
      BOOST_DEDUCED_TYPENAME::boost::enable_if<is_compatible_range<const ForwardRange2>>::type * =
          0)
    : base(impl::adl_begin(r), impl::adl_end(r))
  {
  }
  ...
  template <class ForwardRange2>
  BOOST_DEDUCED_TYPENAME::boost::enable_if<is_compatible_range<const ForwardRange2>,
                                           sub_range &>::type

...
public:
  ...
  typedef typename boost::mpl::
      if_<boost::is_const<M>, typename M::const_reference, typename M::reference>::type reference;
  ...
  // Accessors
  BOOST_UBLAS_INLINE
  size_type size() const { return data_.size2(); }
  BOOST_UBLAS_INLINE
  size_type index() const { return i_; }

  // Storage accessors
  BOOST_UBLAS_INLINE
  const matrix_closure_type & data() const { return data_; }
  BOOST_UBLAS_INLINE
  matrix_closure_type & data() { return data_; }

// Element access
#ifndef BOOST_UBLAS_PROXY_CONST_MEMBER
  BOOST_UBLAS_INLINE
  const_reference operator()(size_type j) const { return data_(i_, j); }
  BOOST_UBLAS_INLINE
  reference operator()(size_type j) { return data_(i_, j); }

  BOOST_UBLAS_INLINE
  const_reference operator[](size_type j) const { return (*this)(j); }
  BOOST_UBLAS_INLINE
  reference operator[](size_type j) { return (*this)(j); }
#else
  BOOST_UBLAS_INLINE
  reference operator()(size_type j) const { return data_(i_, j); }

  BOOST_UBLAS_INLINE
  reference operator[](size_type j) const { return (*this)(j); }
#endif
  ...
  // Closure comparison
  BOOST_UBLAS_INLINE
  bool same_closure(const matrix_row & mr) const { return (*this).data_.same_closure(mr.data_); }
  ...
  BOOST_UBLAS_INLINE
  friend void swap(matrix_row mr1, matrix_row mr2) { mr1.swap(mr2); }
...
public:
  ...
  typedef indexed_iterator<matrix_row<matrix_type>, typename subiterator_type::iterator_category>
      iterator;
  ...
  class const_iterator
      : public container_const_reference<matrix_row>,
        public iterator_base_traits<typename const_subiterator_type::iterator_category>::
  ...
  public:
    ...
    // Index
    BOOST_UBLAS_INLINE
    size_type index() const { return it_.index2(); }
  ...
  class iterator : public container_reference<matrix_row>,
                   public iterator_base_traits<typename subiterator_type::iterator_category>::
                       template iterator_base<iterator, value_type>::type
  {
  public:
...
// Projections
template <class M>
BOOST_UBLAS_INLINE matrix_row<M>
row(M & data, typename M::size_type i)
{
  return matrix_row<M>(data, i);
}
template <class M>
BOOST_UBLAS_INLINE const matrix_row<const M>
...
template <class M>
struct vector_temporary_traits<matrix_row<M>> : vector_temporary_traits<M>
{
};
template <class M>
struct vector_temporary_traits<const matrix_row<M>> : vector_temporary_traits<M>
{
};
...
public:
  ...
  // Accessors
  BOOST_UBLAS_INLINE
  size_type size() const { return data_.size1(); }
  BOOST_UBLAS_INLINE
  size_type index() const { return j_; }
...
// Element access
#ifndef BOOST_UBLAS_PROXY_CONST_MEMBER
  BOOST_UBLAS_INLINE
  const_reference operator()(size_type i) const { return data_(i, j_); }
  BOOST_UBLAS_INLINE
  reference operator()(size_type i) { return data_(i, j_); }
...
#else
  BOOST_UBLAS_INLINE
  reference operator()(size_type i) const { return data_(i, j_); }
  ...
  // Closure comparison
  BOOST_UBLAS_INLINE
  bool same_closure(const matrix_column & mc) const { return (*this).data_.same_closure(mc.data_); }
  ...
  BOOST_UBLAS_INLINE
  friend void swap(matrix_column mc1, matrix_column mc2) { mc1.swap(mc2); }
...
public:
#ifdef BOOST_UBLAS_USE_INDEXED_ITERATOR
  typedef indexed_iterator<matrix_column<matrix_type>, typename subiterator_type::iterator_category>
      iterator;
  ...
  public:
    ...
    // Index
    BOOST_UBLAS_INLINE
    size_type index() const { return it_.index1(); }
...
// Projections
template <class M>
BOOST_UBLAS_INLINE matrix_column<M>
column(M & data, typename M::size_type j)
{
  return matrix_column<M>(data, j);
}
template <class M>
BOOST_UBLAS_INLINE const matrix_column<const M>
...
// Specialize temporary
template <class M>
struct vector_temporary_traits<matrix_column<M>> : vector_temporary_traits<M>
{
};
template <class M>
struct vector_temporary_traits<const matrix_column<M>> : vector_temporary_traits<M>
{
};
...
public:
  ...
  // Accessors
  BOOST_UBLAS_INLINE
  size_type start1() const { return r1_.start(); }
  BOOST_UBLAS_INLINE
  size_type start2() const { return r2_.start(); }
  BOOST_UBLAS_INLINE
  size_type size() const { return BOOST_UBLAS_SAME(r1_.size(), r2_.size()); }
...
// Element access
#ifndef BOOST_UBLAS_PROXY_CONST_MEMBER
  BOOST_UBLAS_INLINE
  const_reference operator()(size_type i) const { return data_(r1_(i), r2_(i)); }
  BOOST_UBLAS_INLINE
  reference operator()(size_type i) { return data_(r1_(i), r2_(i)); }
...
#else
  BOOST_UBLAS_INLINE
  reference operator()(size_type i) const { return data_(r1_(i), r2_(i)); }
  ...
  BOOST_UBLAS_INLINE
  friend void swap(matrix_vector_range mvr1, matrix_vector_range mvr2) { mvr1.swap(mvr2); }
...
public:
  ...
  BOOST_UBLAS_INLINE
  iterator find(size_type i) { return iterator(*this, r1_.begin() + i, r2_.begin() + i); }

  class const_iterator
      : public container_const_reference<matrix_vector_range>,
        public iterator_base_traits<typename M::const_iterator1::iterator_category>::
            template iterator_base<const_iterator, value_type>::type
  {
  public:
    // FIXME Iterator can never be different code was:
    // typename iterator_restrict_traits<typename M::const_iterator1::iterator_category, typename
    // M::const_iterator2::iterator_category>::iterator_category>
    BOOST_STATIC_ASSERT((boost::is_same<typename M::const_iterator1::iterator_category,
                                        typename M::const_iterator2::iterator_category>::value));
    ...
    BOOST_UBLAS_INLINE
    const_iterator(const self_type & mvr,
    ...
    // Index
    BOOST_UBLAS_INLINE
    size_type index() const { return BOOST_UBLAS_SAME(it1_.index(), it2_.index()); }
  ...
  class iterator : public container_reference<matrix_vector_range>,
                   public iterator_base_traits<typename M::iterator1::iterator_category>::
                       template iterator_base<iterator, value_type>::type
  {
  public:
    // FIXME Iterator can never be different code was:
...
// Specialize temporary
template <class M>
struct vector_temporary_traits<matrix_vector_range<M>> : vector_temporary_traits<M>
{
};
template <class M>
struct vector_temporary_traits<const matrix_vector_range<M>> : vector_temporary_traits<M>
{
};
...
public:
    ...
    : data_(data), s1_(s1.preprocess(data.size1())), s2_(s2.preprocess(data.size2()))
  {
    ...
    //                    s1_.start () + s1_.stride () * (s1_.size () - (s1_.size () > 0)) <=
    //                    data_.size1 (), bad_index ());
    // BOOST_UBLAS_CHECK (s2_.start () <= data_.size2 () &&
    //                    s2_.start () + s2_.stride () * (s2_.size () - (s2_.size () > 0)) <=
    //                    data_.size2 (), bad_index ());
  }

  // Accessors
  BOOST_UBLAS_INLINE
  size_type start1() const { return s1_.start(); }
  BOOST_UBLAS_INLINE
  size_type start2() const { return s2_.start(); }
  BOOST_UBLAS_INLINE
  difference_type stride1() const { return s1_.stride(); }
  BOOST_UBLAS_INLINE
  difference_type stride2() const { return s2_.stride(); }
  BOOST_UBLAS_INLINE
  size_type size() const { return BOOST_UBLAS_SAME(s1_.size(), s2_.size()); }
...
// Element access
#ifndef BOOST_UBLAS_PROXY_CONST_MEMBER
  BOOST_UBLAS_INLINE
  const_reference operator()(size_type i) const { return data_(s1_(i), s2_(i)); }
  BOOST_UBLAS_INLINE
  reference operator()(size_type i) { return data_(s1_(i), s2_(i)); }
...
#else
  BOOST_UBLAS_INLINE
  reference operator()(size_type i) const { return data_(s1_(i), s2_(i)); }
  ...
  BOOST_UBLAS_INLINE
  friend void swap(matrix_vector_slice mvs1, matrix_vector_slice mvs2) { mvs1.swap(mvs2); }
...
public:
  ...
  BOOST_UBLAS_INLINE
  iterator find(size_type i) { return iterator(*this, s1_.begin() + i, s2_.begin() + i); }
  ...
  public:
    ...
    const_iterator() : container_const_reference<self_type>(), it1_(), it2_() {}
    BOOST_UBLAS_INLINE
    const_iterator(const self_type & mvs,
                   const const_subiterator1_type & it1,
                   const const_subiterator2_type & it2)
...
// Specialize temporary
template <class M>
struct vector_temporary_traits<matrix_vector_slice<M>> : vector_temporary_traits<M>
{
};
template <class M>
struct vector_temporary_traits<const matrix_vector_slice<M>> : vector_temporary_traits<M>
{
};
...
public:
  ...
  BOOST_UBLAS_INLINE
  matrix_vector_indirect(matrix_type & data,
  ...
  // Accessors
  BOOST_UBLAS_INLINE
  size_type size() const { return BOOST_UBLAS_SAME(ia1_.size(), ia2_.size()); }
  BOOST_UBLAS_INLINE
  const indirect_array_type & indirect1() const { return ia1_; }
  BOOST_UBLAS_INLINE
  indirect_array_type & indirect1() { return ia1_; }
  BOOST_UBLAS_INLINE
  const indirect_array_type & indirect2() const { return ia2_; }
  BOOST_UBLAS_INLINE
  indirect_array_type & indirect2() { return ia2_; }
...
// Element access
#ifndef BOOST_UBLAS_PROXY_CONST_MEMBER
  BOOST_UBLAS_INLINE
  const_reference operator()(size_type i) const { return data_(ia1_(i), ia2_(i)); }
  BOOST_UBLAS_INLINE
  reference operator()(size_type i) { return data_(ia1_(i), ia2_(i)); }
...
#else
  BOOST_UBLAS_INLINE
  reference operator()(size_type i) const { return data_(ia1_(i), ia2_(i)); }
  ...
  BOOST_UBLAS_INLINE
  friend void swap(matrix_vector_indirect mvi1, matrix_vector_indirect mvi2) { mvi1.swap(mvi2); }
...
public:
  ...
  BOOST_UBLAS_INLINE
  iterator find(size_type i) { return iterator(*this, ia1_.begin() + i, ia2_.begin() + i); }
  ...
  public:
    ...
    const_iterator() : container_const_reference<self_type>(), it1_(), it2_() {}
    BOOST_UBLAS_INLINE
    const_iterator(const self_type & mvi,
                   const const_subiterator1_type & it1,
                   const const_subiterator2_type & it2)
...
// Specialize temporary
template <class M, class IA>
struct vector_temporary_traits<matrix_vector_indirect<M, IA>> : vector_temporary_traits<M>
{
};
template <class M, class IA>
struct vector_temporary_traits<const matrix_vector_indirect<M, IA>> : vector_temporary_traits<M>
{
};
...
public:
  ...
  size_type start1() const { return r1_.start(); }
  BOOST_UBLAS_INLINE
  size_type size1() const { return r1_.size(); }
  BOOST_UBLAS_INLINE
  size_type start2() const { return r2_.start(); }
  BOOST_UBLAS_INLINE
  size_type size2() const { return r2_.size(); }
...
// Element access
#ifndef BOOST_UBLAS_PROXY_CONST_MEMBER
  BOOST_UBLAS_INLINE
  const_reference operator()(size_type i, size_type j) const { return data_(r1_(i), r2_(j)); }
  BOOST_UBLAS_INLINE
  reference operator()(size_type i, size_type j) { return data_(r1_(i), r2_(j)); }
#else
  BOOST_UBLAS_INLINE
  reference operator()(size_type i, size_type j) const { return data_(r1_(i), r2_(j)); }
#endif
  ...
  {
    return matrix_range<matrix_type>(data_,
                                     r1_.compose(r1.preprocess(data_.size1())),
                                     r2_.compose(r2.preprocess(data_.size2())),
                                     0);
  }
  ...
  BOOST_UBLAS_INLINE
  matrix_range & assign_temporary(matrix_range & mr) { return *this = mr; }
  template <class AE>
  ...
  // Closure comparison
  BOOST_UBLAS_INLINE
  bool same_closure(const matrix_range & mr) const { return (*this).data_.same_closure(mr.data_); }
  ...
  BOOST_UBLAS_INLINE
  friend void swap(matrix_range mr1, matrix_range mr2) { mr1.swap(mr2); }
...
public:
  ...
  class const_iterator1
      : public container_const_reference<matrix_range>,
        public iterator_base_traits<typename const_subiterator1_type::iterator_category>::
            template iterator_base<const_iterator1, value_type>::type
  {
  public:
    ...
    // Indices
    BOOST_UBLAS_INLINE
    size_type index1() const { return it_.index1() - (*this)().start1(); }
    BOOST_UBLAS_INLINE
    size_type index2() const { return it_.index2() - (*this)().start2(); }
  ...
  BOOST_UBLAS_INLINE
  const_iterator1 begin1() const { return find1(0, 0, 0); }
  BOOST_UBLAS_INLINE
  const_iterator1 cbegin1() const { return begin1(); }
  BOOST_UBLAS_INLINE
  const_iterator1 end1() const { return find1(0, size1(), 0); }
  BOOST_UBLAS_INLINE
  const_iterator1 cend1() const { return end1(); }

#ifndef BOOST_UBLAS_USE_INDEXED_ITERATOR
  class iterator1 : public container_reference<matrix_range>,
                    public iterator_base_traits<typename subiterator1_type::iterator_category>::
                        template iterator_base<iterator1, value_type>::type
  {
  public:
  ...
  BOOST_UBLAS_INLINE
  iterator1 begin1() { return find1(0, 0, 0); }
  BOOST_UBLAS_INLINE
  iterator1 end1() { return find1(0, size1(), 0); }

#ifndef BOOST_UBLAS_USE_INDEXED_ITERATOR
  class const_iterator2
      : public container_const_reference<matrix_range>,
        public iterator_base_traits<typename const_subiterator2_type::iterator_category>::
            template iterator_base<const_iterator2, value_type>::type
  {
  public:
  ...
  BOOST_UBLAS_INLINE
  const_iterator2 begin2() const { return find2(0, 0, 0); }
  BOOST_UBLAS_INLINE
  const_iterator2 cbegin2() const { return begin2(); }
  BOOST_UBLAS_INLINE
  const_iterator2 end2() const { return find2(0, 0, size2()); }
  BOOST_UBLAS_INLINE
  const_iterator2 cend2() const { return end2(); }

#ifndef BOOST_UBLAS_USE_INDEXED_ITERATOR
  class iterator2 : public container_reference<matrix_range>,
                    public iterator_base_traits<typename subiterator2_type::iterator_category>::
                        template iterator_base<iterator2, value_type>::type
  {
  public:
  ...
  BOOST_UBLAS_INLINE
  iterator2 begin2() { return find2(0, 0, 0); }
  BOOST_UBLAS_INLINE
  iterator2 end2() { return find2(0, 0, size2()); }
  ...
  BOOST_UBLAS_INLINE
  const_reverse_iterator1 crbegin1() const { return rbegin1(); }
  BOOST_UBLAS_INLINE
  const_reverse_iterator1 rend1() const { return const_reverse_iterator1(begin1()); }
  BOOST_UBLAS_INLINE
  const_reverse_iterator1 crend1() const { return rend1(); }
  ...
  BOOST_UBLAS_INLINE
  const_reverse_iterator2 crbegin2() const { return rbegin2(); }
  BOOST_UBLAS_INLINE
  const_reverse_iterator2 rend2() const { return const_reverse_iterator2(begin2()); }
  BOOST_UBLAS_INLINE
  const_reverse_iterator2 crend2() const { return rend2(); }
...
// Simple Projections
template <class M>
BOOST_UBLAS_INLINE matrix_range<M>
subrange(M & data,
...
template <class M>
BOOST_UBLAS_INLINE matrix_range<const M>
subrange(const M & data,
         typename M::size_type start1,
         typename M::size_type stop1,
         typename M::size_type start2,
         typename M::size_type stop2)
...
template <class M>
BOOST_UBLAS_INLINE const matrix_range<const M>
project(const M & data,
        const typename matrix_range<M>::range_type & r1,
        const typename matrix_range<M>::range_type & r2)
{
...
template <class M>
BOOST_UBLAS_INLINE const matrix_range<M>
project(const matrix_range<M> & data,
        const typename matrix_range<M>::range_type & r1,
        const typename matrix_range<M>::range_type & r2)
{
  return data.project(r1, r2);
...
template <class M>
struct matrix_temporary_traits<matrix_range<M>> : matrix_temporary_traits<M>
{
};
template <class M>
struct matrix_temporary_traits<const matrix_range<M>> : matrix_temporary_traits<M>
{
};

template <class M>
struct vector_temporary_traits<matrix_range<M>> : vector_temporary_traits<M>
{
};
template <class M>
struct vector_temporary_traits<const matrix_range<M>> : vector_temporary_traits<M>
{
};
...
public:
  ...
  difference_type stride2() const { return s2_.stride(); }
  BOOST_UBLAS_INLINE
  size_type size1() const { return s1_.size(); }
  BOOST_UBLAS_INLINE
  size_type size2() const { return s2_.size(); }
...
// Element access
#ifndef BOOST_UBLAS_PROXY_CONST_MEMBER
  BOOST_UBLAS_INLINE
  const_reference operator()(size_type i, size_type j) const { return data_(s1_(i), s2_(j)); }
  BOOST_UBLAS_INLINE
  reference operator()(size_type i, size_type j) { return data_(s1_(i), s2_(j)); }
#else
  BOOST_UBLAS_INLINE
  reference operator()(size_type i, size_type j) const { return data_(s1_(i), s2_(j)); }
#endif
  ...
  {
    return matrix_slice<matrix_type>(data_,
                                     s1_.compose(r1.preprocess(data_.size1())),
                                     s2_.compose(r2.preprocess(data_.size2())),
                                     0);
  }
  BOOST_UBLAS_INLINE
  ...
  {
    return matrix_slice<matrix_type>(data_,
                                     s1_.compose(s1.preprocess(data_.size1())),
                                     s2_.compose(s2.preprocess(data_.size2())),
                                     0);
  }
  ...
  BOOST_UBLAS_INLINE
  matrix_slice & assign_temporary(matrix_slice & ms) { return *this = ms; }
  template <class AE>
  ...
  // Closure comparison
  BOOST_UBLAS_INLINE
  bool same_closure(const matrix_slice & ms) const { return (*this).data_.same_closure(ms.data_); }
  ...
  BOOST_UBLAS_INLINE
  friend void swap(matrix_slice ms1, matrix_slice ms2) { ms1.swap(ms2); }
...
// Iterators simply are indices.
  ...
  public:
    ...
    BOOST_UBLAS_INLINE
    const_iterator1(const self_type & ms,
                    const const_subiterator1_type & it1,
                    const const_subiterator2_type & it2)
    ...
    // Indices
    BOOST_UBLAS_INLINE
    size_type index1() const { return it1_.index(); }
    BOOST_UBLAS_INLINE
    size_type index2() const { return it2_.index(); }
  ...
  class const_iterator2
      : public container_const_reference<matrix_slice>,
        public iterator_base_traits<typename M::const_iterator2::iterator_category>::
            template iterator_base<const_iterator2, value_type>::type
  {
  public:
    ...
    BOOST_UBLAS_INLINE
    const_iterator2(const self_type & ms,
                    const const_subiterator1_type & it1,
                    const const_subiterator2_type & it2)
      : container_const_reference<self_type>(ms), it1_(it1), it2_(it2)
    {
  ...
  class iterator2 : public container_reference<matrix_slice>,
                    public iterator_base_traits<typename M::iterator2::iterator_category>::
                        template iterator_base<iterator2, value_type>::type
  {
  public:
...
// Simple Projections
template <class M>
BOOST_UBLAS_INLINE matrix_slice<M>
subslice(M & data,
         typename M::size_type start1,
         ...
         typename M::size_type size2)
{
  ...
  return matrix_slice<M>(
      data, slice_type(start1, stride1, size1), slice_type(start2, stride2, size2));
}
template <class M>
BOOST_UBLAS_INLINE matrix_slice<const M>
...
template <class M>
BOOST_UBLAS_INLINE const matrix_slice<const M>
project(const M & data,
        const typename matrix_slice<M>::slice_type & s1,
        const typename matrix_slice<M>::slice_type & s2)
{
...
// ISSUE in the following two functions it would be logical to use matrix_slice<V>::range_type but
// this confuses VC7.1 and 8.0
template <class M>
BOOST_UBLAS_INLINE matrix_slice<M>
project(matrix_slice<M> & data,
        const typename matrix_range<M>::range_type & r1,
        const typename matrix_range<M>::range_type & r2)
{
  return data.project(r1, r2);
...
template <class M>
BOOST_UBLAS_INLINE const matrix_slice<M>
project(const matrix_slice<M> & data,
        const typename matrix_range<M>::range_type & r1,
        const typename matrix_range<M>::range_type & r2)
{
  return data.project(r1, r2);
...
// Specialization of temporary_traits
template <class M>
struct matrix_temporary_traits<matrix_slice<M>> : matrix_temporary_traits<M>
{
};
template <class M>
struct matrix_temporary_traits<const matrix_slice<M>> : matrix_temporary_traits<M>
{
};

template <class M>
struct vector_temporary_traits<matrix_slice<M>> : vector_temporary_traits<M>
{
};
template <class M>
struct vector_temporary_traits<const matrix_slice<M>> : vector_temporary_traits<M>
{
};
...
/** \brief A matrix referencing a non continuous submatrix of elements given another matrix of
 * indices.
 *
 * It is the most general version of any submatrices because it uses another matrix of indices to
 * reference
 * the submatrix.
 *
 * The matrix of indices can be of any type with the restriction that its elements must be
 * type-compatible with the size_type \c of the container. In practice, the following are good
 * candidates:
 * - \c boost::numeric::ublas::indirect_array<A> where \c A can be \c int, \c size_t, \c long,
 * etc...
 * - \c boost::numeric::ublas::matrix<int> can work too (\c int can be replaced by another integer
 * type)
 * - etc...
 *
 * An indirect matrix can be used as a normal matrix in any expression. If the specified indirect
 * matrix
 * falls outside that of the indices of the matrix, then the \c matrix_indirect is not a well formed
 * \i Matrix \i Expression and access to an element outside of indices of the matrix is \b
 * undefined.
 *
...
public:
  ...
  BOOST_UBLAS_INLINE
  matrix_indirect(matrix_type & data,
                  const indirect_array_type & ia1,
                  const indirect_array_type & ia2)
  ...
  BOOST_UBLAS_INLINE
  matrix_indirect(const matrix_closure_type & data,
                  const indirect_array_type & ia1,
                  const indirect_array_type & ia2,
                  int)
    : data_(data), ia1_(ia1.preprocess(data.size1())), ia2_(ia2.preprocess(data.size2()))
  ...
  // Accessors
  BOOST_UBLAS_INLINE
  size_type size1() const { return ia1_.size(); }
  BOOST_UBLAS_INLINE
  size_type size2() const { return ia2_.size(); }
  BOOST_UBLAS_INLINE
  const indirect_array_type & indirect1() const { return ia1_; }
  BOOST_UBLAS_INLINE
  indirect_array_type & indirect1() { return ia1_; }
...
// Element access
#ifndef BOOST_UBLAS_PROXY_CONST_MEMBER
  BOOST_UBLAS_INLINE
  const_reference operator()(size_type i, size_type j) const { return data_(ia1_(i), ia2_(j)); }
  BOOST_UBLAS_INLINE
  reference operator()(size_type i, size_type j) { return data_(ia1_(i), ia2_(j)); }
#else
  BOOST_UBLAS_INLINE
  reference operator()(size_type i, size_type j) const { return data_(ia1_(i), ia2_(j)); }
#endif
  ...
  // Critical is that matrix_type and data_ (vector_closure_type) are const correct
  BOOST_UBLAS_INLINE
  matrix_indirect<matrix_type, indirect_array_type> project(const range_type & r1,
                                                            const range_type & r2) const
  {
    return matrix_indirect<matrix_type, indirect_array_type>(
        data_,
        ia1_.compose(r1.preprocess(data_.size1())),
        ia2_.compose(r2.preprocess(data_.size2())),
        0);
  }
  BOOST_UBLAS_INLINE
  matrix_indirect<matrix_type, indirect_array_type> project(const slice_type & s1,
                                                            const slice_type & s2) const
  {
    return matrix_indirect<matrix_type, indirect_array_type>(
        data_,
        ia1_.compose(s1.preprocess(data_.size1())),
        ia2_.compose(s2.preprocess(data_.size2())),
        0);
  }
  BOOST_UBLAS_INLINE
  matrix_indirect<matrix_type, indirect_array_type> project(const indirect_array_type & ia1,
                                                            const indirect_array_type & ia2) const
  {
    return matrix_indirect<matrix_type, indirect_array_type>(
        data_,
        ia1_.compose(ia1.preprocess(data_.size1())),
        ia2_.compose(ia2.preprocess(data_.size2())),
        0);
  }
  ...
  BOOST_UBLAS_INLINE
  matrix_indirect & assign_temporary(matrix_indirect & mi) { return *this = mi; }
  template <class AE>
  ...
  BOOST_UBLAS_INLINE
  friend void swap(matrix_indirect mi1, matrix_indirect mi2) { mi1.swap(mi2); }
...
// Iterators simply are indices.
  ...
  public:
    ...
    const_iterator1() : container_const_reference<self_type>(), it1_(), it2_() {}
    BOOST_UBLAS_INLINE
    const_iterator1(const self_type & mi,
                    const const_subiterator1_type & it1,
                    const const_subiterator2_type & it2)
  ...
  public:
    ...
    const_iterator2() : container_const_reference<self_type>(), it1_(), it2_() {}
    BOOST_UBLAS_INLINE
    const_iterator2(const self_type & mi,
                    const const_subiterator1_type & it1,
                    const const_subiterator2_type & it2)
      : container_const_reference<self_type>(mi), it1_(it1), it2_(it2)
    {
...
BOOST_UBLAS_INLINE matrix_indirect<M, indirect_array<A>>
...
template <class M, class A>
BOOST_UBLAS_INLINE const matrix_indirect<const M, indirect_array<A>>
...
template <class M, class IA>
BOOST_UBLAS_INLINE matrix_indirect<M, IA>
project(matrix_indirect<M, IA> & data,
...
template <class M, class IA>
BOOST_UBLAS_INLINE const matrix_indirect<M, IA>
project(const matrix_indirect<M, IA> & data,
        const typename matrix_indirect<M, IA>::range_type & r1,
        const typename matrix_indirect<M, IA>::range_type & r2)
{
  return data.project(r1, r2);
...
template <class M, class A>
BOOST_UBLAS_INLINE matrix_indirect<M, indirect_array<A>>
project(matrix_indirect<M, indirect_array<A>> & data,
...
template <class M, class A>
BOOST_UBLAS_INLINE const matrix_indirect<M, indirect_array<A>>
project(const matrix_indirect<M, indirect_array<A>> & data,
        const indirect_array<A> & ia1,
        const indirect_array<A> & ia2)
{
  return data.project(ia1, ia2);
...
/// Specialization of temporary_traits
template <class M>
struct matrix_temporary_traits<matrix_indirect<M>> : matrix_temporary_traits<M>
{
};
template <class M>
struct matrix_temporary_traits<const matrix_indirect<M>> : matrix_temporary_traits<M>
{
};

template <class M>
struct vector_temporary_traits<matrix_indirect<M>> : vector_temporary_traits<M>
{
};
template <class M>
struct vector_temporary_traits<const matrix_indirect<M>> : vector_temporary_traits<M>
{
};
}
}

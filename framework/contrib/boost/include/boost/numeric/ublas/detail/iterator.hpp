...
public:
  ...
  BOOST_UBLAS_INLINE
  const container_type & operator()() const { return *c_; }
  ...
  // Closure comparison
  BOOST_UBLAS_INLINE
  bool same_closure(const container_const_reference & cr) const { return c_ == cr.c_; }
...
public:
  ...
  BOOST_UBLAS_INLINE
  container_type & operator()() const { return *c_; }
  ...
  // Closure comparison
  BOOST_UBLAS_INLINE
  bool same_closure(const container_reference & cr) const { return c_ == cr.c_; }
...
struct random_access_iterator_base : public std::iterator<IC, T>
{
  ...
  /* FIXME Need to explicitly pass derived_reference_type as otherwise I undefined type or forward
  declared
...
public:
  ...
  // Arithmetic
  BOOST_UBLAS_INLINE
  reverse_iterator_base & operator++() { return *this = --this->base(); }
  BOOST_UBLAS_INLINE
  ...
  BOOST_UBLAS_INLINE
  reverse_iterator_base & operator+=(difference_type n) { return *this = this->base() - n; }
  BOOST_UBLAS_INLINE
  reverse_iterator_base & operator-=(difference_type n) { return *this = this->base() + n; }
  ...
  BOOST_UBLAS_INLINE
  friend difference_type operator-(const reverse_iterator_base & it1,
                                   const reverse_iterator_base & it2)
  {
    return it2.base() - it1.base();
  }

  BOOST_UBLAS_INLINE
  const container_type & operator()() const { return this->base()(); }
...
public:
  ...
  // Arithmetic
  BOOST_UBLAS_INLINE
  reverse_iterator_base1 & operator++() { return *this = --this->base(); }
  BOOST_UBLAS_INLINE
  ...
  BOOST_UBLAS_INLINE
  reverse_iterator_base1 & operator+=(difference_type n) { return *this = this->base() - n; }
  BOOST_UBLAS_INLINE
  reverse_iterator_base1 & operator-=(difference_type n) { return *this = this->base() + n; }
  ...
  BOOST_UBLAS_INLINE
  friend difference_type operator-(const reverse_iterator_base1 & it1,
                                   const reverse_iterator_base1 & it2)
  {
    return it2.base() - it1.base();
  }
...
public:
  ...
  // Arithmetic
  BOOST_UBLAS_INLINE
  reverse_iterator_base2 & operator++() { return *this = --this->base(); }
  BOOST_UBLAS_INLINE
  ...
  BOOST_UBLAS_INLINE
  reverse_iterator_base2 & operator+=(difference_type n) { return *this = this->base() - n; }
  BOOST_UBLAS_INLINE
  reverse_iterator_base2 & operator-=(difference_type n) { return *this = this->base() + n; }
  ...
  BOOST_UBLAS_INLINE
  friend difference_type operator-(const reverse_iterator_base2 & it1,
                                   const reverse_iterator_base2 & it2)
  {
    return it2.base() - it1.base();
  }
...
public:
  ...
  BOOST_UBLAS_INLINE
  dual_iterator_type begin() const { return (*this)().find2(1, index1(), 0); }
  BOOST_UBLAS_INLINE
  dual_iterator_type end() const { return (*this)().find2(1, index1(), (*this)().size2()); }
  BOOST_UBLAS_INLINE
  dual_reverse_iterator_type rbegin() const { return dual_reverse_iterator_type(end()); }
  BOOST_UBLAS_INLINE
  dual_reverse_iterator_type rend() const { return dual_reverse_iterator_type(begin()); }
...
public:
  ...
  BOOST_UBLAS_INLINE
  dual_iterator_type begin() const { return (*this)().find1(1, 0, index2()); }
  BOOST_UBLAS_INLINE
  dual_iterator_type end() const { return (*this)().find1(1, (*this)().size1(), index2()); }
  BOOST_UBLAS_INLINE
  dual_reverse_iterator_type rbegin() const { return dual_reverse_iterator_type(end()); }
  BOOST_UBLAS_INLINE
  dual_reverse_iterator_type rend() const { return dual_reverse_iterator_type(begin()); }

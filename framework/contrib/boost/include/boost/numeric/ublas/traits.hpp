...
typename boost::enable_if<mpl::and_<boost::is_float<R>, boost::is_integral<I>>,
...
struct promote_traits
{
  ...
  static const std::size_t size =
      sizeof(type_deduction_detail::test<typename base_type::x_type, typename base_type::y_type>(
          x + y) // Use x+y to stand of all the arithmetic actions
             );

  static const std::size_t index = (size / sizeof(char)) - 1;
  typedef typename mpl::at_c<typename base_type::types, index>::type id;
...
struct scalar_traits
{
  ...
  typedef T real_type;
  typedef real_type
      precision_type; // we do not know what type has more precision then the real_type
  ...
  static BOOST_UBLAS_INLINE real_type imag(const_reference /*t*/) { return 0; }
  ...
  static BOOST_UBLAS_INLINE real_type norm_1(const_reference t) { return self_type::type_abs(t); }
  static BOOST_UBLAS_INLINE real_type norm_2(const_reference t) { return self_type::type_abs(t); }
  static BOOST_UBLAS_INLINE real_type norm_inf(const_reference t) { return self_type::type_abs(t); }
  ...
  static BOOST_UBLAS_INLINE bool equals(const_reference t1, const_reference t2)
  {
    return self_type::norm_inf(t1 - t2) <
           BOOST_UBLAS_TYPE_CHECK_EPSILON *
               (std::max)((std::max)(self_type::norm_inf(t1), self_type::norm_inf(t2)),
...
struct complex_traits
{
  ...
  static BOOST_UBLAS_INLINE real_type real(const_reference t) { return std::real(t); }
  static BOOST_UBLAS_INLINE real_type imag(const_reference t) { return std::imag(t); }
  static BOOST_UBLAS_INLINE value_type conj(const_reference t) { return std::conj(t); }

  static BOOST_UBLAS_INLINE real_type type_abs(const_reference t) { return abs(t); }
  static BOOST_UBLAS_INLINE value_type type_sqrt(const_reference t) { return sqrt(t); }

  static BOOST_UBLAS_INLINE real_type norm_1(const_reference t)
  {
    return self_type::type_abs(t);
    // original computation has been replaced because a complex number should behave like a scalar
    // type
...
struct type_traits<boost::numeric::interval<long double>>
    : scalar_traits<boost::numeric::interval<long double>>
{
...
template <>
struct iterator_restrict_traits<packed_random_access_iterator_tag,
                                sparse_bidirectional_iterator_tag>
{
  typedef sparse_bidirectional_iterator_tag iterator_category;
};
template <>
struct iterator_restrict_traits<sparse_bidirectional_iterator_tag,
...
template <class I>
BOOST_UBLAS_INLINE void
increment(I & it, const I & it_end, typename I::difference_type compare)
{
...
/**  \brief Traits class to extract additional type information from a mutable matrix or vector
 * CONTAINER.
 *
 */
template <class E>
 ...
 */
template <class E>
struct container_traits : container_view_traits<E>, mutable_container_traits<E>
{
};
 ...
 */
template <class MATRIX>
struct mutable_matrix_traits : mutable_container_traits<MATRIX>
{
 ...
 */
template <class MATRIX>
struct matrix_traits : matrix_view_traits<MATRIX>, mutable_matrix_traits<MATRIX>
{
};
...
struct vector_view_traits : container_view_traits<VECTOR>
{
  ...
  static const_iterator begin(const VECTOR & v) { return v.begin(); }
  /// iterator pointing behind the last element
  static const_iterator end(const VECTOR & v) { return v.end(); }
};
...
struct mutable_vector_traits : mutable_container_traits<VECTOR>
{
  ...
  /// iterator pointing to the first element
  static iterator begin(VECTOR & v) { return v.begin(); }

  /// iterator pointing behind the last element
  static iterator end(VECTOR & v) { return v.end(); }
};
 ...
 */
template <class VECTOR>
struct vector_traits : vector_view_traits<VECTOR>, mutable_vector_traits<VECTOR>
{
};

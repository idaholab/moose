...
/** \brief Expception raised when some interal errors occurs like computations errors, zeros values
 * where you should not have zeros, etc...
 */
...
#define BOOST_UBLAS_CHECK(expression, e)                                                           \
  if (!(expression))                                                                               \
  {                                                                                                \
    std::cerr << "Check failed in file " << __FILE__ << " at line " << __LINE__ << ":"             \
              << std::endl;                                                                        \
...
#else
#define BOOST_UBLAS_CHECK_FALSE(e) e.raise();
#define BOOST_UBLAS_CHECK(expression, e)                                                           \
  if (!(expression))                                                                               \
  {                                                                                                \
    e.raise();                                                                                     \

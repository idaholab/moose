...
inline void
for_each1(Iterator1 first1, Iterator1 last1, Operation op)
{
  for (; first1 != last1;)
    op(*first1++);
}
...
inline void
for_each2(Iterator1 first1, Iterator1 last1, Iterator2 first2, Operation op)
{
  for (; first1 != last1;)
    op(*first1++, *first2++);
}
...
inline void
for_each3(Iterator1 first1, Iterator1 last1, Iterator2 first2, Iterator3 first3, Operation op)
{
  for (; first1 != last1;)

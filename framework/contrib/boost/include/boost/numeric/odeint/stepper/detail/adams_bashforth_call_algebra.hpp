...
struct adams_bashforth_call_algebra<1, Algebra, Operations>
{
  ...
  void operator()(Algebra & algebra,
                  const StateIn & in,
                  StateOut & out,
                  const StepStorage & steps,
...
struct adams_bashforth_call_algebra<2, Algebra, Operations>
{
  ...
  {
    typedef typename Coefficients::value_type value_type;
    algebra.for_each4(out,
                      in,
                      steps[0].m_v,
                      steps[1].m_v,
                      typename Operations::template scale_sum3<value_type, Time, Time>(
                          1.0, dt * coef[0], dt * coef[1]));
  }
};
...
struct adams_bashforth_call_algebra<8, Algebra, Operations>
{
                  ...
                  Time dt) const
  {
    ...
    algebra.for_each10(
        ...
        steps[7].m_v,
        typename Operations::
            template scale_sum9<value_type, Time, Time, Time, Time, Time, Time, Time>(1.0,
                                                                                      dt * coef[0],
                                                                                      dt * coef[1],
                                                                                      dt * coef[2],
                                                                                      dt * coef[3],

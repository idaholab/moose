...
public:
                    ...
                    time_type dt)
  {
    ...
    stepper_base_type::m_algebra.for_each6(
        ...
        m_dxm.m_v,
        m_dxh.m_v,
        typename operations_type::
            template scale_sum5<value_type, time_type, time_type, time_type, time_type>(
                1.0, dt6, dt3, dt3, dt6));

    // x += dt/6 * m_dxdt + dt/3 * m_dxt )
    // stepper_base_type::m_algebra.for_each4( out , in , dxdt , m_dxt.m_v ,
    //                                         typename operations_type::template scale_sum3<
    //                                         value_type , time_type , time_type >( 1.0 , dt6 , dt3
    //                                         ) );
    // // x += dt/3 * m_dxm + dt/6 * m_dxh )
    // stepper_base_type::m_algebra.for_each4( out , out , m_dxm.m_v , m_dxh.m_v ,
    //                                         typename operations_type::template scale_sum3<
    //                                         value_type , time_type , time_type >( 1.0 , dt3 , dt6
    //                                         ) );
  }

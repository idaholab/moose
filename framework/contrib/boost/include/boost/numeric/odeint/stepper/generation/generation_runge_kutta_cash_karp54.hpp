/*
 ...
 [begin_description]
 Enable the factory functions for the controller and the dense output of the Runge-Kutta-Cash-Karp
 54 method.
 [end_description]
...
struct get_controller<
    runge_kutta_cash_karp54<State, Value, Deriv, Time, Algebra, Operations, Resize>>
{
  typedef runge_kutta_cash_karp54<State, Value, Deriv, Time, Algebra, Operations, Resize>
      stepper_type;

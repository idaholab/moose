...
struct generic_rk_call_algebra<1, Algebra>
{
  ...
  void
  operator()(algebra_type & algebra, S1 & s1, S2 & s2, S3 & s3, S4 * /* s4_array */, Op op) const
  {
...
struct generic_rk_call_algebra<5, Algebra>
{
  ...
  {
    algebra.for_each7(
        s1, s2, s3, s4_array[0].m_v, s4_array[1].m_v, s4_array[2].m_v, s4_array[3].m_v, op);
  }
  ...
  {
    algebra.for_each6(
        s1, s2, s4_array[0].m_v, s4_array[1].m_v, s4_array[2].m_v, s4_array[3].m_v, op);
  }
};

...
{
  rk54_ck_coefficients_a1(void) { (*this)[0] = static_cast<Value>(1) / static_cast<Value>(5); }
};
...
#ifndef DOXYGEN_SKIP
class runge_kutta_cash_karp54 : public explicit_error_generic_rk<6,
                                                                 5,
                                                                 5,
                                                                 4,
                                                                 State,
...
public:
#ifndef DOXYGEN_SKIP
  typedef explicit_error_generic_rk<6,
                                    5,
                                    5,
                                    4,
                                    State,
  ...
  runge_kutta_cash_karp54(const algebra_type & algebra = algebra_type())
    : stepper_base_type(boost::fusion::make_vector(rk54_ck_coefficients_a1<Value>(),
                                                   rk54_ck_coefficients_a2<Value>(),
                                                   rk54_ck_coefficients_a3<Value>(),
                                                   rk54_ck_coefficients_a4<Value>(),
                                                   rk54_ck_coefficients_a5<Value>()),
                        rk54_ck_coefficients_b<Value>(),
                        rk54_ck_coefficients_db<Value>(),

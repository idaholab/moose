...
template <size_t StageCount, class Value, class Algebra, class Operations>
...
public:
  ...
  struct stage_vector : public stage_vector_base
  {
    struct do_insertion
    {
      ...
      void operator()(Index) const
      {
        ...
        // intermediate_stage >( m_c[ Index::value ] , boost::fusion::at< Index >( m_a ) );
  ...
  struct calculate_stage
  {
    ...
    calculate_stage(Algebra & _algebra,
                    System & _system,
                    const StateIn & _x,
                    const DerivIn & _dxdt,
                    StateOut & _out,
    ...
    // typename stage_fusion_wrapper< T , mpl::size_t< stage_number > , intermediate_stage >::type
    // const &stage ) const
    {
      if (stage_number > 1)
      {
...
#pragma warning(default : 4307 34)
  ...
  template <class System,
            ...
            class StateTemp,
            class Deriv>
  void inline do_step(Algebra & algebra,
                      System system,
                      const StateIn & in,
                      const DerivIn & dxdt,
                      Time t,

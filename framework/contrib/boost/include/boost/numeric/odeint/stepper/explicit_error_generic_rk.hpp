...
public:
#ifndef DOXYGEN_SKIP
  typedef explicit_error_stepper_base<explicit_error_generic_rk<StageCount,
                                                                Order,
                                                                StepperOrder,
                                                                ErrorOrder,
                                                                State,
...
#ifndef DOXYGEN_SKIP
  typedef explicit_error_generic_rk<StageCount,
                                    Order,
                                    StepperOrder,
                                    ErrorOrder,
                                    State,
...
public:
                    ...
                    Err & xerr)
  {
    ...
    detail::template generic_rk_call_algebra<StageCount, algebra_type>()(
        stepper_base_type::m_algebra,
        xerr,
        dxdt,
        m_F,
        detail::generic_rk_scale_sum_err<StageCount, operations_type, value_type, time_type>(m_b2,
                                                                                             dt));
  }
...
/**
 * \class explicit_error_generic_rk
 * \brief A generic implementation of explicit Runge-Kutta algorithms with error estimation. This
 * class is as a
...
/**
 * \fn explicit_error_generic_rk::explicit_error_generic_rk( const coef_a_type &a , const
 * coef_b_type &b , const coef_b_type &b2 , const coef_c_type &c , const algebra_type &algebra )
 * \brief Constructs the explicit_error_generik_rk class with the given parameters a, b, b2 and c.
...
/**
 * \fn explicit_error_generic_rk::do_step_impl( System system , const StateIn &in , const DerivIn
 ...
 * Futhermore, an
 * estimation of the error is stored in `xerr`. `do_step_impl` is used by

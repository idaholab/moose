...
class adaptive_iterator
    : public adaptive_iterator_impl<adaptive_iterator<Stepper, System, State, StepperTag>,
                                    Stepper,
                                    System,
                                    State,
...
make_adaptive_iterator_begin(Stepper stepper,
                             System system,
                             State & x,
...
make_adaptive_range(Stepper stepper,
                    System system,
                    State & x,
                    typename traits::time_type<Stepper>::type t_start,
                    typename traits::time_type<Stepper>::type t_end,
 ...
 * \class adaptive_iterator
 *
 * \brief ODE Iterator with adaptive step size. The value type of this iterator is the state type of
 * the stepper.
 *
 ...
 * \fn make_adaptive_range( Stepper stepper , System system , State &x ,
    ...
    typename traits::time_type< Stepper >::type dt )
 *
 * \brief Factory function to construct a single pass range of adaptive iterators. A range is here a
 pair of adaptive_iterator.
 *
 * \param stepper The stepper to use during the iteration.
 * \param system The system function (ODE) to solve.
 * \param x The initial state.

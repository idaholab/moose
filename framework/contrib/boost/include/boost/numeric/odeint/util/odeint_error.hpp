...
{
public:
  odeint_error(const std::string & s) : std::runtime_error(s) {}
};
...
{
public:
  no_progress_error(const std::string & s) : odeint_error(s) {}
};
...
{
public:
  step_adjustment_error(const std::string & s) : odeint_error(s) {}
};
}
}
}

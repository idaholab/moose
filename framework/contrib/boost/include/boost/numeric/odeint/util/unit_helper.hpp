...
template <class T>
typename detail::get_unit_value_impl<T>::result_type
...
struct inverse_time<boost::units::quantity<Unit, Value>>
{
  ...
  typedef
      typename boost::mpl::divides<boost::units::dimensionless_type, dimension>::type inv_dimension;

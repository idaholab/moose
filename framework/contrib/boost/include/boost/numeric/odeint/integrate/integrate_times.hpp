...
/*
 * \brief Integrates while calling the observer at the time points given by sequence [times_start,
 * time_end)
                ...
                StepOverflowChecker checker)
{
  ...
  return detail::integrate_times(checked_stepper<stepper_type, checker_type>(stepper, checker),
                                 system,
                                 start_state,
                                 times_start,
                                 times_end,
                ...
                StepOverflowChecker checker)
{
  return integrate_times(
      stepper, system, start_state, boost::begin(times), boost::end(times), dt, observer, checker);
}
                ...
                Observer observer)
{
  ...
  return detail::integrate_times(
      stepper, system, start_state, times_start, times_end, dt, observer, stepper_category());
}
...
{
  return integrate_times(
      stepper, system, start_state, boost::begin(times), boost::end(times), dt, observer);
}

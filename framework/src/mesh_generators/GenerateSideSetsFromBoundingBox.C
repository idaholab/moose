...
#include "GenerateSideSetsFromBoundingBox.h"
...
registerMooseObject("MooseApp", GenerateSideSetsFromBoundingBox);

template <>
InputParameters
validParams<GenerateSideSetsFromBoundingBox>()
{
...
GenerateSideSetsFromBoundingBox::generate()
{

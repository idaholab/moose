...
StitchedMeshGenerator::generate()
{
  ...
  std::unique_ptr<ReplicatedMesh> mesh = dynamic_pointer_cast<MeshBase, ReplicatedMesh>(*_mesh_ptrs[0]);
  ...
  {
    _meshes.push_back(dynamic_pointer_cast<MeshBase, ReplicatedMesh>(*_mesh_ptrs[i]));
  }

...
template <>
InputParameters
validParams<GenerateSideSetsBase>()
{
...
GenerateSideSetsBase::GenerateSideSetsBase(const InputParameters & parameters)
...
GenerateSideSetsBase::~GenerateSideSetsBase() {}

void
GenerateSideSetsBase::setup(MeshBase & mesh)
{

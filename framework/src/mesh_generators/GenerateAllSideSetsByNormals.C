...
registerMooseObject("MooseApp", GenerateAllSideSetsByNormals);

template <>
InputParameters
validParams<GenerateAllSideSetsByNormals>()
{
...
GenerateAllSideSetsByNormals::generate()
{
...
boundary_id_type
GenerateAllSideSetsByNormals::getNextBoundaryID()
{

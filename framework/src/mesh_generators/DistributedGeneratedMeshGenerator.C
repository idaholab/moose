...
#include "DistributedGeneratedMeshGenerator.h"
...
template <>
InputParameters
validParams<DistributedGeneratedMeshGenerator>()
{
...
DistributedGeneratedMeshGenerator::generate()
{
  ...
  switch (_dim)
  {
    ...
    case 1:
      build_cube<Edge2>(static_cast<UnstructuredMesh &>(*mesh),
                        _nx,
                        1,
                        1,
                        _xmin,
      ...
      break;
    case 2:
      build_cube<Quad4>(static_cast<UnstructuredMesh &>(*mesh),
                        _nx,
                        _ny,
                        1,
                        _xmin,
      ...
      break;
    case 3:
      build_cube<Hex8>(static_cast<UnstructuredMesh &>(*mesh),
                       _nx,
                       _ny,
                       _nz,
                       _xmin,

        ...
        switch (etype)
        {
          ...
          case libMesh::C0POLYGON:
          {
            ...
            for (const auto side_i : make_range(num_sides))
            {
              ...
              vert_side->set_node(0, mesh->node_ptr(elem->node_ptr(side_i)->id()));
              ...
              vert_side->set_node(
                  3, mesh->node_ptr(elem->node_ptr(side_i)->id() + (current_layer * orig_nodes)));

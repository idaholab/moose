...
ParsedGenerateSideset::validParams()
{
  ...
  params.addClassDescription(
      ...
      "the `combinatorial_geometry` expression. Optionally, additional constraints can be imposed "
      "based on the side's normal, the subdomain of the element, or whether the side is already "
      "part (or not) of an existing boundary.");

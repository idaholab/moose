...
CutMeshByPlaneGenerator::hexNodeOptimizer(
...
void
CutMeshByPlaneGenerator::hexElemSplitter(ReplicatedMesh & mesh,
...
std::vector<unsigned int>
CutMeshByPlaneGenerator::nodeRotationPRISM6(unsigned int min_id_index,
                                            std::vector<unsigned int> & face_rotation) const
{
...
std::vector<std::vector<Node *>>
CutMeshByPlaneGenerator::prismNodeOptimizer(
...
void
CutMeshByPlaneGenerator::prismElemSplitter(ReplicatedMesh & mesh,
                                           const dof_id_type elem_id,
                                           std::vector<dof_id_type> & converted_elems_ids)
{
  // Build boundary information of the mesh
...
std::vector<unsigned int>
CutMeshByPlaneGenerator::nodeRotationPYRAMIND5(unsigned int min_id_index,
                                               std::vector<unsigned int> & face_rotation) const
{
  const std::vector<std::vector<unsigned int>> preset_indices = {
...
std::vector<std::vector<Node *>>
CutMeshByPlaneGenerator::pyramidNodeOptimizer(
...
void
CutMeshByPlaneGenerator::pyramidElemSplitter(ReplicatedMesh & mesh,
                                             const dof_id_type elem_id,
                                             std::vector<dof_id_type> & converted_elems_ids)
{
  // Build boundary information of the mesh

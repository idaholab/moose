...
MFEMSteady::init()
{
  ...
  _problem_data.eqn_system->Init(_problem_data.gridfunctions, _problem_data.cpx_gridfunctions, _problem_data.fespaces, getParam<MooseEnum>("assembly_level").getEnum<mfem::AssemblyLevel>());

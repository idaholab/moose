...
CubitElementInfo::CubitElementInfo(int num_nodes_per_element, int dimension)
{
  switch (dimension)
  {
    case 1:
    {
      buildCubit1DElementInfo(num_nodes_per_element);
      break;
    }
    case 2:
    {
...
void
CubitElementInfo::buildCubit1DElementInfo(int num_nodes_per_element)
{
  _dimension = 1;
  ...
  switch (num_nodes_per_element)
  {
    case 2:
    {
      ...
      _num_corner_nodes = 2;
      _num_faces = 2;
      _face_info = {CubitFaceInfo(CubitFaceInfo::FACE_POINT1)};
      break;
    }
    case 3:
    {
    ...
    default:
    {
      mooseError("Unsupported 1D element with ", num_nodes_per_element, " nodes per element.");
      break;
    }
  }
}

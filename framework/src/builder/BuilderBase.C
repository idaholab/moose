...
BuilderBase::BuilderBase(std::shared_ptr<Parser> parser)
  : _parser(parser), _current_params(nullptr), _current_error_stream(nullptr)
{
  mooseAssert(_parser, "Parser is not set");
  mooseAssert(_parser->hasParsed(), "Has not parsed yet");
}

const Parser &
BuilderBase::parser() const
{
  mooseAssert(_parser, "Parser is not set");
  return *_parser;
}
...
std::string
BuilderBase::getPrimaryFileName(bool strip_leading_path) const
{
  const auto path = parser().getLastInputFilePath();
  return (strip_leading_path ? path.filename() : std::filesystem::absolute(path)).string();
}

std::string
BuilderBase::hitCLIFilter(const std::string & appname, CommandLine & command_line)
{
  auto & argv = command_line.getArguments();
...
BuilderBase::parseCLIArgs(const std::string & app_name, CommandLine & command_line)
{
  std::unique_ptr<hit::Node> cli_root;

  try
  {
    auto cli_input = hitCLIFilter(app_name, command_line);
...
template <>
void BuilderBase::setScalarParameter<RealVectorValue, RealVectorValue>(
...
template <>
void BuilderBase::setScalarParameter<Point, Point>(const std::string & full_name,
                                                   const std::string & short_name,
...
template <>
void BuilderBase::setScalarParameter<RealEigenVector, RealEigenVector>(
    const std::string & full_name,
    const std::string & short_name,
...
template <>
void BuilderBase::setScalarParameter<RealEigenMatrix, RealEigenMatrix>(
    const std::string & full_name,
    const std::string & short_name,
...
template <>
void BuilderBase::setScalarParameter<PostprocessorName, PostprocessorName>(
    const std::string & full_name,
    const std::string & short_name,
...
template <>
void
BuilderBase::setScalarParameter<MooseEnum, MooseEnum>(const std::string & full_name,
                                                      const std::string & short_name,
...
template <>
void BuilderBase::setScalarParameter<MultiMooseEnum, MultiMooseEnum>(
    const std::string & full_name,
    const std::string & short_name,
...
template <>
void BuilderBase::setScalarParameter<ExecFlagEnum, ExecFlagEnum>(
    const std::string & full_name,
    const std::string & short_name,
...
template <>
void BuilderBase::setScalarParameter<RealTensorValue, RealTensorValue>(
    const std::string & full_name,
    const std::string & short_name,
...
template <>
void BuilderBase::setScalarParameter<ReporterName, std::string>(
    const std::string & full_name,
    const std::string & short_name,
...
// Vectors
template <>
void BuilderBase::setVectorParameter<RealVectorValue, RealVectorValue>(
    const std::string & full_name,
    const std::string & short_name,
...
template <>
void BuilderBase::setVectorParameter<Point, Point>(
    const std::string & full_name,
    const std::string & short_name,
...
template <>
void BuilderBase::setVectorParameter<PostprocessorName, PostprocessorName>(
    const std::string & full_name,
    const std::string & short_name,
...
template <>
void BuilderBase::setVectorParameter<MooseEnum, MooseEnum>(
    const std::string & full_name,
    const std::string & short_name,
...
template <>
void BuilderBase::setVectorParameter<VariableName, VariableName>(
    const std::string & full_name,
    const std::string & short_name,
...
template <>
void BuilderBase::setVectorParameter<ReporterName, std::string>(
    const std::string & full_name,
    const std::string & short_name,
...
template <>
void BuilderBase::setVectorParameter<CLIArgString, std::string>(
    const std::string & full_name,
    const std::string & short_name,
...
template <>
void BuilderBase::setDoubleIndexParameter<Point>(
    const std::string & full_name,
    const std::string & short_name,
...
void
BuilderBase::extractParams(const std::string & prefix,
                           InputParameters & p,
                           ...
                           const std::optional<std::string> global_params_block_name)
{
  ...
  for (const auto & it : p)
  {
    ...
    for (const auto & param_name : p.paramAliases(it.first))
    {
      ...
      else if (global_params_block && global_params_block_name)
      {
...
std::unique_ptr<hit::Node>
BuilderBase::mergeCLIArgs(const std::string & app_name, CommandLine & command_line)
{
  auto cli_root = parseCLIArgs(app_name, command_line);
...
void
BuilderBase::setScalarParameter(const std::string & full_name,
                                const std::string & short_name,
...
template <typename T>
void
BuilderBase::setFilePathParam(const std::string & full_name,
                              const std::string & short_name,
                              InputParameters::Parameter<T> * param,
...
void
BuilderBase::setScalarValueTypeParameter(const std::string & full_name,
                                         const std::string & short_name,
                                         InputParameters::Parameter<T> * param,
                                         bool in_global,
                                         GlobalParamsAction * global_block)
...
template <typename T, typename Base>
void
BuilderBase::setVectorParameter(const std::string & full_name,
                                const std::string & short_name,
...
void
BuilderBase::setMapParameter(const std::string & full_name,
                             const std::string & short_name,
...
template <typename T>
void
BuilderBase::setVectorFilePathParam(const std::string & full_name,
                                    const std::string & short_name,
                                    InputParameters::Parameter<std::vector<T>> * param,
                                    InputParameters & params,
                                    bool in_global,
...
template <typename T>
void
BuilderBase::setDoubleIndexParameter(
    const std::string & full_name,
    const std::string & short_name,
...
template <typename T>
void
BuilderBase::setTripleIndexParameter(
    const std::string & full_name,
    const std::string & short_name,
...
template <typename T>
void
BuilderBase::setScalarComponentParameter(const std::string & full_name,
                                         const std::string & short_name,
                                         InputParameters::Parameter<T> * param,
                                         bool in_global,
                                         GlobalParamsAction * global_block)
...
template <typename T>
void
BuilderBase::setVectorComponentParameter(const std::string & full_name,
                                         const std::string & short_name,
                                         InputParameters::Parameter<std::vector<T>> * param,
                                         bool in_global,
                                         GlobalParamsAction * global_block)
...
template <typename T>
void
BuilderBase::setVectorVectorComponentParameter(
    const std::string & full_name,
    const std::string & short_name,
    InputParameters::Parameter<std::vector<std::vector<T>>> * param,
    bool in_global,
...
template <>
void
BuilderBase::setScalarParameter<RealVectorValue, RealVectorValue>(
    const std::string & full_name,
    const std::string & short_name,
    InputParameters::Parameter<RealVectorValue> * param,
    bool in_global,
...
template <>
void
BuilderBase::setScalarParameter<Point, Point>(const std::string & full_name,
                                              const std::string & short_name,
                                              InputParameters::Parameter<Point> * param,
                                              bool in_global,
                                              GlobalParamsAction * global_block)
...
template <>
void
BuilderBase::setScalarParameter<RealEigenVector, RealEigenVector>(
    const std::string & full_name,
    const std::string & short_name,
    InputParameters::Parameter<RealEigenVector> * param,
    bool in_global,
...
template <>
void
BuilderBase::setScalarParameter<RealEigenMatrix, RealEigenMatrix>(
    const std::string & full_name,
    const std::string & short_name,
    InputParameters::Parameter<RealEigenMatrix> * param,
    bool in_global,
...
template <>
void
BuilderBase::setScalarParameter<MultiMooseEnum, MultiMooseEnum>(
    const std::string & full_name,
    const std::string & short_name,
    InputParameters::Parameter<MultiMooseEnum> * param,
    bool in_global,
...
template <>
void
BuilderBase::setScalarParameter<ExecFlagEnum, ExecFlagEnum>(
    const std::string & full_name,
    const std::string & short_name,
    InputParameters::Parameter<ExecFlagEnum> * param,
    bool in_global,
...
template <>
void
BuilderBase::setScalarParameter<RealTensorValue, RealTensorValue>(
    const std::string & full_name,
    const std::string & short_name,
    InputParameters::Parameter<RealTensorValue> * param,
    bool in_global,
...
template <>
void
BuilderBase::setScalarParameter<PostprocessorName, PostprocessorName>(
    const std::string & full_name,
    const std::string & short_name,
    InputParameters::Parameter<PostprocessorName> * param,
    bool in_global,
...
template <>
void
BuilderBase::setScalarParameter<ReporterName, std::string>(
    const std::string & full_name,
    const std::string & /*short_name*/,
    InputParameters::Parameter<ReporterName> * param,
    bool /*in_global*/,
    GlobalParamsAction * /*global_block*/)
{
  std::vector<std::string> names = MooseUtils::rsplit(root().param<std::string>(full_name), "/", 2);
  if (names.size() != 2)
    _errmsg += hit::errormsg(root().find(full_name),
...
template <>
void
BuilderBase::setVectorParameter<RealVectorValue, RealVectorValue>(
    const std::string & full_name,
    const std::string & short_name,
    InputParameters::Parameter<std::vector<RealVectorValue>> * param,
    bool in_global,
...
template <>
void
BuilderBase::setVectorParameter<Point, Point>(
    const std::string & full_name,
    const std::string & short_name,
    InputParameters::Parameter<std::vector<Point>> * param,
    bool in_global,
...
template <>
void
BuilderBase::setVectorParameter<MooseEnum, MooseEnum>(
    const std::string & full_name,
    const std::string & short_name,
    InputParameters::Parameter<std::vector<MooseEnum>> * param,
    bool in_global,
...
template <>
void
BuilderBase::setVectorParameter<PostprocessorName, PostprocessorName>(
    const std::string & full_name,
    const std::string & short_name,
    InputParameters::Parameter<std::vector<PostprocessorName>> * param,
    bool in_global,
...
template <>
void
BuilderBase::setVectorParameter<VariableName, VariableName>(
    const std::string & full_name,
    const std::string & short_name,
    InputParameters::Parameter<std::vector<VariableName>> * param,
    bool /*in_global*/,
...
template <>
void
BuilderBase::setVectorParameter<ReporterName, std::string>(
    const std::string & full_name,
    const std::string & /*short_name*/,
    InputParameters::Parameter<std::vector<ReporterName>> * param,
    bool /*in_global*/,
...
template <>
void
BuilderBase::setVectorParameter<CLIArgString, std::string>(
    const std::string & full_name,
    const std::string & /*short_name*/,
    InputParameters::Parameter<std::vector<CLIArgString>> * param,
    bool /*in_global*/,
...
template <>
void
BuilderBase::setDoubleIndexParameter<Point>(
    const std::string & full_name,
    const std::string & short_name,
    InputParameters::Parameter<std::vector<std::vector<Point>>> * param,
    bool in_global,

...
BuilderBase::parseCLIArgs(CommandLine & command_line)
{
  std::unique_ptr<hit::Node> cli_root;

  try
  {
    auto cli_input = command_line.buildHitParams();
...
std::unique_ptr<hit::Node>
BuilderBase::mergeCLIArgs(CommandLine & command_line)
{
  auto cli_root = parseCLIArgs(command_line);

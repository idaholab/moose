...
// See vector type explanation
      ...
      else if (!extractCustomParams(full_name, short_name, par, in_global, global_params_block))
      {
...
bool
Parser::extractCustomParams(
    const std::string &, const std::string &, Parameters::Value *, bool, GlobalParamsAction *)
{
  return false;
}
...
template <>
bool
Parser::toBool<bool>(const std::string & s, bool & val)
{

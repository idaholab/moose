...
SurfaceEdge2::SurfaceEdge2(const Elem * elem)
  : LineSegment(elem->point(0), elem->point(1)), SurfaceElement(elem, LineSegment::normal())
{
  ...
  mooseAssert(MooseUtils::absoluteFuzzyEqual(elem->point(0)(2), elem->point(1)(2)),
              "Currently SurfaceEdge2 must be parallel to the x-y plane, i.e., z-coordinates of "

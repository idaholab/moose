                                ...
                                const std::vector<double> & graph_vals)
{
  ...
  plot_object.title().font().pointsize(16);
  ...
  plot_object.x1Axis().labelFont().pointsize(16);
  plot_object.x1Axis().tickLabelFont().pointsize(14);
  ...
  plot_object.y1Axis().labelFont().pointsize(16);
  plot_object.y1Axis().tickLabelFont().pointsize(14);

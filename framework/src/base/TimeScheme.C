...
_use_littlef(false),
_nl(c),
_solution_u_dot(c->addVector("u_dot", false, GHOSTED)),
_solution_du_dot_du(c->addVector("du_dot_du", false, GHOSTED)),
_residual_old( c->addVector("residual_old", false, GHOSTED)),
_predicted_solution(c->addVector("predicted_solution", false, GHOSTED)),
_tmp_previous_solution(c->addVector("tmp_previous_solution", false, GHOSTED)),
_tmp_residual_old(c->addVector("tmp_residual_old", false, GHOSTED)),
_tmp_solution_u_dot(c->addVector("tmp_solution_u_dot", false, GHOSTED)),

...
void AuxData::reinit(THREAD_ID tid, const NumericVector<Number>& soln, const Node & node)
{
...
void AuxData::reinit(THREAD_ID tid, const NumericVector<Number>& /*soln*/, const Elem & elem)
{

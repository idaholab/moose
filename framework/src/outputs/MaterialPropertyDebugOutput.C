...
MaterialPropertyDebugOutput::printMaterialMap() const
{
  ...
  {
    const MooseObjectWarehouse<Material> & warehouse = _problem_ptr->getVolumeMaterialWarehouse();
  ...
  {
    const MooseObjectWarehouse<Material> & warehouse = _problem_ptr->getBoundaryMaterialWarehouse();

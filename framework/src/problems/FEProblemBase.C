...
FEProblemBase::checkProblemIntegrity()
{
  ...
  // Coordinate transforms except with length_unit are only intended for use with MultiApps
  if (_mesh.hasCoordTransform() && _app.isUltimateMaster() && !hasMultiApps())
    mooseError(
        "Coordinate transformation parameters, 'alpha_rotation', 'beta_rotation', "

...
MooseMesh::MooseMesh(const InputParameters & parameters)
  : MooseObject(parameters),
    ...
    _prepare_timer(registerTimedSection("prepare")),
    _update_timer(registerTimedSection("update")),
    _mesh_changed_timer(registerTimedSection("meshChanged")),
    _cache_changed_lists_timer(registerTimedSection("cacheChangedLists")),
    _update_active_semi_local_node_range_timer(
        registerTimedSection("updateActiveSemiLocalNodeRange")),
    _build_node_list_timer(registerTimedSection("buildNodeList")),
    _build_bnd_elem_list_timer(registerTimedSection("buildBndElemList")),
    _node_to_elem_map_timer(registerTimedSection("nodeToElemMap")),
    _node_to_active_semilocal_elem_map_timer(registerTimedSection("nodeToActiveSemilocalElemMap")),
    _get_active_local_element_range_timer(registerTimedSection("getActiveLocalElementRange")),
    _get_active_node_range_timer(registerTimedSection("getActiveNodeRange")),
    _get_local_node_range_timer(registerTimedSection("getLocalNodeRange")),
    _get_boundary_node_range_timer(registerTimedSection("getBoundaryNodeRange")),
    _get_boundary_element_range_timer(registerTimedSection("getBoundaryElementRange")),
    _cache_info_timer(registerTimedSection("cacheInfo")),
    _build_periodic_node_map_timer(registerTimedSection("buildPeriodicNodeMap")),
    _build_periodic_node_sets_timer(registerTimedSection("buildPeriodicNodeSets")),
    _detect_orthogonal_dim_ranges_timer(registerTimedSection("detectOrthogonalDimRanges")),
    _detect_paired_sidesets_timer(registerTimedSection("detectPairedSidesets")),
    _build_refinement_map_timer(registerTimedSection("buildRefinementMap")),
    _build_coarsening_map_timer(registerTimedSection("buildCoarseningMap")),
    _find_adaptivity_qp_maps_timer(registerTimedSection("findAdaptivityQpMaps")),
    _build_refinement_and_coarsening_maps_timer(
        registerTimedSection("buildRefinementAndCoarseningMaps")),
    _change_boundary_id_timer(registerTimedSection("changeBoundaryId")),
    _init_timer(registerTimedSection("init")),
    _read_recovered_mesh_timer(registerTimedSection("readRecoveredMesh")),
    _ghost_ghosted_boundaries_timer(registerTimedSection("GhostGhostedBoundaries")),
    _add_mortar_interface_timer(registerTimedSection("addMortarInterface"))
{

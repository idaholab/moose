...
Real
InterfaceValueUserObject::computeInterfaceValueType(const Real value_master, const Real value_secondary)
{
  return InterfaceValueTools::getQuantity(_interface_value_type, value_master, value_secondary);
}

...
const VectorPostprocessorValue &
GeneralUserObject::getVectorPostprocessorValue(const std::string & name,
                                               const std::string & vector_name, bool use_broadcast)
{
  _depend_vars.insert(_pars.get<VectorPostprocessorName>(name));
  return VectorPostprocessorInterface::getVectorPostprocessorValue(name, vector_name, use_broadcast);
}
...
{
  _depend_vars.insert(name);
  return VectorPostprocessorInterface::getVectorPostprocessorValueByName(name, vector_name, use_broadcast);
}

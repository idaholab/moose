...
int XFEM_ellipse_cut::plane_normal_line_exp_int_3d(double pp[3], double normal[3], double p1[3], double p2[3], double pint[3]){
# define DIM_NUM 3
...
bool XFEM_ellipse_cut::line_exp_is_degenerate_nd(int dim_num, double p1[], double p2[]){
     return r8vec_eq(dim_num, p1, p2);
}


double XFEM_ellipse_cut::r8vec_norm(int n, double a[]){
...
void XFEM_ellipse_cut::r8vec_copy(int n, double a1[], double a2[]){
//    John Burkardt geometry.cpp
  for (unsigned int i = 0; i < n; i++)
    a2[i] = a1[i];
  return;
...
double XFEM_ellipse_cut::r8vec_dot_product(int n, double a1[], double a2[]){
//    John Burkardt geometry.cpp
  double value = 0.0;
  for (unsigned int i = 0; i < n; i++)
    value += a1[i] * a2[i];
...
bool XFEM_ellipse_cut::r8vec_eq(int n, double a1[], double a2[]){
//    John Burkardt geometry.cpp
  for (unsigned int i = 0; i < n; i++)
    if ( a1[i] != a2[i] )
      return false;
...
bool XFEM_ellipse_cut::isInsideEdge(Point p1, Point p2, Point p)
{
...
Real XFEM_ellipse_cut::getRelativePosition(Point p1, Point p2, Point p){

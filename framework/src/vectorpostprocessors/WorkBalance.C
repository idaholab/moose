...
WorkBalance::execute()
{
  ...
  Threads::parallel_reduce(*mesh.getActiveLocalElementRange(), wb_el, getMooseApp().numThreads());
  ...
  Threads::parallel_reduce(*mesh.getLocalNodeRange(), wb_nl, getMooseApp().numThreads());

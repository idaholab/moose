...
bool
LineSegment::closest_point (const Point & p, bool clamp_to_segment, Point & closest_p)
{
  Point p0_p  = p - _p0;
  Point p0_p1 = _p1 - _p0;
...
Point
LineSegment::closest_point (const Point & p)
{
  Point closest_p;
...
bool
LineSegment::closest_normal_point (const Point & p, Point & closest_p)
{
  return closest_point(p, false, closest_p);
}

bool
LineSegment::contains_point (const Point & p)
{
  Point closest_p;
  return closest_point(p, false, closest_p);
}
...
bool
LineSegment::intersect (const Plane & pl, Point & intersect_p)
{
  /**

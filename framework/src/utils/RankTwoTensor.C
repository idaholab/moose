...
template <typename T>
void
RankTwoTensorTempl<T>::diagonalize(RankTwoTensorTempl<T> & Q, RankTwoTensorTempl<T> & D) const
{ // A must be a symmetric matrix.
  ...
  for (int i = 0; i < maxsteps; ++i)
  {
    ...
    // AQ = A * Q
    AQ(0, 0) = Q(0, 0) * (*this)(0, 0) + Q(1, 0) * (*this)(0, 1) + Q(2, 0) * (*this)(0, 2);
    AQ(0, 1) = Q(0, 1) * (*this)(0, 0) + Q(1, 1) * (*this)(0, 1) + Q(2, 1) * (*this)(0, 2);
    AQ(0, 2) = Q(0, 2) * (*this)(0, 0) + Q(1, 2) * (*this)(0, 1) + Q(2, 2) * (*this)(0, 2);
    AQ(1, 0) = Q(0, 0) * (*this)(0, 1) + Q(1, 0) * (*this)(1, 1) + Q(2, 0) * (*this)(1, 2);
    AQ(1, 1) = Q(0, 1) * (*this)(0, 1) + Q(1, 1) * (*this)(1, 1) + Q(2, 1) * (*this)(1, 2);
    AQ(1, 2) = Q(0, 2) * (*this)(0, 1) + Q(1, 2) * (*this)(1, 1) + Q(2, 2) * (*this)(1, 2);
    AQ(2, 0) = Q(0, 0) * (*this)(0, 2) + Q(1, 0) * (*this)(1, 2) + Q(2, 0) * (*this)(2, 2);
    AQ(2, 1) = Q(0, 1) * (*this)(0, 2) + Q(1, 1) * (*this)(1, 2) + Q(2, 1) * (*this)(2, 2);
    AQ(2, 2) = Q(0, 2) * (*this)(0, 2) + Q(1, 2) * (*this)(1, 2) + Q(2, 2) * (*this)(2, 2);
    // D = Qt * AQ
    ...
    t = sgn /
        (thet + ((thet < 1.E6) ? std::sqrt(thet * thet + 1.0) : thet)); // sign(T)/(|T|+sqrt(T^2+1))
    ...
    jr[k0] =
        sgn * std::sqrt((1.0 - c) / 2.0); // using 1/2 angle identity sin(a/2) = sqrt((1-cos(a))/2)

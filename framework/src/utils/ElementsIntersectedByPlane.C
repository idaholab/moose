...
void
findElementsIntersectedByPlane(const Plane & plane, const MeshBase & mesh, std::vector<const Elem *> & intersected_elems)
{
...
void
elementsIntersectedByPlane(const Point & p0, const Point & normal, const MeshBase & mesh, std::vector<const Elem *> & intersected_elems)
{
...
void
elementsIntersectedByPlane(const Point & p0, const Point & p1, const Point & p2, const MeshBase & mesh, std::vector<const Elem *> & intersected_elems)
{
  // Make sure our list is clear
  intersected_elems.clear();

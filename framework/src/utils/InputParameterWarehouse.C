...
InputParameterWarehouse::InputParameterWarehouse(THREAD_ID num_threads)
  : _num_threads(num_threads), _input_parameters(num_threads), _controllable_items(num_threads)
{
}

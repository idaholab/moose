...
SolutionFunction::initialSetup()
{
  ...
  else
  {
    ...
    if (vars.size() > 1)
      mooseError2("The SolutionUserObject contains multiple variables, the SolutionFunction must specifiy the desired variable in the input file with 'from_variable'");

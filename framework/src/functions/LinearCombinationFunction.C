...
InputParameters validParams<LinearCombinationFunction>()
{
  ...
  params.addRequiredParam<std::vector<FunctionName> >("functions", "This function will return Sum_over_i(w_i * functions_i)");
  params.addRequiredParam<std::vector<Real> >("w", "This function will return Sum_over_i(w_i * functions_i)");

...
class VersionInfo:
    ...
    def writeRevision(self, repo_location, app_name, revision_header, installable_dirs):
        ...
        if revision_changed:
            ...
            installable_dirs = self.parseInstallableDirs(installable_dirs)
...
if len(sys.argv) == 4:
    ...
    app_name = sys.argv[3]
    installable_dirs = os.environ.get('INSTALLABLE_DIRS', None)

    version_info = VersionInfo()
    version_info.writeRevision(repo_location, app_name, header_file, installable_dirs)

...
## Reducing the number of threads for an application

The user may pass [!param](/Application/num_threads) in addition to the command line argument `--n-threads` to reduce the number of threads for an

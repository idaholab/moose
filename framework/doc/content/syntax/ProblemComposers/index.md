...
[!file text=custom_composer_and_operator.i](/test/tests/mfem/problemcomposers/custom_composer_and_operator.i)
test which is based on MFEM's [ex0p](https://github.com/mfem/mfem/blob/master/examples/ex0p.cpp). Firstly, a

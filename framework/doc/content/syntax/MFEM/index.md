...
- [Linear Elasticity](LinearElasticity.md): Solves a 3D linear elasticity problem for
  the deformation of a multi-material cantilever beam. This example
  is based on [MFEM Example 2](https://mfem.org/examples/).

## Electromagnetic Problems

- [Definite Maxwell](DefiniteMaxwell.md): Solves a 3D electromagnetic diffusion problem for
...
- [GradDiv](GradDiv.md): Solves a diffusion problem for a vector field
...
- [Darcy Problem](Darcy.md): Solves a 2D mixed Darcy problem. This is a saddle point

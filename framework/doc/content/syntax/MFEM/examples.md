...
- [Steady State Diffusion](syntax/MFEM/Diffusion.md): Steady state diffusion problem
...
- [Definite Maxwell](syntax/MFEM/DefiniteMaxwell.md): Solves a 3D electromagnetic
  ...
  [MFEM Example 3](https://mfem.org/examples/).
...
- [Grad-div](syntax/MFEM/Grad-Div.md): Solves a diffusion problem for a vector field
  ...
  elements. This example is based on [MFEM Example 4](https://mfem.org/examples/) and

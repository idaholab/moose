...
These objects use `precomputeQpResidual()`, `precomputeQpJacobian()`, and `precomputeQpOffDiagJacobian()` hooks with signatures that differ from those in `Moose::Kokkos::Kernel`.

...
for two rectangular objects of [MFEMKernel.md] type, one representing a real contribution to
...
but they do need to be applied to the same pair of variables, which must be of [MFEMComplexVariable.md] type.

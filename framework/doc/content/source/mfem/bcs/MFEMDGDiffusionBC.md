...
`createBFIntegrator()` returns an `mfem::DGDiffusionIntegrator` object ([see mfem docs for more info](https://docs.mfem.org/html/classmfem_1_1DGDiffusionIntegrator.html)).
`createLFIntegrator()` returns an `mfem::DGDirichletLFIntegrator` object ([see mfem docs for more info](https://docs.mfem.org/html/classmfem_1_1DGDirichletLFIntegrator.html)).

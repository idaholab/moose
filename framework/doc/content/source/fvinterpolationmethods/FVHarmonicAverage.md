...
!listing framework/doc/content/source/fvinterpolationmethods/examples/linear-fv-diffusion-coeff-harmonic.i start=[harm] end=[] include-end=true

Use it for a coefficient functor via
[!param](/LinearFVKernels/LinearFVDiffusion/coeff_interp_method):

!listing framework/doc/content/source/fvinterpolationmethods/examples/linear-fv-diffusion-coeff-harmonic.i start=[diffusion] end=[] include-end=true

## Useful Links

See [FVInterpolationMethod.md] for the base class and [../linearfvkernels/LinearFVDiffusion.md] for
typical usage.

!syntax parameters /InterpolationMethods/FVHarmonicAverage

!syntax inputs /InterpolationMethods/FVHarmonicAverage

!syntax children /InterpolationMethods/FVHarmonicAverage

...
\end{equation}
where the underlined term is the vector provided by [!file text=ArrayReaction::computeQpResidual](/ArrayReaction.C).
...
\end{equation}
The underlined part is the local Jacobian evaluated by [!file text=ArrayReaction::computeQpJacobian](/ArrayReaction.C) and [!file text=ArrayReaction::computeQpOffDiagJacobian](/ArrayReaction.C).

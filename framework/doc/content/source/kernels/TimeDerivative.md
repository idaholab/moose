...
In that case, $u$, $u_h$, $\psi_i$, and $\phi_j$ above are all to be understood as vector-valued functions.

The user can also provide an optional constant scalar coefficient to multiply the time derivative by.

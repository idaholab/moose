...
\end{equation}
where the underlined term is the array provided by [!file text=ArrayDiffusion::computeQpResidual](/ArrayDiffusion.C).
...
\end{equation}
where the underlined part is the local Jacobian evaluated by [!file text=ArrayDiffusion::computeQpJacobian](/ArrayDiffusion.C) and [!file text=ArrayDiffusion::computeQpOffDiagJacobian](/ArrayDiffusion.C).

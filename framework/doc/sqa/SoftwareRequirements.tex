...
\begin{table}[!htbp]
  ...
  \newcounter{MySecondTableCounter}
...
\begin{table}[!htbp]
  ...
  \newcounter{MyFourthTableCounter}
...
\begin{table}[!htbp]
  ...
  \newcounter{MySeventhTableCounter}
...
\begin{table}[!htbp]
  ...
  \newcounter{MyEighthTableCounter}
...
\begin{table}[!htbp]
  ...
  \newcounter{UseFirstTableCounter}
...
\begin{table}[!htbp]
  ...
  \newcounter{PerfFirstTableCounter}
...
\begin{table}[!htbp]
  \caption{Core Framework\label{tab:perf_core}}
  \newcounter{SysFirstTableCounter}

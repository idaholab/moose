...
def frames():
    ...
    master_reader = chigger.exodus.ExodusReader(
        "step10_out.e", displacement_magnitude=500
    )
    ...
    sub1_result = chigger.exodus.ExodusResult(
        ...
        cmap="plasma",
        camera=sub_camera,
        viewport=[1 / 6.0, 1 / 3.0, 2 / 6.0, 2 / 3.0],
    )
    ...
    sub2_result = chigger.exodus.ExodusResult(
        ...
        cmap="plasma",
        camera=sub_camera,
        viewport=[2 / 6.0, 1 / 3.0, 3 / 6.0, 2 / 3.0],
    )
    ...
    sub3_result = chigger.exodus.ExodusResult(
        ...
        cmap="plasma",
        camera=sub_camera,
        viewport=[3 / 6.0, 1 / 3.0, 4 / 6.0, 2 / 3.0],
    )
    ...
    sub4_result = chigger.exodus.ExodusResult(
        ...
        cmap="plasma",
        camera=sub_camera,
        viewport=[4 / 6.0, 1 / 3.0, 5 / 6.0, 2 / 3.0],
    )
    ...
    sub5_result = chigger.exodus.ExodusResult(
        ...
        cmap="plasma",
        camera=sub_camera,
        viewport=[5 / 6.0, 1 / 3.0, 6 / 6.0, 2 / 3.0],
    )
    ...
    laby = 1 / 3.0 - 1 / 64.0
    lab0 = chigger.annotations.TextAnnotation(
        text="Sub0: x=0",
        position=[1 / 12.0, laby],
        font_size=FONTSIZE,
        text_color=[0.5] * 3,
        justification="center",

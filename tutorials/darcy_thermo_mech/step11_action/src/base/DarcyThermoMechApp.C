...
{
  registerAction(DarcyVelocityAction, "DarcyVelocity");
  registerSyntaxTask("DarcyVelocityAction", "DarcyVelocity", "add_aux_variable");
  registerSyntaxTask("DarcyVelocityAction", "DarcyVelocity", "add_aux_kernel");
}

...
def frames():
    ...
    temp = chigger.exodus.ExodusResult(
        reader,
        camera=camera,
    ...
    disp = chigger.exodus.ExodusResult(
        reader,
        camera=camera,
    ...
    time = chigger.annotations.TextAnnotation(
        position=[0.5, 0.9], font_size=48, text_color=[0, 0, 0], justification="center"
    )

    tdisp = chigger.annotations.TextAnnotation(
        position=[0.5, 0.05],
        font_size=48,
        text_color=[0, 0, 0],

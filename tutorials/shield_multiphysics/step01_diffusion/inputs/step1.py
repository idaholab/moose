...
camera.SetPosition(15.20000000, 12.8500000, 10.3251647185)
camera.SetFocalPoint(0.1520000000, 0.0128500000, 0.0000000000)

reader = chigger.exodus.ExodusReader('step1_out.e')
pressure = chigger.exodus.ExodusResult(reader, camera=camera, variable='T', cmap='viridis')
cbar = chigger.exodus.ExodusColorBar(pressure,
                                     length=0.6,
                                     colorbar_origin=[0.2, 0.7],
                                     location='top')
cbar.setOptions('primary', title='Temperature (T)', font_size=48, font_color=[0,0,0])

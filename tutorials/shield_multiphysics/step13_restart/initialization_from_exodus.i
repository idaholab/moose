...
[AuxVariables]
  [T_water]
    # auxiliary variables can also be initialized from exodus files
    initial_from_file_var = 'T_water'
    block = 'water'
  []
  [heat_flux_x]
    family = MONOMIAL
...
[Executioner]
  type = Transient
  # 10 time steps from the default start_time = 0
  num_steps = 10
  solve_type = NEWTON

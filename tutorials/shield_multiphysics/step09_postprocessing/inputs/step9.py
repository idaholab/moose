...
def frames():
    ...
    reader = chigger.exodus.ExodusReader('step9_out.e')
    ...
    vpp_data = mooseutils.VectorPostprocessorReader('step9_out_temperature_sample_*.csv')
    ...
    for i, t in enumerate(reader.getTimes()):
        ...
        vpp = vpp_data(['y', 'T'], time=i)
        line_temp.setOptions(x=vpp['T'].tolist(), y=vpp['y'].multiply(100).tolist())

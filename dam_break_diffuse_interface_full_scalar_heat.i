# Full OpenFOAM-parity diffuse-interface VOF dam-break case with confined
# scalar and conserved heat transport.
...
[Physics]
  [NavierStokes]
    [ConservativeDiffuseInterfaceFlowSegregated]
      [flow]
      ...
      []
    []
    [ConservativeDiffuseInterfaceVOFSegregated]
      [vof]
...
[Outputs]
  execute_on = 'INITIAL TIMESTEP_END'
  file_base = dam_break_diffuse_interface_full_scalar_heat
  [csv]
    type = CSV

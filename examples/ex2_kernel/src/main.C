/**
 * Example 2 - Creating your first custom Kernel
 * This example augments the first example (Diffusion) by adding a custom kernel
...
// Moose Registration
#include "KernelFactory.h"        // <- New includes for registration
...
PerfLog Moose::perf_log("Example 2");

/**
 * Example 7 - Running a transient simulation.  This example uses the transient execution and
 * also demonstrates the use of an implicit Euler time kernel "ExampleImplicitEuler"
 */
...
PerfLog Moose::perf_log("Example 7");

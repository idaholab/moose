...
class TestExamples(unittest.TestCase):
    def test(self):
        ...
        # Read the file
        root = hit.load(os.path.join(os.path.dirname(__file__), "input.i"))

        # Locate and modify "x_max" parameter for the mesh
        mesh = tree.find(root, func=lambda n: n.fullpath == "/Mesh/gen")
        mesh["x_max"] = 4
        ...
        hit.write(os.path.join(os.path.dirname(__file__), "input_modified.i"), root)

...
"""Tests moosetools.control.moosecontrol.MooseControl."""
...
from moosetools.control import MooseControl, SubprocessSocketRunner
from moosetools.control.exceptions import (
    ControlNotWaiting,
    NotInitialized,
    UnexpectedFlag,
)
from moosetools.control.moosecontrol import (
    DEBUG_LOG_FORMAT,
    DEFAULT_LOG_FORMAT,
    STREAM_HANDLER,
...
MOOSECONTROL = "moosetools.control.MooseControl"
BASERUNNER = "moosetools.control.runners.BaseRunner"
...
class TestMooseControl(MooseControlTestCase):
    ...
    def test_init(self):
        ...
        with patch(
            "moosetools.control.moosecontrol.logging.basicConfig"
        ) as basic_config:
...
class TestMooseControlSetUpControl(MooseControlTestCase):
    """Test moosetools.control.moosecontrol.MooseControl with automatic setup."""

...
void
dataStore(std::ostream & stream, DataType & v, std::any context)
{
  dataStore(stream, v.data, context);
}

void
dataLoad(std::istream & stream, DataType & v, std::any context)
{
  dataLoad(stream, v.data, context);
}

void
dataStore(std::ostream & stream, std::unique_ptr<DataType> & v, std::any context)
{
  dataStore(stream, *v, context);
}

void
dataLoad(std::istream & stream, std::unique_ptr<DataType> & v, std::any context)
{
...
void
dataStore(std::ostream & stream, DataStorage & v, std::any context)
{
  storeHelper(stream, static_cast<UniqueStorage<DataType> &>(v), context);
}

void
dataLoad(std::istream & stream, DataStorage & v, std::any context)
{

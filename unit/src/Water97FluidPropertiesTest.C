...
Water97FluidPropertiesTest::properties()
{
  ...
  REL_TEST("h", _fp->h(p0, T0), 115.331273, 1.0e-8);
  REL_TEST("h", _fp->h(p1, T1), 184.142828, 1.0e-8);
  REL_TEST("h", _fp->h(p2, T2), 975.542239, 1.0e-8);
  REL_TEST("e", _fp->e(p0, T0), 112.324818, 1.0e-8);
  REL_TEST("e", _fp->e(p1, T1), 106.448356, 1.0e-8);
  REL_TEST("e", _fp->e(p2, T2), 971.934985, 1.0e-8);
  REL_TEST("s", _fp->s(p0, T0), 0.392294792, 1.0e-8);
  REL_TEST("s", _fp->s(p1, T1), 0.368563852, 1.0e-8);
  REL_TEST("s", _fp->s(p2, T2), 2.58041912, 1.0e-8);
  REL_TEST("cp", _fp->cp(p0, T0), 4.17301218, 1.0e-8);
  REL_TEST("cp", _fp->cp(p1, T1), 4.01008987, 1.0e-8);
  REL_TEST("cp", _fp->cp(p2, T2), 4.65580682, 1.0e-8);
  ...
  REL_TEST("h", _fp->h(p0, T0), 2549.91145, 1.0e-8);
  REL_TEST("h", _fp->h(p1, T1), 3335.68375, 1.0e-8);
  REL_TEST("h", _fp->h(p2, T2), 2631.49474, 1.0e-8);
  REL_TEST("e", _fp->e(p0, T0), 2411.6916, 1.0e-8);
  REL_TEST("e", _fp->e(p1, T1), 3012.62819, 1.0e-8);
  REL_TEST("e", _fp->e(p2, T2), 2468.61076, 1.0e-8);
  REL_TEST("s", _fp->s(p0, T0), 8.52238967, 1.0e-8);
  REL_TEST("s", _fp->s(p1, T1), 10.1749996, 1.0e-8);
  REL_TEST("s", _fp->s(p2, T2), 5.17540298, 1.0e-8);
  REL_TEST("cp", _fp->cp(p0, T0), 1.91300162, 1.0e-8);
  REL_TEST("cp", _fp->cp(p1, T1), 2.08141274, 1.0e-8);
  REL_TEST("cp", _fp->cp(p2, T2), 10.3505092, 1.0e-8);
  ...
  REL_TEST("h", _fp->h(p0, T0), 1863.43019, 1.0e-5);
  REL_TEST("h", _fp->h(p1, T1), 2375.12401, 1.0e-5);
  REL_TEST("h", _fp->h(p2, T2), 2258.68845, 1.0e-5);
  REL_TEST("e", _fp->e(p0, T0), 1812.26279, 1.0e-5);
  REL_TEST("e", _fp->e(p1, T1), 2263.65868, 1.0e-5);
  REL_TEST("e", _fp->e(p2, T2), 2102.06932, 1.0e-5);
  REL_TEST("s", _fp->s(p0, T0), 4.05427273, 1.0e-5);
  REL_TEST("s", _fp->s(p1, T1), 4.85438792, 1.0e-5);
  REL_TEST("s", _fp->s(p2, T2), 4.46971906, 1.0e-5);
  REL_TEST("cp", _fp->cp(p0, T0), 13.8935717, 1.0e-4);
  REL_TEST("cp", _fp->cp(p1, T1), 44.6579342, 1.0e-5);
  REL_TEST("cp", _fp->cp(p2, T2), 6.34165359, 1.0e-5);
  ...
  REL_TEST("h", _fp->h(p0, T0), 5219.76855, 1.0e-8);
  REL_TEST("h", _fp->h(p1, T1), 5167.23514, 1.0e-8);
  REL_TEST("h", _fp->h(p2, T2), 6571.22604, 1.0e-8);
  REL_TEST("e", _fp->e(p0, T0), 4527.4931, 1.0e-8);
  REL_TEST("e", _fp->e(p1, T1), 4474.95124, 1.0e-8);
  REL_TEST("e", _fp->e(p2, T2), 5637.07038, 1.0e-8);
  REL_TEST("s", _fp->s(p0, T0), 9.65408875, 1.0e-8);
  REL_TEST("s", _fp->s(p1, T1), 7.72970133, 1.0e-8);
  REL_TEST("s", _fp->s(p2, T2), 8.53640523, 1.0e-8);
  REL_TEST("cp", _fp->cp(p0, T0), 2.61609445, 1.0e-8);
  REL_TEST("cp", _fp->cp(p1, T1), 2.72724317, 1.0e-8);
  REL_TEST("cp", _fp->cp(p2, T2), 2.88569882, 1.0e-8);

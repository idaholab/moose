...
static double
SolveEquationAndCheckResidual(std::unique_ptr<Moose::MFEM::EquationSystemProblemOperator> &,
...
{
public:
  MFEMMeshRefinementTest() : MFEMObjectUnitTest("MooseUnitApp")
  {
    int rank;
    ...
    problem_data.eqn_system = std::make_shared<Moose::MFEM::EquationSystem>();
    ...
    bc_bottom_params.set<VariableName>("variable") = "diffused";
    ...
    bc_low_terminal_params.set<VariableName>("variable") = "diffused";
    ...
    kernel_params.set<VariableName>("variable") = "diffused";
    kernel_params.set<MFEMScalarCoefficientName>("coefficient") = "diffused";
...
static double
SolveEquationAndCheckResidual(
    std::unique_ptr<Moose::MFEM::EquationSystemProblemOperator> & problem_operator,

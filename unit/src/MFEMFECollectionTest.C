...
INSTANTIATE_TEST_CASE_P(
    VectorFECollections,
    MFEMFECollectionUnitTest,
    testing::Values(FECollectionParameters("ref-segment.mesh", "RT", 0, "RT_1D_P1", 1),
                    FECollectionParameters("ref-square.mesh", "RT", 0, "RT_2D_P1", 1),
                    FECollectionParameters("ref-cube.mesh", "RT", 0, "RT_3D_P1", 1),
                    FECollectionParameters("ref-segment.mesh", "RT", 1, "RT_1D_P1", 1),
                    FECollectionParameters("ref-square.mesh", "RT", 2, "RT_2D_P1", 1),
                    FECollectionParameters("ref-cube.mesh", "RT", 3, "RT_3D_P1", 1),
                    FECollectionParameters("ref-segment.mesh", "ND", 0, "ND_2D_P1", 1),
                    FECollectionParameters("ref-square.mesh", "ND", 0, "ND_2D_P1", 1),
                    FECollectionParameters("ref-cube.mesh", "ND", 0, "ND_3D_P1", 1),
                    FECollectionParameters("ref-segment.mesh", "ND", 1, "ND_2D_P1", 1),
...
INSTANTIATE_TEST_CASE_P(ExpectError,
                        ...
                        testing::Values(FECollectionParameters("ref-segment.mesh", "RT", 2, "", -1),
                                        ...
                                        FECollectionParameters("ref-cube.mesh", "RT", 3, "", -1),
                                        FECollectionParameters("ref-segment.mesh", "ND", 1, "", -1),
                                        FECollectionParameters("ref-square.mesh", "ND", 2, "", -1),
                                        FECollectionParameters("ref-cube.mesh", "ND", 2, "", -1),
                                        FECollectionParameters("ref-cube.mesh", "ND", 3, "", -1)));

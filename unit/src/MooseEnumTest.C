...
TEST(MultiMooseEnum, testExecuteOn)
{
  ...
  EXPECT_EQ(exec_enum.getRawNames(),
            "NONE INITIAL LINEAR NONLINEAR TIMESTEP_END TIMESTEP_BEGIN FIXED_POINT_END "
            "FIXED_POINT_BEGIN FINAL CUSTOM ALWAYS");
  ...
  EXPECT_EQ(doc,
            ...
            "TIMESTEP_BEGIN, FIXED_POINT_END, FIXED_POINT_BEGIN, FINAL, FAILED, CUSTOM, ALWAYS.");

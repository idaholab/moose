...
public:
  ...
  MFEMPostprocessorTest() : MFEMObjectUnitTest("MooseUnitApp")
  {
    ...
    _scalar_var = _mfem_problem->getProblemData().gridfunctions.real_gfs.Get("scalar_var");
    ...
    _vector_var = _mfem_problem->getProblemData().gridfunctions.real_gfs.Get("vector_var");
  }
};

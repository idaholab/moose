...
if __name__ == "__main__":
    ...
    data += mooseutils.compute_requirement_stats("modules/shifted_boundary_method")
    ...
    if tdata.files != data.files:
        msg = (
            "ERROR: The total number of test files for the supplied directories does not match\n"

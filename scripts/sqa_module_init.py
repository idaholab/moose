...
parser = argparse.ArgumentParser(
    description="Setup SQA documentation for a MOOSE module."
)
...
sqa_files = [
    "index.md",
    "tensor_mechanics_sdd.md",
    "tensor_mechanics_stp.md",
    "tensor_mechanics_rtm.md",
    "tensor_mechanics_srs.md",
    "tensor_mechanics_vvr.md",
]

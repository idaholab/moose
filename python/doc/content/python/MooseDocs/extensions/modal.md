...
[!file text=style classes language=css](framework/doc/content/css/moose.css). For example, the search button at
the top of this page triggers a modal created by the
[!file text=Navigation extension](python/MooseDocs/extensions/navigation.py).

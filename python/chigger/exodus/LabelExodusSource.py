...
class LabelExodusSource(base.ChiggerSource2D):
    ...
    def getOptions():
        ...
        opt.add(
            "label_type",
            "variable",
            "Specify the type of label to create.",
            vtype=str,
    ...
    def __init__(self, exodus_source, **kwargs):
        super(LabelExodusSource, self).__init__(
    ...
    def update(self, **kwargs):
        ...
        # Update fonts
        utils.FontOptions.set_options(
            self._vtkmapper.GetLabelTextProperty(), self._options
        )

    ...
    class PlaneSourceMeta(source_type):
        ...
        def getOptions():
            ...
            opt.add(
                "point1",
                [1, 0, 0],
                "Define the first edge of the plane (origin->point1).",
            )
            opt.add(
                "point2",
                [0, 1, 0],
                "Define the second edge of the plane (origin->point2).",
            )
            opt.add(
                "resolution",
                [1, 1],
                "Define the number of subdivisions in the x- and "
                "y-direction of the plane.",
            )
            opt.add(
                "data",
                None,
                "The VTK data to attach to the vtkMapper for this object, for "
                "used with the 'cmap' option.",
                vtype=vtk.vtkFloatArray,
            )
        ...
        def __init__(self, **kwargs):
            super(PlaneSourceMeta, self).__init__(
                vtkgeometric_type=vtk.vtkPlaneSource, **kwargs
            )

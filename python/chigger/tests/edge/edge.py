...
exodus0.update()
exodus1 = chigger.exodus.ExodusSource(
    reader, block=["76"], edges=True, edge_color=[1, 0, 0], edge_width=1
)
exodus1.update()

result = chigger.base.ChiggerResult(
    exodus0, exodus1, variable="diffused", camera=camera
)

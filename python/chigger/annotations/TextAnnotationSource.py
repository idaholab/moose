...
class TextAnnotationSource(base.ChiggerSourceBase):
    ...
    def getOptions():
        ...
        opt.add(
            "position",
            [0.5, 0.5],
            "The text position within the viewport, in relative " "coordinates.",
            vtype=tuple,
        )
    ...
    def __init__(self, **kwargs):
        super(TextAnnotationSource, self).__init__(
            vtkactor_type=vtk.vtkActor2D, vtkmapper_type=vtk.vtkTextMapper, **kwargs
        )

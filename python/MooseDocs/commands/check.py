...
def command_line_options(subparser, parent):
    ...
    parser.add_argument(
        "--show-warnings", action="store_true", help="Display all report warnings."
    )
...
def main(opt):
    ...
    if opt.app_reports and app_reports:
        app_reports = [
            report for report in app_reports if report.title in opt.app_reports
        ]
    if opt.req_reports and req_reports:
        req_reports = [
            report for report in req_reports if report.title in opt.req_reports
        ]

...
class TestCheckRequirements(unittest.TestCase):
    ...
    def setUp(self):
        self._patcher = mock.patch(
            "mooseutils.colorText", side_effect=lambda t, c, **kwargs: t
        )
        self._patcher.start()

    def testDeprecated(self):
        req0 = moosesqa.Requirement(
            name="req0",
            deprecated=True,
            ...
            issues=["issues"],
            issues_line=2,
            verification=["Diffusion.md"],
            verification_line=3,
            validation=["Diffusion.md"],
            validation_line=4,
        )
        req0.detail = "text"
        req0.detail_line = 5
    ...
    def testDuplicates(self):
        ...
        with self.assertLogs(level="WARNING") as cm:
            moosesqa.check_requirements(
                [req0, req1], duplicate_requirement=logging.WARNING
            )
        self.assertIn("Duplicate requirements found", cm.output[0])
    ...
    def testIssuesFormat(self):
        issues = [
            "11600c68be9e8f77e4870d7b8efb26e5ada10a5a",
        ...
        req0.details = [
            moosesqa.Detail(name="req0-0", detail="detail")
        ]  # add detail so Req. is testable
    ...
    def testTestable(self):
        ...
        with self.assertLogs(level="ERROR") as cm:
            moosesqa.check_requirements([req0])
        self.assertIn(
            "Test will not execute because it is marked as skipped or deleted",
            cm.output[0],
        )
    ...
    def testCollections(self):
        req0 = moosesqa.Requirement(
            ...
            design=["Diffusion.md"],
            issues=["#1234"],
            specification=moosesqa.TestSpecification(),
            collections={"test"},
        )
        req1 = moosesqa.Requirement(
            name="req1",

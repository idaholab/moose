...
class TestRequirement(unittest.TestCase):
    ...
    def testStr(self):
        s = str(
            Requirement(requirement="requirement", design=["design"], issues=["issues"])
        )
    ...
    def testPrerequisites(self):
        ...
        req = Requirement(
            details=[
                Detail(specification=TestSpecification(prerequisites={"andrew"})),
    ...
    def testTypes(self):
        ...
        req = Requirement(
            details=[
                Detail(specification=TestSpecification(type="andrew")),
    ...
    def testNames(self):
        ...
        req = Requirement(
            details=[
                Detail(specification=TestSpecification(name="andrew")),

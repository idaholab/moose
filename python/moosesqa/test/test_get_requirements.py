...
class TestGetRequirementsFromFile(unittest.TestCase):
    def testBasic(self):
        ...
        filename = os.path.join(
            MOOSE_DIR, "python", "moosesqa", "test", "specs", "spec_basic"
        )
...
class TestFindFile(unittest.TestCase):
    ...
    def testEndswith(self):
        ...
        self.assertEqual(
            filename,
            os.path.join(root_dir, "test", "tests", "markers", "box_marker", "tests"),
        )
...
class TestRequirementCollections(unittest.TestCase):
    def testAvailable(self):
        ...
        self.assertEqual(
            moosesqa.MOOSESQA_COLLECTIONS,
            {"FUNCTIONAL", "USABILITY", "PERFORMANCE", "SYSTEM", "FAILURE_ANALYSIS"},

...
class IndexGenerator:
    def __init__(self, load_local: bool, model_path: str, model_name: str, show_progress: bool, database: str, dry_run: bool):
    ...
    def read_documents(self) -> List[Document]:
        reader = SimpleDirectoryReader(
            input_dir=self.response_dir, file_extractor={".json": self.MyFileReader(self.get_post_content)}
        )

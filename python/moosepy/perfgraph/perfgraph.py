...
class PerfGraph:
        ...
        def parse(cls, data: dict) -> Self:
            ...
            if root_data.version > 0:
                ...
                if "max_memory_per_rank" in data:
                    ...
                    assert all(
                        isinstance(v, int) for v in root_data.max_memory_per_rank
                    )
    ...
    class SetupData:
        ...
        def setup(
            ...
            """
            root_data = PerfGraph.RootData.parse(data)
            setup_data = cls(root_data)
            ...
            def process_data(name: str, data: dict, parent: Optional[PerfGraphNode]):
                ...
                node_data = PerfGraph.NodeData.parse(data, root_data.version)

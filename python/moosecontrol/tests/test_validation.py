...
from moosecontrol.validation import check_response_data, process_response, \
...
class TestValidation(TestCase):
    ...
    def test_check_response_no_data(self):
        ...
        self.assertEqual(
            str(e.exception),
            f'Response from {FAKE_URL} does not contain data'
        )
    ...
    def test_check_response_data_unexpected_keys(self):
        ...
        self.assertEqual(
            str(e.exception),
            f'Response from {FAKE_URL} has unexpected key(s): {key}'
        )
    ...
    def test_check_response_data_missing_keys(self):
        ...
        self.assertEqual(
            str(e.exception),
            f'Response from {FAKE_URL} has missing key(s): {key}'
        )

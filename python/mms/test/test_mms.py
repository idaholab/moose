...
class TestMMS(unittest.TestCase):
    ...
    def testEvaluate(self):
        ...
        self.assertEqual(
            s,
            "-x^2*r*t^2*cos(x*y*t) - x*y*sin(x*y*t) - x*t*u_y*sin(x*y*t) - "
        ...
        self.assertEqual(
            s,
            "-std::pow(p(0), 2)*_r*std::pow(t, 2)*std::cos(p(0)*p(1)*t) - "

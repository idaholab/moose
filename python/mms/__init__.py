...
try:
    ...
    print(
        "The 'mms' package requires sympy for symbolic function evaluation, it can be installed "
...
try:
    ...
    print(
        "The 'mms' package requires matplotlib for the ConvergencePlot object, matplotlib can "

...
class TestMeshPlugin(Testing.PeacockImageTestCase):
    ...
    def testInitial(self):
        ...
        self.assertEqual(
            self._widget.MeshPlugin.Representation.currentText(), "Surface"
        )
    ...
    def testViewMeshToggle(self):
        ...
        self.assertImage(
            "testViewMeshToggle.png", allowed=0.97
        )  # lines are slightly different across platforms
        ...
        self.assertImage(
            "testViewMeshToggle.png", allowed=0.95
        )  # lines are slightly different across platforms
    ...
    def testRepresentation(self):
        ...
        self._widget.MeshPlugin.Representation.currentIndexChanged.emit(1)
        self.assertImage(
            "testRepresentationWireframe.png", allowed=0.90
        )  # lines are different across platforms
    ...
    def testDisplacements(self):
        ...
        self._window._result.update(
            camera=None, colorbar={"visible": False}, block=["2"]
        )
    ...
    def testState(self):
        ...
        self.assertEqual(self._widget.MeshPlugin.DisplacementMagnitude.value(), 1.0)
        self.assertEqual(
            self._widget.MeshPlugin.Representation.currentText(), "Wireframe"
        )
        ...
        self.assertEqual(
            self._widget.FilePlugin.VariableList.currentText(), "convected"
        )

...
class TestBlockPlugin(Testing.PeacockImageTestCase):
    ...
    def testBlocks(self):
        ...
        self.assertEqual(
            self._widget.BlockPlugin.BlockSelector.getBlocks(), ["1", "76"]
        )
    ...
    def testSidesets(self):
        ...
        item.setCheckState(QtCore.Qt.Checked)
        self._widget.BlockPlugin.SidesetSelector.StandardItemModel.itemChanged.emit(
            item
        )
        self.assertEqual(
            self._widget.BlockPlugin.SidesetSelector.getBlocks(),
            sorted(["top", "bottom"]),
        )
    ...
    def testNodesets(self):
        ...
        item.setCheckState(QtCore.Qt.Checked)
        self._widget.BlockPlugin.NodesetSelector.StandardItemModel.itemChanged.emit(
            item
        )
        self.assertEqual(
            self._widget.BlockPlugin.NodesetSelector.getBlocks(), ["1", "2"]
        )

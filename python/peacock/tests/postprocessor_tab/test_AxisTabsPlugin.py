...
class TestAxisTabsPlugin(Testing.PeacockImageTestCase):
    ...
    def testRepr(self):
        ...
        self.assertIn("axes0.set_xlim([-1.548, 32.508000000000003])", output)
        self.assertIn("axes0.set_ylim([4.2599999999999998, 35.939999999999998])", output)
        self.assertIn("axes1.set_ylim([40.600000000000001, 181.40000000000001])", output)

...
class TestHarness:
    ...
    def parseCLArgs(self, argv):
        ...
        hpcgroup.add_arugment('--hpc-place', nargs=1, action='store', dest='hpc_place', choices=['free', 'pack', 'scatter'], default='free', help='The default placement method for HPC jobs')

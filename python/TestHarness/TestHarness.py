...
class TestHarness:
   ...
   # Create and return list of tester objects. A tester is created by providing
    ...
    def parseCLArgs(self, argv):
        ...
        queuegroup.add_argument('--queue-project', nargs=1, action='store', type=str, default='moose', metavar='project', help='Identify your job(s) with this project (default:  moose)')
        queuegroup.add_argument('--queue-queue', nargs=1, action='store', type=str, metavar='queue', help='Submit jobs to the specified queue (leave disabled to use the default queue)')

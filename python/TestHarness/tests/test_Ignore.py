...
class TestHarnessTester(TestHarnessTestCase):
    def testIgnoreSkip(self):
        ...
        self.assertRegexpMatches(output.decode('utf-8'), 'test_harness\.ignore_skipped.*?OK')
    ...
    def testIgnoreHeavy(self):
        ...
        self.assertRegexpMatches(output.decode('utf-8'), 'test_harness\.ignore_heavy.*?OK')
    ...
    def testIgnoreCompiler(self):
        ...
        self.assertRegexpMatches(output.decode('utf-8'), 'test_harness\.ignore_compiler.*?OK')
    ...
    def testIgnorePlatform(self):
        ...
        self.assertRegexpMatches(output.decode('utf-8'), 'test_harness\.ignore_platform.*?OK')
    ...
    def testIgnorePreReq(self):
        ...
        self.assertRegexpMatches(output.decode('utf-8'), 'test_harness\.always_skipped.*? \[ALWAYS SKIPPED\] SKIP')
        self.assertRegexpMatches(output.decode('utf-8'), 'test_harness\.ignore_skipped_dependency.*?OK')
        ...
        self.assertRegexpMatches(output.decode('utf-8'), 'test_harness\.always_skipped.*?OK')
        self.assertRegexpMatches(output.decode('utf-8'), 'test_harness\.ignore_skipped_dependency.*?OK')
    ...
    def testIgnoreMultiple(self):
        ...
        self.assertRegexpMatches(output.decode('utf-8'), 'test_harness\.ignore_multiple.*?OK')
    ...
    def testIgnoreMissingOne(self):
        ...
        self.assertRegexpMatches(output.decode('utf-8'), 'test_harness\.ignore_multiple.*? \[PLATFORM!=NON_EXISTENT\] SKIP')
    ...
    def testIgnoreMultiplePreReq(self):
        ...
        self.assertRegexpMatches(output.decode('utf-8'), 'test_harness\.always_skipped.*?OK')
        self.assertRegexpMatches(output.decode('utf-8'), 'test_harness\.ignore_multi_prereq_dependency.*?OK')
        ...
        self.assertRegexpMatches(output.decode('utf-8'), 'test_harness\.always_skipped.*?OK')
        self.assertRegexpMatches(output.decode('utf-8'), 'test_harness\.ignore_multi_prereq_dependency.*? \[PLATFORM!=NON_EXISTENT\] SKIP')
        ...
        self.assertRegexpMatches(output.decode('utf-8'), 'test_harness\.always_skipped.*? \[ALWAYS SKIPPED\] SKIP')
        self.assertRegexpMatches(output.decode('utf-8'), 'test_harness\.ignore_multi_prereq_dependency.*? \[SKIPPED DEPENDENCY\] SKIP')

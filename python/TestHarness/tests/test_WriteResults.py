...
class TestHarnessTester(TestHarnessTestCase):
    ...
    def checkFilesExist(
        self, result, tests, output_object_names, spec_file, unique_test_id=None
    ):
    ...
    def testWriteAll(self):
        ...
        with tempfile.TemporaryDirectory() as output_dir:
            ...
            self.checkFilesExist(
                result, ["csvdiff", "exodiff"], ["runner_run", "tester"], "diffs"
            )
        ...
        with tempfile.TemporaryDirectory() as output_dir:
            ...
            self.checkFilesExist(
                result, ["always_ok"], ["runner_run"], "always_ok", unique_test_id="foo"
            )

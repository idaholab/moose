...
class TestHarnessTester(TestHarnessTestCase):
    def testNotHeavy(self):
        ...
        self.assertRegex(
            output,
            "test_harness\.heavy_on_not_heavy_a_and_not_heavy_b .*? \[HEAVY\] SKIP",
        )
        ...
        self.assertRegex(
            output, "test_harness\.not_heavy_on_singleton_a_and_singleton_b .*? OK"
        )
        ...
        self.assertNotRegex(
            output, "test_harness\.singleton_a .*? \[IMPLICT HEAVY\] OK"
        )
        self.assertNotRegex(
            output, "test_harness\.singleton_b .*? \[IMPLICT HEAVY\] OK"
        )
        self.assertNotRegex(output, "test_harness\.not_heavy .*? \[IMPLICT HEAVY\] OK")
        self.assertNotRegex(
            output, "test_harness\.not_heavy_a .*? \[IMPLICT HEAVY\] OK"
        )
        self.assertNotRegex(
            output, "test_harness\.not_heavy_b .*? \[IMPLICT HEAVY\] OK"
        )
        self.assertNotRegex(
            output,
            "test_harness\.not_heavy_on_singleton_a_and_singleton_b .*? \[IMPLICT HEAVY\] OK",
        )
    ...
    def testSoftHeavy(self):
        ...
        self.assertRegex(
            output, "test_harness\.heavy_on_not_heavy_a_and_not_heavy_b .*? OK"
        )
        ...
        self.assertNotRegex(
            output, "test_harness\.heavy_on_not_heavy .*? \[IMPLICT HEAVY\] OK"
        )
        self.assertNotRegex(
            output,
            "test_harness\.heavy_on_heavy_a_and_heavy_b .*? \[IMPLICT HEAVY\] OK",
        )
        self.assertNotRegex(
            output,
            "test_harness\.heavy_on_not_heavy_a_and_not_heavy_b .*? \[IMPLICT HEAVY\] OK",
        )
        ...
        self.assertNotRegex(
            output, "test_harness\.not_heavy_on_singleton_a_and_singleton_b.*?"
        )

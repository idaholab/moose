...
class Tester(MooseObject):
    ...
    def __init__(self, name, params):
        ...
        # Enumerate the possible status buckets
        self.bucket_success = 'PASS'
        self.bucket_fail    = 'FAIL'
        self.bucket_diff    = 'DIFF'
        self.bucket_pbs     = 'PBS'
        self.bucket_pending = 'PENDING'
        self.bucket_deleted = 'DELETED'
        self.bucket_skip    = 'SKIP'
        self.bucket_silent  = 'SILENT'

        # Create a color for our different statuses
        self.BUCKET_COLOR = { self.bucket_success : 'GREEN',
                              self.bucket_fail    : 'RED',
                              self.bucket_diff    : 'YELLOW',
                              self.bucket_pbs     : 'CYAN',
                              self.bucket_pending : 'YELLOW',
                              self.bucket_deleted : 'RED',
                              self.bucket_skip    : 'RESET'}
    ...
    def getColor(self, status):
        if status in self.BUCKET_COLOR:
            return self.BUCKET_COLOR[status]
        return 'RESET'
